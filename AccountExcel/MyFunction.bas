...
Public Sub Con()
    ...
    With Cn
        ...
        .ConnectionString = "Provider=SQLOLEDB.1;Integrated Security=SSPI; " & _
           "Persist Security Info=False;Initial Catalog=S" & _
           SysSQLServerDataBaseName & ";Data Source=" & SysSQLServerName & ""
            
        If SysSQLServerType = LocalServer Then
            .ConnectionString = "Provider=SQLOLEDB.1;Integrated Security=SSPI; " & _
               "Persist Security Info=False;Initial Catalog=" & _
               SysSQLServerDataBaseName & ";Data Source=" & _
               SysSQLServerName & ";Port=1433"
        
        ElseIf SysSQLServerType = RemoteServer Then
            ...
            If SysSQLServerTypeTechnical = server1 Then
                .ConnectionString = "Provider=SQLOLEDB.1;Integrated Security=SSPI; " & _
                   "Persist Security Info=False;Initial Catalog=" & _
                   SysSQLServerDataBaseName & ";Data Source=" & SysSQLServerName & ";Port=1433"
            Else
                '        .ConnectionString = "Provider=SQLOLEDB.1;Password=salim;Persist Security Info=True;User ID=salim;Initial Catalog=" & SystemOptions.SysSQLServerDataBaseName & ";Data Source=" & SystemOptions.SysSQLServerName
                If SysSQLServerUserpassword = "" Then SysSQLServerUserpassword = "Admin@123"
                If SysSQLServerUserId = "" Then SysSQLServerUserId = "sa"
                .ConnectionString = "Provider=SQLOLEDB.1;Password=" & SysSQLServerUserpassword & _
                   ...
                   ";Initial Catalog=" & SysSQLServerDataBaseName & _
