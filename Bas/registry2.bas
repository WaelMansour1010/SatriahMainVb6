...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_currency_rate = 1: Exit Function
'    get_currency_rate = IIf(IsNull(Rs3("rate").value), 1, Rs3("rate").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then check_bill_voucher = 0: Exit Function
'    check_bill_voucher = IIf(IsNull(Rs3("Transaction_ID").value), 0, Rs3("Transaction_ID").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_transaction_id = 0: Exit Function
'    get_transaction_id = IIf(IsNull(Rs3("Transaction_ID").value), 0, Rs3("Transaction_ID").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_transaction_idByNoteSerial1 = 0: Exit Function
'    get_transaction_idByNoteSerial1 = IIf(IsNull(Rs3("Transaction_ID").value), 0, Rs3("Transaction_ID").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then Get_item_Cost_price = 0: Exit Function
'    Get_item_Cost_price = IIf(IsNull(Rs3("Price").value), 0, Rs3("Price").value): Exit Function
'    Rs3.Close
'
'End Function
'Public Function save_employee_prohectt_EndDate(EndDate As Date, toid As Integer, Emp_id As Integer)
'
'  '  Dim sql As String
...
'End Function
'Public Function save_employee_current_status(project_id As Integer, _
'                                             term_fullcode As String, _
'                                             opr_fullcode As String, _
'                                             Emp_id As Integer)
'    Dim sql As String
'    sgl = "update  TblEmployee  set project_id=" & IIf(Not IsNumeric(project_id), 0, project_id)
...
'End Function
'
' Public Function getActualpayedToContract(ContNo As Integer, Optional ByRef RentValuePayed As Double, Optional ByRef WaterPayed As Double, Optional ByRef TelandNetPayed As Double, Optional ByRef ElectricPayed As Double)
'    Dim sql As String
'    Dim i As Integer
...
'
'
'   Public Function saveContractInstallments(NoteID As Double, RecordDate As Date, RecordDateH As String _
'                                       , Optional Total As Double, Optional RentValuePayed As Double, Optional CommissionsPayed As Double, Optional InsurancePayed As Double, Optional WaterPayed As Double, Optional ElectricPayed As Double, Optional TelandNetPayed As Double, Optional EmpID As Integer, Optional ContNo As Integer)
'
'    Dim sql As String
'    Dim i As Integer
'    Dim rs As New ADODB.Recordset
...
'End Function
'
' Public Function saveContractInstallmentsxxyd(NoteID As Double, RecordDate As Date, RecordDateH As String _
'                                       , Optional Total As Double, Optional RentValuePayed As Double, Optional CommissionsPayed As Double, Optional InsurancePayed As Double, Optional WaterPayed As Double, Optional ElectricPayed As Double, Optional TelandNetPayed As Double, Optional EmpID As Integer, Optional ContNo As Integer)
'
'    Dim sql As String
'    Dim i As Integer
...
'
'
'Public Function saveContractInstallmentsxx(NoteID As Double, RecordDate As Date, RecordDateH As String _
'                                       , Optional Total As Double, Optional RentValuePayed As Double, Optional CommissionsPayed As Double, Optional InsurancePayed As Double, Optional WaterPayed As Double, Optional ElectricPayed As Double, Optional TelandNetPayed As Double, Optional EmpID As Integer, Optional ContNo As Integer)
'
'    Dim sql As String
'    Dim i As Integer
...
'                                       Optional Total As Double, Optional NoteID As Double)
'
'    Dim sql As String
'    Dim i As Integer
'    Dim rs As New ADODB.Recordset
...
'
'
'  Public Function getinsttPayedTocontract(Optional ContNo As Double = 0, Optional ByRef RentValuePayed As Double, Optional ByRef CommissionsPayed As Double, Optional ByRef InsurancePayed As Double, Optional ByRef WaterPayed As Double, Optional ByRef ElectricPayed As Double, Optional ByRef TelandNetPayed As Double, Optional ByRef TotalOldValue As Double, Optional NoteID As Double, Optional Typ As Integer = 0, Optional ByRef VATPayed As Double) As Double
'    On Error Resume Next
'
'    Dim Total As Single
'
...
'End Function
'
' Public Function getinsttPayedTocontractxxy(Optional ContNo As Double = 0, Optional ByRef RentValuePayed As Double, Optional ByRef CommissionsPayed As Double, Optional ByRef InsurancePayed As Double, Optional ByRef WaterPayed As Double, Optional ByRef ElectricPayed As Double, Optional ByRef TelandNetPayed As Double) As Double
'    On Error Resume Next
'
'    Dim Total As Single
'
...
'  '  getinsttPayedTocontract = Total
'End Function
'Public Function getBillPayedToproject(Optional bill_id As Integer = 0) As Double
'    On Error Resume Next
'
'    Dim Total As Single
'
...
'    checkitems = True
'
'    If opr_fullcode = "" Then Exit Function
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then Get_currency_txt = "": Exit Function
'    If SystemOptions.UserInterface = ArabicInterface Then
'        Get_currency_txt = IIf(IsNull(Rs3("name").value), "", Rs3("name").value): Exit Function
'    Else
'        Get_currency_txt = IIf(IsNull(Rs3("namee").value), "", Rs3("namee").value): Exit Function
'    End If
'
'    Rs3.Close
'
...
'                          Optional date_from, _
'                          Optional NoteType As Integer, _
'                          Optional notes_id As Variant = -1, Optional notevale As String, Optional NoteSerial1 As Double)
'
'
...
'    Dim sAns  As String
'
'    If Not IsDate(date1) Then ExactAge = "": Exit Function
'    dt = CDate(date1)
'
'    If dt > date2 Then ExactAge = "0-0-0": Exit Function
'
'    yer = year(dt)
'    mon = Month(dt)
'    d = Day(dt)
...
'
'
'Public Function Notes_codingByBreaks(my_branch As Integer, _
'                             date1 As Date, _
'                             Optional departement_name As Integer = 1, Optional ByVal mTableName As String = "", Optional ByVal mUserID As Long = 0, Optional ByRef mSerInv As Long = 0) As String
'    On Error Resume Next
'    Dim start_at As Double
'    Dim end_at As Single
'    Dim auto_sanad_no As String
...
'        'Notes_coding = Voucher_codingByBreaks(my_branch, date1, val(Sanad_No), val(NoteType), departement_name, val(Transaction_Type), CStr(Prefix), val(StoreId), BillType, MosemID, mTableName, mUserID, mSerInv)
'        'Exit Function
'End If
'
'If SystemOptions.IsSerialByUserVouch Then
...
'                               Optional departement_name As Integer = 1, _
'                               Optional Transaction_Type As Integer = 0, _
'                               Optional Prefix As String = "", Optional StoreId As Integer = 0, Optional BillType As Integer = 0, Optional MosemID As Double = 0, Optional ByVal mTableName As String = "", Optional ByVal mUserID As Long = 0, Optional ByRef mSerInv As Long = 0) As String
'
'
'      On Error Resume Next
...
'                  Else
'                    Dim ss As String
'                    Dim rsDuu As New ADODB.Recordset
'                    sql = "select max(CAST (NoteSerial1 AS BigInt)) as last_sand_no from  Transactions where  BranchId= " & my_branch & "  and   Transaction_Type=" & Transaction_Type & "   and year(Transaction_Date)=" & mId(Format$(date1, "dd/mm/yyyy"), 7, 4) & " and month(Transaction_Date)=" & mId(Format$(date1, "dd/mm/yyyy"), 4, 2)
'
'                    ss = sql & " And " & mWhere3 & mWhereUser2
'                    rsDuu.Open ss, Cn, adOpenStatic, adLockReadOnly
'                    If Not rsDuu.EOF Then
'                        If (rsDuu!last_sand_no & "") <> "" Then
'                            sql = last_sand_no
'                        End If
'                    End If
'                    sql = sql & mWhereUser2
...
'storecode = zeropadding(storecode, Int(SystemOptions.StoreDigit))
'
'    If numbering_type = 1 Then Voucher_codingoriginal = auto_sanad_no: Exit Function
'    If first_serial = True Then
'        If auto_sanad_no <> "" Then
'
'            If StoreCoding = True And StoreId <> 0 Then
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_late_COLOR = "": Exit Function
'    Name = IIf(IsNull(Rs3("Name").value), "", Rs3("Name").value)
'    get_late_COLOR = IIf(IsNull(Rs3("COLOR").value), "", Rs3("COLOR").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_item_group_account_in_branch = "Error": Exit Function
...
'
'    If Rs3.RecordCount = 0 Then get_item_group_account_in_branch = "Error": Exit Function
'    get_item_group_account_in_branch = IIf(IsNull(Rs3("account_code").value), "Error", Rs3("account_code").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_item_group_account_inventory = "Error": Exit Function
'    GroupID = IIf(IsNull(Rs3("GroupID").value), 0, Rs3("GroupID").value)
'    Rs3.Close
'
...
'
'    If Rs3.RecordCount = 0 Then get_item_group_account_inventory = "Error": Exit Function
'    get_item_group_account_inventory = IIf(IsNull(Rs3("account_code").value), "Error", Rs3("account_code").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_item_id = 0: Exit Function
'    get_item_id = IIf(IsNull(Rs3("ItemID").value), 0, Rs3("ItemID").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_project_id = 0: Exit Function
'    get_project_id = IIf(IsNull(Rs3("id").value), 0, Rs3("id").value): Exit Function
'    Rs3.Close
'
'End Function
'
'Public Function get_project_customer_account(ID As Integer, _
'                                             account_name As String, Optional CustomerType As Integer = 0) As String
'    Dim Rs3 As ADODB.Recordset
'    Set Rs3 = New ADODB.Recordset
'    Dim sql As String
'    Dim i As Integer
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_project_customer_account = "": Exit Function
'
'    get_project_customer_account = IIf(IsNull(Rs3(account_name).value), 0, Rs3(account_name).value): Exit Function
'
'    Rs3.Close
'
'End Function
...
'                            get_project_customer_id = val(IIf(IsNull(Rs3("End_user_id").value), 0, Rs3("End_user_id").value)): Exit Function
'                         Else
'                         get_project_customer_id = val(IIf(IsNull(Rs3("sub_contractor_id").value), 0, Rs3("sub_contractor_id").value)): Exit Function
'                         End If
'
'             Rs3.Close
'    Rs4.Close
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_item_qty = 0: Exit Function
'    get_item_qty = IIf(IsNull(Rs3("totalqty").value), 0, Rs3("totalqty").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_item_Order_qty = 0: Exit Function
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_item_Reserved_qty = 0: Exit Function
'    get_item_Reserved_qty = IIf(IsNull(Rs3("total_rsv_qty").value), 0, Rs3("total_rsv_qty").value): Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_late_location2 = 0: Exit Function
'
'    For i = 1 To Rs3.RecordCount
'
'        If Rs3("to").value <> 0 Then
'            If days >= Rs3("from").value And days <= Rs3("to").value Then
'                get_late_location2 = Rs3("id").value: Exit Function
'            End If
'
'        Else
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_late_location = 0: Exit Function
'
'    For i = 1 To Rs3.RecordCount
'
'        If Rs3("to").value <> 0 Then
'            If days >= Rs3("from").value And days <= Rs3("to").value Then
'                get_late_location = Rs3("id").value: Exit Function
'            End If
'
'        Else
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_Cheque_report_no = "": Exit Function
'    If IsNull(Rs3("report_no").value) Then get_Cheque_report_no = "": Exit Function
'    If Not IsNull(Rs3("report_no").value) Then get_Cheque_report_no = Rs3("report_no").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_user_name = "": Exit Function
'    If IsNull(Rs3("UserName").value) Then get_user_name = "": Exit Function
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_Notes_id = 0: Exit Function
'    If IsNull(Rs3("NoteID").value) Then get_Notes_id = 0: Exit Function
'    If Not IsNull(Rs3("NoteID").value) Then get_Notes_id = Rs3("NoteID").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'
'    sql = "Select * from TblBranchesData where branch_id=" & ID
'
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_branch_name = "": Exit Function
'    ActivityId = IIf(IsNull(Rs3("ActivityTypeId").value), 0, Rs3("ActivityTypeId").value)
'
'    If SystemOptions.UserInterface = EnglishInterface Then
'        If IsNull(Rs3("branch_nameE").value) Then get_branch_name = "": Exit Function
'        If Not IsNull(Rs3("branch_nameE").value) Then get_branch_name = Rs3("branch_nameE").value
'    Else
'
'        If IsNull(Rs3("branch_name").value) Then get_branch_name = "": Exit Function
'        If Not IsNull(Rs3("branch_name").value) Then get_branch_name = Rs3("branch_name").value
'    End If
'
'    Rs3.Close
'
...
'    Rs4.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs4.RecordCount = 0 Then get_branch_name = "": Exit Function
'    If SystemOptions.UserInterface = EnglishInterface Then
'        If IsNull(Rs4("Namee").value) Then activityName = "": Exit Function
'        If Not IsNull(Rs4("Namee").value) Then activityName = Rs4("Namee").value: Exit Function
'    Else
'
'        If IsNull(Rs4("Name").value) Then activityName = "": Exit Function
'        If Not IsNull(Rs4("Name").value) Then activityName = Rs4("Name").value: Exit Function
'    End If
'
'    Rs4.Close
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then GET_ACCOUNT_CURRENCY = "": Exit Function
'    If SystemOptions.UserInterface = EnglishInterface Then
'        If IsNull(Rs3("branch_nameE").value) Then GET_ACCOUNT_CURRENCY = "": Exit Function
'        If Not IsNull(Rs3("branch_nameE").value) Then GET_ACCOUNT_CURRENCY = Rs3("branch_nameE").value: Exit Function
'    Else
'
'        If IsNull(Rs3("branch_name").value) Then GET_ACCOUNT_CURRENCY = "": Exit Function
'        If Not IsNull(Rs3("branch_name").value) Then GET_ACCOUNT_CURRENCY = Rs3("branch_name").value: Exit Function
'    End If
'
'    Rs3.Close
'End Function
'
'
'Public Function GET_ACCOUNT_name_by_Code(Account_code As String) As String
'    Dim Rs3 As ADODB.Recordset
'    Set Rs3 = New ADODB.Recordset
'    Dim sql As String
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then GET_ACCOUNT_name_by_Code = "": Exit Function
'
'    If SystemOptions.UserInterface = EnglishInterface Then
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_note_type_name = "": Exit Function
'    If IsNull(Rs3("NotesTypeName").value) Then get_note_type_name = "": Exit Function
...
'
'    If Account_code = "" Then
'        If Rs3.RecordCount = 0 Then get_FixedAsset_Account = "": Exit Function
'        If IsNull(Rs3("Account_Code").value) Then get_FixedAsset_Account = "": Exit Function
'        If Not IsNull(Rs3("Account_Code").value) Then get_FixedAsset_Account = Rs3("account_code").value: Exit Function
'    Else
'
'        If Rs3.RecordCount = 0 Then get_FixedAsset_Account = "": Exit Function
'        If IsNull(Rs3(Account_code).value) Then get_FixedAsset_Account = "": Exit Function
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_Revenue_id = 0: Exit Function
'    If IsNull(Rs3("RevenuesID").value) Then get_Revenue_id = 0: Exit Function
'    AccountName = IIf(IsNull(Rs3("RevenuesName").value), "", Rs3("RevenuesName").value)
'
'    If Not IsNull(Rs3("RevenuesID").value) Then get_Revenue_id = Rs3("RevenuesID").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_Expenses_id = 0: Exit Function
'    If IsNull(Rs3("id").value) Then get_Expenses_id = 0: Exit Function
'    AccountName = IIf(IsNull(Rs3("Name").value), "", Rs3("Name").value)
'
'    If Not IsNull(Rs3("id").value) Then get_Expenses_id = Rs3("id").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_Customer_id = 0: Exit Function
'    If IsNull(Rs3("CusID").value) Then get_Customer_id = 0: Exit Function
'    If Not IsNull(Rs3("CusID").value) Then get_Customer_id = Rs3("CusID").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then create_Branch_group = False: Exit Function
'
'    Dim rs As ADODB.Recordset
'    Set rs = New ADODB.Recordset
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then create_Branch_FixedAssets_group = False: Exit Function
'
'    Dim rs As ADODB.Recordset
'    Set rs = New ADODB.Recordset
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then create_inventory_group = False: Exit Function
'    If Rs3.RecordCount > 0 Then
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_Customer_Account = 0: Exit Function
'    If IsNull(Rs3("Account_Code").value) Then get_Customer_Account = 0: Exit Function
'    If Not IsNull(Rs3("Account_Code").value) Then get_Customer_Account = Rs3("Account_Code").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_expanses_id = 0: Exit Function
'    If IsNull(Rs3("id").value) Then get_expanses_id = 0: Exit Function
'    If Not IsNull(Rs3("id").value) Then get_expanses_id = Rs3("id").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_opr_expenses_total = 0: Exit Function
'    If IsNull(Rs3("total").value) Then get_opr_expenses_total = 0: Exit Function
'    If Not IsNull(Rs3("total").value) Then get_opr_expenses_total = Rs3("total").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_opr_material_total = 0: Exit Function
'    If IsNull(Rs3("total").value) Then get_opr_material_total = 0: Exit Function
'    If Not IsNull(Rs3("total").value) Then get_opr_material_total = Rs3("total").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_notes_foxy_no = 0: Exit Function
'    If IsNull(Rs3(filed).value) Then get_notes_foxy_no = 0: Exit Function
'    If Not IsNull(Rs3(filed).value) Then get_notes_foxy_no = Rs3(filed).value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_COST_CENTER_NAME = "": Exit Function
'    If IsNull(Rs3(filed).value) Then get_COST_CENTER_NAME = "": Exit Function
'    If Not IsNull(Rs3(filed).value) Then get_COST_CENTER_NAME = Rs3(filed).value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_EMPLOYEEIdFromAccountCode = 0: Exit Function
'    If IsNull(Rs3(filed).value) Then get_EMPLOYEEIdFromAccountCode = 0: Exit Function
'    If Not IsNull(Rs3(filed).value) Then get_EMPLOYEEIdFromAccountCode = Rs3(filed).value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_StoreBYSalesPerson = 0: Exit Function
'    If IsNull(Rs3("StoreID").value) Then get_StoreBYSalesPerson = 0: Exit Function
'    If Not IsNull(Rs3("StoreID").value) Then get_StoreBYSalesPerson = Rs3("StoreID").value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'                                  filed As String, Optional ByRef jobstatus As Integer = 0) As String
'    Dim Rs3 As ADODB.Recordset
'    Set Rs3 = New ADODB.Recordset
'    Dim sql As String
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_EMPLOYEE_Data = "": Exit Function
'    If IsNull(Rs3(filed).value) Then get_EMPLOYEE_Data = "": Exit Function
'    If Not IsNull(Rs3(filed).value) Then get_EMPLOYEE_Data = Rs3(filed).value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_EMPLOYEE_COST_CENTER_NAME = "": Exit Function
'    If IsNull(Rs3(filed).value) Then get_EMPLOYEE_COST_CENTER_NAME = "": Exit Function
'    If Not IsNull(Rs3(filed).value) Then get_EMPLOYEE_COST_CENTER_NAME = Rs3(filed).value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_NO_OF_row = 0: Exit Function
'    get_NO_OF_row = Rs3.RecordCount: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_EMPLOYEE_Account = "": Exit Function
'    If IsNull(Rs3(filed).value) Then get_EMPLOYEE_Account = "": Exit Function
'    If Not IsNull(Rs3(filed).value) Then get_EMPLOYEE_Account = Rs3(filed).value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then Change_filed_value = False: Exit Function
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_project_Account = "": Exit Function
'    If IsNull(Rs3(filed).value) Then get_project_Account = "": Exit Function
'    If Not IsNull(Rs3(filed).value) Then get_project_Account = Rs3(filed).value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_bank_Account = "": Exit Function
'    If IsNull(Rs3(filed).value) Then get_bank_Account = "": Exit Function
'    If Not IsNull(Rs3(filed).value) Then get_bank_Account = Rs3(filed).value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then get_store_Account = "": Exit Function
'    If IsNull(Rs3(filed).value) Then get_store_Account = "": Exit Function
'    If Not IsNull(Rs3(filed).value) Then get_store_Account = Rs3(filed).value: Exit Function
'    Rs3.Close
'
'End Function
'
...
'End Function
'
'Public Function getCustomerAgeingData(StrAccountCode As String, Optional ByRef salesPersonName As String, Optional allCustomer As Boolean = False, Optional OnlyCheck As Boolean = False) As String
...
'                      Optional FromDate As Date, _
'                      Optional toDate As Date, _
'                      Optional manyString As Boolean = False, Optional BranchID As Integer = 0)
...
'    Rs3.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
'
'    If Rs3.RecordCount = 0 Then getFixedAsstName = "":   code = "": Exit Function
'    If IsNull(Rs3(filed).value) Then getFixedAsstName = "":   code = "": Exit Function
'     If Not IsNull(Rs3(filed).value) Then getFixedAsstName = Rs3(filed).value:     Exit Function
'    Rs3.Close
'
'End Function
'
...
'                                     Optional ByRef KhordaPrice As Double, _
'                                     Optional ByRef group_id As Integer, Optional DepitAccount As String, Optional CreditAccount As String, Optional ByRef PurchaseDate As Date, Optional branch_no As Integer)
'    Dim noOfInstallments As Double
'    Dim sql As String
...
'
'
' Public Function getinsttPayedTocontract2(Optional ContNo As Double = 0, Optional ByRef RentValuePayed As Double, Optional ByRef CommissionsPayed As Double, Optional ByRef InsurancePayed As Double, Optional ByRef WaterPayed As Double, Optional ByRef ElectricPayed As Double, Optional ByRef TelandNetPayed As Double, Optional ByRef TotalOldValue As Double, Optional NoteID As Double, Optional Typ As Integer = 0, Optional ByRef VATPayed As Double, Optional ByVal mData As String = "", Optional ByVal DateTypeHij As Boolean = False) As Double
'    On Error Resume Next
'
'    Dim Total As Single
'
...
'        StoreCoding = IIf(IsNull(rs("StoreCoding").value), 0, rs("StoreCoding").value)
'        YearDigit = IIf(IsNull(rs("YearDigit").value), 4, rs("YearDigit").value)
'        IsBreaks = IIf(IsNull(rs("IsBreaks").value), 0, rs("IsBreaks").value)
'        IsCodeByBranch = IIf(IsNull(rs("IsCodeByBranch").value), 0, rs("IsCodeByBranch").value)
'        IsSerialByUser = IIf(IsNull(rs("IsSerialByUser").value), 0, rs("IsSerialByUser").value)
'        Breaks = IIf(IsNull(rs("Breaks").value), "", rs("Breaks").value)
'
'        storepadding = SystemOptions.StoreDigit - 1
'        If YearDigit = 0 Then YearDigit = 4
'
...
'      If Sanad_No = 62 Then
'                mWhereBranchYear = " Year(NoteDate) = " & year(date1)
'                sql = "select max(Ser) as last_sand_no from  Notes    where  branch_no= " & my_branch & "  and     (NoteType= 9 or NoteType= 10)  "
'                sql = sql & mWhereUser
'        End If
'
'          If Sanad_No = 64 Then
...
'      If Sanad_No = 62 Then
'           mWhereBranchYear = " Year(NoteDate) = " & year(date1) & " and Month(NoteDate) =  " & Month(date1)
'                sql = "select max(Ser) as last_sand_no from  Notes where  branch_no= " & my_branch & "  and   (NoteType= 9 or NoteType= 10)    and year(NoteDate)=" & mId(Format$(date1, "dd/mm/yyyy"), 7, 4) & " and month(NoteDate)=" & mId(Format$(date1, "dd/mm/yyyy"), 4, 2)
'            sql = sql & " and " & mWhere3
'           sql = sql & mWhereUser
'        End If
'        ''////
...
'        If Sanad_No = 62 Then
'
'                sql = "select max(Ser) as last_sand_no from  Notes where  branch_no= " & my_branch & "  and   (NoteType= 9 or NoteType= 10)     and year(NoteDate)=" & mId(Format$(date1, "dd/mm/yyyy"), 7, 4)
'
'                sql = sql & mWhereUser
'                sql = sql & " and " & mWhere3
'        End If
...
'
'
'    If numbering_type = 1 Then Voucher_codingByBreaks = auto_sanad_no: Exit Function
'    If first_serial = True Then
'        If auto_sanad_no <> "" Then
'
'            If StoreCoding = True And StoreId <> 0 Then
