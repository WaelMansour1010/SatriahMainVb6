Attribute VB_Name = "registry3546"
 ...
 '        End If
    ...
    If Rs3.RecordCount = 0 Or IsNull(Rs3("last_sand_no").value) Then
        ...
        ElseIf numbering_type = 2 Then
            ...
            If IsCodeByBranch Then
                mSerInv = 1
                auto_sanad_no = mSerInv & Breaks & Month(date1) & Breaks & year(date1) & Breaks & mUserID
            Else
                auto_sanad_no = mSerInv & Breaks & Breaks & year(date1) & Breaks & mUserID
            End If
        ...
        ElseIf numbering_type = 3 Then
            ...
            If IsCodeByBranch Then
                auto_sanad_no = "1" & Breaks & Month(date1) & Breaks & year(date1) & Breaks & mUserID
            Else
                auto_sanad_no = "1" & Breaks & Breaks & year(date1) & Breaks & mUserID
            End If
    ...
    Else
        ...
        ElseIf numbering_type = 2 Then
                ...
                If IsCodeByBranch Then
                    auto_sanad_no = val(Rs3("last_sand_no").value + 1) & Breaks & Month(date1) & Breaks & year(date1) & Breaks & mUserID
                Else
                    auto_sanad_no = val(Rs3("last_sand_no").value + 1) & Breaks & Breaks & year(date1) & Breaks & mUserID
                End If
