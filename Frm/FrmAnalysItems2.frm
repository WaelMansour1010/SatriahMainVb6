...
Begin VB.Form FrmAnalysItems2 
      ...
      Begin VB.Frame Fra 
         ...
         Begin VB.Frame Frame7 
            ...
            Begin VB.Image Image3 
               Height          =   5715
               Left            =   0
               Picture         =   "FrmAnalysItems2.frx":038A
               Stretch         =   -1  'True
               Top             =   120
               Width           =   4395
            End
         ...
         Begin MSDataListLib.DataCombo DCActivity 
            Bindings        =   "FrmAnalysItems2.frx":28E2
            Height          =   315
            Left            =   120
            TabIndex        =   107
            Top             =   720
      ...
      Begin VB.Frame Fra 
         ...
         Begin VB.Frame Frame4 
            ...
            Begin VB.Image Image2 
               Height          =   5715
               Left            =   0
               Picture         =   "FrmAnalysItems2.frx":28F7
               Stretch         =   -1  'True
               Top             =   120
               Width           =   4395
            End
         ...
         Begin MSDataListLib.DataCombo DCActivity2 
            Bindings        =   "FrmAnalysItems2.frx":4E4F
            Height          =   315
            Left            =   120
            TabIndex        =   109
            Top             =   1440
      ...
      Begin VB.Frame Fra 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.Image Image1 
               Height          =   3675
               Left            =   0
               Picture         =   "FrmAnalysItems2.frx":4E64
               Stretch         =   -1  'True
               Top             =   120
               Width           =   4395
            End
   ...
   End
End
Attribute VB_Name = "FrmAnalysItems2"
...
sql = sql & "                      dbo.TblMultuPayment ON dbo.TblPaymentType.PaymentID = dbo.TblMultuPayment.PaymentID ON dbo.Notes.NoteID = dbo.TblMultuPayment.NoteID LEFT OUTER JOIN"
...
StrSQL = "SELECT     CAST(last_changed AS TIME) Time2,dbo.Transactions.last_changed, dbo.Transactions.Transaction_Type, dbo.Transactions.Transaction_Date, dbo.Transactions.Transaction_NetValue, "
    ...
    End If
     If BrnchesReg <> "-1" Then
       ...
       End If
      If BrnchAct <> "-1" Then
        StrSQL = StrSQL & " ANDTransactions. BranchId in( " & BrnchAct & " )"
       End If
...
End If
  '  StrSQL = StrSQL & " ORDER BY last_changed,CAST(last_changed AS TIME)"
    ...
    StrSQL = "select * from (( SELECT     POSBillType,dbo.Transactions.CashCustomerName,dbo.Transactions.PaymentType, dbo.TblTransactionPayments.id, dbo.TblTransactionPayments.Transaction_ID, dbo.TblTransactionPayments.PaymentID, "
    StrSQL = StrSQL & "                    IsNull(TblTransactionPayments.value,0) * IsNull(TblTransactionPayments.Effect,0) AS Value, dbo.TblTransactionPayments.CardNo, dbo.Transactions.Transaction_Date, dbo.Transactions.Transaction_NetValue,"
    ...
    StrSQL = StrSQL & "                  dbo.TblPaymentType ON dbo.TblTransactionPayments.PaymentID = dbo.TblPaymentType.PaymentID"
     If optPos(0).value = True Then
            StrSQL = StrSQL & "                  WHERE  (dbo.TblTransactionPayments.Transaction_ID IN"
        StrSQL = StrSQL & "   (SELECT        Transaction_ID"
        StrSQL = StrSQL & "   From dbo.transactions"
        StrSQL = StrSQL & "   WHERE        (POSBillType = 1) )))"
    End If
    'where  "
