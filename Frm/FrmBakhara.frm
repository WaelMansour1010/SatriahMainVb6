   ...
   Begin C1SizerLibCtl.C1Elastic C1E»Ì«‰« «·»‰Êﬂ 
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmBakhara.frx":0000
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmBakhara.frx":039A
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmBakhara.frx":0734
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmBakhara.frx":0ACE
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
...
Select Case Index
    Case 0
        ...
        TxtModFlg.text = "N"
        clear_all Me
        XPTxtBankID.text = CStr(new_id("tblBakhara", "code", "", True))
...
Rs.Open "[tblBakhara]", Cn, adOpenStatic, adLockOptimistic, adCmdTable
Me.TxtModFlg.text = "R"
XPBtnMove_Click 2
Exit Sub
ErrTrap:
...
If Me.TxtModFlg.text <> "R" Then
    ...
    Select Case Me.TxtModFlg.text
        Case "N"
            StrSQL = "select * From  tblBakhara where namee='" & Trim(XPTxtBankName.text) & "'"
...
If XPTxtBankID.text <> "" Then
    StrSQL = "select * From Transactions where BakhID=" & Trim(XPTxtBankID.text)
    RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
    If Not (RsTemp.EOF Or RsTemp.BOF) Then
        Msg = "·« Ì„ﬂ‰ Õ–› »Ì«‰«  Â–Â «·»«Œ—…" & Chr(13)
        Msg = Msg + "Â‰«ﬂ »⁄÷ «·⁄„·Ì«  „— »ÿ… »Â–Â «·»«Œ—…"
