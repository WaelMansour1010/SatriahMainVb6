    ...
    Select Case Index
        ...
        Case 2
            ...
            If val(txtAdvPay.text) > val(LblTotal.Caption) Then
                MsgBox "Advance payment value is greater than invoice total"
                txtAdvPay.SetFocus
                Screen.MousePointer = vbDefault
                Exit Sub
            End If
...
chkTaxExempt_Click
    ...
    If Me.XPChkPayType(0).value = vbChecked Then
        If val(CboPayMentType.ListIndex) = 0 Then
            ...
            If ModAccounts.AddNewDev(LngDevID, LngDevNO, StrTempAccountCode, SngTemp - val(txtAdvPay.text), 1, StrTempDes, general_noteid, , , , Me.XPDtbBill.value, Me.DCboUserName.BoundText, val(Me.XPTxtBillID.text), , , SngTemp2, Dccurrency.text, val(txt_Currency_rate.text), , , , , , , , , , , , val(Me.dcBranch.BoundText), , , , , , , , , , , , , , , , , , , , , , , , , , , OtherInformation) = False Then
                GoTo ErrTrap
            End If
            If val(txtAdvPay.text) > 0 Then
                LngDevNO = LngDevNO + 1
                If ModAccounts.AddNewDev(LngDevID, LngDevNO, AdvancedAccount, val(txtAdvPay.text), 1, StrTempDes, general_noteid, , , , Me.XPDtbBill.value, Me.DCboUserName.BoundText, val(Me.XPTxtBillID.text), , , val(txtAdvPay.text), Dccurrency.text, val(txt_Currency_rate.text), , , , , , , , , , , val(Me.dcBranch.BoundText), , , , , , , , , , , , , , , , , , , , , , , , , , , OtherInformation) = False Then
                    GoTo ErrTrap
                End If
            End If
