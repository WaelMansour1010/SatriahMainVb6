...
Begin VB.Form FrmCarAuthontication2 
   BackColor       =   &H00E2E9E9&
   ...
   ClientTop       =   405
   ClientWidth     =   19050
   Icon            =   "FrmCarAuthontication2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame gimage 
      ...
      Begin VB.Image img9 
         Height          =   615
         Left            =   7920
         Picture         =   "FrmCarAuthontication2.frx":038A
         Stretch         =   -1  'True
         Top             =   4440
         Width           =   705
      End
      Begin VB.Image img10 
         Height          =   615
         Left            =   6960
         Picture         =   "FrmCarAuthontication2.frx":0938
         Stretch         =   -1  'True
         Top             =   4680
         Width           =   705
      End
      Begin VB.Image img8 
         Height          =   615
         Left            =   8760
         Picture         =   "FrmCarAuthontication2.frx":0EE6
         Stretch         =   -1  'True
         Top             =   4680
         Width           =   705
      End
      Begin VB.Image img13 
         Height          =   615
         Left            =   2160
         Picture         =   "FrmCarAuthontication2.frx":1494
         Stretch         =   -1  'True
         Top             =   4440
         Width           =   705
      End
      Begin VB.Image img11 
         Height          =   615
         Left            =   5160
         Picture         =   "FrmCarAuthontication2.frx":1A42
         Stretch         =   -1  'True
         Top             =   4560
         Width           =   705
      End
      Begin VB.Image img12 
         Height          =   615
         Left            =   3600
         Picture         =   "FrmCarAuthontication2.frx":1FF0
         Stretch         =   -1  'True
         Top             =   4560
         Width           =   705
      End
      Begin VB.Image img14 
         Height          =   615
         Left            =   600
         Picture         =   "FrmCarAuthontication2.frx":259E
         Stretch         =   -1  'True
         Top             =   4560
         Width           =   705
      End
      Begin VB.Image imag1 
         Height          =   615
         Left            =   8760
         Picture         =   "FrmCarAuthontication2.frx":2B4C
         Stretch         =   -1  'True
         Top             =   1920
         Width           =   705
      End
      Begin VB.Image imag2 
         Height          =   615
         Left            =   7920
         Picture         =   "FrmCarAuthontication2.frx":30FA
         Stretch         =   -1  'True
         Top             =   1680
         Width           =   705
      End
      Begin VB.Image imag3 
         Height          =   615
         Left            =   7080
         Picture         =   "FrmCarAuthontication2.frx":36A8
         Stretch         =   -1  'True
         Top             =   1920
         Width           =   705
      End
      Begin VB.Image imag4 
         Height          =   615
         Left            =   5640
         Picture         =   "FrmCarAuthontication2.frx":3C56
         Stretch         =   -1  'True
         Top             =   1440
         Width           =   705
      End
      Begin VB.Image imag5 
         Height          =   615
         Left            =   4200
         Picture         =   "FrmCarAuthontication2.frx":4204
         Stretch         =   -1  'True
         Top             =   1680
         Width           =   705
      End
      Begin VB.Image img6 
         Height          =   615
         Left            =   2520
         Picture         =   "FrmCarAuthontication2.frx":47B2
         Stretch         =   -1  'True
         Top             =   1800
         Width           =   705
      End
      Begin VB.Image img7 
         Height          =   615
         Left            =   720
         Picture         =   "FrmCarAuthontication2.frx":4D60
         Stretch         =   -1  'True
         Top             =   1680
         Width           =   705
      End
      Begin VB.Image Image6 
         Height          =   5775
         Left            =   -120
         Picture         =   "FrmCarAuthontication2.frx":530E
         Stretch         =   -1  'True
         Top             =   480
         Width           =   9735
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCarAuthontication2.frx":22A5E
         Height          =   555
         Index           =   11
         Left            =   0
         Picture         =   "FrmCarAuthontication2.frx":29D90
         Style           =   1  'Graphical
         TabIndex        =   186
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCarAuthontication2.frx":2A924
         Height          =   555
         Index           =   10
         Left            =   6360
         Picture         =   "FrmCarAuthontication2.frx":2AF0B
         Style           =   1  'Graphical
         TabIndex        =   185
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCarAuthontication2.frx":2B4F2
         Height          =   555
         Index           =   9
         Left            =   720
         Picture         =   "FrmCarAuthontication2.frx":32824
         Style           =   1  'Graphical
         TabIndex        =   184
         Top             =   120
         Width           =   735
      ...
      Begin VB.CommandButton menue 
         ...
         Index           =   8
         Left            =   2040
         Picture         =   "FrmCarAuthontication2.frx":32D44
         Style           =   1  'Graphical
         TabIndex        =   177
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCarAuthontication2.frx":33229
         Height          =   555
         Index           =   7
         Left            =   4200
         Picture         =   "FrmCarAuthontication2.frx":3A55B
         Style           =   1  'Graphical
         TabIndex        =   156
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCarAuthontication2.frx":3ADEB
         Height          =   555
         Index           =   6
         Left            =   5640
         Picture         =   "FrmCarAuthontication2.frx":4211D
         Style           =   1  'Graphical
         TabIndex        =   146
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCarAuthontication2.frx":425BE
         Height          =   555
         Index           =   0
         Left            =   7080
         Picture         =   "FrmCarAuthontication2.frx":498F0
         Style           =   1  'Graphical
         TabIndex        =   145
         Top             =   120
         Width           =   735
      ...
      Begin VB.CommandButton menue 
         ...
         Index           =   1
         Left            =   3240
         Picture         =   "FrmCarAuthontication2.frx":49E97
         Style           =   1  'Graphical
         TabIndex        =   144
         Top             =   840
         Width           =   735
      ...
      Begin VB.CommandButton menue 
         ...
         Index           =   2
         Left            =   4920
         Picture         =   "FrmCarAuthontication2.frx":4A338
         Style           =   1  'Graphical
         TabIndex        =   143
         Top             =   120
         Width           =   735
      ...
      Begin VB.CommandButton menue 
         ...
         Index           =   3
         Left            =   3480
         Picture         =   "FrmCarAuthontication2.frx":4A808
         Style           =   1  'Graphical
         TabIndex        =   142
         Top             =   120
         Width           =   735
      ...
      Begin VB.CommandButton menue 
         ...
         Index           =   4
         Left            =   2760
         Picture         =   "FrmCarAuthontication2.frx":4ACC1
         Style           =   1  'Graphical
         TabIndex        =   141
         Top             =   120
         Width           =   735
      ...
      Begin VB.CommandButton menue 
         ...
         Index           =   5
         Left            =   1440
         Picture         =   "FrmCarAuthontication2.frx":4B219
         Style           =   1  'Graphical
         TabIndex        =   140
         Top             =   120
         Width           =   735
   ...
   Begin C1SizerLibCtl.C1Elastic EleHeader 
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarAuthontication2.frx":4B664
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarAuthontication2.frx":4B9FE
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarAuthontication2.frx":4BD98
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarAuthontication2.frx":4C132
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin VB.Image ImgFavorites 
         Height          =   390
         Left            =   11760
         Picture         =   "FrmCarAuthontication2.frx":4C4CC
         Stretch         =   -1  'True
         Top             =   0
         Width           =   525
      End
   ...
   Begin MSDataListLib.DataCombo Dcbranch 
      Bindings        =   "FrmCarAuthontication2.frx":50134
      Height          =   315
      Left            =   5880
      TabIndex        =   39
      Top             =   735
   ...
   Begin C1SizerLibCtl.C1Tab XPTab301 
      ...
      AccessibleValue =   ""
      AccessibleRole  =   37
      Picture(0)      =   "FrmCarAuthontication2.frx":50149
      Flags(2)        =   2
      Begin C1SizerLibCtl.C1Elastic C1Elastic5 
         ...
         Begin VSFlex8UCtl.VSFlexGrid FG22 
            ...
            FormatString    =   $"FrmCarAuthontication2.frx":504E3
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         Begin VB.Frame lblExt 
            ...
            Begin VSFlex8Ctl.VSFlexGrid fg2 
               ...
               FormatString    =   $"FrmCarAuthontication2.frx":50758
               ScrollTrack     =   0   'False
               ScrollBars      =   2
               ScrollTips      =   0   'False
               MergeCells      =   0
            ...
            Begin ImpulseButton.ISButton Cmd 
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               ButtonImage     =   "FrmCarAuthontication2.frx":508D9
               DrawFocusRectangle=   0   'False
            End
         ...
         Begin VB.Frame LblWork 
            ...
            Begin VSFlex8Ctl.VSFlexGrid fg 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"FrmCarAuthontication2.frx":50E73
               ScrollTrack     =   0   'False
               ScrollBars      =   2
               ScrollTips      =   0   'False
               MergeCells      =   0
            ...
            Begin ImpulseButton.ISButton Cmd 
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               ButtonImage     =   "FrmCarAuthontication2.frx":511EB
               DrawFocusRectangle=   0   'False
            End
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         FrameShadow     =   -2147483632
         FloodStyle      =   1
         _GridInfo       =   $"FrmCarAuthontication2.frx":51785
         AccessibleName  =   ""
         AccessibleDescription=   ""
         AccessibleValue =   ""
         AccessibleRole  =   9
         Begin C1SizerLibCtl.C1Elastic Ele 
            ...
            Begin VB.Frame lblDataCli 
               ...
               Begin VB.CommandButton menue 
                  ...
                  Index           =   12
                  Left            =   14520
                  Picture         =   "FrmCarAuthontication2.frx":517BB
                  Style           =   1  'Graphical
                  TabIndex        =   189
                  Top             =   600
                  Width           =   375
               ...
               Begin VB.CommandButton Command1 
                  ...
                  Height          =   1035
                  Left            =   4200
                  Picture         =   "FrmCarAuthontication2.frx":51C1F
                  TabIndex        =   17
                  Top             =   2010
                  Width           =   1935
               End
               ...
               Begin VB.CommandButton menuet 
                  ...
                  Height          =   405
                  Left            =   4200
                  Picture         =   "FrmCarAuthontication2.frx":55B66
                  TabIndex        =   172
                  Top             =   3120
                  Width           =   1935
               End
               ...
               Begin VB.CommandButton BtImage 
                  ...
                  Height          =   495
                  Left            =   120
                  Picture         =   "FrmCarAuthontication2.frx":560BE
                  TabIndex        =   24
                  Top             =   4560
                  Width           =   3975
               End
               ...
               Begin MSDataListLib.DataCombo DcbCarType 
                  Bindings        =   "FrmCarAuthontication2.frx":5A005
                  Height          =   315
                  Left            =   7200
                  TabIndex        =   9
                  Top             =   600
               ...
               Begin MSDataListLib.DataCombo DcbCarModel 
                  Bindings        =   "FrmCarAuthontication2.frx":5A01A
                  Height          =   315
                  Left            =   7200
                  TabIndex        =   10
                  Top             =   1080
               ...
               Begin MSDataListLib.DataCombo DcbColor 
                  Bindings        =   "FrmCarAuthontication2.frx":5A02F
                  Height          =   315
                  Left            =   7200
                  TabIndex        =   12
                  Top             =   2040
               ...
               Begin MSDataListLib.DataCombo DcbCar 
                  Bindings        =   "FrmCarAuthontication2.frx":5A044
                  Height          =   315
                  Left            =   7200
                  TabIndex        =   212
                  Top             =   2610
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic3 
         ...
         Begin VSFlex8UCtl.VSFlexGrid vchrgrid 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"FrmCarAuthontication2.frx":5A059
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   Begin VB.Image img 
      Height          =   855
      Left            =   22680
      Picture         =   "FrmCarAuthontication2.frx":5A225
      Stretch         =   -1  'True
      Top             =   6000
      Width           =   720
   End
   ...
   Begin VB.Image Image3 
      Height          =   975
      Left            =   15600
      Picture         =   "FrmCarAuthontication2.frx":5A7D3
      Stretch         =   -1  'True
      Top             =   10920
      Visible         =   0   'False
      Width           =   720
   ...
   End
End
Attribute VB_Name = "FrmCarAuthontication2"
...
Private Sub FG22_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
 With FG22
        Select Case .ColKey(Col)
            Case "ActualQty", "isReplaced", "ForUnit", "TotalWithVat", "PriceBDisc", "DiscPercent", "DiscValue"
            .ComboList = ""
            ...
            .ComboList = ""
            Case "ItemPrice", "BeforeVat", "Price"
            Cancel = True
        End Select
...
Function print_report(Optional NoteSerial As String, Optional x As Integer)
 ...
 MySQL = MySQL & "                     dbo.TblCardAuthorizationReform.TypeCustomer, dbo.TblCardAuthorizationReform.OverKM, dbo.TblCustemers.CusName, dbo.TblCustemers.CusNamee,"
 ...
 MySQL = MySQL & " FROM         dbo.TblColor RIGHT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TblCardAuthorizationReform LEFT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TblCustemers ON dbo.TblCardAuthorizationReform.ClientCode = dbo.TblCustemers.Fullcode LEFT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TblUsers ON dbo.TblCardAuthorizationReform.FitterID = dbo.TblUsers.UserID ON dbo.TblColor.Id = dbo.TblCardAuthorizationReform.ColorID LEFT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TblBranchesData ON dbo.TblCardAuthorizationReform.BranchID = dbo.TblBranchesData.branch_id LEFT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TblCarModels ON dbo.TblCardAuthorizationReform.CarModelID = dbo.TblCarModels.Id RIGHT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TBLCarTypes ON dbo.TblCardAuthorizationReform.CarTypeID = dbo.TBLCarTypes.id RIGHT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TblCardAuthorizationReformDetails INNER JOIN"
 MySQL = MySQL & "                     dbo.TblMaintenanceWork ON dbo.TblCardAuthorizationReformDetails.Mainte = dbo.TblMaintenanceWork.Id ON"
 MySQL = MySQL & "                     dbo.TblCardAuthorizationReform.ID = dbo.TblCardAuthorizationReformDetails.ID LEFT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TblEmpDepartments ON dbo.TblCardAuthorizationReformDetails.Deptid = dbo.TblEmpDepartments.DeparmentID LEFT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TblEmployee TblEmployee_1 ON dbo.TblCardAuthorizationReformDetails.empsuper = TblEmployee_1.Emp_ID LEFT OUTER JOIN"
 MySQL = MySQL & "                     dbo.TblEmployee TblEmployee_2 ON dbo.TblCardAuthorizationReformDetails.EmpID = TblEmployee_2.Emp_ID"
 MySQL = MySQL & "  Where (dbo.TblCardAuthorizationReform.id =  " & val(XPTxtID.Text) & ") and (dbo.TblCardAuthorizationReformDetails.type=0)"
If x = 9 Then
...
Dim s As String
s = "Select  TblCardAuthorizationReformItems.beforeVat   ,TblCardAuthorizationReformItems.qty,TblCardAuthorizationReformItems.Price ShowPrice,TblCardAuthorizationReformItems.TotalWithVat localprice,tblItems.ItemCode,tblItems.ItemName,tblItems.ItemNamee from TblCardAuthorizationReformItems Left Outer Join tblItems On tblItems.ItemID =TblCardAuthorizationReformItems.ItemID "
...
Dim year As Integer
   ...
   ' YearMonth
    Set rs = New ADODB.Recordset
    StrSQL = "select * dbo.From TblCardAuthorizationReform     where 1=-1"
       rs.Open StrSQL, Cn, adOpenKeyset, adLockOptimistic, adCmdText
    'rs.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
...
Me.CheckBox2.Caption = "Final"
 ...
 Cmd(9).Caption = "Print"
    ...
    XPTab301.CurrTab = 0
    XPTab301.Caption = "ID card repair data|Reform work|CC|Bills of exchange"
...
'If TransType = 9 And ReturnSales = True Then
    ...
    End If
     ...
     FG22.TextMatrix(LongRow, FG22.ColIndex("Vat2")) = val(FG22.TextMatrix(LongRow, FG22.ColIndex("beforeVat"))) * Percentg / 100
     FG22.TextMatrix(LongRow, FG22.ColIndex("TotalWithVat")) = val(FG22.TextMatrix(LongRow, FG22.ColIndex("beforeVat"))) + val(FG22.TextMatrix(LongRow, FG22.ColIndex("Vat2")))
