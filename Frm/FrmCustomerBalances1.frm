...
Begin VB.Form FrmCustomerBalances1 
   ...
   Begin C1SizerLibCtl.C1Elastic EleMain 
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin ImpulseButton.ISButton CmdPrint 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmCustomerBalances1.frx":0724
            ColorButton     =   14871017
            ColorHighlight  =   16777215
            ColorHoverText  =   16711680
            ColorShadow     =   -2147483637
      ...
      Begin VSFlex8UCtl.VSFlexGrid Fg 
         ...
         FormatString    =   $"FrmCustomerBalances1.frx":0ABE
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Image Image1 
         Height          =   480
         Left            =   30
         Picture         =   "FrmCustomerBalances1.frx":0C4E
         Top             =   30
         Width           =   480
      End
...
Dim RsTemp As New ADODB.Recordset
  ...
  Dim RowNum As Double
    ...
    Dim BolShowRequest As Boolean
        ...
        StrSQL = " SELECT distinct    CusName, CusNamee, CusID, Cus_Phone, Cus_mobile"
...
Set RsTemp = Nothing
 ...
 StrSQL = StrSQL + " Where ( Name like '%" & (TxtSearch) & "%'  or Namee like '%" & (TxtSearch) & "%' )"
...
Private Sub txtQuicSearch_Change()
GetQuicSearch txtQuicSearch
End Sub
