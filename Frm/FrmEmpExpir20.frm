...
Begin VB.Form FrmEmpExpir20 
      ...
      Begin MSComctlLib.ImageList GrdImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir20.frx":058A
               Key             =   "CompanyName"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir20.frx":0924
               Key             =   "Ser"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir20.frx":0CBE
               Key             =   "Vac_Name"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir20.frx":1058
               Key             =   "ShareCount"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir20.frx":13F2
               Key             =   "Dis_Count"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir20.frx":178C
               Key             =   "Bouns"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir20.frx":1B26
               Key             =   "SharesValue"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir20.frx":20C0
               Key             =   "BuyValue"
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame Frm2 
      ...
      Begin VB.ComboBox CmbType 
         BackColor       =   &H80000018&
         Height          =   315
         ItemData        =   "FrmEmpExpir20.frx":245A
         Left            =   2280
         List            =   "FrmEmpExpir20.frx":246A
         RightToLeft     =   -1  'True
   ...
   Begin C1SizerLibCtl.C1Elastic EltCont 
      ...
      Begin ImpulseButton.ISButton btnNew 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir20.frx":2483
      ...
      Begin ImpulseButton.ISButton btnSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir20.frx":281D
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnModify 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir20.frx":2BB7
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnUndo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir20.frx":2F51
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnDelete 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir20.frx":32EB
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnQuery 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir20.frx":3885
      ...
      Begin ImpulseButton.ISButton BtnUpdate 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir20.frx":3C1F
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir20.frx":3FB9
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
   ...
   Begin VSFlex8Ctl.VSFlexGrid Grid 
      ...
      FormatString    =   $"FrmEmpExpir20.frx":4353
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin ImpulseButton.ISButton btnCancel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmEmpExpir20.frx":451F
      ColorButton     =   14871017
      DrawFocusRectangle=   0   'False
      DisabledImageStyle=   1
   End
End
Attribute VB_Name = "FrmEmpExpir20"
...
Private Sub Command1_Click()
    ...
    My_SQL = "SELECT   * from TblLC WHERE      Todate   >=" & SQLDate(d1.value, True) & "AND Todate <=" & SQLDate(d2.value, True)
    My_SQL = My_SQL & " order by Todate,LcNo"
    FillGridWithData
...
Command1_Click
    ...
    Set xReport = xApp.OpenReport(App.path & "\reports\REPORTS NEW\LCAlarms.rpt")
    xReport.Database.SetDataSource rs
    Dim FrmReport As New FrmReportViewer
    '   FrmReport = New FrmReportViewer
    FrmReport.CRViewer.ReportSource = xReport
    FrmReport.TxtPath = (App.path & "\reports\REPORTS NEW\LCAlarms.rpt")
...
Private Sub Form_Load()
    ...
    Askinterval = GetSetting(StrAppRegPath, "Setting", "INTERVAL_LC", "D")
    Askcount = GetSetting(StrAppRegPath, "Setting", "count_LC", 0)
    My_SQL = "SELECT     * from dbo.TBLLC Where Todate<='" & SQLDate(DateAdd(Askinterval, Askcount, Date)) & "'"
...
Function ChangeLang()
    ...
    With Me.Grid
        .TextMatrix(0, .ColIndex("LCNO")) = " LCNO "
        .TextMatrix(0, .ColIndex("Name")) = "Name "
        .TextMatrix(0, .ColIndex("Value")) = "value."
        .TextMatrix(0, .ColIndex("fromdate")) = "Open date"
        .TextMatrix(0, .ColIndex("CloseDate")) = "CloseDate"
    ...
    With Me.Grid
        ...
        If rs.RecordCount > 0 Then
            ...
            For i = 1 To .Rows - 1
                ...
                '
                .TextMatrix(i, .ColIndex("LCNO")) = IIf(IsNull(rs.Fields("LCNO").value), "", rs.Fields("LCNO").value)
If SystemOptions.UserInterface = ArabicInterface Then
                ...
                .TextMatrix(i, .ColIndex("CloseDate")) = IIf(IsNull(rs.Fields("Todate").value), "", rs.Fields("Todate").value)
            
             
                .TextMatrix(i, .ColIndex("days")) = IIf(IsNull(rs.Fields("Todate").value), "", DateDiff("d", Date, rs.Fields("Todate").value))
