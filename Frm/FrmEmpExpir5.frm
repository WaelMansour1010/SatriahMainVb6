...
Begin VB.Form FrmEmpExpir5 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "«”„«¡ «·„ÊŸ›Ì‰ «· Ì ” ‰ ÂÌ —Œ’ «ﬁÌ«œ Â„"
   ClientHeight    =   6210
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   15105
   Icon            =   "FrmEmpExpir5.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList GrdImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir5.frx":058A
               Key             =   "CompanyName"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir5.frx":0924
               Key             =   "Ser"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir5.frx":0CBE
               Key             =   "Vac_Name"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir5.frx":1058
               Key             =   "ShareCount"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir5.frx":13F2
               Key             =   "Dis_Count"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir5.frx":178C
               Key             =   "Bouns"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir5.frx":1B26
               Key             =   "SharesValue"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir5.frx":20C0
               Key             =   "BuyValue"
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame Frm2 
      ...
      Begin VB.ComboBox CmbType 
         BackColor       =   &H80000018&
         Height          =   315
         ItemData        =   "FrmEmpExpir5.frx":245A
         Left            =   2280
         List            =   "FrmEmpExpir5.frx":246A
         RightToLeft     =   -1  'True
   ...
   Begin C1SizerLibCtl.C1Elastic EltCont 
      ...
      Begin ImpulseButton.ISButton btnNew 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir5.frx":2483
      ...
      Begin ImpulseButton.ISButton btnSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir5.frx":281D
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnModify 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir5.frx":2BB7
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnUndo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir5.frx":2F51
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnDelete 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir5.frx":32EB
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnQuery 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir5.frx":3885
      ...
      Begin ImpulseButton.ISButton BtnUpdate 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir5.frx":3C1F
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir5.frx":3FB9
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
   ...
   Begin VSFlex8Ctl.VSFlexGrid Grid 
      ...
      FormatString    =   $"FrmEmpExpir5.frx":4353
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin ImpulseButton.ISButton btnCancel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmEmpExpir5.frx":4524
      ColorButton     =   14871017
      DrawFocusRectangle=   0   'False
      DisabledImageStyle=   1
   End
   ...
   End
End
Attribute VB_Name = "FrmEmpExpir5"
...
Private Sub Command1_Click()
  ...
  If date_type = 0 Then date_type = 1
    ...
    My_SQL = "SELECT   * from dbo.TblEmployee WHERE    (NOT (dbo.TblEmployee.DriverLicense IS NULL )) and DriverLicenseend >=" & SQLDate(d1.value, True) & "  AND DriverLicenseend <=" & SQLDate(d2.value, True)
My_SQL = My_SQL & " order by DriverLicenseend,fullcode"
...
Command1_Click
    ...
    Set xReport = xApp.OpenReport(App.path & "\reports\emp\REPORT13.rpt")
    xReport.Database.SetDataSource rs
    Dim FrmReport As New FrmReportViewer
    '   FrmReport = New FrmReportViewer
    FrmReport.CRViewer.ReportSource = xReport
    FrmReport.TxtPath = (App.path & "\reports\emp\REPORT13.rpt")
...
Function ChangeLang()
    ...
    With Me.Grid
        ...
        .TextMatrix(0, .ColIndex("NumLicn")) = "Num."
        .TextMatrix(0, .ColIndex("placeWORK")) = "Work Place"
        .TextMatrix(0, .ColIndex("DateExpLincH")) = "Issue Date H"
        .TextMatrix(0, .ColIndex("DateEndLincH")) = "Expire Date H"
        .TextMatrix(0, .ColIndex("DateExpLinc")) = "Issue Date G"
        .TextMatrix(0, .ColIndex("DateEndLinc")) = "Expire Date G"
        ...
        If rs.RecordCount > 0 Then
            ...
            For i = 1 To .Rows - 1
               ...
               .TextMatrix(i, .ColIndex("Emp_id")) = IIf(IsNull(rs.Fields("Emp_id").value), "", rs.Fields("Emp_id").value)
                ...
                .TextMatrix(i, .ColIndex("NumLicn")) = IIf(IsNull(rs.Fields("DriverLicense").value), "", rs.Fields("DriverLicense").value)
            
                .TextMatrix(i, .ColIndex("placeWORK")) = IIf(IsNull(rs.Fields("placeWORK").value), "", rs.Fields("placeWORK").value)
            
                .TextMatrix(i, .ColIndex("DateExpLincH")) = IIf(IsNull(rs.Fields("DriverLicenseStartdH").value), "", rs.Fields("DriverLicenseStartdH").value)
                .TextMatrix(i, .ColIndex("DateEndLincH")) = IIf(IsNull(rs.Fields("DriverLicenseendH").value), "", rs.Fields("DriverLicenseendH").value)
            
             '   .TextMatrix(i, .ColIndex("DateExpLinc")) = IIf(IsNull(rs.Fields("DateExpLinc").value), "", rs.Fields("DateExpLinc").value)
            
                .TextMatrix(i, .ColIndex("DateEndLinc")) = IIf(IsNull(rs.Fields("DriverLicenseend").value), "", rs.Fields("DriverLicenseend").value)
            
                .TextMatrix(i, .ColIndex("Days")) = IIf(IsNull(rs.Fields("DriverLicenseend").value), "", DateDiff("d", Date, rs.Fields("DriverLicenseend").value))
