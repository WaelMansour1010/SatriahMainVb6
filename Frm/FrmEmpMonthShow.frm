...
Private Sub LoadFgLayout()
    ...
    With Me.Fg
        ...
        For i = .FixedCols To .Cols - 1 Step 5
            .Cell(flexcpText, 1, i, 1, i) = "Õ÷Ê—"
            .Cell(flexcpText, 1, i + 1, 1, i + 1) = " √ŒÌ—"
            .Cell(flexcpText, 1, i + 2, 1, i + 2) = "≈‰’—«›"
            .Cell(flexcpText, 1, i + 3, 1, i + 3) = "” «·⁄„·"
            .Cell(flexcpText, 1, i + 4, 1, i + 4) = "«·≈÷«›Ì"
        
        Next i

        .MergeRow(0) = True
        .MergeRow(1) = True
        StrTemp = " «”„ «·„ÊŸ› " & Chr(13) & " √Ì«„ «·‘Â— "
