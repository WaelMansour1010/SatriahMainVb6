...
Begin VB.Form Ageng_all 
   ...
   Begin C1SizerLibCtl.C1Elastic EleMain 
      ...
      Begin C1SizerLibCtl.C1Tab C1Tab1 
         ...
         Caption         =   "«⁄„«— «·œÌÊ‰| ﬁ«—Ì— «·ﬁÌ„… «·„÷«›…|”œ«œ «·—Ê« »| ﬁ«—Ì— «· Õ’Ì·« | ﬁ«—Ì— «·Õ«ÊÌ« | ﬁ«—Ì— œŒÊ· «·„⁄œ« /«·”Ì«—« "
         Align           =   0
         CurrTab         =   1
         FirstTab        =   0
         Style           =   3
...
sql = sql & "  )) x),"
 ...
 ' End If
   ...
   If SystemOptions.UserInterface = ArabicInterface Then
   desc = desc & "«·Õ”«» " & ": " & DboParentAccount.text & CHR(13)
   Else
...
AddTofaforites Me.Name, " ﬁ«—Ì—", " ﬁ«—Ì—"
End Sub
...
'              If SystemOptions.UserInterface = ArabicInterface Then
'                SortByEmployee = MsgBox("Â·  —Ìœ ›—“ »«·„‰œÊ»  ", vbInformation + vbYesNoCancel)
'            Else
...
XPDtbTransTimeTo.value = Null
    ...
    cmbRecType.AddItem "ÌÊ„Ì"
    cmbRecType.AddItem "”«⁄« "
    cmbRecType.AddItem "»«·„ﬁÿÊ⁄Ì…"
    cmbRecType.AddItem "‘Â—Ì"
    cmbRecType.AddItem "”‰ÊÌ"
...
Function CuurentLogdata(Optional Currentmode As String)
    ...
    LogTextA = LogTextA & "   Õ Ï  «—ÌŒ  " & DTP_Date.value
...
sql = sql & "  ORDER BY dbo.notes.NoteSerial1"
    ...
    End If
    If docType = 3 Then
    StrReportTitle = " Õ·Ì·Ì „’—Ê›« "
     ElseIf docType = 80 Then
    StrReportTitle = "«·›Ê« Ì— «·„«·Ì…  "
    
    ElseIf docType = 802 Then
    StrReportTitle = "›Ê« Ì— ‘—«¡ «·«’Ê·    "
    ElseIf docType = 85 Then
    StrReportTitle = "«·›Ê« Ì— «·Œœ„Ì…  "
...
ElseIf (docType = 80) Then
 sql = sql & " and    (bill_type =0 or bill_type =1) AND (dbo.DOUBLE_ENTREY_VOUCHERS.Credit_Or_Debit = 0) and dbo.Notes.notetype =" & 80 '›« Ê—… „«·Ì…
 
 
ElseIf (docType = 802) Then
 sql = sql & " and   bill_type =2 and dbo.Notes.notetype =" & 80 '›« Ê—… «’Ê·
ElseIf (docType = 8028) Then
 sql = sql & " and   bill_type =2 and dbo.Notes.notetype =" & 8028 '›« Ê—… «’Ê·
...
ElseIf (docType = 85) Then
 ...
 sql = sql & " and    dbo.notes_all.notetype =" & 85  '›« Ê—…  ’—ﬁ«  ⁄ﬁ«—Ì…
 sql = sql & " and  isnull(AkarPayCheck,0) =1"
 
ElseIf (docType = 350) Then
 sql = sql & " and    dbo.notes_all.notetype =" & 350 '   ’›ÌÂ ⁄Âœ…
...
sql = sql & "  ORDER BY dbo.Notes.NoteSerial1"
  ...
  If OptType(0).value = True Then
     StrReportTitle = "  ”ÊÌ«  ﬁÌ„… „÷«›… „œÌ‰… "

 ElseIf OptType(1).value = True Then
     StrReportTitle = " ”ÊÌ«  ﬁÌ„… „÷«›… œ«∆‰…"
Else
StrReportTitle = "  ”ÊÌ«  «·ﬁÌ„… «·„÷«›Ï…   "
...
sql = sql & "  ORDER BY dbo.Notes.NoteSerial1"
  ...
  If OptType(0).value = True Then
     StrReportTitle = " «·ﬁÌ„… «·„÷«›Ï… ··«‘⁄«—«  «·„œÌ‰… "

 ElseIf OptType(1).value = True Then
     StrReportTitle = "«·ﬁÌ„… «·„÷«›Ï… ··«‘⁄«—«  «·œ«∆‰"
Else
StrReportTitle = "«·ﬁÌ„… «·„÷«›Ï… ··«‘⁄«—«   "
...
sql = sql & " ORDER BY dbo.TblContract.NoteSerial1, dbo.TblContractInstallments.Installdate, dbo.TblContractInstallments.InstallNo"
    ...
    End If
 If Typ = 1 Then
     StrReportTitle = " Õ·Ì·   ⁄ﬁÊœ «·«ÌÃ«— «·”ﬂ‰Ì "
  Else
    StrReportTitle = " Õ·Ì·   ⁄ﬁÊœ «·«ÌÃ«— «· Ã«—Ì… "
 End If
    xReport.ParameterFields(3).AddCurrentValue user_name
    xReport.reporttitle = StrReportTitle
    xReport.EnableParameterPrompting = False
...
'------------------
    ...
    If Dcbranch2.BoundText <> "" Then
        If SystemOptions.UserInterface = ArabicInterface Then
             StrDesReport = StrDesReport & CHR(13) & "«·›—⁄ : " & Dcbranch2.text
         Else
    ...
    If Me.DcCustmer.BoundText <> "" Then
        StrDesReport = StrDesReport & CHR(13) & "Ã—  ⁄·Ï «·⁄„Ì·: " & Me.DcCustmer.text
    ...
    If Me.DcboBox(2).BoundText <> "" Then
        StrDesReport = StrDesReport & CHR(13) & "Ã—  ⁄·Ï «·Œ“‰…: " & Me.DcboBox(2).text
    ...
    If Not IsNull(txtFromDate.value) Then
        If SystemOptions.UserInterface = ArabicInterface Then
            StrDesReport = StrDesReport & CHR(13) & " «—ÌŒ «·Õ—ﬂ«  Ì»œ« „‰:" & DisplayDate(txtFromDate.value)
        Else
    ...
    If Not IsNull(txtToDate.value) Then
        If SystemOptions.UserInterface = ArabicInterface Then
            StrDesReport = StrDesReport & CHR(13) & " «—ÌŒ «·Õ—ﬂ«  Ì‰ ÂÏ Õ Ï:" & DisplayDate(txtToDate.value)
        Else
...
'End If
    ...
    Else
        Screen.MousePointer = vbArrowHourglass
        Set xReport = xApp.OpenReport(StrFileName)
        xReport.reporttitle = StrReportDes ' " ﬁ«—Ì— «·„ﬁ»Ê÷« "
