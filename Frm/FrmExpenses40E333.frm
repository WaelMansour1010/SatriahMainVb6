...
Begin VB.Form FrmExpenses40E333 
   BackColor       =   &H00E2E9E9&
   ...
   ClientWidth     =   9960
   HelpContextID   =   280
   Icon            =   "FrmExpenses40E333.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin MSDataListLib.DataCombo AccountVat 
            Bindings        =   "FrmExpenses40E333.frx":038A
            Height          =   315
            Left            =   0
            TabIndex        =   194
            Top             =   0
      ...
      Begin VB.ComboBox CboType2 
         Height          =   315
         ItemData        =   "FrmExpenses40E333.frx":039F
         Left            =   360
         List            =   "FrmExpenses40E333.frx":03A1
         RightToLeft     =   -1  'True
      ...
      Begin VB.ComboBox CboType 
         Height          =   315
         ItemData        =   "FrmExpenses40E333.frx":03A3
         Left            =   5040
         List            =   "FrmExpenses40E333.frx":03A5
         RightToLeft     =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   124
         Top             =   480
      ...
      Begin VB.ComboBox CboPaymentType1 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "FrmExpenses40E333.frx":03A7
         Left            =   10920
         List            =   "FrmExpenses40E333.frx":03A9
         RightToLeft     =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   75
         Top             =   510
      ...
      Begin MSDataListLib.DataCombo DcCostCenter 
         Bindings        =   "FrmExpenses40E333.frx":03AB
         Height          =   315
         Left            =   16440
         TabIndex        =   99
         Top             =   780
      ...
      Begin MSDataListLib.DataCombo Dcbranch 
         Bindings        =   "FrmExpenses40E333.frx":03C0
         Height          =   315
         Left            =   360
         TabIndex        =   112
         Top             =   120
      ...
      Begin VB.Image ImgNote 
         Height          =   240
         Left            =   -240
         Picture         =   "FrmExpenses40E333.frx":03D5
         Top             =   750
         Visible         =   0   'False
         Width           =   240
      End
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
      ...
      FormatString    =   $"FrmExpenses40E333.frx":095F
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin VDSCOMBOLibCtl.SmartCombo SmartCombo1 
         ...
         OnFocus         =   3
         PasswordChar    =   ""
         Picture         =   "FrmExpenses40E333.frx":0C3B
         PictureAlignment=   5
   ...
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      FloodColor      =   6553600
      ForeColorDisabled=   -2147483631
      Picture         =   "FrmExpenses40E333.frx":11D5
      Caption         =   "   Œ·’ «Ê «” »⁄«œ«  «·«’Ê·  "
      Align           =   0
      AutoSizeChildren=   0
      BorderWidth     =   0
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses40E333.frx":1EAF
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses40E333.frx":2249
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses40E333.frx":25E3
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses40E333.frx":297D
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin VB.Image ImgFavorites 
         Height          =   390
         Left            =   3840
         Picture         =   "FrmExpenses40E333.frx":2D17
         Stretch         =   -1  'True
         Top             =   0
         Width           =   525
      End
   ...
   Begin VSFlex8Ctl.VSFlexGrid Fg_Journal 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmExpenses40E333.frx":697F
      ScrollTrack     =   0   'False
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin VDSCOMBOLibCtl.SmartCombo CboDes 
         ...
         OnFocus         =   3
         PasswordChar    =   ""
         Picture         =   "FrmExpenses40E333.frx":6AE5
         PictureAlignment=   5
         PictureBackColor=   -2147483624
         PictureStretchH =   0
         PictureStretchV =   0
   ...
   Begin ALLButtonS.ALLButton ALLButton1 
      ...
      MCOL            =   192
      MPTR            =   1
      MICON           =   "FrmExpenses40E333.frx":707F
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ALLButtonS.ALLButton CmdRemove 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmExpenses40E333.frx":709B
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid2 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmExpenses40E333.frx":70B7
      ScrollTrack     =   0   'False
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmExpenses40E333"
...
If AccountVat.BoundText = "" And mdifrmmain.taxes.Visible = True And CheckAnyVAT(XPDtbTrans.value) = True Then
If SystemOptions.UserInterface = ArabicInterface Then
...
Function print_report(Optional NoteSerial As String)
    ...
    Dim StrFileName As String
    Dim Msg As String
  MySQL = " SELECT     dbo.notes_all.NoteID,notes_all.Vat2,notes_all.Net, dbo.notes_all.NoteDate, dbo.notes_all.NoteType, dbo.notes_all.NoteSerial, dbo.notes_all.Note_Value, dbo.notes_all.NoteSerial1, "
...
If CboType.ListIndex = 1 Then
    Dim LoseProfitValue  As Double
    LoseProfitValue = val(TxtNewCurrentValue) - val(TxtCurrentValue)
    TxtLoseProfitValue.Text = Round(Abs(LoseProfitValue), 2)
    CalculteValueAdded2
End If
End Sub
      ...
      PercentgValueAddedAccount_Transec XPDtbTrans.value, 12, 1, mm, Percentg
       ...
       RsDev.update
        ...
        End If
                ...
                If val(txtAdditions.Text) > 0 Then
            RsDev.AddNew
            RsDev("Double_Entry_Vouchers_ID").value = new_id("DOUBLE_ENTREY_VOUCHERS", "Double_Entry_Vouchers_ID", "", True) 'LngDevID
            RsDev("DEV_ID_Line_No").value = line_no
            RsDev("DEV_ID_Line_No1").value = setfoxy_Line
