...
Begin VB.Form FrmGard 
   ...
   Begin C1SizerLibCtl.C1Elastic EleMain 
      ...
      Begin C1SizerLibCtl.C1Elastic EleFooter 
         ...
         AccessibleValue =   ""
         AccessibleRole  =   9
         Begin VB.CheckBox ChkViewQty 
            Alignment       =   1  'Right Justify
            Caption         =   "«Œ›«¡ «·ﬂ„ÌÂ ›Ì «·ÿ»«⁄Â"
            Height          =   195
            Left            =   2880
            RightToLeft     =   -1  'True
            TabIndex        =   52
...
Private Sub SaveData()
    ...
    If Me.TxtModFlg.text <> "R" Then
        ...
        rs("startDate").value = DTPFrom.value
        rs("EndDate").value = DTPTo.value
...
Public Sub Retrive(Optional Lngid As Long = 0)
    ...
    DTPFrom.value = IIf(IsNull(rs("startDate").value), "", (rs("startDate").value))
    DTPTo.value = IIf(IsNull(rs("EndDate").value), "", (rs("EndDate").value))
...
Private Sub printing()
    ...
    If XPTxtBillID.text <> "" Then
        ...
        If Me.XPOptShowType(0).value = True Then
            ...
            VReport.ShowGardData XPTxtBillID.text, 0, IIf(ChkViewQty.value = vbChecked, True, False)
        Else
            VReport.ShowGardData XPTxtBillID.text, 1, IIf(ChkViewQty.value = vbChecked, True, False)
        End If
