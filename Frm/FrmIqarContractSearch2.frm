...
Begin VB.Form FrmIqarContractSearch2 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   6945
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   16095
   Icon            =   "FrmIqarContractSearch2.frx":0000
   LinkTopic       =   "Form4"
   MaxButton       =   0   'False
   RightToLeft     =   -1  'True
   ScaleHeight     =   6945
   ...
   Begin VB.ComboBox DcbPeriodsID 
      Height          =   315
      ItemData        =   "FrmIqarContractSearch2.frx":000C
      Left            =   6960
      List            =   "FrmIqarContractSearch2.frx":0016
      RightToLeft     =   -1  'True
      TabIndex        =   68
      Top             =   7440
      Width           =   735
   ...
   Begin VB.ComboBox DcbFurnishing 
      Height          =   315
      ItemData        =   "FrmIqarContractSearch2.frx":0024
      Left            =   120
      List            =   "FrmIqarContractSearch2.frx":002E
      RightToLeft     =   -1  'True
      TabIndex        =   58
      Top             =   5520
      Width           =   1965
   ...
   Begin VB.ComboBox DcbRentType 
      Height          =   315
      ItemData        =   "FrmIqarContractSearch2.frx":0042
      Left            =   120
      List            =   "FrmIqarContractSearch2.frx":004C
      RightToLeft     =   -1  'True
      TabIndex        =   28
      Top             =   4080
      Width           =   1965
   ...
   Begin VB.ComboBox DcbContType 
      Height          =   315
      ItemData        =   "FrmIqarContractSearch2.frx":0060
      Left            =   9840
      List            =   "FrmIqarContractSearch2.frx":006A
      RightToLeft     =   -1  'True
      TabIndex        =   17
      Top             =   3600
      Width           =   1695
   ...
   Begin ALLButtonS.ALLButton ALLButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmIqarContractSearch2.frx":0082
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
      ...
      Begin MSComctlLib.ImageList GrdImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmIqarContractSearch2.frx":009E
               Key             =   "CompanyName"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmIqarContractSearch2.frx":0438
               Key             =   "Ser"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmIqarContractSearch2.frx":07D2
               Key             =   "Vac_Name"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmIqarContractSearch2.frx":0B6C
               Key             =   "ShareCount"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmIqarContractSearch2.frx":0F06
               Key             =   "Dis_Count"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmIqarContractSearch2.frx":12A0
               Key             =   "Bouns"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmIqarContractSearch2.frx":163A
               Key             =   "SharesValue"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmIqarContractSearch2.frx":1BD4
               Key             =   "BuyValue"
            EndProperty
         EndProperty
      End
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"FrmIqarContractSearch2.frx":1F6E
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin ImpulseButton.ISButton CmdItemSearch 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmIqarContractSearch2.frx":2448
      ColorButton     =   14871017
      DrawFocusRectangle=   0   'False
   End
   ...
   End
End
Attribute VB_Name = "FrmIqarContractSearch2"
...
'RSContract.Retrive val(Fg.TextMatrix(Fg.Row, Fg.ColIndex("ContNo")))
 ...
 ElseIf m_RetrunType = 2 Then
  ...
  FrmWaiverSettlement.TXTContNo.Text = val(Fg.TextMatrix(Fg.Row, Fg.ColIndex("ContNo")))
   ...
   FrmWaiverSettlement.GetContract val(Fg.TextMatrix(Fg.Row, Fg.ColIndex("NoteSerial"))), val(Fg.TextMatrix(Fg.Row, Fg.ColIndex("ContNo")))
    ...
    If Not (rs.EOF Or rs.BOF) Then
        ...
        For Num = 1 To rs.RecordCount
            ...
            DcbFurnishing.ListIndex = val(IIf(IsNull(rs("Furnishing").value), -1, rs("Furnishing").value))
                ...
                .TextMatrix(Num, .ColIndex("Aqarid")) = IIf(IsNull(rs("UnitNo").value), "", rs("UnitNo").value)
...
End If
   ...
   If val(Me.DcbUnitNo.BoundText) <> 0 And Me.DcbUnitNo.Text <> "" Then
        ...
        StrWhere = StrWhere + " and dbo.TblContract.UnitNo =" & val(Me.DcbUnitNo.BoundText)
