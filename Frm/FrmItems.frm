...
Private Sub ChangeLang()
    ...
    lbl«”„«·ÊÕœ…(8).Caption = "Production line"
    Cmd(40).Caption = "Add"
...
'    End With
    ...
    lbl«”„«·ÊÕœ…(5).Caption = "Store Name"
    lbl«”„«·ÊÕœ…(6).Caption = "Location"
    Cmd(38).Caption = "Add"
...
If optPurchase.value = True Then
    ...
    Else
        FgVendorPrice.TextMatrix(0, FgVendorPrice.ColIndex("CusName")) = "«”„ «·„Ê—œ"
    End If
Else
    If SystemOptions.UserInterface = EnglishInterface Then
        FgVendorPrice.TextMatrix(0, FgVendorPrice.ColIndex("CusName")) = "Customer name"
    Else
        FgVendorPrice.TextMatrix(0, FgVendorPrice.ColIndex("CusName")) = "«”„ «·⁄„Ì·"
    End If
...
ClearMatrix
    ...
    With FG
        ...
        .ColComboList(.ColIndex("MethodCalc")) = "#1;«·ﬂ„Ì… |#2;«·⁄—÷ |#3; «·ÿÊ· |#4;«·ÿÊ· + «·⁄—÷|#5;«·ÿÊ· * «·⁄—÷|#6;«·ÿÊ· ·ﬂ· ⁄—÷|#7;«·⁄—÷ ·ﬂ· ÿÊ·|#8;«·ÿÊ· * «·⁄—÷ * «·«— ›«⁄ ·|#9;«·ÿÊ· * 3.14 * „—»⁄ ‰’ «·ﬁÿ—|#10;«·ÿÊ· * «·⁄—÷ * «·”„ﬂ |#11; 3.14«·ÿÊ· * („—»⁄ ﬁÿ— Œ«—ÃÌ - „—»⁄ ﬁÿ— œ«Œ·Ì)  "
