...
Begin VB.Form FrmManAddNew 
   ...
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      Begin ImpulseButton.ISButton XPBtnNewClients 
         ...
         EndProperty
         BackStyle       =   0
         ButtonImage     =   "FrmManAddNew.frx":038A
      ...
      Begin ImpulseButton.ISButton CmdSearchTrans 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmManAddNew.frx":0724
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton CmdOpenTrans 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmManAddNew.frx":0ABE
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin VB.Label lbl 
   ...
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      Begin ImpulseButton.ISButton CmdShowTransItems 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmManAddNew.frx":0E58
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton CmdSearch 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmManAddNew.frx":11F2
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin MSDataListLib.DataCombo DCboItemsName1 
         Height          =   315
         Left            =   2730
         TabIndex        =   59
         Top             =   1215
         ...
         RightToLeft     =   -1  'True
      End
      Begin MSDataListLib.DataCombo DCboItemsCode1 
         Height          =   315
         Left            =   7140
         TabIndex        =   60
         Top             =   1215
      ...
      Begin ImpulseButton.ISButton ISButton1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmManAddNew.frx":158C
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton CmdSearch 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmManAddNew.frx":1926
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
   ...
   End
End
Attribute VB_Name = "FrmManAddNew"
...
Private Sub DCboItemsCode1_Click(Area As Integer)
    Me.DCboItemsName1.BoundText = DCboItemsCode1.BoundText
End Sub
...
Private Sub DCboItemsName1_Click(Area As Integer)
   Me.DCboItemsCode1.BoundText = DCboItemsName1.BoundText
End Sub
