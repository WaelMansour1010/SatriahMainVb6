...
Begin VB.Form FrmManCusRecive 
   Caption         =   " ”·Ì„ «·’Ì«‰… "
   ClientHeight    =   7905
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11280
   Icon            =   "FrmManCusRecive.frx":0000
   LinkTopic       =   "Form2"
   MDIChild        =   -1  'True
   RightToLeft     =   -1  'True
   ScaleHeight     =   7905
   ...
   Begin C1SizerLibCtl.C1Elastic C1ElasticMain 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmManCusRecive.frx":058A
      AccessibleName  =   ""
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin ImpulseButton.ISButton CmdSearchTrans 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmManCusRecive.frx":0622
         ...
         Begin ImpulseButton.ISButton CmdOpenTrans 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmManCusRecive.frx":09BC
            ColorButton     =   14871017
            DrawFocusRectangle=   0   'False
         End
      ...
      Begin C1SizerLibCtl.C1Tab XPTab301 
         ...
         AccessibleValue =   ""
         AccessibleRole  =   37
         Picture(0)      =   "FrmManCusRecive.frx":0D56
         Flags(1)        =   2
         Begin C1SizerLibCtl.C1Elastic Ele 
            Height          =   4140
            Index           =   2
            ...
            FrameShadow     =   -2147483632
            FloodStyle      =   1
            _GridInfo       =   $"FrmManCusRecive.frx":10F0
            AccessibleName  =   ""
            AccessibleDescription=   ""
            AccessibleValue =   ""
            AccessibleRole  =   9
            Begin C1SizerLibCtl.C1Elastic Ele 
               ...
               Begin ImpulseButton.ISButton CmdShowTransItems 
                  ...
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  ButtonImage     =   "FrmManCusRecive.frx":1144
                  ColorButton     =   14871017
                  DrawFocusRectangle=   0   'False
               End
               Begin ImpulseButton.ISButton CmdAdd 
                  ...
                  EndProperty
                  BackStyle       =   0
                  ButtonImage     =   "FrmManCusRecive.frx":14DE
                  ColorButton     =   14871017
            ...
            Begin VSFlex8UCtl.VSFlexGrid FG 
               ...
               FormatString    =   $"FrmManCusRecive.frx":1DB8
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin C1SizerLibCtl.C1Elastic Ele 
            ...
            FrameShadow     =   -2147483632
            FloodStyle      =   1
            _GridInfo       =   $"FrmManCusRecive.frx":1F86
            AccessibleName  =   ""
            AccessibleDescription=   ""
            AccessibleValue =   ""
            AccessibleRole  =   9
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic6 
         ...
         Begin ImpulseButton.ISButton XPBtnMove 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmManCusRecive.frx":202C
         ...
         Begin ImpulseButton.ISButton XPBtnMove 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmManCusRecive.frx":23C6
            ColorHighlight  =   4194304
            ColorHoverText  =   16777215
            ColorShadow     =   -2147483631
            ColorOutline    =   -2147483631
         ...
         Begin ImpulseButton.ISButton XPBtnMove 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmManCusRecive.frx":2760
            ColorHighlight  =   4194304
            ColorHoverText  =   16777215
            ColorShadow     =   -2147483631
            ColorOutline    =   -2147483631
         ...
         Begin ImpulseButton.ISButton XPBtnMove 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmManCusRecive.frx":2AFA
            ColorHighlight  =   4194304
            ColorHoverText  =   16777215
            ColorShadow     =   -2147483631
            ColorOutline    =   -2147483631
   ...
   End
End
Attribute VB_Name = "FrmManCusRecive"
...
Private Sub ChangeLang()
    ...
    Me.Caption = "Mainteneance Delivery To Customers"
    lbl(20).Caption = "Payment Type"
...
Private Sub CmdSearchTrans_Click()
    TxtOrgManSerial.text = ""
    Load FrmMaintanenceSearch
    FrmMaintanenceSearch.searchtype = 1
    Set FrmMaintanenceSearch1.ExtraRetrunObject = Me.TxtOrgManID
...
Private Sub Form_Load()
    ...
    Else
        StrList = FG.BuildComboList(RsItems, "ItemNamee", "ItemID")
    End If
...
Private Sub TxtOrgManID_Change()
    ...
    If Me.TxtModFlg.text = "N" Or Me.TxtModFlg.text = "E" Then
        If Me.TxtOrgManID.text <> "" Then
            StrTemp = GetManIDSerial(1, val(Me.TxtOrgManID.text), 1, , LngCusID, StrCashCusName, LngStoreID, LngItemID, itemserial, itemqty)
            ...
            If val(Me.DCboStoreName.BoundText) <> LngStoreID Then
                Me.DCboStoreName.BoundText = LngStoreID
            End If
            ...
            DCboItemsCode.BoundText = LngItemID
            DCboItemsName.BoundText = LngItemID
            TxtSerial.text = itemserial
            TxtQuantity.text = itemqty
         
            RetriveOrder Me.TxtOrgManSerial
...
Public Sub RetriveOrder(Optional TicktNO As String = "")
    ...
    StrSQL = "Select * from transactions where  (dbo.Transactions.TicketNO = N'" & TicktNO & "')   "
    Set rs = New ADODB.Recordset
    rs.Open StrSQL, Cn, adOpenStatic, adLockReadOnly, adCmdText
    ...
    StrSQL = "SELECT TblItems.HaveSerial, * FROM TblItems INNER JOIN Transaction_Details " & "ON TblItems.ItemID = Transaction_Details.Item_ID INNER JOIN dbo.TblUnites ON dbo.Transaction_Details.UnitID = dbo.TblUnites.UnitID" & " INNER JOIN dbo.Transactions ON dbo.Transaction_Details.Transaction_ID = dbo.Transactions.Transaction_ID"
    ...
    If Not (RsDetails.EOF Or RsDetails.BOF) Then
        ...
        For Num = 1 To RsDetails.RecordCount
            ...
            FG.TextMatrix(Num, FG.ColIndex("Cost")) = IIf(IsNull(RsDetails("ShowPrice")), 0, (RsDetails("ShowPrice").value)) ' GET_COST_PRICE_FOR_PRODUCT_ITEM(Val(FG.TextMatrix(Num, FG.ColIndex("Code"))))
...
Function calcnet()
    ...
    With FG
        Me.XPTxtSum.text = .Aggregate(flexSTSum, .FixedRows, .ColIndex("Cost"), .Rows - 1, .ColIndex("Cost")) + val(TxtCost.text)
...
Private Sub SaveData()
    ...
    If Me.TxtModFlg.text <> "R" Then
        ...
        If Me.DCboItemsCode.BoundText = "" Then
            Msg = "ÌÃ» ≈Œ Ì«— «·’‰›....!!! " & Chr(13)
            MsgBox Msg, vbOKOnly + vbExclamation + vbMsgBoxRight + vbMsgBoxRtlReading, App.title
            DCboItemsCode.SetFocus
            SendKeys "{F4}"
        ...
        Select Case Me.TxtModFlg.text
            ...
            Case "N"
                ...
                Else
                    ...
                    Msg = Msg + "Enter Another Operation Y/N"
                End If
...
ErrTrap:
    ...
    If Err.Number = -2147217900 Then
        ...
        Else
            ...
            Msg = Msg + "An error In Data " & Chr(13)
...
Public Sub Retrive(Optional Lngid As Long = 0)
    ...
    TxtOrgManSerial.text = IIf(IsNull(rs("ReciptNumber").value), "", (rs("ReciptNumber").value))

    XPTxtMaintanenceID.text = IIf(IsNull(rs("MaintananceID").value), "", (rs("MaintananceID").value))
    DBCboClientName.BoundText = IIf(IsNull(rs("CusID").value), "", rs("CusID").value)
    DCboItemsCode.BoundText = IIf(IsNull(rs("ItemID").value), "", rs("ItemID").value)
    DCboItemsName.BoundText = IIf(IsNull(rs("ItemID").value), "", rs("ItemID").value)
 
    TxtSerial.text = IIf(IsNull(rs("ItemSerial").value), "", (rs("ItemSerial").value))
    TxtQuantity.text = IIf(IsNull(rs("Quantity").value), 0, (rs("Quantity").value))
    TxtCost.text = IIf(IsNull(rs("ExtraCost").value), 0, (rs("ExtraCost").value))
