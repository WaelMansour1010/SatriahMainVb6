...
Dy4 = Dy4 - Dy3
End If
 SaveDataAbcens val(DcboEmpName.BoundText), val(Dcbranch.BoundText), GetMofrad(Me.DcbMang.BoundText), NoDay, ToDate.value
Else
   Dim str As String
...
sql = "select * from tblVacationData where (1=-1)"
    Rs7.Open sql, Cn, adOpenKeyset, adLockOptimistic, adCmdText
     ...
     Rs7("Remark").value = str
      Rs7.update
End Sub
Function GetMofrad(Optional DeparmentID As Integer) As Integer
Dim sql As String
