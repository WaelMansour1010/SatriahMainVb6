...
Public Sub GetData()
    ...
    Dim Msg As String
    Dim i As Integer
 StrSQL = "SELECT     dbo.TblContractInstallments.installValue, ISNULL(dbo.TblContractInstallments.installValue, 0) - ISNULL(dbo.InstallmentValue(dbo.TblContractInstallments.id), 0) "
...
Public Sub GetDataExpEleec()
 ...
 StrSQL = StrSQL & "                     dbo.TblOtheExpensAqar.Total, dbo.TblOtheExpensAqar.Net, dbo.TblOtheExpensAqar.Name AS Expr2, dbo.TblOtheExpensAqar.TotalAfterIns,"
