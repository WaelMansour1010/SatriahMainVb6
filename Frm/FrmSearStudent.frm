...
Begin VB.Form FrmSearStudent 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VSFlex8UCtl.VSFlexGrid GrdCars 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"FrmSearStudent.frx":15F8E
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ImpulseButton.ISButton Cmd 
         ...
         EndProperty
         BackStyle       =   0
         ButtonImage     =   "FrmSearStudent.frx":16080
      ...
      Begin ImpulseButton.ISButton Cmd 
         ...
         EndProperty
         BackStyle       =   0
         ButtonImage     =   "FrmSearStudent.frx":1C8E2
         ColorButton     =   14871017
         ColorHighlight  =   16777215
         ColorHoverText  =   16711680
         ColorShadow     =   -2147483637
      ...
      Begin ImpulseButton.ISButton Cmd 
         ...
         EndProperty
         BackStyle       =   0
         ButtonImage     =   "FrmSearStudent.frx":23144
         ColorButton     =   14871017
         ColorHighlight  =   16777215
         ColorHoverText  =   16711680
         ColorShadow     =   -2147483637
...
Public Sub GetDataStudCalling()
    ...
    sql = sql & "                   dbo.TblStudCalling.EnterDate, dbo.TblStudCalling.EnterTime, dbo.TblStudCalling.Mobile, dbo.TblStudCalling.Phone, dbo.TblStudCalling.Email,"
