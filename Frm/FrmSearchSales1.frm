...
Begin VB.Form FrmSearchSales1 
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"FrmSearchSales1.frx":038A
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmSearchSales1"
...
Private Sub Fg_EnterCell()
  On Error GoTo ErrTrap
    ...
    FrmPay_Garanty_Shipment.FindRec6 val(Me.Fg.TextMatrix(Me.Fg.Row, Me.Fg.ColIndex("empid")))
ErrTrap:
End Sub
...
Public Sub GetData()
    ...
    StrSQL = "SELECT dbo.TblEmployee.Emp_Name, dbo.TblEmployee.Emp_Code, dbo.TblEmployee.Fullcode, dbo.TblEmployee.Emp_Namee, dbo.TblBranchesData.branch_name, "
    StrSQL = StrSQL & " dbo.TblBranchesData.branch_namee, dbo.TblEmpJobsTypes.JobTypeName, dbo.TblEmpJobsTypes.JobTypeNamee, dbo.TblEmployee.Emp_ID,"
    StrSQL = StrSQL & " dbo.TBLSalesRepData2.id, dbo.TblBranchesData.branch_id, dbo.TBLSalesRepGroups2.name, dbo.TBLSalesRepGroups2.namee, dbo.TblEmpJobsTypes.JobTypeID,"
    StrSQL = StrSQL & " dbo.TBLSalesRepData2.DiscountValue, dbo.TBLSalesRepGroups2.id AS IDgroup"
    StrSQL = StrSQL & " FROM dbo.TblEmployee RIGHT OUTER JOIN"
    StrSQL = StrSQL & " dbo.TBLSalesRepData2 LEFT OUTER JOIN"
    StrSQL = StrSQL & " dbo.TblEmpJobsTypes ON dbo.TBLSalesRepData2.JobID = dbo.TblEmpJobsTypes.JobTypeID LEFT OUTER JOIN"
    StrSQL = StrSQL & " dbo.TBLSalesRepGroups2 ON dbo.TBLSalesRepData2.GroupID = dbo.TBLSalesRepGroups2.id LEFT OUTER JOIN"
    ...
    If val(Me.TxtIDFrom.Text) <> 0 Then
        If BolBegine = True Then
            StrWhere = StrWhere & " dbo.TBLSalesRepData2.id >=" & val(Me.TxtIDFrom.Text) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TBLSalesRepData2.id >=" & val(Me.TxtIDFrom.Text) & ""
        End If
    End If
   
    If val(Me.TxtIDTO.Text) <> 0 Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TBLSalesRepData2.id <=" & val(Me.TxtIDTO.Text) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TBLSalesRepData2.id <=" & val(Me.TxtIDTO.Text) & ""
        End If
    End If
    ...
    If Me.txtgroup.Text <> "" Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TBLSalesRepGroups2.name like '%" & Me.txtgroup.Text & "%'"
        Else
            BolBegine = True
            StrWhere = " Where dbo.TBLSalesRepGroups2.name like '%" & Me.txtgroup.Text & "%'"
        End If
    End If

    StrSQL = StrSQL & StrWhere
    StrSQL = StrSQL & " Order By dbo.TBLSalesRepData2.id "
...
Private Sub ChangeLang()
    ...
    Me.Caption = "Search Purchasing Representative"
