...
Case 20
        project_status.mIndex = 6
                project_status.show
                                
Case 21
        project_status.mIndex = 7
                project_status.show
...
FrmVizitScreen.mIndex = 1
 ...
 Case 8
    frmsalebill6.mTypeInvoice = 1
            frmsalebill6.C1Tab1.TabVisible(1) = True
        frmsalebill6.C1Tab1.TabVisible(0) = False
        frmsalebill6.C1Tab1.CurrTab = 1

    frmsalebill6.show

Case 9
        frmsalebill6.mTypeInvoice = 2
        frmsalebill6.C1Tab1.TabVisible(0) = True
        frmsalebill6.C1Tab1.TabVisible(1) = False
        frmsalebill6.C1Tab1.CurrTab = 0
...
'Load WebForm
    Dim ss As String
    ss = "SELECT * FROM TblUsers tu WHERE tu.Empid IN (SELECT cachierData.Empid FROM cachierData) and UserId = " & user_id
    Dim rsDummyUser As New ADODB.Recordset
    rsDummyUser.Open ss, Cn, adOpenKeyset, adLockReadOnly
    If Not rsDummyUser.EOF Then
       Dim Frm As New CashierLogin
...
Private Sub MDIForm_Load()
    ...
    If SystemOptions.IsBlue Then
        Me.Icon = LoadPicture(App.path & "\Garphics\images.ico")
    End If
...
'    Dim ss As String
'    ss = "SELECT * FROM TblUsers tu WHERE tu.Empid IN (SELECT cachierData.Empid FROM cachierData) where UserId = " & user_id
'    Dim rsDummyUser As New ADODB.Recordset
'    rsDummyUser.Open ss, Cn, adOpenKeyset, adLockReadOnly
'    If Not rsDummyUser.EOF Then
'       Dim frm As New CashierLogin
...
Case 7
            If checkApility("frmSubcontractorContract") = False Then
...
GeneralPriceType = 0
FrmPO3.IschkIsFirstInv = True
FrmPO3.Ele(6).Caption = "«·›« Ê—… «·„»œ∆Ì…"
FrmPO3.Caption = "«·›« Ê—… «·„»œ∆Ì…"
FrmPO3.show
...
CarMaintenancesub1(6).Caption = "«‰Ê«⁄ «·„—ﬂ»« "
CarMaintenancesub1(21).Caption = "«‰Ê«⁄ «·“ÌÊ "
...
CarMaintenancesub1(19).Caption = "«‰Ê«⁄ ﬁÿ⁄ «·€Ì«—"
CarMaintenancesub1(21).Caption = "«‰Ê«⁄ «·“ÌÊ "
...
mnuEmployeeBasic(10).Caption = "Œÿ… «·»œ·«  «·„ﬁœ„…"
       ...
       TransporterSub(14).Caption = "Œÿ… «·’Ì«‰…"
        ...
        TransporterSub(20).Caption = "»Ê·Ì’… «· Œ·Ì’"
TransporterSub(21).Caption = " «· ﬁ«—Ì—"
...
SalesBasicSubsub(4).Caption = "»Ì«‰«  «·⁄„·«¡ «·‰ﬁœÌ"
   ...
   SalesTransactionssubss00(2).Caption = "⁄—Ê÷ «·«”⁄«— 2"
        SalesTransactionssubss0(1).Caption = "√Ê«„— «·»Ì⁄"
        SalesTransactionssubss000(0).Caption = " «·›« Ê—… «·„»œ∆Ì…"
       ...
       ' Me.SalesTransactions(12).Caption = "«⁄œ«œ«  ﬂ„Ì«  √Ê«„— «·‘—«¡"
...
'        Me.DelUser.Caption = "Õ–›  „” Œœ„  ..."
        ...
        Me.HelpFileSub(0).Caption = "«·›« Ê—… «·«·ﬂ —Ê‰Ì…..."
...
Me.HelpFileSub(0).Caption = "Electronic Invoice..."
Me.HelpFileSub(8).Caption = "Tax Invoice..."
...
CarMaintenancesub1(19).Caption = "Spare"
CarMaintenancesub1(21).Caption = "Oil"
        '*********************************************
...
CarMaintenancesub1(18).Caption = "Supervisors And Technicals"
 CarMaintenancesub1(19).Caption = "Spare"
 CarMaintenancesub1(19).Caption = "Oil"
...
Private Sub CreateWindowList()
  ...
  '      MnuWindowsListOpen.Enabled = False6
        Exit Sub
    Else
