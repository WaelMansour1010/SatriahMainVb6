...
Begin VB.Form account_search 
   ...
   ClientTop       =   2430
   ClientWidth     =   8430
   Icon            =   "Acccount_search1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   RightToLeft     =   -1  'True
   ...
   Begin MSDataGridLib.DataGrid DataGrid4 
      Bindings        =   "Acccount_search1.frx":000C
      Height          =   2535
      Left            =   1560
      TabIndex        =   16
      Top             =   5040
   ...
   Begin ALLButtonS.ALLButton ALLButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Acccount_search1.frx":0021
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "Acccount_search1.frx":003D
      Height          =   3015
      Left            =   120
      TabIndex        =   4
      Top             =   1440
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "Acccount_search1.frx":0052
      Height          =   2535
      Left            =   0
      TabIndex        =   2
      Top             =   5160
   ...
   Begin MSDataGridLib.DataGrid DataGrid3 
      Bindings        =   "Acccount_search1.frx":0067
      Height          =   2535
      Left            =   1560
      TabIndex        =   12
      Top             =   5040
   ...
   Begin ALLButtonS.ALLButton ALLButton2 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Acccount_search1.frx":007C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ALLButtonS.ALLButton ALLButton3 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Acccount_search1.frx":0098
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ALLButtonS.ALLButton ALLButton4 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Acccount_search1.frx":00B4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid5 
      Bindings        =   "Acccount_search1.frx":00D0
      Height          =   2535
      Left            =   120
      TabIndex        =   20
      Top             =   1440
   ...
   End
End
Attribute VB_Name = "account_search1"
...
tahlil_maly.Text4.text = Adodc1.Recordset.Fields!account_name
End If
...
tahlil_maly.Text6.text = Adodc1.Recordset.Fields!account_name
End If
...
If SystemOptions.UserInterface = EnglishInterface Then
    baranches.DataCombo1(Me.case_index).text = Adodc1.Recordset.Fields!account_name 'Account_NameEng
Else
    baranches.DataCombo1(Me.case_index).text = Adodc1.Recordset.Fields!account_name
End If
