...
Begin VB.Form ArrowsGroup 
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "ArrowssGroup.frx":0724
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "ArrowssGroup.frx":0ABE
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "ArrowssGroup.frx":0E58
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "ArrowssGroup.frx":11F2
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin ImpulseButton.ISButton CmdHelp 
      ...
      ColorTextShadow =   -2147483637
   End
   Begin MSDataListLib.DataCombo XPCboCurrency 
      Height          =   315
      Left            =   60
      TabIndex        =   49
      Top             =   2160
...
Private Sub Cmd_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 0
            ...
            '        XPTxtName.SetFocus
            XPTxtID.text = CStr(new_id("ArrowsGroup", "GroupID", "", True))
...
Private Sub Command1_Click()
    ...
    If Not (RsTemp.EOF Or RsTemp.BOF) Then
        ...
        For i = 1 To RsTemp.RecordCount
            'If createAccounts)(  RsTemp("GroupID").value, RsTemp("GroupName").value) Then
...
Private Sub Form_Load()
    ...
    StrSQL = "select * From ArrowsGroup where GroupID<>1"
...
Private Sub TxtModFlg_Change()
    ...
    Select Case Me.TxtModFlg.text
        ...
        Case "N"
            ...
            If SystemOptions.UserInterface = ArabicInterface Then
                Me.Caption = "»Ì«‰«  „Ã„Ê⁄«  «·«”Â„  ( ÃœÌœ )"
            Else
                Me.Caption = "Arrows Assets   Groups(New Record)"
            End If
        ...
        Case "E"
            ...
            If SystemOptions.UserInterface = ArabicInterface Then
                Me.Caption = "»Ì«‰«  „Ã„Ê⁄«    «·«”Â„(  ⁄œÌ·)"
            Else
                Me.Caption = "   Arrows Groups(Edit Record)"
            End If
...
Public Sub Retrive(Optional Lngid As Long = 0)
    ...
    If Not IsNull(rs("CurrencyId")) Then
        XPCboCurrency.BoundText = rs("CurrencyId")
    Else
        XPCboCurrency.text = ""
    End If
...
Private Sub delete_group_account(group_id As Integer)
    ...
    StrSQL = "select * From ArrowsGroupsAccount where group_id=" & group_id
    RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
    ...
    StrSQL = "Delete From ArrowsGroupsAccount where group_id=" & group_id
...
Private Sub SaveData()
    ...
    If Me.TxtModFlg.text <> "R" Then
        ...
        Select Case TxtModFlg.text
            ...
            Case "N"
                StrSQL = "select * From ArrowsGroup where GroupName='" & Trim(XPTxtName.text) & "'"
                RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
        ...
        Select Case TxtModFlg.text
            ...
            Case "N"
                ...
                If Chklast.value = vbChecked Then
                    If createAccounts = True Then
                        rs("Account_Code").value = ModAccounts.AddNewAccount(Account_Code_dynamic, Get_Account_name(-1, Account_Code_dynamic) & "   " & XPTxtName.text & " ", True, False)
                        rs("Account_Code1").value = ModAccounts.AddNewAccount(Account_Code_dynamic1, Get_Account_name(-1, Account_Code_dynamic1) & "   " & XPTxtName.text & "", True, False)
                        rs("Account_Code2").value = ModAccounts.AddNewAccount(Account_Code_dynamic2, Get_Account_name(-1, Account_Code_dynamic2) & "   " & XPTxtName.text & " ", True, False)
                        rs("Account_Code3").value = ModAccounts.AddNewAccount(Account_Code_dynamic3, Get_Account_name(-1, Account_Code_dynamic3) & "   " & XPTxtName.text & " ", True, False)
                    Else
                        Exit Sub
                    End If
                End If
        ...
        rs("CurrencyId").value = val(XPCboCurrency.BoundText)
...
Private Sub FillGroupCombo()
    ...
    Dim StrSQL As String
    Dim RsTemp As New ADODB.Recordset
    StrSQL = "SELECT * FROM ArrowsGroup Order By GroupName"
    RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
    fill_combo XPCboGroup, StrSQL

    If SystemOptions.UserInterface = ArabicInterface Then
        StrSQL = "  select id,name from currency  order by name  "
    Else
        StrSQL = "  select id,code from currency  order by code  "
    End If

    fill_combo XPCboCurrency, StrSQL
...
Private Sub LoadTreeGroups(ItemsTree As MSComctlLib.TreeView)
    ...
    If SystemOptions.UserInterface = ArabicInterface Then
        ...
        '''''''''''''''''''''''''''add root
        Set nodX = ItemsTree.Nodes.Add(, , "1G", "„Ã„Ê⁄… «·«”Â„  ", "Root")
        ItemsTree.Nodes("1G").Expanded = True
    Else
        BolDisplayArabic = False
        '''''''''''''''''''''''''''add root
        ItemsTree.Tag = "E"
        Set nodX = ItemsTree.Nodes.Add(, , "1G", " Arrows Assets Groups ", "Root")
        ItemsTree.Nodes("1G").Expanded = True
    End If

    Me.TreeGroups.Sorted = False
    '''''''''''''''''''''''''''' add group
    My_SQL = " SELECT ArrowsGroup.* "
    My_SQL = My_SQL + "  From ArrowsGroup  "
    ...
    If BolDisplayArabic = True Then
        Call fill_my_Children("1G", my_ch_rs, ItemsTree, "ArrowsGroup", "ParentID")
    Else
        Call fill_my_Children("1G", my_ch_rs, ItemsTree, "ArrowsGroup", "ParentID", , 2)
    End If
    ...
    With Me.XPPopUp
        ...
        If SystemOptions.UserInterface = ArabicInterface Then
            ...
            With .Menus.Add("mnuDropMenu1", tsSecondaryMenu, True)
                ...
                .MenuItems.Add tsMenuSeperator
                .MenuItems.Add tsMenuCaption, "ÿ»«⁄… ‘Ã—… «·«”Â„", False, False, 10, , , True, , "PrintGroup", , , , "ÿ»«⁄…"
            End With
...
Private Function GetNewGroupCode(LngParentGroupID As Long) As String
    ...
    On Error GoTo ErrTrap
    StrSQL = "Select GroupCode From ArrowsGroup Where GroupID=" & LngParentGroupID & ""
    Set rs = New ADODB.Recordset
    ...
    rs.Close
    Set rs = New ADODB.Recordset
    StrSQL = "Select * From ArrowsGroup Where ParentID=" & LngParentGroupID & " Order By GroupID"
    rs.Open StrSQL, Cn, adOpenStatic, adLockReadOnly, adCmdText
...
Private Sub GetGroupInfo(Optional Lngid As Long = 0)
    ...
    Set rs = New ADODB.Recordset
    StrSQL = "SELECT Count(ArrowsGroup.GroupID) AS CountGroupID"
    StrSQL = StrSQL + " From ArrowsGroup WHERE (ArrowsGroup.ParentID=" & Lngid & ")"
    rs.Open StrSQL, Cn, adOpenStatic, adLockReadOnly, adCmdText
...
Function createAccounts() As Boolean

    createAccounts = False
    Account_Code_dynamic = get_account_code_branch(42, my_branch)
    ...
    Else
        ...
        If Account_Code_dynamic = "NO account" Then
            MsgBox "·„ Ì „  ÕœÌœ Õ”«» „»Ì⁄«  «·«”Â„ ›Ì «·›—⁄ ·Â–… «·⁄„·Ì…", vbCritical
            GoTo ErrTrap
         
        End If
    End If
               
    Account_Code_dynamic1 = get_account_code_branch(43, my_branch)
    ...
    Account_Code_dynamic2 = get_account_code_branch(44, my_branch)
    ...
    Else
        ...
        If Account_Code_dynamic2 = "NO account" Then
            MsgBox "·„ Ì „  ÕœÌœ Õ”«» “Ì«œ… Ê‰ﬁ’ ›Ì ﬁÌ„… «·«”Â„  -„Ì“«‰Ì… ›Ì «·›—⁄ ·Â–… «·⁄„·Ì…", vbCritical
            GoTo ErrTrap
         
        End If
    End If
     
    Account_Code_dynamic3 = get_account_code_branch(45, my_branch)
    ...
    Else
        ...
        If Account_Code_dynamic3 = "NO account" Then
            MsgBox "·„ Ì „  ÕœÌœ Õ”«» “Ì«œ… Ê‰ﬁ’ ›Ì ﬁÌ„… «·«”Â„  -«—»«Õ ÊŒ”«∆— ›Ì «·›—⁄ ·Â–… «·⁄„·Ì…", vbCritical
            GoTo ErrTrap
