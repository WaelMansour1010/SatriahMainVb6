...
Begin VB.Form BankSetmSearch 
   ...
   Begin VB.Frame Frame7 
      ...
      Begin ImpulseButton.ISButton ISButton2 
         ...
         EndProperty
         ButtonImage     =   "BankSetmSearch.frx":6852
   ...
   Begin VB.Frame lblLW 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin ImpulseButton.ISButton CmdShowMoreOptions 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "BankSetmSearch.frx":D0B4
            ColorButton     =   14871017
            ColorHoverText  =   12582912
            ButtonToggles   =   1
            DrawFocusRectangle=   0   'False
            RightToLeft     =   -1  'True
            ButtonImageToggled=   "BankSetmSearch.frx":D44E
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.Image Imge 
            Height          =   255
            Left            =   1680
            Picture         =   "BankSetmSearch.frx":D7E8
            Stretch         =   -1  'True
            Top             =   240
            Width           =   255
         End
         Begin VB.Image Imgw 
            Height          =   255
            Left            =   3360
            Picture         =   "BankSetmSearch.frx":E0C5
            Stretch         =   -1  'True
            Top             =   240
            Width           =   255
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ImpulseButton.ISButton Cmd 
         ...
         EndProperty
         BackStyle       =   0
         ButtonImage     =   "BankSetmSearch.frx":10160
         ColorButton     =   14871017
      ...
      Begin ImpulseButton.ISButton Cmd 
         ...
         EndProperty
         BackStyle       =   0
         ButtonImage     =   "BankSetmSearch.frx":169C2
         ColorButton     =   14871017
         ColorHighlight  =   16777215
         ColorHoverText  =   16711680
         ColorShadow     =   -2147483637
      ...
      Begin ImpulseButton.ISButton Cmd 
         ...
         EndProperty
         BackStyle       =   0
         ButtonImage     =   "BankSetmSearch.frx":1D224
         ColorButton     =   14871017
         ColorHighlight  =   16777215
         ColorHoverText  =   16711680
         ColorShadow     =   -2147483637
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VSFlex8UCtl.VSFlexGrid Fg 
         ...
         FormatString    =   $"BankSetmSearch.frx":46E46
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame FraHeader 
      ...
      Begin VB.Image Image1 
         Height          =   615
         Left            =   12360
         Picture         =   "BankSetmSearch.frx":46FF8
         Stretch         =   -1  'True
         Top             =   120
         Width           =   735
      End
   ...
   End
End
Attribute VB_Name = "BankSetmSearch"
...
BankSettlementt.FindRec val(Fg.TextMatrix(Fg.Row, 1))
End Sub
...
Public Sub GetData()
    ...
    sql = sql & "     dbo.BanksData ON dbo.TBLBankSettlement.BankID = dbo.BanksData.BankID ON dbo.TblBranchesData.branch_id = dbo.TBLBankSettlement.BranchID"
