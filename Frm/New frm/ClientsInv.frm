...
Begin VB.Form ClientsInv 
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      Begin VSFlex8Ctl.VSFlexGrid GridCashing 
         ...
         FormatString    =   $"ClientsInv.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
         ...
         AccessibleRole  =   24
      End
      Begin VSFlex8Ctl.VSFlexGrid FGReturns 
         Height          =   3885
         Left            =   240
         TabIndex        =   65
         Top             =   720
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"ClientsInv.frx":02C5
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Frame FraHeader 
         ...
         Begin MSComctlLib.ImageList GrdImageList 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "ClientsInv.frx":05CB
                  Key             =   "CompanyName"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "ClientsInv.frx":0965
                  Key             =   "Ser"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "ClientsInv.frx":0CFF
                  Key             =   "Vac_Name"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "ClientsInv.frx":1099
                  Key             =   "ShareCount"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "ClientsInv.frx":1433
                  Key             =   "Dis_Count"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "ClientsInv.frx":17CD
                  Key             =   "Bouns"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "ClientsInv.frx":1B67
                  Key             =   "SharesValue"
               EndProperty
               BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "ClientsInv.frx":2101
                  Key             =   "BuyValue"
               EndProperty
            EndProperty
         End
         Begin ImpulseButton.ISButton btnLast 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "ClientsInv.frx":249B
         ...
         Begin ImpulseButton.ISButton btnNext 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "ClientsInv.frx":2835
            ColorButton     =   14871017
            DrawFocusRectangle=   0   'False
            DisabledImageStyle=   1
         End
         Begin ImpulseButton.ISButton btnPrevious 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "ClientsInv.frx":2BCF
            ColorButton     =   14871017
            DrawFocusRectangle=   0   'False
            DisabledImageStyle=   1
         End
         Begin ImpulseButton.ISButton btnFirst 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "ClientsInv.frx":2F69
            ColorButton     =   14871017
            DrawFocusRectangle=   0   'False
            DisabledImageStyle=   1
         End
      ...
      Begin C1SizerLibCtl.C1Elastic GroupCusFram 
         ...
         Begin VB.ListBox SelectedCusList 
            Height          =   1815
            ItemData        =   "ClientsInv.frx":3303
            Left            =   300
            List            =   "ClientsInv.frx":330A
            RightToLeft     =   -1  'True
            TabIndex        =   31
            Top             =   345
            Width           =   3255
         ...
         Begin VB.ListBox CusList 
            Height          =   1815
            ItemData        =   "ClientsInv.frx":331D
            Left            =   4725
            List            =   "ClientsInv.frx":3324
            RightToLeft     =   -1  'True
            TabIndex        =   30
            Top             =   345
            Width           =   3255
      ...
      Begin VSFlex8Ctl.VSFlexGrid GR 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"ClientsInv.frx":3331
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
'                        .TextMatrix(i, .ColIndex("PayedValue")) = Diff
                      ...
                      ' .TextMatrix(i, .ColIndex("NetValue")) = val(.TextMatrix(i, .ColIndex("RemainingValue"))) - val(.TextMatrix(i, .ColIndex("TransPayedValue")))
                        RsDetails("NetValue").value = val(.TextMatrix(i, .ColIndex("Note_Value")))
            ...
            With GR
                For i = .FixedRows To .rows - 1
                    If .cell(flexcpChecked, i, .ColIndex("payed")) = flexChecked Then
                        ...
                        RsDetails("AUToJoinid").value = val(TxtCode.text)
                        RsDetails("NoteID").value = val(GR.TextMatrix(i, GR.ColIndex("NoteIdC")))
                        RsDetails("RecDate").value = GR.TextMatrix(i, GR.ColIndex("NoteDateC"))  '   Trim(GridCashing.TextMatrix(j, GridCashing.ColIndex("RecordDate")))
                        
                        RsDetails("Serial").value = GR.TextMatrix(i, GR.ColIndex("NoteSerial1C")) 'Trim(GridCashing.TextMatrix(j, GridCashing.ColIndex("NoteSerial1")))
...
With GR
    For i = .FixedRows To .rows - 1
        ' ﬁ—«¡… »Ì«‰«  «·›« Ê—…
        NoteSerial1 = .TextMatrix(i, .ColIndex("NoteSerial1"))
        InvoiceTotal = val(.TextMatrix(i, .ColIndex("Note_Value")))
        paidAmount = val(.TextMatrix(i, .ColIndex("PayedValue")))
        RemainingAmount = InvoiceTotal - paidAmount ' «Õ ”«» «·„ »ﬁÌ
        ...
        If RemainingAmount > 0 Then
            ...
            With GridCashing
                For j = .FixedRows To .rows - 1
                    If val(.TextMatrix(j, .ColIndex("value"))) > 0 Then
                        ReceiptAmount = val(.TextMatrix(j, .ColIndex("value")))
                        mNoteId = val(.TextMatrix(j, .ColIndex("NoteId")))
                        mRecordDate = (.TextMatrix(j, .ColIndex("RecordDate")))
                        NoteSerial1C = (.TextMatrix(j, .ColIndex("NoteSerial1")))
                        '  ÕœÌœ «·„»·€ «·„„ﬂ‰ ”œ«œÂ „‰ «·„ﬁ»Ê÷
                        TransPayed = IIf(ReceiptAmount >= RemainingAmount, RemainingAmount, ReceiptAmount)

                        '  ÕœÌÀ »Ì«‰«  «·›« Ê—… ›Ì GR
                        GR.TextMatrix(i, GR.ColIndex("NoteDateC")) = mRecordDate
                        GR.TextMatrix(i, GR.ColIndex("NoteSerial1C")) = NoteSerial1C
                        GR.TextMatrix(i, GR.ColIndex("NoteIdC")) = mNoteId
                        
                        GR.TextMatrix(i, GR.ColIndex("PayedValue")) = paidAmount + TransPayed
                        GR.TextMatrix(i, GR.ColIndex("RemainingValue")) = RemainingAmount - TransPayed
                        GR.TextMatrix(i, GR.ColIndex("TransPayedValue")) = TransPayed
                        
                        '  ÕœÌÀ »Ì«‰«  «·„ﬁ»Ê÷ ›Ì GridCashing
                        .TextMatrix(j, .ColIndex("value")) = ReceiptAmount - TransPayed

                        ' ≈–«  „ ”œ«œ «·›« Ê—… »«·ﬂ«„·° «‰ ﬁ· ≈·Ï «·›« Ê—… «· «·Ì…
                        If RemainingAmount - TransPayed <= 0 Then Exit For
                    End If
                Next j
            End With
        End If
...
'        For i = .FixedRows To .rows - 1
'         NoteSerial1 = .TextMatrix(i, .ColIndex("NoteSerial1"))
'        .TextMatrix(i, .ColIndex("RetunByInvoice")) = findTotalReturnsForThisInvoice(NoteSerial1, val(.TextMatrix(i, .ColIndex("Note_Value"))))
'
'
'         Next i
'
...
'        For i = .FixedRows To .rows - 1
'         NoteSerial1 = .TextMatrix(i, .ColIndex("NoteSerial1"))
''        .TextMatrix(i, .ColIndex("RetunByInvoice")) = findTotalReturnsForThisInvoice(NoteSerial1)
'
'
'         Next i
'
...
End Sub
Function findTotalReturnsForThisInvoice(NoteSerial1 As String, Note_Value As Double) As Double
 Dim Remark As String
 Dim totalReturned As Double
 totalReturned = 0
With FGReturns

        For i = .FixedRows To .rows - 1
         Remark = .TextMatrix(i, .ColIndex("Remark"))
         If Remark = NoteSerial1 Then
.TextMatrix(i, .ColIndex("SalesInvoiceVakue")) = Note_Value
             totalReturned = totalReturned + val(.TextMatrix(i, .ColIndex("value")))
          End If
             
         Next i

End With
findTotalReturnsForThisInvoice = totalReturned
...
Private Sub Cmd_Click(index As Integer) '%%%%%%%%% Command Bar %%%%%%%%%
    ...
    Select Case index
        ...
        'check if user have permission to EDIT recored
         ...
         StrSQL = "Delete From TblBillBuyPayment2 Where   AUToJoinid=" & val(Me.TxtCode.text)
         Cn.Execute StrSQL, , adExecuteNoRecords
...
Public Sub Retrive(Optional Lngid As Long = 0) '%%%%%%%%%% Get the last Recored %%%%%%%%%%
    ...
    Me.cmbBranch.BoundText = IIf(IsNull(rs("BranchID").value), "", rs("BranchID").value)
...
Private Sub SaveData()
 ...
 Dim mTransType1 As Long
 Dim mTransType2 As Long
 Dim mTransType3 As Long
 Dim mTransType4 As Long
  If Rd(4) Then
    mTransType1 = 22
    mTransType2 = 5
    mTransType3 = 5
...
sql = sql & "  WHERE     (dbo.Transactions.PaymentType = 1) AND (dbo.Transactions.Transaction_Type = " & mTransType1 & " OR"
sql = sql & "                       dbo.Transactions.Transaction_Type = 2 or dbo.Transactions.Transaction_Type = 71 ) "
 ...
 Cn.Execute sql, , adExecuteNoRecords
    ...
    rs("BranchID").value = val(cmbBranch.BoundText)
        ...
        For i = .FixedRows To .rows - 1
            If .cell(flexcpChecked, i, .ColIndex("payed")) = flexChecked Then
               ...
               ' .TextMatrix(i, .ColIndex("NetValue")) = val(.TextMatrix(i, .ColIndex("RemainingValue"))) - val(.TextMatrix(i, .ColIndex("TransPayedValue")))
                ...
                If val(val(.TextMatrix(i, .ColIndex("RemainingValue")))) = 0 Then
                    StrSQL = "Update Transactions Set  TotalPayed=1 Where Transaction_ID=" & val(.TextMatrix(i, .ColIndex("NoteID"))) & ""
                    Cn.Execute StrSQL, , adExecuteNoRecords
                Else
                    StrSQL = "Update Transactions Set TotalPayed=0 Where Transaction_ID =" & val(.TextMatrix(i, .ColIndex("NoteID"))) & ""
...
With Me.GR
 For i = .FixedRows To .rows - 1
 'RemainingValue = Note_Value - RetunByInvoice - Cashing - RetunWithoutInvoice - Others
     .TextMatrix(i, .ColIndex("RemainingValue")) = val(.TextMatrix(i, .ColIndex("Note_Value"))) - val(.TextMatrix(i, .ColIndex("RetunByInvoice"))) - val(.TextMatrix(i, .ColIndex("Others")))
...
sql = sql & "                       dbo.Transactions.Transaction_Type = 2 or dbo.Transactions.Transaction_Type = 71 ) "
   ...
   If Trim(cmbBranch.text) <> "" Then
        sql = sql & " AND (Transactions.BranchId =  " & val(cmbBranch.BoundText) & ")"
   End If
    ...
    sql = sql & "  WHERE     (dbo.Notes.NoteType = " & mTransType3 & " OR dbo.Notes.NoteType = 200 or dbo.Notes.NoteType = 57 Or "
    sql = sql & "                       dbo.Notes.NoteType = 9 OR"
    sql = sql & "                       dbo.Notes.NoteType = 220)"
        If Trim(cmbBranch.text) <> "" Then
        sql = sql & " AND (Notes.branch_no =  " & val(cmbBranch.BoundText) & ")"
   End If
    sql = sql & "                       AND (dbo.DOUBLE_ENTREY_VOUCHERS.Account_Code = '" & AccountCode & "'))"
...
sql = sql & "  WHERE     (dbo.Transactions.PaymentType = 1) AND (dbo.Transactions.Transaction_Type = " & mTransType1 & " OR"
sql = sql & "                       dbo.Transactions.Transaction_Type = 2 or dbo.Transactions.Transaction_Type = 71 ) "
sql = sql & "   AND (dbo.Transactions.TotalPayed IS NULL OR        dbo.Transactions.TotalPayed = 0) "
   If CUIDs <> "" Then
   sql = sql & " AND (Transactions.CusID in (" & CUIDs & ")) "
  End If
  If Trim(cmbBranch.text) <> "" Then
...
sql = " SELECT"
sql = sql & "    n.NoteID, d.Account_Code,"
sql = sql & "    ISNULL(SUM(p.PayedValue), 0) AS Total_Payed," ' ≈–« ·„  ﬂ‰ Â‰«ﬂ „œ›Ê⁄« ° ÌﬂÊ‰ «·„»·€ 0
sql = sql & "    d.Value,"
sql = sql & "    d.RecordDate,"
sql = sql & "    t.NotesTypeName, t.NotesTypeNameE, n.Remark,"
sql = sql & "    n.NoteSerial,"
sql = sql & "    n.NoteSerial1"
sql = sql & " FROM dbo.Notes n"
sql = sql & " INNER JOIN dbo.DOUBLE_ENTREY_VOUCHERS d ON n.NoteID = d.Notes_ID"
sql = sql & " INNER JOIN dbo.TblNotesTypes t ON n.NoteType = t.NotesType"
sql = sql & " LEFT JOIN dbo.TblBillBuyPayment2 p ON n.NoteID = p.NoteID" '  €ÌÌ— INNER JOIN ≈·Ï LEFT JOIN

sql = sql & " WHERE (n.NoteType = " & mTransType3
sql = sql & " OR n.NoteType = 200"
sql = sql & " OR n.NoteType = 57"
sql = sql & " OR n.NoteType = 9"
sql = sql & " )"
    If Trim(cmbBranch.text) <> "" Then
        sql = sql & " AND (n.branch_no =  " & val(cmbBranch.BoundText) & ")"
   End If

    

sql = sql & " AND (d.Account_Code  = '" & AccountCode & "')"

sql = sql & " GROUP BY n.NoteID, d.Account_Code, d.Value, d.RecordDate, t.NotesTypeName, n.NoteSerial, n.NoteSerial1, t.NotesTypeNameE, n.Remark"

sql = sql & " HAVING ISNULL(SUM(p.PayedValue), 0) < d.Value" '  Ã‰» «·›Ê« Ì— «·„”œœ… »«·ﬂ«„·

sql = sql & " ORDER BY d.RecordDate, n.NoteSerial;"
...
Set Rs8 = New ADODB.Recordset
 ...
 sql = "SELECT     dbo.DOUBLE_ENTREY_VOUCHERS.Account_Code, dbo.DOUBLE_ENTREY_VOUCHERS.[Value], dbo.DOUBLE_ENTREY_VOUCHERS.RecordDate, dbo.Notes.NoteID, "
    sql = sql & "                       dbo.TblNotesTypes.NotesTypeName , dbo.TblNotesTypes.NotesTypeNameE, dbo.Notes.NoteSerial, dbo.Notes.NoteSerial1 "
    sql = sql & " , Remark= ("
    sql = sql & "  select  max(ReturnSerial) from"
    sql = sql & "  dbo.transactions"
    sql = sql & "  Where Transaction_Type = " & mTransType2 & " And (transactions.NoteID = NoteID))"

    sql = sql & "  FROM         dbo.Notes INNER JOIN"
    sql = sql & "                        dbo.DOUBLE_ENTREY_VOUCHERS ON dbo.Notes.NoteID = dbo.DOUBLE_ENTREY_VOUCHERS.Notes_ID INNER JOIN"
    sql = sql & "                       dbo.TblNotesTypes ON dbo.Notes.NoteType = dbo.TblNotesTypes.NotesType"
    sql = sql & "  WHERE     (dbo.Notes.NoteType = 220  )"
    If Trim(cmbBranch.text) <> "" Then
        sql = sql & " AND (Notes.branch_no =  " & val(cmbBranch.BoundText) & ")"
    End If
    sql = sql & "                          AND (dbo.DOUBLE_ENTREY_VOUCHERS.Account_Code = '" & AccountCode & "')"
...
Function GeteBillBuy2(Optional Transaction_ID As Double = 0) As Double
   ...
   sql = " SELECT   SUM(TransPayedValue) AS Smatiobn"
    ...
    Rs8.Open sql, Cn, adOpenStatic, adLockOptimistic, adCmdText
    If Rs8.RecordCount > 0 Then
        GeteBillBuy2 = IIf(IsNull(Rs8("Smatiobn").value), 0, Rs8("Smatiobn").value)
    Else
        GeteBillBuy2 = 0
    End If
    Rs8.Close
...
'############################################### Cus List Part ##################################################
    ...
    Dcombos.GetBranches Me.cmbBranch
    '#############################################################################################################
