...
Function CuurentLogdata(Optional Currentmode As String)
    LogTextA = "    ‘«‘… " & ScreenNameArabic & CHR(13) & "ﬂÊœ  «·„—ﬂ“ " & txt_code.text & CHR(13) & "   «”„ «·„—ﬂ“  " & TxtVacName & CHR(13) & "  «·‰Ê⁄  " & Combo1 & CHR(13) & "  Ì »⁄  " & DcboGovernmentID & CHR(13) & "   «·›∆…   " & dcCATEGORY
...
Private Sub Combo1_Change()
    ...
    If Me.TxtModFlg.text <> "R" Then
        If Combo1.ListIndex = 1 Then
            Dcombos.getCC DcboGovernmentID, "—∆Ì”Ì", "Major"
        ElseIf Combo1.ListIndex = 2 Then
            Dcombos.getCC DcboGovernmentID, "⁄«„", "General", "—∆Ì”Ì", "Major"
        Else
...
Public Function get_cost_center_code(parent_no As String, _
    ...
    My_SQL = "select  max(CONVERT(INT, account_no )) as last_root  from   markaas_taklefa where len(account_NO)<=2 and ( account_type='—∆Ì”Ì'  or account_type='major' ) "
