...
Begin VB.Form FemSearchDevelopment 
   ...
   Begin VSFlex8UCtl.VSFlexGrid FG3 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   -1  'True
      FormatString    =   $"FrmSearchDevelopment.frx":22BE
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
    ...
    Select Case Index
        ...
        Case 0
            ...
            ElseIf mIndex = 3 Then
                ...
                FG2.Visible = False
                FG3.Visible = True
                loadgrid Build_Sql3, FG3, True, False
    ...
    On Error GoTo ErrTrap
       If mIndex <> 3 Then
        ...
        Else
            ...
            dean.FiLLTXT3 val(FG.TextMatrix(FG.Row, 1))
        End If
ErrTrap:
End Sub
...
Private Sub FG3_Click()
       ...
       If mIndex <> 3 Then
        ...
        ElseIf mIndex = 3 Then
            ...
            dean.FiLLTXT3 val(FG3.TextMatrix(FG3.Row, 1))
        End If
ErrTrap:
End Sub
...
Private Sub Form_Activate()
    ...
    ElseIf mIndex = 3 Then
        ...
        LOcalCBO = " SELECT     dbo.TblItems.ItemID, dbo.TblItems.ItemName  FROM         dbo.Groups INNER JOIN dbo.TblItems ON dbo.Groups.GroupID = dbo.TblItems.GroupID  Where (dbo.Groups.Separate = 1)"
        fill_combo cmbCarName, LOcalCBO
        XPLbl(0).Caption = "«·ﬁÿ⁄…"
...
StrSQL = "SELECT    TblJobOrders.*,tblItems.ItemName,TblCustemers.CusName,TblEmployee.Emp_Name,TblBranchesData.branch_name   from TblJobOrders  Left  Outer join TblBranchesData On  TblBranchesData.branch_id = TblJobOrders.branchid"
StrSQL = StrSQL & " Left  Outer join TblJobOrders2      On  TblJobOrders.ID= TblJobOrders2.MasterID"
StrSQL = StrSQL & " Left  Outer join TblCustemers      On  TblCustemers.CusID= TblJobOrders.CusID"
StrSQL = StrSQL & " Left  Outer join TblEmployee    On  TblEmployee.Emp_ID= TblJobOrders.EmpID"
StrSQL = StrSQL & " Left  Outer join tblItems    On  TblJobOrders2.ItemID= tblItems.ItemId"
...
StrWhere = ""
    ...
    If Trim(Me.txtCustName.Text) <> "" Then
        ...
        StrWhere = StrWhere + " and dbo.TblCustemers.CusName Like '%" & Trim(Me.txtCustName.Text) & "%'"
 
    End If
 
     If Trim(Me.txtPhoneCust.Text) <> "" Then
 
        StrWhere = StrWhere + " and dbo.TblCustemers.Cus_mobile Like '%" & Trim(Me.txtPhoneCust.Text) & "%'"
 
    End If
    
     If Trim(Me.XPTxtVal.Text) <> "" Then
 
        StrWhere = StrWhere + " and dbo.TblJobOrders.TotalNet = " & val(Me.XPTxtVal.Text)
    ...
    If val(Me.cmbLocationsName.BoundText) <> 0 And Me.cmbLocationsName.Text <> "" Then
        ...
        StrWhere = StrWhere + " and dbo.TblJobOrders.BranchID =" & val(Me.cmbLocationsName.BoundText)
 ...
 '   End If
    ...
    If Me.TXTOrDer_no.Text <> "" Then
        ...
        StrWhere = StrWhere + " and dbo.TblJobOrders.id = " & val(Me.TXTOrDer_no.Text)
 
    End If
    
        If Me.cmbCarName.Text <> "" Then
 
                StrWhere = StrWhere + " and dbo.tblItems.ItemName Like '%" & Trim(Me.cmbCarName.Text) & "%'"
        End If
    
 If Not IsNull(Me.XPDtbBill.value) Then
       
            StrWhere = StrWhere & " AND dbo.TblJobOrders.RecordDate >=" & SQLDate(Me.XPDtbBill.value, True) & ""
        End If
        
         If Not IsNull(Me.ToDate.value) Then
       
            StrWhere = StrWhere & " AND dbo.TblJobOrders.RecordDate <=" & SQLDate(Me.ToDate.value, True) & ""
        End If
    StrWhere = StrWhere + " order by dbo.TblJobOrders.Id"

    Build_Sql3 = StrSQL + StrWhere
    Exit Function
ErrTrap:
End Function
