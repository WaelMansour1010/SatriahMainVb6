...
Begin VB.Form risky_items_alarm 
   BackColor       =   &H000000FF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "ÇáÊÐßíÑ ÈãÓÊÃÌÑíä ÚãáíÇÊ ÎÇÑÌíÉ íÍá Úáíåã ÞÓØ ÅíÌÇÑ"
   ClientHeight    =   7965
   ClientLeft      =   3150
   ClientTop       =   930
   ClientWidth     =   10890
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "risky_items_alarm.frx":0000
      Height          =   4695
      Left            =   120
      TabIndex        =   27
      Top             =   2040
   ...
   Begin ALLButtonS.ALLButton CMD_language 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "risky_items_alarm.frx":0015
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ALLButtonS.ALLButton close_all_alarms 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "risky_items_alarm.frx":0031
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "risky_items_alarm"
...
If my_language = "E" Then
   Set wb = xlApp.Workbooks.Open(system_path & "\reports\en\data.xlt")

   Set ws = wb.Worksheets("Sheet1") 'Specify your worksheet name
   
For i = 1 To Adodc3.Recordset.RecordCount
xx = i + 2
    ws.Cells(xx, 6).value = Adodc3.Recordset.Fields!avilable_in_inventories
       ws.Cells(xx, 5).value = Adodc3.Recordset.Fields!last_purchase_price
    ws.Cells(xx, 4).value = Adodc3.Recordset.Fields!had_talab
      ws.Cells(xx, 3).value = Adodc3.Recordset.Fields!item_name
      ws.Cells(xx, 2).value = Adodc3.Recordset.Fields!item_code
      ws.Cells(xx, 1).value = i
...
End If
   ...
   Set wb = xlApp.Workbooks.Open(system_path & "\reports\data.xlt")

   Set ws = wb.Worksheets("Sheet1") 'Specify your worksheet name
   
For i = 1 To Adodc3.Recordset.RecordCount
xx = i + 2
    ws.Cells(xx, 1).value = Adodc3.Recordset.Fields!avilable_in_inventories
       ws.Cells(xx, 2).value = Adodc3.Recordset.Fields!last_purchase_price
    ws.Cells(xx, 3).value = Adodc3.Recordset.Fields!had_talab
      ws.Cells(xx, 4).value = Adodc3.Recordset.Fields!item_name
      ws.Cells(xx, 5).value = Adodc3.Recordset.Fields!item_code
      ws.Cells(xx, 6).value = i
   Adodc3.Recordset.MoveNext
Next i
 
LL:
'wb.SaveAs system_path & "\reports\xxx.xls"
   wb.Close
...
If my_language = "E" Then
ALLButton1.Caption = "Export"
Print_cmd.Caption = "Print"
Label14.Caption = "No Purchase Request Today"
...
If my_language = "E" Then
Label17.Caption = "No Purchase Request  Today"
...
Label1.Caption = "Purchase Request "
...
Adodc3.RecordSource = "select *  from risky_items_alarm where branch_no=" & branch_no & " and departement='" & departement_name & "'"
Adodc3.Refresh
...
If Adodc2.Recordset.Fields!toatal <= Adodc1.Recordset.Fields!risk Then
...
Adodc3.Recordset.Fields!had_talab = Adodc1.Recordset.Fields!risk
Adodc3.Recordset.Fields!avilable_in_inventories = Adodc2.Recordset.Fields!toatal
Adodc3.Recordset.Fields!last_purchase_price = Adodc1.Recordset.Fields!akher_s3r_shera
