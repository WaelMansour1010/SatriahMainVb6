...
Begin VB.Form FrmAccountDestribution 
   BackColor       =   &H00E2E9E9&
   ...
   ClientWidth     =   14400
   HelpContextID   =   580
   Icon            =   "FrmAccountDestribution.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   RightToLeft     =   -1  'True
   ...
   Begin C1SizerLibCtl.C1Elastic EleMain 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmAccountDestribution.frx":038A
      AccessibleName  =   ""
      ...
      Begin C1SizerLibCtl.C1Tab C1Tab1 
         ...
         Begin C1SizerLibCtl.C1Elastic C1Elastic1 
            ...
            Begin VB.Frame Frame4 
               ...
               Begin ImpulseButton.ISButton Cmd 
                  ...
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  ButtonImage     =   "FrmAccountDestribution.frx":040F
               ...
               Begin ImpulseButton.ISButton Cmd 
                  ...
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  ButtonImage     =   "FrmAccountDestribution.frx":07A9
                  DrawFocusRectangle=   0   'False
               End
               Begin VB.Label lbl 
                  Alignment       =   1  'Right Justify
            ...
            Begin VSFlex8Ctl.VSFlexGrid GridIntervals 
               ...
               FormatString    =   $"FrmAccountDestribution.frx":0D43
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin C1SizerLibCtl.C1Elastic Ele 
            ...
            Begin C1SizerLibCtl.C1Elastic Ele 
               ...
               Begin VB.Frame Frame1 
                  ...
                  Begin ImpulseButton.ISButton Cmd 
                     ...
                     BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     ButtonImage     =   "FrmAccountDestribution.frx":0FB4
                     DrawFocusRectangle=   0   'False
                  End
                  Begin ImpulseButton.ISButton Cmd 
                     Height          =   390
                     ...
                     BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     ButtonImage     =   "FrmAccountDestribution.frx":134E
                     DrawFocusRectangle=   0   'False
                  End
                  Begin VB.Label lbl 
                     Alignment       =   1  'Right Justify
               ...
               Begin VSFlex8Ctl.VSFlexGrid Grid 
                  ...
                  ColWidthMax     =   0
                  ExtendLastCol   =   -1  'True
                  FormatString    =   $"FrmAccountDestribution.frx":18E8
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
      ...
      Begin C1SizerLibCtl.C1Elastic EltCont 
         ...
         Begin ImpulseButton.ISButton btnQuery 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmAccountDestribution.frx":1B89
         ...
         Begin ImpulseButton.ISButton BtnUpdate 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmAccountDestribution.frx":1F23
         ...
         Begin ImpulseButton.ISButton BtnPrint 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmAccountDestribution.frx":22BD
            ColorButton     =   14871017
            DrawFocusRectangle=   0   'False
         ...
         Begin ALLButtonS.ALLButton CmdRemove 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "FrmAccountDestribution.frx":2657
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
   ...
   Begin ImpulseButton.ISButton ISButton1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmAccountDestribution.frx":2673
      ColorButton     =   14871017
      DrawFocusRectangle=   0   'False
   End
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      FloodColor      =   6553600
      ForeColorDisabled=   -2147483631
      Picture         =   "FrmAccountDestribution.frx":2A0D
      Caption         =   "ŒÿÂ  Ê“Ì⁄ «·Õ”«»«   "
      Align           =   0
      AutoSizeChildren=   0
      BorderWidth     =   0
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAccountDestribution.frx":36E7
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAccountDestribution.frx":3A81
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAccountDestribution.frx":3E1B
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAccountDestribution.frx":41B5
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
   ...
   End
End
Attribute VB_Name = "FrmAccountDestribution"
...
Private Sub SaveData()
    ...
    rs("AccountMasterName").value = IIf(Me.DCAccountMaster.text = "", Null, Me.DCAccountMaster.text)
    rs("AccountMasterSerial").value = val(GetID("ACCOUNTS", "Account_Code", "Account_Serial", Me.DCAccountMaster.BoundText))
    ...
    If DistType(0).value = True Then
        rs("DistType").value = 0
    ElseIf DistType(1).value = True Then
        rs("DistType").value = 1
    ElseIf DistType(2).value = True Then
        rs("DistType").value = Null
    End If
...
Private Sub Cmd_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 0
            ...
            GridIntervals.Clear flexClearScrollable, flexClearEverything
            GridIntervals.Rows = 1
            GridIntervals.Enabled = True
...
Public Sub Retrive(Optional Lngid As Long = 0)
    ...
    If (rs("DistType").value) = False Then
        DistType(0).value = True
    ElseIf (rs("DistType").value) = True Then

        DistType(1).value = True
    ElseIf IsNull(rs("DistType").value) Then

        DistType(2).value = True
    End If
    ...
    If Not (RsDev.BOF Or rs.EOF) Then
        ...
        With Me.Grid
            ...
            For i = .FixedRows To .Rows - 1
                ...
                .TextMatrix(i, .ColIndex("Aid")) = IIf(IsNull(RsDev("Aid").value), "", RsDev("Aid").value)
            
                .TextMatrix(i, .ColIndex("ACode")) = IIf(IsNull(RsDev("ACode").value), "", RsDev("ACode").value)
            
                .TextMatrix(i, .ColIndex("ASerial")) = IIf(IsNull(RsDev("ASerial").value), "", RsDev("ASerial").value)
                .TextMatrix(i, .ColIndex("AName")) = IIf(IsNull(RsDev("AName").value), "", RsDev("AName").value)
    ...
    If Not (RsDev.BOF Or rs.EOF) Then
        ...
        With Me.GridIntervals
            ...
            For i = .FixedRows To .Rows - 1
                ...
                .TextMatrix(i, .ColIndex("IntervalSerial")) = IIf(IsNull(RsDev("IntervalSerial").value), "", RsDev("IntervalSerial").value)
                ...
                If RsDev("DistributedDone").value = True Then
                ...
                .TextMatrix(i, .ColIndex("NoteID")) = IIf(IsNull(RsDev("NoteID").value), 0, (RsDev("Remarks").value))
            
                .TextMatrix(i, .ColIndex("NoteSerial")) = IIf(IsNull(RsDev("NoteSerial").value), "", (RsDev("NoteSerial").value))
                .TextMatrix(i, .ColIndex("PrintJL")) = "ÿ»«⁄Â"
