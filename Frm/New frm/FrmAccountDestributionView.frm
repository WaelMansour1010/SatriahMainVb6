         ...
         Begin C1SizerLibCtl.C1Elastic Ele 
            ...
            Begin C1SizerLibCtl.C1Elastic Ele 
               ...
               Begin VB.Label lbl 
                  Alignment       =   1  'Right Justify
                  BackColor       =   &H00C0FFFF&
                  Caption         =   " Ê›— Â–… «·‘ ‘Â «„ﬂ«‰ÌÂ ⁄„· ŒÿÂ  Ê“Ì⁄ Õ”«» ⁄·Ï ⁄œÂ Õ”«»«  «Ê ⁄·Ï ⁄œÂ „—«ﬂ“  ﬂ·›… ›Ì › —«  „Œ ·›… »‰”» „Œ ·›Â   "
                  BeginProperty Font 
                     Name            =   "Tahoma"
                     Size            =   8.25
                     Charset         =   178
...
Function DistributAccounts(AccountMaster As String, Balance As Double, TblAccountsDestributionsid As Long, IntervalID As Long)
    ...
    If SystemOptions.UserInterface = ArabicInterface Then
        X = MsgBox(" „ «‰‘«¡  ﬁÌœ «· Ê“Ì⁄  »—ﬁ„ " & Chr(13) & NoteSerial & " Â·  —Ìœ ⁄—÷ «·ﬁÌœ ‰⁄„ «„ ·«", vbInformation + vbYesNo)
