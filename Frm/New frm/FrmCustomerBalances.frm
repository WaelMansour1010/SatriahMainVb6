...
Begin VB.Form FrmCustomerBalances 
   Caption         =   "  «·«ﬁ”«ÿ «· Ì ·„  ”œœ"
   ClientHeight    =   8430
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11790
   HelpContextID   =   440
   Icon            =   "FrmCustomerBalances.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   RightToLeft     =   -1  'True
   ScaleHeight     =   8430
   ...
   Begin C1SizerLibCtl.C1Elastic EleMain 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmCustomerBalances.frx":038A
      AccessibleName  =   ""
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin ImpulseButton.ISButton CmdExit 
            ...
            EndProperty
            BackStyle       =   0
            ButtonImage     =   "FrmCustomerBalances.frx":03E4
         ...
         Begin ImpulseButton.ISButton CmdPrint 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmCustomerBalances.frx":077E
            ColorButton     =   14871017
            ColorHighlight  =   16777215
            ColorHoverText  =   16711680
            ColorShadow     =   -2147483637
      ...
      Begin VSFlex8UCtl.VSFlexGrid Fg 
         ...
         FormatString    =   $"FrmCustomerBalances.frx":0B18
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Image Image1 
         Height          =   585
         Left            =   30
         Picture         =   "FrmCustomerBalances.frx":0E1E
         Top             =   30
         Width           =   1125
      End
   ...
   End
End
Attribute VB_Name = "FrmCustomerBalances"
...
Private Sub Form_Load()
    ...
    ElseIf SystemOptions.SysDataBaseType = SQLServerDataBase Then
       ...
       ' StrSQL = StrSQL + "  order by CusName,QryCust_Qest.Transaction_ID,QeqtNum"
StrSQL = " SELECT     TOP 100 PERCENT dbo.QryCust_Qest.QestID, dbo.QryCust_Qest.NoteID, dbo.QryCust_Qest.QeqtNum, dbo.QryCust_Qest.PartID, dbo.QryCust_Qest.[Value],"
StrSQL = StrSQL + "                      dbo.QryCust_Qest.DueDate, dbo.QryCust_Qest.Receipt, dbo.QryCust_Qest.Summition, dbo.QryCust_Qest.Transaction_ID, dbo.QryCust_Qest.Transaction_Date,"
StrSQL = StrSQL + "                      dbo.Transactions.NoteSerial1, dbo.QryCust_Qest.CustID, dbo.TblCustemers.CusName, dbo.TblCustemers.CusNamee, dbo.TblCustemers.Cus_Phone,"
...
StrSQL = StrSQL + "                      dbo.TblCustemers.Mobile2 , dbo.TblCustemers.entry , dbo.TblCustemers.Fullcode"
StrSQL = StrSQL + " FROM         dbo.QryCust_Qest LEFT OUTER JOIN"
...
StrSQL = StrSQL + "                          (SELECT     QestID"
StrSQL = StrSQL + "                             From InstallmentDet_Junc_Receipt"
StrSQL = StrSQL + "                             WHERE     Status <> 1)) AND (dbo.QryCust_Qest.DueDate <" & SQLDate(Date, True) & ")"
    ...
    If Not (RsTemp.EOF Or RsTemp.BOF) Then
        ...
        With Fg
            ...
            For ReCount = 1 To RsTemp.RecordCount
                ...
                .TextMatrix(RowNum, .ColIndex("Fullcode")) = "...."
