...
Begin VB.Form FrmDiffrentReceptChargAlrm 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "‘«‘…  ‰»ÌÂ«  «·›—ﬁ »Ì‰ «·ﬂ„Ì«  «·„” ·„Â Ê«·ﬂ„Ì«  «·„‘ÕÊ‰Â"
   ClientHeight    =   8520
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   16335
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ImpulseButton.ISButton Cmd1 
         ...
         EndProperty
         ButtonImage     =   "FrmDiffrentReceptChargAlrm.frx":0000
         ColorButton     =   8438015
      ...
      Begin VB.Label lbl 
         Alignment       =   1  'Right Justify
         BackColor       =   &H00C0FFFF&
         Caption         =   "Â–Â «·‘«‘…  ﬁÊ„ »«ŸÂ«— «·›—ﬁ »Ì‰ «·ﬂ„Ì«  «·„” ·„Â Ê«·ﬂ„Ì«  «·„‘ÕÊ‰Â"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   178
      ...
      Begin MSComctlLib.ImageList GrdImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmDiffrentReceptChargAlrm.frx":039A
               Key             =   "CompanyName"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmDiffrentReceptChargAlrm.frx":03F8
               Key             =   "Ser"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmDiffrentReceptChargAlrm.frx":0456
               Key             =   "Vac_Name"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmDiffrentReceptChargAlrm.frx":04B4
               Key             =   "ShareCount"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmDiffrentReceptChargAlrm.frx":0512
               Key             =   "Dis_Count"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmDiffrentReceptChargAlrm.frx":0570
               Key             =   "Bouns"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmDiffrentReceptChargAlrm.frx":05CE
               Key             =   "SharesValue"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmDiffrentReceptChargAlrm.frx":062C
               Key             =   "BuyValue"
            EndProperty
         EndProperty
      End
   ...
   Begin VSFlex8UCtl.VSFlexGrid GridInstallments 
      ...
      FormatString    =   $"FrmDiffrentReceptChargAlrm.frx":068A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin ImpulseButton.ISButton Cmd1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmDiffrentReceptChargAlrm.frx":0856
      ColorButton     =   14871017
      DrawFocusRectangle=   0   'False
   End
   ...
   End
End
Attribute VB_Name = "FrmDiffrentReceptChargAlrm"
...
On Error Resume Next
 ...
 My_SQL = My_SQL + " where  dbo.Transactions.Transaction_Type=56"
        ...
        If rs.RecordCount > 0 Then
           ...
           rs.MoveFirst
            ...
            For i = 1 To .Rows - 1
              ...
              .TextMatrix(i, .ColIndex("RecivedShippedQty")) = (IIf(IsNull(rs.Fields("RecivedShippedQty").value), 0, rs.Fields("RecivedShippedQty").value))
              .TextMatrix(i, .ColIndex("showqty")) = IIf(IsNull(rs.Fields("showqty").value), 0, rs.Fields("showqty").value)
              .TextMatrix(i, .ColIndex("diff")) = val(.TextMatrix(i, .ColIndex("RecivedShippedQty"))) - val(.TextMatrix(i, .ColIndex("showqty")))
...
Function print_report(Optional NoteSerial As String)
    ...
    Dim Msg As String
        ...
        If SystemOptions.UserInterface = ArabicInterface Then
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepDiffReceptChargAlarm.rpt"
        Else
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepDiffReceptChargAlarm.rpt"
        End If
...
Function cahngelang()
    Label1(2).Caption = "The Difference Between The amounts Received and Charged"
    ...
    .TextMatrix(0, .ColIndex("RecivedShippedQty")) = "Qty Charged"
    .TextMatrix(0, .ColIndex("showqty")) = "Qty Received "
