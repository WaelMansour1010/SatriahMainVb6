...
Begin VB.Form FrmEmpExpir1 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "«”„«¡ «·„ÊŸ›Ì‰ «· Ì ” ‰ ÂÌ «·ÃÊ«“«  "
   ClientHeight    =   6180
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14295
   Icon            =   "FrmEmpExpir1.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList GrdImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir1.frx":058A
               Key             =   "CompanyName"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir1.frx":0924
               Key             =   "Ser"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir1.frx":0CBE
               Key             =   "Vac_Name"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir1.frx":1058
               Key             =   "ShareCount"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir1.frx":13F2
               Key             =   "Dis_Count"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir1.frx":178C
               Key             =   "Bouns"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir1.frx":1B26
               Key             =   "SharesValue"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmEmpExpir1.frx":20C0
               Key             =   "BuyValue"
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame Frm2 
      ...
      Begin VB.ComboBox CmbType 
         BackColor       =   &H80000018&
         Height          =   315
         ItemData        =   "FrmEmpExpir1.frx":245A
         Left            =   2280
         List            =   "FrmEmpExpir1.frx":246A
         RightToLeft     =   -1  'True
   ...
   Begin C1SizerLibCtl.C1Elastic EltCont 
      ...
      Begin ImpulseButton.ISButton btnNew 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir1.frx":2483
      ...
      Begin ImpulseButton.ISButton btnSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir1.frx":281D
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnModify 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir1.frx":2BB7
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnUndo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir1.frx":2F51
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnDelete 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir1.frx":32EB
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnQuery 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir1.frx":3885
      ...
      Begin ImpulseButton.ISButton BtnUpdate 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir1.frx":3C1F
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmEmpExpir1.frx":3FB9
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
   ...
   Begin VSFlex8Ctl.VSFlexGrid Grid 
      ...
      FormatString    =   $"FrmEmpExpir1.frx":4353
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin ImpulseButton.ISButton btnCancel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmEmpExpir1.frx":4559
      ColorButton     =   14871017
      DrawFocusRectangle=   0   'False
      DisabledImageStyle=   1
   End
   ...
   End
End
Attribute VB_Name = "FrmEmpExpir1"
...
Private Sub Command1_Click()
    ...
    My_SQL = "SELECT   * from dbo.TblEmployee WHERE (  NOT (dbo.TblEmployee.NumPasp IS NULL ) ) "
    'and   DateEndPasp >=" & SQLDate(d1.value, True) & " AND DateEndPasp <=" & SQLDate(d2.value, True)

  
      
   If mIsEndType = 1 Then
        My_SQL = My_SQL & " AND DateEndPasp>'" & SQLDate(DateAdd(Askinterval, Askcount, SQLDate(d1.value, True))) & "'"
    ElseIf mIsEndType = 2 Then
        My_SQL = My_SQL & "  AND (   DateEndPasp   >=" & SQLDate(d1.value, True) & "AND DateEndPasp <=" & SQLDate(d2.value, True) & ")"
    Else
        My_SQL = My_SQL & " AND (   DateEndPasp   >=" & SQLDate(d1.value, True) & "AND DateEndPasp <=" & SQLDate(d2.value, True) & ")"
    End If
  
  My_SQL = My_SQL & " order by DateEndPasp,fullcode"
...
Command1_Click
    ...
    Set xReport = xApp.OpenReport(App.path & "\reports\emp\REPORT14.rpt")
    xReport.Database.SetDataSource rs
    Dim FrmReport As New FrmReportViewer
    '   FrmReport = New FrmReportViewer
    FrmReport.CRViewer.ReportSource = xReport
    FrmReport.txtpath = (App.path & "\reports\emp\REPORT14.rpt")
    FrmReport.CRViewer.ViewReport
    FrmReport.show
    xReport.ParameterFields(1).AddCurrentValue CStr(d1.value)
    xReport.ParameterFields(2).AddCurrentValue CStr(d2.value)
...
Private Sub Form_Load()
    ...
    If mIsEndType = 1 Then
        My_SQL = My_SQL & " AND DateEndPasp>'" & SQLDate(DateAdd(Askinterval, Askcount, mNewDate)) & "'"
    ElseIf mIsEndType = 2 Then
        My_SQL = My_SQL & " AND DateEndPasp<='" & SQLDate(DateAdd(Askinterval, Askcount, mNewDate)) & "'"
    Else
        My_SQL = My_SQL & " AND DateEndPasp<='" & SQLDate(DateAdd(Askinterval, Askcount, mNewDate)) & "'"
...
Function ChangeLang()
    ...
    With Me.Grid
        ...
        .TextMatrix(0, .ColIndex("NumPasp")) = "Num."
        .TextMatrix(0, .ColIndex("pasplace")) = "Issue Place"
 
        .TextMatrix(0, .ColIndex("DateExpPasp")) = "Issue Date G"
        .TextMatrix(0, .ColIndex("DateEndPasp")) = "Expire Date G"
...
Public Sub FillGridWithData()
    ...
    '    My_SQL = "select * From TblEmployee  where    (MONTH(DateEndekama) <= MONTH(GETDATE()) and (year(DateEndekama) <= year(GETDATE()))"
    ...
    With Me.Grid
        ...
        If rs.RecordCount > 0 Then
            ...
            For i = 1 To .Rows - 1
                ...
                .TextMatrix(i, .ColIndex("NumPasp")) = IIf(IsNull(rs.Fields("NumPasp").value), "", rs.Fields("NumPasp").value)
                .TextMatrix(i, .ColIndex("NumPaspOld")) = IIf(IsNull(rs.Fields("NumPasp").value), "", rs.Fields("NumPasp").value)
            
                .TextMatrix(i, .ColIndex("pasplace")) = IIf(IsNull(rs.Fields("pasplace").value), "", rs.Fields("pasplace").value)
            
                .TextMatrix(i, .ColIndex("DateExpPasp")) = IIf(IsNull(rs.Fields("DateExpPasp").value), "", rs.Fields("DateExpPasp").value)
                .TextMatrix(i, .ColIndex("DateEndPasp")) = IIf(IsNull(rs.Fields("DateEndPasp").value), "", rs.Fields("DateEndPasp").value)
            
                .TextMatrix(i, .ColIndex("Days")) = IIf(IsNull(rs.Fields("DateEndPasp").value), "", DateDiff("d", Date, rs.Fields("DateEndPasp").value))
