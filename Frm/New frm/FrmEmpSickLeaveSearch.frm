...
Begin VB.Form FrmEmpSickLeaveSearch 
   BackColor       =   &H00E2E9E9&
   ...
   ClientTop       =   435
   ClientWidth     =   9450
   Icon            =   "FrmEmpSickLeaveSearch.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   RightToLeft     =   -1  'True
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"FrmEmpSickLeaveSearch.frx":038A
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmEmpSickLeaveSearch"
...
Private Sub fg_Click()
    ...
    With Me.Fg
        ...
        End If
        If index = 0 Then
            FrmRegsterSickleave.FindRec val(.TextMatrix(.row, .ColIndex("ID")))
        ElseIf index = 1 Then
            FrmRegsterSickleave.TxtSerial1.text = val(.TextMatrix(.row, .ColIndex("ID")))
            'FrmRegsterSickleave.TxtSerial1_KeyPress (13)
        End If
    End With
...
Private Sub GetData()
    ...
    StrSQL = "SELECT dbo.TblRegsterSickleave.ID, "
    StrSQL = StrSQL & "       dbo.TblRegsterSickleave.RecordDate, "
    StrSQL = StrSQL & "       dbo.TblRegsterSickleave.EmpID, "
    StrSQL = StrSQL & "       dbo.TblEmployee.Emp_Name, "
    StrSQL = StrSQL & "       dbo.TblEmployee.Fullcode, "
    StrSQL = StrSQL & "       dbo.TblEmployee.Emp_Namee, "
    StrSQL = StrSQL & "       dbo.TblRegsterSickleave.ToDate ToDate, "
    StrSQL = StrSQL & "TblRegsterSickleave.ToDateH ToDateH, "
    StrSQL = StrSQL & "       TblRegsterSickleave.FrmDate FromDate "
    StrSQL = StrSQL & "     ,TblRegsterSickleave.FrmDateH FromDateH "
    StrSQL = StrSQL & "FROM dbo.TblRegsterSickleave "
    StrSQL = StrSQL & "    LEFT OUTER JOIN dbo.TblEmployee "
    StrSQL = StrSQL & "        ON dbo.TblRegsterSickleave.EmpID = dbo.TblEmployee.Emp_ID"
    BolBegine = False
    StrWhere = ""

    If val(Me.TxtIDFrom.text) <> 0 Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TblRegsterSickleave.ID >=" & val(Me.TxtIDFrom.text) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TblRegsterSickleave.ID >=" & val(Me.TxtIDFrom.text) & ""
        End If
    End If

    If val(Me.TxtIDTO.text) <> 0 Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TblRegsterSickleave.ID <=" & val(Me.TxtIDTO.text) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TblRegsterSickleave.ID <=" & val(Me.TxtIDTO.text) & ""
        End If
    End If

    If Me.DcboEmpName.BoundText <> "" Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TblRegsterSickleave.EmpID=" & Me.DcboEmpName.BoundText & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TblRegsterSickleave.EmpID=" & Me.DcboEmpName.BoundText & ""
        End If
    End If

    If Not IsNull(Me.DtpDateFrom.value) Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TblRegsterSickleave.RecordDate >=" & SQLDate(Me.DtpDateFrom.value, True) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TblRegsterSickleave.RecordDate >=" & SQLDate(Me.DtpDateFrom.value, True) & ""
        End If
    End If

    If Not IsNull(Me.DtpDateTo.value) Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TblRegsterSickleave.RecordDate <=" & SQLDate(Me.DtpDateTo.value, True) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TblRegsterSickleave.RecordDate <=" & SQLDate(Me.DtpDateTo.value, True) & ""
        End If
    End If
    ''''
    If Not IsNull(Me.FromStartDate.value) Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TblRegsterSickleave.FrmDate >=" & SQLDate(Me.FromStartDate.value, True) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TblRegsterSickleave.FrmDate >=" & SQLDate(Me.FromStartDate.value, True) & ""
        End If
    End If
    If Not IsNull(Me.ToStartDate.value) Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TblRegsterSickleave.FrmDate <=" & SQLDate(Me.ToStartDate.value, True) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TblRegsterSickleave.FrmDate <=" & SQLDate(Me.ToStartDate.value, True) & ""
        End If
    End If
    ''''''
    '-----------------------------------
    If Not IsNull(Me.FromEndDate.value) Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TblRegsterSickleave.ToDate >=" & SQLDate(Me.FromEndDate.value, True) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TblRegsterSickleave.ToDate >=" & SQLDate(Me.FromEndDate.value, True) & ""
        End If
    End If
    If Not IsNull(Me.ToEndDate.value) Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND dbo.TblRegsterSickleave.ToDate <=" & SQLDate(Me.ToEndDate.value, True) & ""
        Else
            BolBegine = True
            StrWhere = " Where dbo.TblRegsterSickleave.ToDate <=" & SQLDate(Me.ToEndDate.value, True) & ""
        End If
    End If
    ''''''''''''''''''''''''''
    ...
    If index = 1 Then
        ...
        End If
'        Dim Scren As String
'        Scren = "FrmRegsterSickleave"
'        If CheckAprroveScreen("FrmRegsterSickleave") = True Then
...
'        End If
    ...
    StrSQL = StrSQL & " Order By dbo.TblRegsterSickleave.ID"
