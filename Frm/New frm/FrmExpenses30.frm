...
Begin VB.Form FrmExpenses30 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin ImpulseAniLabel.ISAniLabel LblLink 
         ...
         ForeColor       =   4210688
         MousePointer    =   99
         MouseIcon       =   "FrmExpenses30.frx":038A
         BackColor       =   12648447
         Alignment       =   1
         Caption         =   ""
         ColorHover      =   16711680
      ...
      Begin ImpulseAniLabel.ISAniLabel ISAniLabel1 
         ...
         ForeColor       =   4210688
         MousePointer    =   99
         MouseIcon       =   "FrmExpenses30.frx":04EC
         BackColor       =   12648447
         Alignment       =   1
         Caption         =   ""
         ColorHover      =   16711680
      ...
      Begin ImpulseAniLabel.ISAniLabel LblLink1 
         ...
         ForeColor       =   4210688
         MousePointer    =   99
         MouseIcon       =   "FrmExpenses30.frx":064E
         BackColor       =   12648447
         Alignment       =   1
         Caption         =   ""
         ColorHover      =   16711680
      ...
      Begin ImpulseAniLabel.ISAniLabel ISAniLabel2 
         ...
         ForeColor       =   4210688
         MousePointer    =   99
         MouseIcon       =   "FrmExpenses30.frx":07B0
         BackColor       =   12648447
         Alignment       =   1
         Caption         =   ""
         ColorHover      =   16711680
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataListLib.DataCombo DcCostCenter 
         Bindings        =   "FrmExpenses30.frx":0912
         Height          =   315
         Left            =   120
         TabIndex        =   3
         Top             =   510
      ...
      Begin MSDataListLib.DataCombo Dcbranch 
         Bindings        =   "FrmExpenses30.frx":0927
         Height          =   315
         Left            =   120
         TabIndex        =   1
         Top             =   120
      ...
      Begin VB.Image ImgNote 
         Height          =   240
         Left            =   -240
         Picture         =   "FrmExpenses30.frx":093C
         Top             =   750
         Visible         =   0   'False
         Width           =   240
      End
   ...
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      Picture         =   "FrmExpenses30.frx":0EC6
      Caption         =   "  ’›Ì… «·⁄Âœ…  "
      Align           =   0
      AutoSizeChildren=   0
      BorderWidth     =   0
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses30.frx":1BA0
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses30.frx":1F3A
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses30.frx":22D4
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses30.frx":266E
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin VB.Image ImgFavorites 
         Height          =   390
         Left            =   12240
         Picture         =   "FrmExpenses30.frx":2A08
         Stretch         =   -1  'True
         Top             =   120
         Width           =   525
      End
   ...
   Begin C1SizerLibCtl.C1Tab XPTab301 
      ...
      AccessibleValue =   ""
      AccessibleRole  =   37
      Picture(0)      =   "FrmExpenses30.frx":66C4
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         Begin VSFlex8Ctl.VSFlexGrid Fg_Journal 
            ...
            FormatString    =   $"FrmExpenses30.frx":6A5E
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"FrmExpenses30.frx":6FCC
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
            ...
            Begin VDSCOMBOLibCtl.SmartCombo CboDes 
               ...
               OnFocus         =   3
               PasswordChar    =   ""
               Picture         =   "FrmExpenses30.frx":781D
               PictureAlignment=   5
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic6 
         ...
         Begin VSFlex8UCtl.VSFlexGrid GRID2 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"FrmExpenses30.frx":7DB7
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmExpenses30"
...
Public Sub GetAcount(Optional UnitName As String, Optional ByRef UnitID As Double)
Dim sql As String
...
Function addrow2(fullcode As String, Qty As Double, Optional Name As String, Optional Eque As String, Optional des As String)
  ...
  '  UnitID = GetUnitID(Name)
   If fullcode <> "" Then
    ...
    With Me.VSFlexGrid1
        .rows = .rows + 1
        .TextMatrix(.rows - 1, .ColIndex("Account_Serial")) = fullcode
        .TextMatrix(.rows - 1, .ColIndex("value")) = Qty
        ...
        If .TextMatrix(.rows - 1, .ColIndex("FixCode")) <> "" Then
           ' .Rows = .Rows + 1
            VSFlexGrid1_AfterEdit .rows - 1, .ColIndex("FixCode")
        ...
        If .TextMatrix(.rows - 1, .ColIndex("Account_Serial")) <> "" Then
           ' .Rows = .Rows + 1
            VSFlexGrid1_AfterEdit .rows - 1, .ColIndex("Account_Serial")

        End If
             If val(.TextMatrix(.rows - 1, .ColIndex("value"))) <> 0 Then
           ' .Rows = .Rows + 1
            VSFlexGrid1_AfterEdit .rows - 1, .ColIndex("value")
...
Private Sub Accredit_Click()
    ...
    SendTopost Me.Name, "notes_all", "NoteID", 0, val(dcBranch.BoundText), val(XPTxtID.Text), TxtSerial1.Text, , val(DcboEmpDepartments.BoundText)
  '' RsNetes.Resync
 If SystemOptions.UserInterface = ArabicInterface Then
    Accredit.Caption = " „ «·«—”«· ··«⁄ „«œ"
Else
...
CboPaymentType1.ListIndex = 1
       ...
       End If
        ...
        End If
             ...
             If SystemOptions.MonyeIssueVchrNoMust = True And TxtOrder.Text = "" Then
...
MySQL = MySQL & "                      dbo.notes_all.note_value_by_characters, dbo.notes_all.general_des, dbo.notes_all.NoteSerial1, dbo.Notes.ExpensesRemark, dbo.Notes.fixedid,"
MySQL = MySQL & "                      FixedAssets.Code + dbo.FixedAssets.Name Name, dbo.FixedAssets.namee, dbo.Notes.ProjectID, dbo.Notes.Pand, dbo.projects.Project_name, dbo.projects.Project_nameE,"
MySQL = MySQL & "                      dbo.projects_des.des, dbo.Notes.Oper, dbo.TblProcessDEF.ProcessName, dbo.TblProcessDEF.ProcessNameE,"
MySQL = MySQL & "                      dbo.DOUBLE_ENTREY_VOUCHERS.Double_Entry_Vouchers_ID, dbo.DOUBLE_ENTREY_VOUCHERS.DEV_ID_Line_No,"
MySQL = MySQL & "                      dbo.DOUBLE_ENTREY_VOUCHERS.Account_Code, dbo.ACCOUNTS.Account_Name, dbo.ACCOUNTS.Account_Serial, dbo.ACCOUNTS.Account_NameEng,"
MySQL = MySQL & "                      dbo.DOUBLE_ENTREY_VOUCHERS.Remarks2, dbo.DOUBLE_ENTREY_VOUCHERS.notes_all, dbo.Notes.ExpensesID AS Sub_expensesID,"
MySQL = MySQL & "                      dbo.ExpensesType.Name AS Sub_expenses_name, dbo.ExpensesType.Namee AS Sub_expenses_nameE, dbo.DOUBLE_ENTREY_VOUCHERS.Credit_Or_Debit,"
MySQL = MySQL & "'" & DcbAccount.Text & "' as AccountName2,'" & TxtAccount.Text & "' as AccountSerial2,projects_2.code projectCode "
MySQL = MySQL & " FROM         dbo.TblBoxesData RIGHT OUTER JOIN"
MySQL = MySQL & "                      dbo.notes_all ON dbo.TblBoxesData.BoxID = dbo.notes_all.BoxID RIGHT OUTER JOIN"
...
MySQL = MySQL & "                      dbo.TblProcessDEF ON dbo.Notes.Oper = dbo.TblProcessDEF.TblProcessDEFID LEFT OUTER JOIN"
MySQL = MySQL & "                      dbo.projects ON dbo.Notes.ProjectID = dbo.projects.id LEFT OUTER JOIN"
MySQL = MySQL & "                      dbo.projects_des ON dbo.Notes.Pand = dbo.projects_des.oprid and dbo.projects_des.oprid <>0 LEFT OUTER JOIN"
MySQL = MySQL & "                      dbo.FixedAssets ON dbo.Notes.fixedid = dbo.FixedAssets.id ON dbo.notes_all.NoteID = dbo.Notes.notes_all LEFT OUTER JOIN"
MySQL = MySQL & "                      dbo.TblUsers ON dbo.Notes.UserID = dbo.TblUsers.UserID FULL OUTER JOIN"
MySQL = MySQL & "                      dbo.BanksData ON dbo.Notes.BankID = dbo.BanksData.BankID"
MySQL = MySQL & "               LEFT OUTER JOIN dbo.projects projects_2 ON dbo.DOUBLE_ENTREY_VOUCHERS.project_id = projects_2.id "

MySQL = MySQL & " Where ( hideline is null  and dbo.DOUBLE_ENTREY_VOUCHERS.notes_all =" & val(XPTxtID.Text) & ") And (dbo.Notes.NoteType = 350) And (dbo.DOUBLE_ENTREY_VOUCHERS.Credit_Or_Debit = 0)"
     '    MySQL = "SELECT     dbo.notes_all.NoteID, dbo.notes_all.NoteDate, dbo.notes_all.NoteType, dbo.notes_all.NoteSerial, dbo.notes_all.Note_Value, dbo.notes_all.BankID, "
     '   MySQL = MySQL & "   dbo.notes_all.ChqueNum, dbo.notes_all.DueDate, dbo.notes_all.UserID, dbo.notes_all.Remark, dbo.notes_all.ExpensesID, dbo.notes_all.BoxID,"
     '   MySQL = MySQL & "  dbo.TblUsers.UserName, dbo.TblBoxesData.BoxName, dbo.BanksData.BankName, dbo.notes_all.too, dbo.Notes.Note_Value AS [Sub-value],"
     ...
     '   MySQL = MySQL & "  WHERE     (dbo.Notes.NoteType = 350) AND (NOT (dbo.ExpensesType.Name IS NULL))  and  dbo.Notes.noteserial='" & NoteSerial & "'"
    Else
       ...
       MySQL = MySQL & "               dbo.Notes.CusID, dbo.Notes.Note_Value, dbo.Notes.note_value_by_characters, dbo.Notes.Remark AS sub_remark, dbo.ACCOUNTS.Account_Name,"
       ...
       MySQL = MySQL & "               dbo.DOUBLE_ENTREY_VOUCHERS.pandid, dbo.projects_des.des, dbo.DOUBLE_ENTREY_VOUCHERS.projectid, projects_2.Project_name, projects_2.Project_nameE,"
       MySQL = MySQL & "               dbo.DOUBLE_ENTREY_VOUCHERS.operid, dbo.TblProcessDEF.ProcessName, dbo.TblProcessDEF.ProcessNameE, dbo.DOUBLE_ENTREY_VOUCHERS.NEmpid,"
       ...
       MySQL = MySQL & "               dbo.TblEmployee.Emp_Namee, dbo.DOUBLE_ENTREY_VOUCHERS.Departementid, dbo.TblEmpDepartments.DepartmentName,"
       MySQL = MySQL & "               dbo.TblEmpDepartments.DepartmentNamee, dbo.DOUBLE_ENTREY_VOUCHERS.FixedAssetId, FixedAssets.Code + dbo.FixedAssets.Name Name , dbo.FixedAssets.namee,"
       MySQL = MySQL & "               dbo.DOUBLE_ENTREY_VOUCHERS.Aqarid, dbo.TblAqar.aqarname, dbo.DOUBLE_ENTREY_VOUCHERS.unitno, dbo.TblAqarDetai.unitno AS unitnoName,"
       MySQL = MySQL & "               dbo.DOUBLE_ENTREY_VOUCHERS.unittype, dbo.TblAkarUnit.name AS name1, dbo.TblAkarUnit.namee AS name1E, dbo.DOUBLE_ENTREY_VOUCHERS.Notes_ID,"
       MySQL = MySQL & "               dbo.DOUBLE_ENTREY_VOUCHERS.DEV_ID_Line_No1, dbo.DOUBLE_ENTREY_VOUCHERS.Billno, dbo.Notes.project_Expensen_account,"
       MySQL = MySQL & "               projects_1.expanses_account, projects_1.Project_name AS Project_name1, projects_1.Project_nameE AS Project_name1E,"
       MySQL = MySQL & "               dbo.DOUBLE_ENTREY_VOUCHERS.Remarks2 , dbo.Notes.boxId, dbo.TblBoxesData.BoxName, dbo.TblBoxesData.BoxNameE,projects_2.code projectCode,ACCOUNTS.Account_Serial,ACCOUNTS.Account_Name as Account_Name2, "
       MySQL = MySQL & "'" & DcbAccount.Text & "' as AccountName2,'" & TxtAccount.Text & "' as AccountSerial2"
       MySQL = MySQL & "        FROM         dbo.TblBoxesData RIGHT OUTER JOIN"
       MySQL = MySQL & "               dbo.Notes INNER JOIN"
       MySQL = MySQL & "               dbo.DOUBLE_ENTREY_VOUCHERS ON dbo.Notes.NoteID = dbo.DOUBLE_ENTREY_VOUCHERS.Notes_ID INNER JOIN"
       MySQL = MySQL & "               dbo.ACCOUNTS ON dbo.DOUBLE_ENTREY_VOUCHERS.Account_Code = dbo.ACCOUNTS.Account_Code ON"
       MySQL = MySQL & "               dbo.TblBoxesData.BoxID = dbo.Notes.BoxID LEFT OUTER JOIN"
       MySQL = MySQL & "               dbo.projects projects_1 ON dbo.Notes.project_Expensen_account = projects_1.expanses_account LEFT OUTER JOIN"
       MySQL = MySQL & "               dbo.TblAkarUnit ON dbo.DOUBLE_ENTREY_VOUCHERS.unittype = dbo.TblAkarUnit.id LEFT OUTER JOIN"
       MySQL = MySQL & "               dbo.TblAqarDetai ON dbo.DOUBLE_ENTREY_VOUCHERS.unitno = dbo.TblAqarDetai.Id LEFT OUTER JOIN"
       MySQL = MySQL & "               dbo.TblAqar ON dbo.DOUBLE_ENTREY_VOUCHERS.Aqarid = dbo.TblAqar.Aqarid LEFT OUTER JOIN"
       ...
       MySQL = MySQL & "               dbo.TblProcessDEF ON dbo.DOUBLE_ENTREY_VOUCHERS.operid = dbo.TblProcessDEF.TblProcessDEFID LEFT OUTER JOIN"
       MySQL = MySQL & "               dbo.projects projects_2 ON dbo.DOUBLE_ENTREY_VOUCHERS.projectid = projects_2.id LEFT OUTER JOIN"
       MySQL = MySQL & "               dbo.projects_des ON dbo.DOUBLE_ENTREY_VOUCHERS.pandid = dbo.projects_des.oprid and dbo.projects_des.oprid <>0 "
       MySQL = MySQL & "   WHERE     (  hideline is null  and dbo.DOUBLE_ENTREY_VOUCHERS.Credit_Or_Debit = 0) AND (dbo.Notes.NoteSerial = " & NoteSerial & ")"
        MySQL = MySQL & "    and notetype=350" & "  and Notes.NoteSerial1=" & TxtSerial1
   '    MySQL = MySQL & " Where ( hideline is null  and dbo.DOUBLE_ENTREY_VOUCHERS.notes_all =" & val(XPTxtID.Text) & ") And (dbo.Notes.NoteType = 350) And (dbo.DOUBLE_ENTREY_VOUCHERS.Credit_Or_Debit = 0)"
    End If
  ...
  EmpIDD = IIf(IsNull(Rs4("Empid").value), 0, Rs4("Empid").value)
            ...
            Set xLogo = xReport.Areas(4).Sections(1).AddPictureObject(App.path & "\" & SystemOptions.ImagesPath & "\sign" & EmpIDD & ".JPG", xWidth, 300)
            xLogo.Width = 800
            xLogo.Height = 800
...
Dim acc As String
    ...
    LblLink1.Caption = ""
        If Not SystemOptions.HiddenBalanceFromBox Then
...
Private Sub dcproject_KeyUp(KeyCode As Integer, Shift As Integer)
        ...
        If KeyCode = vbKeyF3 Then
           FrmProjectSearch.lblSearchtype.Caption = 26
...
If flg = 1 Then
 Deb_Cred = CheckProjectAccountDept(.TextMatrix(Row, .ColIndex("AccountCode")))
If Deb_Cred = 1 Then
GetValueAddedAccount XPDtbTrans.value, , AccountVATDept
ElseIf Deb_Cred = 0 Then
GetValueAddedAccount XPDtbTrans.value, AccountVATDept
Else
...
If val(.TextMatrix(Row, .ColIndex("PriceTotal"))) > 0 Then
.TextMatrix(Row, .ColIndex("value")) = .TextMatrix(Row, .ColIndex("PriceTotal"))
End If
...
Private Sub Fg_Journal_KeyUp(KeyCode As Integer, _
    ...
    With Fg_Journal
        ...
        If KeyCode = vbKeyF3 Then
           FrmProjectSearch.lblSearchtype.Caption = 25
               FrmProjectSearch.show vbModal
        End If
        End Select
...
Private Sub Fg_Journal_StartEdit(ByVal Row As Long, _
  ...
  Case "CarName"
                ...
                rs.Open StrSQL, Cn, adOpenStatic, adLockReadOnly, adCmdText
                StrComboList = Fg_Journal.BuildComboList(rs, "BoardNO", "id")
    ...
    Else
                       StrSQL = " SELECT  LTRIM(RTRIM( Project_namee )) as Project_name,Project_nameE , id From dbo.Projects  "
...
Dcombos.GetEmpDepartments Me.DcboEmpDepartments
    ...
    StrSQL = " select expanses_account,Project_name from projects  where   Project_name<>N'""' and not (Project_name is null)  and   IsNull(expanses_account,'' ) <> '' "
    ...
    With VSFlexGrid1
        ...
        If mdifrmmain.AssetsMngBase.Visible = False Then
           ...
           .ColHidden(.ColIndex("aqarname")) = True
              .ColHidden(.ColIndex("name")) = True
              .ColHidden(.ColIndex("unitnoName")) = True
   ...
   StrSQL = StrSQL & "  AND      branch_no in(" & Current_branchSql & ")"
    ...
    StrSQL = StrSQL & " Order By NoteSerial1"
      If mdifrmmain.TransporterMain.Visible = False Then
            Fg_Journal.ColHidden(Fg_Journal.ColIndex("CarName")) = True
        End If
    rs.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
    XPBtnMove_Click 2
    Me.TxtModFlg.Text = "R"
...
StrSQL = StrSQL & GetAccountByBarnchUser
        ...
        StrSQL = StrSQL & GetAccountByBarnchUser
              ...
              StrComboList = VSFlexGrid1.BuildComboList(Rs3, "RootName,ParentName,*FirstName,Account_Serial", "Account_Code")
...
NotValue = GetVal((Me.TxtOrder.Text), val(Me.XPTxtID), 350)
...
Me.txtordervalue.Text = Price - NotValue
...
If KeyCode = vbKeyF3 Then
 Load FrmReqExchangeSearch
             ...
             FrmReqExchangeSearch.lbltype = 30
...
Select Case .ColKey(.Col)
   Case "AccountName", "Account_Serial"
    If KeyCode = vbKeyF3 Then
       Account_search.show
       Account_search.case_id = 350

    End If
      Case "project", "ProjectCode"
        If KeyCode = vbKeyF3 Then
           FrmProjectSearch.lblSearchtype.Caption = 27
               FrmProjectSearch.show vbModal
        End If
    End Select
  End With
...
Dim Rs3 As ADODB.Recordset
    ...
    StrSQL = " SELECT  LTRIM(RTRIM( Project_name )) as Project_name ,Project_nameE, id From dbo.Projects  "
        StrSQL = StrSQL & " where  not (Project_name is null)and Project_name<>N'""'"
    Else
        StrSQL = " SELECT  LTRIM(RTRIM( Project_namee )) as Project_name  , id From dbo.Projects  "
        StrSQL = StrSQL & " where  not (Project_nameE is null)and Project_nameE<>N'""'"
    End If
    StrSQL = StrSQL & " and (Not (Fullcode Is Null))"
    If SystemOptions.UserInterface = ArabicInterface Then
...
Dim acc As String
 ...
 StrSQL = " SELECT OrderIDD = (select   OrderIDD from notes where NoteID=DOUBLE_ENTREY_VOUCHERS.notes_id  )"

StrSQL = StrSQL + "    ,   dbo.DOUBLE_ENTREY_VOUCHERS.Carid,dbo.DOUBLE_ENTREY_VOUCHERS.DEV_ID_Line_No1, dbo.ACCOUNTS.Account_Name, dbo.ACCOUNTS.Account_Serial, "
...
StrSQL = StrSQL + "                       dbo.DOUBLE_ENTREY_VOUCHERS.Departementid, dbo.DOUBLE_ENTREY_VOUCHERS.FixedAssetId, dbo.FixedAssets.Name AS fixedassetname, FixedAssets.Fullcode FixCode,"
StrSQL = StrSQL + "                       dbo.FixedAssets.namee AS fixedassetnamee, dbo.TblEmpDepartments.DepartmentName, dbo.TblEmpDepartments.DepartmentNamee,FixedAssets.Code,"
...
StrSQL = StrSQL + "                       dbo.DOUBLE_ENTREY_VOUCHERS.projectid, dbo.projects.Project_name,dbo.projects.Project_namee, dbo.DOUBLE_ENTREY_VOUCHERS.pandid, dbo.projects_des.des,"
 ...
 '  RsDev.Open StrSQL, Cn, adOpenKeyset, adLockOptimistic, adCmdText
        ...
        With Me.VSFlexGrid1
            ...
            For i = .FixedRows To .rows - 1
              ...
              Me.TxtOrder.Text = IIf(IsNull(RsDev("OrderIDD").value), "", RsDev("OrderIDD").value)
           ...
           If SystemOptions.UserInterface = ArabicInterface Then
                .TextMatrix(i, .ColIndex("FixedAsset")) = IIf(IsNull(RsDev("fixedassetname").value), "", RsDev("fixedassetname").value)
                 
            Else
                .TextMatrix(i, .ColIndex("FixedAsset")) = IIf(IsNull(RsDev("fixedassetnamee").value), "", RsDev("fixedassetnamee").value)
            End If
            
            CarID = IIf(IsNull(RsDev("CarID").value), 0, RsDev("CarID").value)
            '.TextMatrix(i, .ColIndex("FixCode")) = IIf(IsNull(RsDev("FixCode").value), "", RsDev("FixCode").value)
            .TextMatrix(i, .ColIndex("FixCode")) = IIf(Trim(RsDev!FixCode & "") = "", IIf(Trim(RsDev!code & "") <> "", Trim(RsDev!code & ""), RsDev("FixCode").value & ""), "")
            If CarID <> 0 Then
           ...
           If SystemOptions.UserInterface = ArabicInterface Then
                .TextMatrix(i, .ColIndex("NEmpName")) = IIf(IsNull(RsDev("NEmpName").value), "", RsDev("NEmpName").value)
                 
            Else
                .TextMatrix(i, .ColIndex("NEmpName")) = IIf(IsNull(RsDev("NEmpNamee").value), "", RsDev("NEmpNamee").value)
            End If
    ...
    If SystemOptions.SysAppAccoutingType = CompeleteAccounting Then '«·„—Ê›« 
        ...
        'StrSQL = StrSQL + "ORDER BY dbo.DOUBLE_ENTREY_VOUCHERS.DEV_ID_Line_No"
         StrSQL = " SELECT OrderIDD = (select   OrderIDD from notes where NoteID=DOUBLE_ENTREY_VOUCHERS.notes_id  )"
          ...
          StrSQL = StrSQL + "        , dbo.DOUBLE_ENTREY_VOUCHERS.Carid,dbo.DOUBLE_ENTREY_VOUCHERS.opr_fullcode, dbo.DOUBLE_ENTREY_VOUCHERS.Account_Interval_ID, "
          ...
          StrSQL = StrSQL + "            dbo.TblProcessDEF.ProcessName, dbo.TblProcessDEF.ProcessNameE, dbo.Notes.fixedid, dbo.FixedAssets.code, dbo.FixedAssets.Name, dbo.FixedAssets.Fullcode, FixedAssets.Fullcode FixCode,"
          ...
          StrSQL = StrSQL + "            dbo.TblBranchesData.branch_namee, dbo.projects.Fullcode AS ProjectCode, dbo.DOUBLE_ENTREY_VOUCHERS.FlgVat, dbo.DOUBLE_ENTREY_VOUCHERS.Vatyo,"
          StrSQL = StrSQL + "            dbo.DOUBLE_ENTREY_VOUCHERS.Vat, dbo.DOUBLE_ENTREY_VOUCHERS.CurrRow, dbo.DOUBLE_ENTREY_VOUCHERS.Rate2,"
          StrSQL = StrSQL + "            dbo.DOUBLE_ENTREY_VOUCHERS.SupplierName, dbo.DOUBLE_ENTREY_VOUCHERS.CusVATNO, dbo.DOUBLE_ENTREY_VOUCHERS.PriceTotal,"
          StrSQL = StrSQL + "            dbo.DOUBLE_ENTREY_VOUCHERS.SupplierID, dbo.TblCustemers.CusName, dbo.TblCustemers.CusNamee, dbo.TblCustemers.Fullcode AS Expr2 ,dbo.DOUBLE_ENTREY_VOUCHERS.Billno"
...
'        If Trim(dcproject.text) = "" Then
'            MsgBox "·« Ì„ﬂ‰ «·Õ›Ÿ ﬁ»· «œŒ«· «·„‘—Ê⁄", vbCritical
'            Exit Sub
'        End If
'
'    End If
            ...
            If SystemOptions.SuppCreat4Acc Then
                        With Fg_Journal
                            ...
                            For i = .FixedRows To .rows - 2
                                ...
                                If .TextMatrix(i, .ColIndex("project")) = "" And val(.TextMatrix(i, .ColIndex("FlgVat"))) = 0 Then
                                    '////////////////////////////////////////notes
                           
                                    If SystemOptions.UserInterface = ArabicInterface Then
'                                        MsgBox "·« ÌÊÃœ „‘—Ê⁄ ›Ì «·”ÿ— —ﬁ„ " & i, vbCritical
                                    Else
'                                        MsgBox "Select project in line no" & i, vbCritical
                                    End If
            ...
            If SystemOptions.SuppCreat4Acc Then
                        With VSFlexGrid1
                            ...
                            For i = .FixedRows To .rows - 2
                                ...
                                If .TextMatrix(i, .ColIndex("project")) = "" And val(.TextMatrix(i, .ColIndex("FlgVat"))) = 0 Then
                                '.TextMatrix(row, .ColIndex("ForcedFlg"))
                                    '////////////////////////////////////////notes
  ...
  XPTxtID.Text = CStr(new_id("notes_all", "NoteID", "", True))
       ...
       '     Cn.Execute StrSQL, , adExecuteNoRecords
           ...
           StrSQL = "Delete  TblChecqueBoxContent1  where NoteID =" & val(Me.XPTxtID.Text)
            ...
            StrSQL = "Delete From notes Where  NoteType= 350 and  notes_all=" & val(XPTxtID.Text)
            Cn.Execute StrSQL, , adExecuteNoRecords
...
'rs("note_value_by_characters").value = Trim$(Me.LblValue.Caption)
   ...
   RsNotes.Open StrSQL, Cn, adOpenKeyset, adLockOptimistic, adCmdText
           ...
           '     Cn.Execute StrSQL, , adExecuteNoRecords
            ...
            'Õ”«»« 
            RsNotes.AddNew
      RsNotes("OrderIDD").value = IIf(TxtOrder.Text = "", Null, (TxtOrder.Text))
    ...
    '--------------------555555555
            ...
            With VSFlexGrid1
                ...
                For i = .FixedRows To .rows - 1
                    ...
                    OtherInformation.DescAccount = (.TextMatrix(i, .ColIndex("AccountName")))
...
line_no = line_no + 1
                                               If ModAccounts.AddNewDev(LngDevID, line_no, credit_side, total_value, 0, .TextMatrix(i, .ColIndex("Des")), A_NoteID, , , , XPDtbTrans.value, user_id, , , , , , , , , val(.TextMatrix(i, .ColIndex("LineNo1"))), , , , , , , , , BranchID, , , , , , , , , , , , , , , , , , 1, , , , , , , Posted) = False Then
                                                                   
                                                              End If
                                                              
                                                             line_no = line_no + 1
                                                        '????
                                                              If ModAccounts.AddNewDev(LngDevID, line_no, DeptSide, total_value, 1, .TextMatrix(i, .ColIndex("Des")), A_NoteID, , , , XPDtbTrans.value, user_id, , , , , , , , , val(.TextMatrix(i, .ColIndex("LineNo1"))), , , , , , , , , BranchID2, , , , , , , , , , , , , , , , , , 1, , , , , , , Posted) = False Then
...
If val(.TextMatrix(i, .ColIndex("PriceTotal"))) <> 0 Then
  ...
  End If
                ...
                If SystemOptions.AllowAnalyticJL = True Then
                         line_no = line_no + 1
          '  LngDevID = new_id("DOUBLE_ENTREY_VOUCHERS", "Double_Entry_Vouchers_ID", "", True)
            ...
            OtherInformation.DescAccount = (.TextMatrix(i, .ColIndex("AccountName")))
             OtherInformation.NextAccount_Code = (.TextMatrix(i, .ColIndex("AccountCode")))
             BranchID = val(Me.dcBranch.BoundText)
            If ModAccounts.AddNewDev(LngDevID, line_no, DcboCreditSide.BoundText, .TextMatrix(i, .ColIndex("Value")), 1, txt_general_des.Text & "    " & .TextMatrix(i, .ColIndex("Des")), A_NoteID, , , SystemOptions.SysCurrentAccountIntervalID, Me.XPDtbTrans.value, Me.DCboUserName.BoundText, , , , , , , , , , val(Me.XPTxtID.Text), , , , , , , , BranchID, , , , , , , , , , , , , , , , , , , , , , , , , Posted, , OtherInformation) = False Then
                GoTo ErrTrap
...
Next i
            ...
            If SystemOptions.AllowAnalyticJL = False Then
            line_no = line_no + 1
            LngDevID = new_id("DOUBLE_ENTREY_VOUCHERS", "Double_Entry_Vouchers_ID", "", True)
            OtherInformation.FlgVat = 0
            OtherInformation.Vat = 0
            ...
            With Fg_Journal
                ...
                For i = .FixedRows To .rows - 1
                    ...
                    If .TextMatrix(i, .ColIndex("AccountCode")) <> "" Then
                        ...
                        RsNotes("CarId").value = val(.TextMatrix(i, .ColIndex("CarId")))
...
End If
                        ...
                        OtherInformation.NextAccount_Code = DcboCreditSide.BoundText
                        If ModAccounts.AddNewDev(LngDevID, line_no, .TextMatrix(i, .ColIndex("AccountCode")), val(.TextMatrix(i, .ColIndex("value"))), 0, .TextMatrix(i, .ColIndex("des")), val(NoteID), , , SystemOptions.SysCurrentAccountIntervalID, Me.XPDtbTrans.value, Me.DCboUserName.BoundText, , , , .TextMatrix(i, .ColIndex("value")), , , , , val(.TextMatrix(i, Fg_Journal.ColIndex("LineNo1"))), val(Me.XPTxtID.Text), project_id, .TextMatrix(i, Fg_Journal.ColIndex("opr_fullcode")), , , val(.TextMatrix(i, .ColIndex("fixedid"))), , , brnchid, val(.TextMatrix(i, .ColIndex("CarId"))), , , , , , , , , , , , .TextMatrix(i, Fg_Journal.ColIndex("Billno")), , val(Fg_Journal.TextMatrix(i, .ColIndex("pandid2"))), val(Fg_Journal.TextMatrix(i, .ColIndex("operid2"))), , , , , , , , , Posted, , OtherInformation) = False Then
                            '   GoTo ErrTrap
...
line_no = line_no + 1
                                               ...
                                               If ModAccounts.AddNewDev(LngDevID, line_no, credit_side, total_value, 0, .TextMatrix(i, .ColIndex("des")), val(NoteID), , , , XPDtbTrans.value, user_id, , , , , , , , , val(.TextMatrix(i, .ColIndex("LineNo1"))), val(Me.XPTxtID.Text), , , , , val(.TextMatrix(i, .ColIndex("fixedid"))), , , BranchID, val(.TextMatrix(i, .ColIndex("CarId"))), , , , , , , , , , , , , , , , , 1, , , , , , , Posted) = False Then
                                                                   
                                                              End If
                                                              
                                                             line_no = line_no + 1
                                                        '????
                                                              If ModAccounts.AddNewDev(LngDevID, line_no, DeptSide, total_value, 1, .TextMatrix(i, .ColIndex("des")), val(NoteID), , , , XPDtbTrans.value, user_id, , , , , , , , , val(.TextMatrix(i, .ColIndex("LineNo1"))), val(Me.XPTxtID.Text), , , , , val(.TextMatrix(i, .ColIndex("fixedid"))), , , brnchid, val(.TextMatrix(i, .ColIndex("CarId"))), , , , , , , , , , , , , , , , , , , 1, , , , , Posted) = False Then
   ...
   If project_id <> 0 And dcproject.BoundText = "" Then
       ...
       If SystemOptions.gldetails_or_gl_general = 1 Then
                        ...
                        OtherInformation.DescAccount = (.TextMatrix(i, .ColIndex("AccountName")))
                        OtherInformation.NextAccount_Code = DcboCreditSide.BoundText
                   If ModAccounts.AddNewDev(LngDevID, line_no, Material_account, val(.TextMatrix(i, .ColIndex("value"))), 0, .TextMatrix(i, .ColIndex("des")), val(NoteID), , , SystemOptions.SysCurrentAccountIntervalID, Me.XPDtbTrans.value, Me.DCboUserName.BoundText, , , , .TextMatrix(i, .ColIndex("value")), , , , , val(.TextMatrix(i, Fg_Journal.ColIndex("LineNo1"))), val(Me.XPTxtID.Text), , .TextMatrix(i, Fg_Journal.ColIndex("opr_fullcode")), , , val(.TextMatrix(i, .ColIndex("fixedid"))), , , brnchid, val(.TextMatrix(i, .ColIndex("CarID"))), , , , , , , , , , , , .TextMatrix(i, Fg_Journal.ColIndex("Billno")), , , , , 1, , , , , , , Posted, , OtherInformation) = False Then
                            '   GoTo ErrTrap
                    
                        End If

                        line_no = line_no + 1
                        OtherInformation.NextAccount_Code = Material_account
                   If ModAccounts.AddNewDev(LngDevID, line_no, .TextMatrix(i, .ColIndex("AccountCode")), val(.TextMatrix(i, .ColIndex("value"))), 1, .TextMatrix(i, .ColIndex("des")), val(NoteID), , , SystemOptions.SysCurrentAccountIntervalID, Me.XPDtbTrans.value, Me.DCboUserName.BoundText, , , , .TextMatrix(i, .ColIndex("value")), , , , , val(.TextMatrix(i, Fg_Journal.ColIndex("LineNo1"))), val(Me.XPTxtID.Text), , .TextMatrix(i, Fg_Journal.ColIndex("opr_fullcode")), , , val(.TextMatrix(i, .ColIndex("fixedid"))), , , brnchid, val(.TextMatrix(i, .ColIndex("CarID"))), , , , , , , , , , , , , , , , , 1, , , , , , , Posted, , OtherInformation) = False Then
                            '   GoTo ErrTrap
 ...
 End If
            ...
            RsNotes("Note_Value").value = val(.TextMatrix(i, .ColIndex("value")))
...
'-------555555555555
            ...
            RsDev("Value").value = val(.TextMatrix(i, .ColIndex("value"))) '.TextMatrix(I, .ColIndex("VALUE"))
...
Private Sub ChangeLang()
    ...
    XPTab301.TabCaption(1) = "Approval"
