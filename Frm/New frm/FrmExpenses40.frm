...
Begin VB.Form FrmExpenses40 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox CboType 
         Height          =   315
         ItemData        =   "FrmExpenses40.frx":038A
         Left            =   5160
         List            =   "FrmExpenses40.frx":038C
         RightToLeft     =   -1  'True
      ...
      Begin VB.ComboBox CboPaymentType1 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "FrmExpenses40.frx":038E
         Left            =   6120
         List            =   "FrmExpenses40.frx":0390
         RightToLeft     =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   75
         Top             =   510
      ...
      Begin MSDataListLib.DataCombo DcCostCenter 
         Bindings        =   "FrmExpenses40.frx":0392
         Height          =   315
         Left            =   11400
         TabIndex        =   100
         Top             =   780
      ...
      Begin MSDataListLib.DataCombo Dcbranch 
         Bindings        =   "FrmExpenses40.frx":03A7
         Height          =   315
         Left            =   120
         TabIndex        =   114
         Top             =   120
      ...
      Begin VB.Image ImgNote 
         Height          =   240
         Left            =   -240
         Picture         =   "FrmExpenses40.frx":03BC
         Top             =   750
         Visible         =   0   'False
         Width           =   240
      End
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
      ...
      FormatString    =   $"FrmExpenses40.frx":0946
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin VDSCOMBOLibCtl.SmartCombo SmartCombo1 
         ...
         OnFocus         =   3
         PasswordChar    =   ""
         Picture         =   "FrmExpenses40.frx":0C22
         PictureAlignment=   5
   ...
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      FloodColor      =   6553600
      ForeColorDisabled=   -2147483631
      Picture         =   "FrmExpenses40.frx":11BC
      Caption         =   "‘«‘… «· Œ·’ „‰ «·«’·  "
      Align           =   0
      AutoSizeChildren=   0
      BorderWidth     =   0
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses40.frx":1E96
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses40.frx":2230
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses40.frx":25CA
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses40.frx":2964
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin VB.Image ImgFavorites 
         Height          =   390
         Left            =   3960
         Picture         =   "FrmExpenses40.frx":2CFE
         Stretch         =   -1  'True
         Top             =   120
         Width           =   525
      End
   ...
   Begin VSFlex8Ctl.VSFlexGrid Fg_Journal 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmExpenses40.frx":6966
      ScrollTrack     =   0   'False
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin VDSCOMBOLibCtl.SmartCombo CboDes 
         ...
         OnFocus         =   3
         PasswordChar    =   ""
         Picture         =   "FrmExpenses40.frx":6ACC
         PictureAlignment=   5
         PictureBackColor=   -2147483624
         PictureStretchH =   0
         PictureStretchV =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid2 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmExpenses40.frx":709E
      ScrollTrack     =   0   'False
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmExpenses40"
...
ShowAttachments TxtSerial1, "0612201406"
