...
Begin VB.Form FrmBalanceSheet 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSDataListLib.DataCombo Dcbranch 
         Bindings        =   "FrmExpenses50.frx":038A
         Height          =   315
         Left            =   3240
         TabIndex        =   117
         Top             =   240
      ...
      Begin MSDataListLib.DataCombo DCActivity 
         Bindings        =   "FrmExpenses50.frx":039F
         Height          =   315
         Left            =   120
         TabIndex        =   118
         Top             =   240
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataListLib.DataCombo DcCostCenter 
         Bindings        =   "FrmExpenses50.frx":03B4
         Height          =   315
         Left            =   12840
         TabIndex        =   63
         Top             =   630
      ...
      Begin MSDataListLib.DataCombo DcbYear 
         Bindings        =   "FrmExpenses50.frx":03C9
         Height          =   315
         Left            =   2880
         TabIndex        =   126
         Top             =   120
      ...
      Begin VB.Image ImgNote 
         Height          =   240
         Left            =   0
         Picture         =   "FrmExpenses50.frx":03DE
         Top             =   750
         Visible         =   0   'False
         Width           =   240
      End
   ...
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      Picture         =   "FrmExpenses50.frx":0968
      Caption         =   "  »ÊÌ» «·ﬁÊ«∆„"
      Align           =   0
      AutoSizeChildren=   0
      BorderWidth     =   0
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses50.frx":1642
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses50.frx":19DC
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses50.frx":1D76
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmExpenses50.frx":2110
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
   ...
   Begin C1SizerLibCtl.C1Tab C1Tab1 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         Begin VSFlex8Ctl.VSFlexGrid GridEstimatedCost 
            ...
            FormatString    =   $"FrmExpenses50.frx":24E2
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin C1SizerLibCtl.C1Elastic Ele 
            ...
            Begin VSFlex8Ctl.VSFlexGrid Fg_Journal 
               ...
               FormatString    =   $"FrmExpenses50.frx":27D4
               ScrollTrack     =   0   'False
               ScrollBars      =   2
               ScrollTips      =   0   'False
               MergeCells      =   0
               ...
               Begin VDSCOMBOLibCtl.SmartCombo CboDes 
                  ...
                  OnFocus         =   3
                  PasswordChar    =   ""
                  Picture         =   "FrmExpenses50.frx":29AD
                  PictureAlignment=   5
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmExpenses50.frx":2F47
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin VDSCOMBOLibCtl.SmartCombo SmartCombo1 
         ...
         OnFocus         =   3
         PasswordChar    =   ""
         Picture         =   "FrmExpenses50.frx":32EE
         PictureAlignment=   5
         PictureBackColor=   -2147483624
         PictureStretchH =   0
         PictureStretchV =   0
...
'    On Error GoTo ErrTrap
    ...
    Select Case Index
        ...
        Case 8
           ...
           ' If chkContinue.value = vbUnchecked Then
                updateopeningbalanceNewFromsqlTrialBalance2 DTStartDate.value, DTEnddate.value, False, val(Me.DCActivity.BoundText), val(Me.Dcbranch.BoundText), GetAllTrialBalanceAccounts(val(XPTxtID.Text)), 5, , True
           ' Else
              '  updateopeningbalanceNewFromsqlTrialBalance DTPickerAccFrom.value, DTPickerAccTo.value, True, val(Me.DCActivity.BoundText), val(Me.Dcbranch.BoundText), , 5, , showlastaccount
           ' End If
             
             
            '    End If
            Cn.Execute "update     TblBalanceSheetHeader   set Branch_NO =" & val(Me.Dcbranch.BoundText) & ",ActivityID=" & val(Me.DCActivity.BoundText)
...
Function print_report(Optional BalanceSheetHeaderid As Integer)
    ...
    If SystemOptions.UserInterface = ArabicInterface Then
        xReport.ParameterFields(1).AddCurrentValue cCompanyInfo.ArabCompanyName 'RPTCompany_Name_Arabic
                xReport.ParameterFields(3).AddCurrentValue cCompanyInfo.ArabCompanyName 'RPTCompany_Name_Arabic
                        xReport.ParameterFields(4).AddCurrentValue cCompanyInfo.ArabCompanyName 'RPTCompany_Name_Arabic
...
Private Sub VSFlexGrid1_KeyUp(KeyCode As Integer, _
   ...
   If KeyCode = vbKeyF3 Then
        Account_search.show
        Account_search.case_id = 29112014
        'to Add new row if needed
      With VSFlexGrid1
        If .Row = .Rows - 1 Then
            .Rows = .Rows + 1
...
Public Sub Retrive(Optional Lngid As Long = 0)
    ...
    DcbYear.Text = IIf(IsNull(rs("DYear").value), "", (rs("DYear").value))
    ...
    If 1 = 1 Then 'Õ”«Ì« 
        ...
        StrSQL = "SELECT dbo.TblBalanceSheetDetails.DebitValue,dbo.TblBalanceSheetDetails.CreditValue,dbo.TblBalanceSheetDetails.AValue,     dbo.TblBalanceSheetDetails.BalanceSheetDetailsid, dbo.TblBalanceSheetDetails.BalanceSheetHeaderid, dbo.TblBalanceSheetDetails.LinesNo, "
        ...
        With Me.VSFlexGrid1
            ...
            For i = .FixedRows To .Rows - 1
                ...
                .TextMatrix(i, .ColIndex("DebitValue")) = IIf(IsNull(RsDev("DebitValue").value), "", RsDev("DebitValue").value)
                .TextMatrix(i, .ColIndex("CreditValue")) = IIf(IsNull(RsDev("CreditValue").value), "", RsDev("CreditValue").value)
...
Private Sub SaveData()
    ...
    If Me.TxtModFlg.Text <> "R" Then
        ...
        End If
    rs("DYear").value = val(DcbYear.Text)
        ...
        With VSFlexGrid1
            ...
            For i = .FixedRows To .Rows - 1
                ...
                If .TextMatrix(i, .ColIndex("AccountCode")) <> "" Or .TextMatrix(i, .ColIndex("Add")) <> "" Then
                    RsDev.AddNew
                    ...
                    RsDev("DebitValue").value = val(.TextMatrix(i, .ColIndex("DebitValue")))
                    RsDev("CreditValue").value = val(.TextMatrix(i, .ColIndex("CreditValue")))
                    If val(.TextMatrix(i, .ColIndex("DebitValue"))) > 0 Then
                       RsDev("AValue").value = val(.TextMatrix(i, .ColIndex("DebitValue")))
                   Else
                   RsDev("AValue").value = val(.TextMatrix(i, .ColIndex("CreditValue"))) * -1
                   End If
...
Private Sub AddTip()
    ...
    If BolRtl = True Then
        ...
        With TTP
            .Create Me.hwnd, " »ÊÌ» «·„Ì“«‰Ì…", 1, 15204351, -2147483630, BolRtl
            .MaxWidth = 4000
            .VisibleTime = 9000
            .DelayTime = 600
...
Private Sub ViewDataList()
    ...
    With fg
        ...
        .TextMatrix(0, 2) = "«· «—ÌŒ"
        .ColKey(2) = "NoteDate"
        .TextMatrix(0, 3) = "‰Ê⁄  »ÊÌ» «·„Ì“«‰Ì…"
        .ColKey(3) = "Name"
        .TextMatrix(0, 4) = "ﬁÌ„…  »ÊÌ» «·„Ì“«‰Ì…"
        .ColKey(4) = "Note_Value"
    ...
    FrmView.Caption = "⁄—÷ ‘Ã—Ï ÃœÊ·Ï ·»Ì«‰«   »ÊÌ» «·„Ì“«‰Ì…"
    FrmView.show
End Sub
...
cmdAdd.Caption = "Add Line"
    ...
    With Me.VSFlexGrid1
        ...
        .TextMatrix(0, .ColIndex("Add")) = "Title"
