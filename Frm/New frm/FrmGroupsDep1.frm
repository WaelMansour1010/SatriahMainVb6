...
Begin VB.Form FrmGroupsDEp1 
   ...
   Begin VB.ComboBox CboEXpirType 
      Height          =   315
      ItemData        =   "FrmGroupsDep1.frx":038A
      Left            =   11160
      List            =   "FrmGroupsDep1.frx":0397
      RightToLeft     =   -1  'True
      TabIndex        =   48
      Top             =   2040
      Visible         =   0   'False
   ...
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      Picture         =   "FrmGroupsDep1.frx":03AA
      Caption         =   "„⁄·Ê„«  ≈÷«›Ì… ⁄‰ «·„Ã„Ê⁄…"
      Align           =   0
      AutoSizeChildren=   0
      BorderWidth     =   6
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmGroupsDep1.frx":0744
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmGroupsDep1.frx":0ADE
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmGroupsDep1.frx":0E78
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmGroupsDep1.frx":1212
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin VB.Image Image1 
      Height          =   2205
      Left            =   120
      Picture         =   "FrmGroupsDep1.frx":15C4
      Stretch         =   -1  'True
      Top             =   3360
      Width           =   7245
   End
   ...
   End
End
Attribute VB_Name = "FrmGroupsDEp1"
...
Private Sub Form_Load()
    ...
    ScreenNameArabic = " »Ì«‰«    «·«œ«—… Ê «·«œ«—«  «· «»⁄Â "
    ScreenNameEnglish = "Locations Data "
    ...
    StrSQL = "select * From EmpGroupDep1 where GroupID<>1"
...
'        RsTemp.Close
        ...
        StrSQL = "select * From EmpGroupDep1 where ParentID=" & Trim(XPTxtID.text)
        RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
...
'    On Error GoTo ErrTrap
    ...
    If Me.TxtModFlg.text <> "R" Then
        ...
        Select Case TxtModFlg.text
            ...
            Case "N"
                StrSQL = "select * From EmpGroupDep1 where GroupName='" & Trim(XPTxtName.text) & "'"
                RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
                ...
                XPTxtID.text = CStr(new_id("EmpGroupDep1", "GroupID", "", True))
...
Private Sub FillGroupCombo()
    ...
    Dim StrSQL As String
    Dim RsTemp As New ADODB.Recordset
    StrSQL = "SELECT * FROM EmpGroupDep1 Order By GroupName"
    RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
...
Private Sub LoadTreeGroups(ItemsTree As MSComctlLib.TreeView)
    ...
    If SystemOptions.UserInterface = ArabicInterface Then
        ...
        '''''''''''''''''''''''''''add root
        Set nodX = ItemsTree.Nodes.Add(, , "1G", " «·«œ«—… «·⁄«„…  ", "Root")
    ...
    '''''''''''''''''''''''''''' add group
    My_SQL = " SELECT EmpGroupDep1.* "
    My_SQL = My_SQL + "  From EmpGroupDep1 "
    ...
    If BolDisplayArabic = True Then
        Call fill_my_Children("1G", my_ch_rs, ItemsTree, "EmpGroupDep1", "ParentID")
    Else
        Call fill_my_Children("1G", my_ch_rs, ItemsTree, "EmpGroupDep1", "ParentID", , 2)
    End If
