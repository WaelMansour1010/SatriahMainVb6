...
Begin VB.Form FrmGroupsDEp 
   ...
   Begin VB.ComboBox CboEXpirType 
      Height          =   315
      ItemData        =   "FrmGroupsDepx.frx":038A
      Left            =   6360
      List            =   "FrmGroupsDepx.frx":0397
      RightToLeft     =   -1  'True
      TabIndex        =   48
      Top             =   2280
      Visible         =   0   'False
   ...
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      Picture         =   "FrmGroupsDepx.frx":03AA
      Caption         =   "„⁄·Ê„«  ≈÷«›Ì… ⁄‰ «·„Ã„Ê⁄…"
      Align           =   0
      AutoSizeChildren=   0
      BorderWidth     =   6
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmGroupsDepx.frx":0744
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmGroupsDepx.frx":0ADE
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmGroupsDepx.frx":0E78
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmGroupsDepx.frx":1212
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   End
End
Attribute VB_Name = "FrmGroupsDEp"
...
Private Sub Form_Load()
    ...
    ScreenNameArabic = " »Ì«‰«   „Ê«ﬁ⁄ «·⁄„·   "
    ScreenNameEnglish = "Work Locations Groups  "
    ...
    StrSQL = "select * From EmpGroupDep where GroupID<>1"
...
Dim X As Integer
    ...
    If SystemOptions.UserInterface = EnglishInterface Then
      X = MsgBox("do you want a photo from folder", vbExclamation + vbYesNoCancel)
    Else
...
Private Sub Del_Group()
    ...
    If XPTxtID.text <> "" Then
        ...
        StrSQL = "select * From EmpGroupDep where ParentID=" & Trim(XPTxtID.text)
        RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
    ...
    Else
        ...
        If SystemOptions.UserInterface = EnglishInterface Then
        Msg = "This operation is not available because there are no records"
        Else
...
ErrTrap:
    ...
    If Err.Number = -2147217887 Then
      ...
      If SystemOptions.UserInterface = EnglishInterface Then
        Msg = "This record cannot be deleted because it's associated with other data"
      Else
...
'    On Error GoTo ErrTrap
    ...
    If Me.TxtModFlg.text <> "R" Then
        ...
        Select Case TxtModFlg.text
            ...
            Case "N"
                StrSQL = "select * From EmpGroupDep where GroupName='" & Trim(XPTxtName.text) & "'"
                RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
                ...
                XPTxtID.text = CStr(new_id("EmpGroupDep", "GroupID", "", True))
        ...
        Select Case TxtModFlg.text
            ...
            Case "E"
                ...
                If XPTxtName.text = XPCboGroup.text Then
                  If SystemOptions.UserInterface = EnglishInterface Then
                    Msg = "The main set cannot be " & Chr(13)
                    Msg = Msg + " the same as subset"
                  Else
...
Private Sub FillGroupCombo()
    ...
    Dim StrSQL As String
    Dim RsTemp As New ADODB.Recordset
    StrSQL = "SELECT * FROM EmpGroupDep Order By GroupName"
    RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText
...
Private Sub LoadTreeGroups(ItemsTree As MSComctlLib.TreeView)
    ...
    If SystemOptions.UserInterface = ArabicInterface Then
        ...
        '''''''''''''''''''''''''''add root
        Set nodX = ItemsTree.Nodes.Add(, , "1G", "„Ê«ﬁ⁄ «·⁄„·", "Root")
    ...
    '''''''''''''''''''''''''''' add group
    My_SQL = " SELECT EmpGroupDep.* "
    My_SQL = My_SQL + "  From EmpGroupDep "
    ...
    If BolDisplayArabic = True Then
        Call fill_my_Children("1G", my_ch_rs, ItemsTree, "EmpGroupDep", "ParentID")
    Else
        Call fill_my_Children("1G", my_ch_rs, ItemsTree, "EmpGroupDep", "ParentID", , 2)
    End If
