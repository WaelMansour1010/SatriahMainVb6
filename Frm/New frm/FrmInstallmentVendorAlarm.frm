...
txtMySQL = txtMySQL & " SELECT  cast(dbo.TblDefComItem.id as nvarchar(10)) as id ,TblDefComItem.NoteSerial13 NoteSerial11 ,Grou.GroupName,       TblDefComItem.PaymentType,tdcid.Vat2,tdcid.TotalWithVat,       TblDefComItem.id    Transaction_ID1,  TmpItemsQty.Qty   Qty1," & mQty & "   Qty2,"
...
txtMySQL = txtMySQL & vbNewLine & "       tu.UnitName UnitName2,tdcid.LineID MaxNo, cast(tdcid.LineID as nvarchar(10)) as LineID ,TblItems.barCodeNO"
