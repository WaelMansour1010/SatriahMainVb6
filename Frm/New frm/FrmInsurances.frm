      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic2 
         ...
         Begin ImpulseButton.ISButton btnLast 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmInsurances.frx":4E370
         ...
         Begin ImpulseButton.ISButton btnFirst 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmInsurances.frx":4E70A
            ColorButton     =   16777215
            DrawFocusRectangle=   0   'False
            DisabledImageStyle=   1
         End
         Begin ImpulseButton.ISButton btnNext 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmInsurances.frx":4EAA4
            ColorButton     =   16777215
            DrawFocusRectangle=   0   'False
            DisabledImageStyle=   1
         End
         Begin ImpulseButton.ISButton btnPrevious 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "FrmInsurances.frx":4EE3E
            ColorButton     =   16777215
            DrawFocusRectangle=   0   'False
            DisabledImageStyle=   1
         End
         Begin VB.Image Image1 
            Height          =   555
            Left            =   13830
            Picture         =   "FrmInsurances.frx":4F1D8
            Stretch         =   -1  'True
            Top             =   120
            Width           =   1095
         End
   ...
   Begin MSComctlLib.ImageList GrdImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInsurances.frx":549AA
            Key             =   "CompanyName"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInsurances.frx":54D44
            Key             =   "Ser"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInsurances.frx":550DE
            Key             =   "Vac_Name"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInsurances.frx":55478
            Key             =   "ShareCount"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInsurances.frx":55812
            Key             =   "Dis_Count"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInsurances.frx":55BAC
            Key             =   "Bouns"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInsurances.frx":55F46
            Key             =   "SharesValue"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInsurances.frx":564E0
            Key             =   "BuyValue"
         EndProperty
      EndProperty
   End
  ...
  On Error GoTo ErrTrap
   ...
   Dim sql As String
         Dim mDate As Date
                    ...
                    mDate = val(CboYear.text) & "-" & CmbMonth.ListIndex + 1 & "-01"
 ...
 sql = sql & " ORDER BY dbo.TblEmployee.Emp_ID"
     ...
     With Me.Grid
                   ...
                   .TextMatrix(i, .ColIndex("BignDateWork")) = IIf(IsNull(Rs1("BignDateWork").value), "", Rs1("BignDateWork").value)
                    ...
                    Else
                        .TextMatrix(i, .ColIndex("WorkDays")) = daysInMonth(mDate)
                    End If
                   ...
                   If .TextMatrix(i, .ColIndex("BignDateWork")) <> "" Then
                        If CmbMonth.ListIndex + 1 = Month(.TextMatrix(i, .ColIndex("BignDateWork"))) And val(CboYear.text) = year(.TextMatrix(i, .ColIndex("BignDateWork"))) Then
                            .TextMatrix(i, .ColIndex("WorkDays")) = DateDiff("d", .TextMatrix(i, .ColIndex("BignDateWork")), ss) + 1
                        End If
                    End If
                   ...
                   'daysInMonth(mDate)
                  '.TextMatrix(i, .ColIndex("InsTotal")) = val(.TextMatrix(i, .ColIndex("InsTotal"))) / GetMonthDay(val(CmbMonth.ListIndex) + 1) * val(.TextMatrix(i, .ColIndex("WorkDays")))
                  '.TextMatrix(i, .ColIndex("InsTotal2")) = val(.TextMatrix(i, .ColIndex("InsTotal2"))) / GetMonthDay(val(CmbMonth.ListIndex) + 1) * val(.TextMatrix(i, .ColIndex("WorkDays")))
                  If SystemOptions.MonthIs30days = True Then
                  ...
                  Else
                    .TextMatrix(i, .ColIndex("InsTotal")) = val(.TextMatrix(i, .ColIndex("InsTotal"))) / daysInMonth(mDate) * val(.TextMatrix(i, .ColIndex("WorkDays")))
                    .TextMatrix(i, .ColIndex("InsTotal2")) = val(.TextMatrix(i, .ColIndex("InsTotal2"))) / daysInMonth(mDate) * val(.TextMatrix(i, .ColIndex("WorkDays")))
                  End If
