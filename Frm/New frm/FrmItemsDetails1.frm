...
Begin VB.Form FrmItemsDetails1 
   ...
   ClientTop       =   375
   ClientWidth     =   13395
   Icon            =   "FrmItemsDetails1.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   RightToLeft     =   -1  'True
   ...
   Begin VB.TextBox Text1 
      ...
      TabIndex        =   27
      Text            =   "FrmItemsDetails1.frx":000C
      Top             =   11040
      Width           =   9015
   End
   ...
   Begin VSFlex8Ctl.VSFlexGrid Grid 
      ...
      FormatString    =   $"FrmItemsDetails1.frx":0012
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin ALLButtonS.ALLButton CmdRemove 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmItemsDetails1.frx":040C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ALLButtonS.ALLButton ALLButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmItemsDetails1.frx":0428
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin C1SizerLibCtl.C1Elastic Ele 
      ...
      FloodColor      =   6553600
      ForeColorDisabled=   -2147483631
      Picture         =   "FrmItemsDetails1.frx":0444
      Caption         =   " ‘«‘…  Ê“Ì⁄ «·„’—Ê›«  ⁄·Ï «·«’‰«›  "
      Align           =   0
      AutoSizeChildren=   0
      BorderWidth     =   0
   ...
   Begin ImpulseButton.ISButton ISButton1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmItemsDetails1.frx":111E
      ColorButton     =   14871017
      ColorHighlight  =   16777215
      ColorHoverText  =   16711680
   ...
   Begin ImpulseButton.ISButton SearchCashCustomer 
      ...
      EndProperty
      BackStyle       =   0
      ButtonImage     =   "FrmItemsDetails1.frx":14B8
      ColorButton     =   14871017
      ColorHighlight  =   16777215
   ...
   End
End
Attribute VB_Name = "FrmItemsDetails1"
...
totalvalue = 0
    With Me.Grid
        ...
        For i = .FixedRows To .Rows - 1
            ...
            If .TextMatrix(i, .ColIndex("Count")) <> "" And .Cell(flexcpChecked, i, .ColIndex("Print")) = flexChecked Then
         totalvalue = totalvalue + Round(val(.TextMatrix(i, .ColIndex("Count"))) * val(.TextMatrix(i, .ColIndex("Price"))), 2)
    ...
    End With
        ...
        For i = .FixedRows To .Rows - 1
            ...
            If .TextMatrix(i, .ColIndex("Count")) <> "" And .Cell(flexcpChecked, i, .ColIndex("Print")) = flexChecked Then
 '        .TextMatrix(i, .ColIndex("Percentage ")) = Round(val(.TextMatrix(i, .ColIndex("Price"))) * val(.TextMatrix(i, .ColIndex("Count"))) / totalvalue * 100, 2)
' .TextMatrix(i, .ColIndex("Cost ")) = Round(.TextMatrix(i, .ColIndex("Percentage ")) * val(TxtValue), 2)
...
End Sub
  ...
  With FrmBillBuy.FG
                  ...
                  For i = 1 To FrmBillBuy.FG.Rows - 1
                  total = val(TxtValue.text)
                  
                          Grid.TextMatrix(i, Grid.ColIndex("itemId")) = .TextMatrix(i, .ColIndex("Code"))
                          Grid.TextMatrix(i, Grid.ColIndex("Count")) = .TextMatrix(i, .ColIndex("Count"))
                          Grid.TextMatrix(i, Grid.ColIndex("Price")) = .TextMatrix(i, .ColIndex("Price"))
                     '     Grid.TextMatrix(i, Grid.ColIndex("Percentage")) = .TextMatrix(i, .ColIndex("Price"))
                          
                          
                          GetItemData val(Grid.TextMatrix(i, Grid.ColIndex("itemId"))), ItemFullcode, itemname
                      Grid.TextMatrix(i, Grid.ColIndex("ItemFullcode")) = ItemFullcode
                  Grid.TextMatrix(i, Grid.ColIndex("ItemName")) = itemname
                  'ItemName
                 Next i
...
, Optional NameE As String, Optional Color As String, Optional size As String, Optional Class As String, Optional itemcode As String, Optional CodeAnalisys As String = "")
...
Function addtotablolde(NoOfRow As Integer, code As String, cost As Double, Optional PartNo As String = "", Optional name As String = "" _
