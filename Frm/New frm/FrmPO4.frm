   ...
   Begin C1SizerLibCtl.C1Elastic EleMain 
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin VB.TextBox TXtOrder 
            ...
            Width           =   2055
         End
         Begin VB.TextBox TxtReceptMode 
            Alignment       =   1  'Right Justify
            BackColor       =   &H00FFFFFF&
            BeginProperty Font 
               Name            =   "MS Sans Serif"
         ...
         Begin VB.ComboBox CboPayMentType 
            Height          =   315
            ItemData        =   "FrmPO4.frx":6BEC
            Left            =   720
            List            =   "FrmPO4.frx":6BEE
            Style           =   2  'Dropdown List
            TabIndex        =   164
            Top             =   2160
            Width           =   4905
         End
         Begin VB.ComboBox DcbDMYRecept 
            Height          =   315
            ItemData        =   "FrmPO4.frx":6BF0
            Left            =   720
            List            =   "FrmPO4.frx":6BFD
            RightToLeft     =   -1  'True
            TabIndex        =   163
            Top             =   1800
            Width           =   3855
         End
         Begin VB.TextBox TxtCountRecept 
            Alignment       =   1  'Right Justify
            BackColor       =   &H00FFFFFF&
            BeginProperty Font 
               Name            =   "MS Sans Serif"
            ...
            Width           =   1065
         End
         Begin VB.ComboBox DcbDMYEShow 
            Height          =   315
            ItemData        =   "FrmPO4.frx":6C10
            Left            =   7320
            List            =   "FrmPO4.frx":6C12
            RightToLeft     =   -1  'True
            TabIndex        =   161
            Top             =   1560
            Width           =   4095
         End
         Begin VB.TextBox TxtEndShow 
            Alignment       =   1  'Right Justify
            BackColor       =   &H00FFFFFF&
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               ...
               Begin C1SizerLibCtl.C1Elastic Ele 
                  ...
                  Begin C1SizerLibCtl.C1Elastic Ele 
                     ...
                     Begin VB.ComboBox CboItemCase 
                        Height          =   315
                        ItemData        =   "FrmPO4.frx":74D7
                        Left            =   5040
                        List            =   "FrmPO4.frx":74D9
                        RightToLeft     =   -1  'True
                        Style           =   2  'Dropdown List
                        TabIndex        =   123
                        Top             =   300
...
FillOrderGrid
        ...
        Case 2
            Dim Msg  As String
If SystemOptions.POMustentryAndBillMustEntry = True And (TxtOrder.Text = "") Then
...
End If
        ...
        Case 5
            ...
            FrmBuySearch.DealingForm = GridTransType.purchaseorderrequest
            FrmBuySearch.Caption = "«·»ÕÀ ⁄‰ ÿ·»«  ⁄—Ê÷ «·«”⁄«— ··„‘ —Ì« "
...
Private Sub DCboStoreName_Change()
 TxtStoreID.Text = getStoreCoding(val(DCboStoreName.BoundText))
    ...
    If Me.TxtModFlg = "N" Or Me.TxtModFlg = "E" Then
     ...
     If CheckStoreCoding(val(dcBranch.BoundText), 45) = True Then
'     TxtNoteSerial.Text = ""
    TxtNoteSerial1.Text = ""
...
ShowAttachments TxtNoteSerial1, "060520151"
...
Public Sub RetriveOrder(Optional order_no As String = "", _
                        Optional Transaction_Type As Integer = 0, Optional Index As Integer = 0)
  ...
  If Index = 0 Then
        ...
        Else
          StrSQL = "Select * from transactions where  Transaction_Type=38 and noteserial1='" & order_no & "'"
        End If
    ...
    Else
        ...
        Me.DCbDept.BoundText = IIf(IsNull(rs("Departementid").value), "", rs("Departementid").value)
...
'
    ...
    If Me.TxtModFlg <> "R" And Me.TxtModFlg <> "" Then
        RetriveOrder Me.TxtOrder.Text, Transaction_Type, 1
    End If
...
If SystemOptions.UserInterface = ArabicInterface Then
 ...
 End If
   Ele(6).Caption = Me.Caption
    ...
    Set NewGrid.Grid = FG
    NewGrid.GridTrans = GridTransType.purchaseorderrequest
...
Public Sub Retrive(Optional Lngid As Long = 0)
   ...
   TxtOrder.Text = IIf(IsNull(rs("order_no1").value), "", (rs("order_no1").value))
   ...
   Me.CboPriceType.ListIndex = 0
    ...
    Me.DCboStoreName.BoundText = IIf(IsNull(rs("StoreID").value), "", rs("StoreID").value)
''//
 Me.DcbDMYRecept.ListIndex = IIf(IsNull(rs("DMYRecept").value), -1, rs("DMYRecept").value)
 Me.DcbDMYEShow.ListIndex = IIf(IsNull(rs("DMYEShow").value), -1, rs("DMYEShow").value)
 Me.CboPaymentType.ListIndex = IIf(IsNull(rs("PaymentType").value), -1, rs("PaymentType").value)
Me.TxtEndShow.Text = IIf(IsNull(rs("EndShow").value), "", (rs("EndShow").value))
Me.TxtCountRecept.Text = IIf(IsNull(rs("CountRecept").value), "", (rs("CountRecept").value))
Me.TxtReceptMode.Text = IIf(IsNull(rs("ReceptMode").value), "", (rs("ReceptMode").value))
...
Private Sub AddTip()
    ...
    With TTP
        ...
        .VisibleTime = 9000
        .DelayTime = 600
        .AddControl Cmd(0), "ÃœÌœ ..." & Wrap & "·«÷«›… »Ì«‰«  ÿ·»  ⁄—÷ ”⁄— ÃœÌœ" & Wrap & " ›ﬁÿ ≈÷€ÿ Â‰«", True
    End With
    ...
    With TTP
        ...
        .VisibleTime = 9000
        .DelayTime = 600
        .AddControl Cmd(2), "Õ›Ÿ ..." & Wrap & "·Õ›Ÿ »Ì«‰«   ÿ·»  ⁄—÷ «·”⁄— «·ÃœÌœ" & Wrap & "·Õ›Ÿ «· ⁄œÌ·« " & Wrap & " ›ﬁÿ ≈÷€ÿ Â‰«", True
    End With
    ...
    With TTP
        ...
        .VisibleTime = 9000
        .DelayTime = 600
        .AddControl Cmd(4), "Õ–› ..." & Wrap & "·Õ–› »Ì«‰«  ÿ·»   «·⁄—÷ «·Õ«·Ì" & Wrap & " ›ﬁÿ ≈÷€ÿ Â‰«", True
    End With
    ...
    With TTP
        ...
        .VisibleTime = 9000
        .DelayTime = 600
        .AddControl Cmd(5), "»ÕÀ ..." & Wrap & "···»ÕÀ ⁄‰  ÿ·»  ⁄—÷ ”⁄—" & Wrap & "Ì‰ÿ»ﬁ ⁄·ÌÂ« ‘—Êÿ „⁄Ì‰…" & Wrap & " ›ﬁÿ ≈÷€ÿ Â‰«", True
    End With
...
Private Sub SaveData()
   ...
   RSTransDetails.Open StrSQL, Cn, adOpenKeyset, adLockOptimistic, adCmdText
      ...
      rs("order_no1").value = Me.TxtOrder.Text
    ...
    rs("Departementid").value = IIf(DCbDept.BoundText = "", Null, val(DCbDept.BoundText))
...
rs("Transaction_Type").value = CurrentTransactionType
        ...
        ''//
          rs("DMYEShow").value = IIf(Me.DcbDMYEShow.ListIndex = -1, Null, val(DcbDMYEShow.ListIndex))
          rs("EndShow").value = IIf(Me.TxtEndShow.Text = "", Null, val(TxtEndShow.Text))
          rs("DMYRecept").value = IIf(Me.DcbDMYRecept.ListIndex = -1, Null, val(DcbDMYRecept.ListIndex))
          rs("CountRecept").value = IIf(Me.TxtCountRecept.Text = "", Null, val(TxtCountRecept.Text))
          rs("PaymentType").value = IIf(CboPaymentType.ListIndex = -1, Null, val(CboPaymentType.ListIndex))
          rs("ReceptMode").value = IIf(Me.TxtReceptMode.Text = "", Null, TxtReceptMode.Text)
        ''//
...
MySQL = " SELECT     dbo.Transactions.NoteSerial, dbo.Transactions.NoteSerial1, dbo.Transactions.Transaction_ID, dbo.Transaction_Details.ItemDiscountType, "
...
MySQL = MySQL & "                      dbo.TblUnites.UnitNamee, dbo.Transactions.ReceptMode, dbo.Transactions.DMYRecept, dbo.Transactions.CountRecept, dbo.Transactions.DMYEShow,"
MySQL = MySQL & "                      dbo.Transactions.EndShow, dbo.Transactions.PaymentType, dbo.Transactions.DepartementID, dbo.TblEmpDepartments.DepartmentName,"
MySQL = MySQL & "                      dbo.TblEmpDepartments.DepartmentNamee , dbo.Transactions.order_no1"
...
MySQL = MySQL & " Where (dbo.Transactions.Transaction_ID =" & val(XPTxtBillID.Text) & ")"
 ...
 If SystemOptions.UserInterface = ArabicInterface Then
         StrFileName = App.path & "\Reports\Inventory\PerformaInvoicesShow91.rpt"
     Else
       StrFileName = App.path & "\Reports\Inventory\PerformaInvoicesShow91.rpt"
       End If
    If Dir(StrFileName) = "" Then
...
Private Sub PrintReport()
    ...
    If XPTxtBillID.Text <> "" Then
        Set SaleReport = New ClsSaleReport
        SaleReport.ShowPrice XPTxtBillID.Text, 91, DcboEmp.Text
    End If
...
Private Sub ChangeLang()
    ...
    chkshipped.Caption = "shipped"
     Me.Caption = "Requests Offers Procurement Prices"
  '  Ele(6).Caption = "Purchase Quotation Requests"
    Me.Label1(2).Caption = "Requests Offers Procurement Prices"
    'Me.Caption = "Order Request/Proforma   Invoice"
    Me.XPTab301.TabCaption(0) = "Items"
    Me.XPTab301.TabCaption(1) = "Internal Orders"
    Me.XPTab301.TabCaption(2) = "Approve Data"
    lbl(18).Caption = "Type"
    ...
    lbl(37).Caption = "Method of Receipt"
    lbl(38).Caption = "Management Offer"
    lbl(36).Caption = "receiving Time"
    lbl(34).Caption = "Payment Way"
    ''''''''''''''''''''''''''''''''
