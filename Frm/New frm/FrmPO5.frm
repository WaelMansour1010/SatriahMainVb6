   ...
   Begin C1SizerLibCtl.C1Elastic EleMain 
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin VB.ComboBox CboPaymentType 
            Height          =   315
            ItemData        =   "FrmPO5.frx":038A
            Left            =   720
            List            =   "FrmPO5.frx":038C
            RightToLeft     =   -1  'True
            TabIndex        =   162
            Top             =   1080
            Width           =   2775
         End
         Begin VB.TextBox TxtPodays 
            Alignment       =   1  'Right Justify
            Height          =   345
            Left            =   4935
            RightToLeft     =   -1  'True
         ...
         Begin MSDataListLib.DataCombo DCbDept 
            ...
            RightToLeft     =   -1  'True
         End
         Begin MSDataListLib.DataCombo DcbCuntry 
            Height          =   315
            Left            =   720
            TabIndex        =   164
            Top             =   150
...
If SystemOptions.POMustentryAndBillMustEntry = True And (TxtPONo.Text = "") Then
...
End If
        ...
        Case 5
            ...
            FrmBuySearch.DealingForm = GridTransType.purchaseorder
...
Private Sub DCboStoreName_Change()
 TxtStoreID.Text = getStoreCoding(val(DCboStoreName.BoundText))
    If Me.TxtModFlg = "N" Or Me.TxtModFlg = "E" Then
     ...
     If CheckStoreCoding(val(dcBranch.BoundText), 46) = True Then
'     TxtNoteSerial.Text = ""
    TxtNoteSerial1.Text = ""
...
ShowAttachments TxtNoteSerial1, "14042015"
...
Public Sub RetriveOrder(Optional order_no As String = "", _
    ...
    FG.Refresh
        ...
        StrSQL = "Select * from transactions where  1=1 and "
        StrSQL = StrSQL & " (Transaction_Type=45 or  Transaction_Type=38)"
       StrSQL = StrSQL & "  and ( Order_no='" & order_no & "' OR NOTESERIAL1='" & order_no & "' )"
 
 
If CheckAprroveScreen("FrmPO5") = True Or CheckAprroveScreen("FrmPO4") = True Then
...
Private Sub TxtPodays_KeyPress(KeyAscii As Integer)
    KeyAscii = KeyAscii_Num(KeyAscii, TxtPodays.Text, 0)
...
Private Sub TxtPONo_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF3 Then
       Order_no_search4.show
        Order_no_search4.RetrunType = 45
...
'            End If
    If GeneralPriceType = 0 Then
        ...
        ScreenNameEnglish = "Purchase  Quotations  "
        CurrentTransactionType = 46
 ...
 With Me.CboPaymentType
    ...
    Set NewGrid.Grid = FG
    NewGrid.GridTrans = GridTransType.purchaseorder
  ...
  Dcombos.GetEmpDepartments Me.DCbDept
    ...
    Dcombos.GETNationality Me.DcbCuntry
...
Public Sub Retrive(Optional Lngid As Long = 0)
    ...
    Me.DcbCuntry.BoundText = IIf(IsNull(rs("CountryID").value), "", rs("CountryID").value)
   ...
   Me.CboPriceType.ListIndex = 0
    ...
    Me.DCboStoreName.BoundText = IIf(IsNull(rs("StoreID").value), "", rs("StoreID").value)
 Me.DCbDept.BoundText = IIf(IsNull(rs("Departementid").value), "", rs("Departementid").value)
    TxtPodays.Text = IIf(IsNull(rs("PODays").value), "", (rs("PODays").value))
 ...
 StrSQL = " SELECT     dbo.TblItems.HaveSerial AS Expr1, *"
  ...
  StrSQL = StrSQL & " Where (dbo.Transaction_Details.Transaction_ID =" & val(rs("Transaction_ID").value) & ")"
    ...
    If Not (RsDetails.EOF Or RsDetails.BOF) Then
        ...
        '      FG.TextMatrix(Num, FG.ColIndex("countrisid")) = IIf(IsNull(RsDetails("countrisid")), "", (RsDetails("countrisid").value))
      ...
      '      FG.TextMatrix(Num, FG.ColIndex("countris")) = IIf(IsNull(RsDetails("CountryName")), "", Trim(RsDetails("CountryName").value))
         ...
         FG.TextMatrix(Num, FG.ColIndex("PODaysSub")) = IIf(IsNull(RsDetails("PODaysSub")), "", (RsDetails("PODaysSub").value))
...
'        End If
   ...
   RSTransDetails.Open StrSQL, Cn, adOpenKeyset, adLockOptimistic, adCmdText
      ...
      rs("PODays").value = IIf(Trim(Me.TxtPodays.Text) = "", Null, Trim(Me.TxtPodays.Text))
...
rs("Transaction_Type").value = CurrentTransactionType
        ...
        rs("CountryID").value = IIf(Me.DcbCuntry.BoundText = "", Null, val(DcbCuntry.BoundText))
    ''//18 05 2015
    If CboPaymentType.ListIndex = -1 Then
       ...
       CuurentLogdata
        ...
        For RowNum = 1 To FG.Rows - 1
           ...
           '     RSTransDetails("Shipping").value = IIf((FG.TextMatrix(RowNum, FG.ColIndex("Shipping")) = ""), Null, val(FG.TextMatrix(RowNum, FG.ColIndex("Shipping"))))
                ...
                RSTransDetails("PODaysSub").value = IIf((FG.TextMatrix(RowNum, FG.ColIndex("PODaysSub")) = ""), val(TxtPodays.Text), val(FG.TextMatrix(RowNum, FG.ColIndex("PODaysSub"))))
                
                RSTransDetails("PoAssumeDate").value = DateAdd("D", RSTransDetails("PODaysSub").value, XPDtbBill.value)
...
Private Sub PrintReport()
    ...
    If XPTxtBillID.Text <> "" Then
        Set SaleReport = New ClsSaleReport
        SaleReport.ShowPrice XPTxtBillID.Text, 92, DcboEmp.Text
    End If
...
lbl(36).Caption = "Dept"
lbl(35).Caption = "Day"
lbl(34).Caption = "Due Date"
lbl(37).Caption = "Payment"

    lbl(29).Caption = "Status"
    lbl(27).Caption = "Qty"
    lbl(26).Caption = "Price"
lbl(38).Caption = "Country"
    lbl(3).Caption = "Total"
    lbl(1).Caption = "By"
   ...
   With Me.GRID2
    ...
    End With
    lbl(33).Caption = "Baed On"
    ISButton2.Caption = "Attachments"
    Label11.Caption = "Need To Approve"
  '  With Me.GRID2
