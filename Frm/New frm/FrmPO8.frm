...
FrmBuySearch.DealingForm = GridTransType.internalorder
  FrmBuySearch.index = 6
            FrmBuySearch.Caption = "«·»ÕÀ ⁄‰ ÿ·»«   œ«Œ·Ì…/ ⁄—÷ ”⁄— „‘ —Ì« "
            FrmBuySearch.show vbModal
       End If
       End If
End Sub
...
MySQL = MySQL & "                      dbo.TblPaymetData.NameE AS PaymNameE,TblItems.ItemComment"
...
Function print_report2(Optional NoteSerial As String)
 ...
 MySQL = MySQL & "                     dbo.Transaction_Details.ItemSalesYear , dbo.Transaction_Details.Remarks,TblItems.ItemComment"
