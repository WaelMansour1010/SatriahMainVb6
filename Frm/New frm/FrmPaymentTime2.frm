...
Begin VB.Form FrmPaymentTime2 
   ...
   Begin C1SizerLibCtl.C1Elastic EleMain 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmPaymentTime2.frx":038A
      AccessibleName  =   ""
      ...
      Begin ImpulseButton.ISButton CmdRef 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmPaymentTime2.frx":0439
      ...
      Begin ImpulseButton.ISButton CmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmPaymentTime2.frx":07D3
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin ImpulseButton.ISButton CmdExit 
            ...
            EndProperty
            BackStyle       =   0
            ButtonImage     =   "FrmPaymentTime2.frx":0B6D
            ColorButton     =   14871017
      ...
      Begin VSFlex8UCtl.VSFlexGrid Fg1 
         ...
         FormatString    =   $"FrmPaymentTime2.frx":0F07
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin ImpulseButton.ISButton CmdOptions 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmPaymentTime2.frx":1206
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         RightToLeft     =   -1  'True
      End
   ...
   End
End
Attribute VB_Name = "FrmPaymentTime2"
...
Private Sub ISButton1_Click()
    ...
    With Fg1
        ...
        FrmPayments.lblsqlstring.Caption = "(" & Mid(SQLString, 4, Len(SQLString) - 3) & ")"
...
Public Sub LoadData(cusid As Double)
    Dim StrSQL As String
    Dim i As Integer

    StrSQL = "SELECT CompanyDebitValues.*"
    StrSQL = StrSQL + " FROM dbo.CompanyDebitValues() CompanyDebitValues "
    StrSQL = StrSQL + " where  (cusid=" & cusid & " and requiredvalue>0  and transaction_type=22 )"
    
    'StrSQL = "SELECT CompanyCreditValues.*  FROM dbo.CompanyCreditValues() CompanyCreditValues   where   (cusid=" & CusID & " and requiredvalue>0  and (transaction_type=21 or transaction_type=1) )"
