...
Begin VB.Form FrmQewstRegesterDate 
   BackColor       =   &H00E2E9E9&
   ...
   End
End
Attribute VB_Name = "FrmQewstRegesterDate"
...
Private Sub CmdOk_Click()
    ...
    If Not FrmExpenses4.FgInstallments Is Nothing Then
...
FrmExpenses4.FgInstallments.TextMatrix(FrmExpenses4.LngRow, FrmExpenses4.FgInstallments.ColIndex("Due_Date")) = XPDtbBill.value

     
           Askinterval = "dd/mm/yyyy"
        'End If
        If FrmExpenses4.FgInstallments.ColIndex("Due_Date") <> -1 Then
         '  dateenter = DateAdd(Askinterval, -2, XPDtbBill.value)
           FrmExpenses4.FgInstallments.TextMatrix(FrmExpenses4.LngRow, FrmExpenses4.FgInstallments.ColIndex("Due_Date")) = XPDtbBill.value ' dateenter
        End If
