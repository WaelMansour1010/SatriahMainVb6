...
Begin VB.Form FrmReceptRawMatrialsAlarm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ImpulseButton.ISButton Cmd1 
         ...
         EndProperty
         ButtonImage     =   "FrmReceptRawMatrialsAlarm.frx":0000
         ColorButton     =   8438015
      ...
      Begin MSComctlLib.ImageList GrdImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmReceptRawMatrialsAlarm.frx":039A
               Key             =   "CompanyName"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmReceptRawMatrialsAlarm.frx":03F8
               Key             =   "Ser"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmReceptRawMatrialsAlarm.frx":0456
               Key             =   "Vac_Name"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmReceptRawMatrialsAlarm.frx":04B4
               Key             =   "ShareCount"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmReceptRawMatrialsAlarm.frx":0512
               Key             =   "Dis_Count"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmReceptRawMatrialsAlarm.frx":0570
               Key             =   "Bouns"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmReceptRawMatrialsAlarm.frx":05CE
               Key             =   "SharesValue"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmReceptRawMatrialsAlarm.frx":062C
               Key             =   "BuyValue"
            EndProperty
         EndProperty
      End
   ...
   Begin VSFlex8UCtl.VSFlexGrid GridInstallments 
      ...
      FormatString    =   $"FrmReceptRawMatrialsAlarm.frx":068A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin ImpulseButton.ISButton Cmd1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "FrmReceptRawMatrialsAlarm.frx":07CA
      ColorButton     =   14871017
      DrawFocusRectangle=   0   'False
   End
   ...
   End
End
Attribute VB_Name = "FrmReceptRawMatrialsAlarm"
...
On Error Resume Next
 ...
 My_SQL = My_SQL + " Where (dbo.Transactions.Transaction_Type = 20)"
...
Function print_report(Optional NoteSerial As String)
    ...
    Dim Msg As String
        ...
        If SystemOptions.UserInterface = ArabicInterface Then
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepReceptRawMatrialsAlarm.rpt"
        Else
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepReceptRawMatrialsAlarm.rpt"
        End If
...
Function cahngelang()
    Label1(2).Caption = "Screen  Receipt of raw materials bonds Alerts"
...
Private Sub GridInstallments_CellButtonClick(ByVal Row As Long, ByVal Col As Long)
    With Me.GridInstallments
      ...
      ' Load FrmInpout
   FrmInpout.show
FrmInpout.Retrive (val(Me.GridInstallments.TextMatrix(Me.GridInstallments.Row, Me.GridInstallments.ColIndex("Transaction_ID"))))
End Select
End With
End Sub
