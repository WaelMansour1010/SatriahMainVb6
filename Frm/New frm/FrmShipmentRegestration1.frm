        ...
        If TOTAL_COST > 0 Then
            If detect_inventory_work_type = 1 Or detect_inventory_work_type = 2 Or detect_inventory_work_type = 3 Then
                ...
                Else
                    ...
                    If Account_Code_dynamic = "NO account" Then
                        MsgBox "·„ Ì „  ÕœÌœ   Õ”«»  ÕÊÌ·«  œ«∆‰…  ›Ì «·›—⁄ ·Â–… «·⁄„·Ì…", vbCritical
                        GoTo ErrTrap
...
'    cal_expenses
 ...
 '   rs.Open "select * from Transactions where Transaction_Serial = " & TxtTransSerial.text & " and Transaction_type = 26"
    ...
    If rs.RecordCount = 0 Then MsgBox "«Õ›Ÿ   «·”‰œ «Ê·«": Exit Sub
    If SystemOptions.UserInterface = ArabicInterface Then
...
'    On Error GoTo ErrTrap
    ...
    ScreenNameEnglish = "Shipment Registeration"
...
If SystemOptions.UserInterface = ArabicInterface Then
CbShippingStatus.AddItem ("„ﬁ»Ê·")
CbShippingStatus.AddItem ("„—›Ê÷")
Else
