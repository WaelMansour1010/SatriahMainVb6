...
Function createVoucher()
    ...
    If SystemOptions.UserInterface = ArabicInterface Then
        bankDes = " «Ìœ«⁄«  »‰ﬂÌÂ  »‰ﬂ " & Me.Dcbank.text
    Else
    ...
    RsNotes("numbering_type1").value = sand_numbering_type(20) '‰Ê⁄  —ﬁÌ„ ”‰œ «·«Ìœ«⁄
    ...
    With Grid1
        ...
        For i = .FixedRows To .Rows - 1
            ...
            If .TextMatrix(i, .ColIndex("BankId")) <> "" Then
                ...
                If SystemOptions.UserInterface = ArabicInterface Then
                    bankDes = " «Ìœ«⁄ »‰ﬂÌ ⁄·Ï »‰ﬂ " & Me.Dcbank.text & "  „‰ ‘Ìﬂ —ﬁ„  " & (.TextMatrix(i, .ColIndex("ChequeNo"))) & " ⁄·Ï »‰ﬂ " & (.TextMatrix(i, .ColIndex("BankName")))
                Else
