...
Function print_report(Optional NoteSerial As String)
    ...
    StrSQL = " SELECT  dbo.notes_all.price,     dbo.TblTripTypesTransport.ID, dbo.TblTripTypesTransport.NotesallID, dbo.TblTripTypesTransport.CardNO, "
      ...
      ElseIf RdPrint(3).value = True Then
       If SystemOptions.UserInterface = ArabicInterface Then
        ...
        End If
            ...
            ElseIf RdPrint(5).value = True Then
       If SystemOptions.UserInterface = ArabicInterface Then
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepTrans5.rpt"
        Else
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepTrans5E.rpt"
        End If
...
Function print_report6(Optional reportno As String)
    ...
    StrSQL = "  SELECT      AVG(dbo.notes_all.Price) AS Price, dbo.TblTripTypesTransport.ID, dbo.TblTripTypesTransport.NotesallID, dbo.TblTripTypesTransport.CardNO, "
   StrSQL = StrSQL & "                    dbo.TblTripTypesTransport.QtyDownload, dbo.TblTripTypesTransport.CardNO2, dbo.TblTripTypesTransport.QtyDischarge, dbo.TblBranchesData.branch_name,"
StrSQL = StrSQL & "                       dbo.TblBranchesData.branch_namee, dbo.notes_all.NoteDate, dbo.notes_all.NoteSerial1, dbo.notes_all.general_des, dbo.notes_all.CityFromId,"
StrSQL = StrSQL & "                       TblCountriesGovernments_2.GovernmentName, dbo.notes_all.CityToId, TblCountriesGovernments_1.GovernmentName AS GovernmentNameTO,"
StrSQL = StrSQL & "                       dbo.notes_all.VehicleType, dbo.TBLCarTypes.name, dbo.TBLCarTypes.namee, dbo.notes_all.CarId, dbo.TblCarsData.BoardNO, dbo.notes_all.CarID2,"
...
StrSQL = StrSQL & "                       dbo.TblShipsData.Name AS ShipName, dbo.TblShipsData.NameE AS ShipNameE, dbo.notes_all.DriverId, dbo.TblEmployee.Emp_Name, dbo.TblEmployee.Fullcode,"
StrSQL = StrSQL & "                       dbo.TblEmployee.Emp_Namee, dbo.notes_all.LeaderName, dbo.TblTripTypesTransport.allocations, dbo.TblTripTypesTransport.BillDate,"
StrSQL = StrSQL & "                       dbo.TblTripTypesTransport.ItemID, dbo.TblItems.ItemName, dbo.TblItems.ItemCode, dbo.TblItems.ItemNamee, dbo.notes_all.CusID, TblCustemers_2.CusName,"
StrSQL = StrSQL & "                       TblCustemers_2.CusNamee, TblCustemers_1.Fullcode AS CusFullcode, dbo.notes_all.VendorID, TblCustemers_1.CusName AS VenCusName,"
StrSQL = StrSQL & "                       TblCustemers_1.CusNamee AS VenCusNameE, TblCustemers_1.Fullcode AS VenFullcode, dbo.notes_all.HarborID, dbo.TblHarborsData.Name AS HarabName,"
StrSQL = StrSQL & "                       dbo.TblHarborsData.NameE AS HarabNameE, dbo.notes_all.TypeTransportID, dbo.TblTypesTransport.Name AS TypeTransName,"
StrSQL = StrSQL & "                       dbo.TblTypesTransport.NameE AS TypeTransNameE, SUM(dbo.DOUBLE_ENTREY_VOUCHERS.[Value]) AS Expr1"
StrSQL = StrSQL & "  FROM         dbo.TblHarborsData RIGHT OUTER JOIN"
StrSQL = StrSQL & "                       dbo.notes_all LEFT OUTER JOIN"
StrSQL = StrSQL & "                       dbo.DOUBLE_ENTREY_VOUCHERS ON dbo.notes_all.NoteID = dbo.DOUBLE_ENTREY_VOUCHERS.notes_all LEFT OUTER JOIN"
StrSQL = StrSQL & "                       dbo.TblTypesTransport ON dbo.notes_all.TypeTransportID = dbo.TblTypesTransport.ID ON dbo.TblHarborsData.id = dbo.notes_all.HarborID LEFT OUTER JOIN"
StrSQL = StrSQL & " dbo.TblCustemers TblCustemers_1 ON dbo.notes_all.VendorID = TblCustemers_1.CusID LEFT OUTER JOIN"
StrSQL = StrSQL & "                       dbo.TblCustemers TblCustemers_2 ON dbo.notes_all.CusID = TblCustemers_2.CusID LEFT OUTER JOIN"
StrSQL = StrSQL & "                       dbo.TblEmployee ON dbo.notes_all.DriverId = dbo.TblEmployee.Emp_ID LEFT OUTER JOIN"
StrSQL = StrSQL & "  dbo.TblShipsData ON dbo.notes_all.ShipID = dbo.TblShipsData.id RIGHT OUTER JOIN"
...
StrSQL = StrSQL & "                       dbo.TblCountriesGovernments TblCountriesGovernments_2 ON dbo.notes_all.CityFromId = TblCountriesGovernments_2.GovernmentID LEFT OUTER JOIN"
StrSQL = StrSQL & "                       dbo.TblBranchesData ON dbo.notes_all.branch_no = dbo.TblBranchesData.branch_id"
StrSQL = StrSQL & " GROUP BY dbo.TblTripTypesTransport.ID, dbo.TblTripTypesTransport.NotesallID, dbo.TblTripTypesTransport.CardNO, dbo.TblTripTypesTransport.QtyDownload,"
StrSQL = StrSQL & "                       dbo.TblTripTypesTransport.CardNO2, dbo.TblTripTypesTransport.QtyDischarge, dbo.TblBranchesData.branch_name, dbo.TblBranchesData.branch_namee,"
StrSQL = StrSQL & "                       dbo.notes_all.NoteDate, dbo.notes_all.NoteSerial1, dbo.notes_all.general_des, dbo.notes_all.CityFromId, TblCountriesGovernments_2.GovernmentName,"
StrSQL = StrSQL & "                       dbo.notes_all.CityToId, TblCountriesGovernments_1.GovernmentName, dbo.notes_all.VehicleType, dbo.TBLCarTypes.name, dbo.TBLCarTypes.namee,"
StrSQL = StrSQL & "                       dbo.notes_all.CarId, dbo.TblCarsData.BoardNO, dbo.notes_all.CarID2, dbo.TblVendorCars.BoardNo, dbo.notes_all.NoteID, dbo.notes_all.NoteType,"
StrSQL = StrSQL & "                       dbo.notes_all.branch_no, dbo.notes_all.CarType, dbo.notes_all.ShipID, dbo.TblShipsData.Name, dbo.TblShipsData.NameE, dbo.notes_all.DriverId,"
StrSQL = StrSQL & "                       dbo.TblEmployee.Emp_Name, dbo.TblEmployee.Fullcode, dbo.TblEmployee.Emp_Namee, dbo.notes_all.LeaderName, dbo.TblTripTypesTransport.allocations,"
StrSQL = StrSQL & "                       dbo.TblTripTypesTransport.BillDate, dbo.TblTripTypesTransport.ItemID, dbo.TblItems.ItemName, dbo.TblItems.ItemCode, dbo.TblItems.ItemNamee,"
StrSQL = StrSQL & "                       dbo.notes_all.CusID, TblCustemers_2.CusName, TblCustemers_2.CusNamee, TblCustemers_1.Fullcode, dbo.notes_all.VendorID, dbo.notes_all.HarborID,"
StrSQL = StrSQL & "                       dbo.TblHarborsData.Name , dbo.TblHarborsData.NameE, dbo.notes_all.TypeTransportID, dbo.TblTypesTransport.Name, dbo.TblTypesTransport.NameE ,dbo.DOUBLE_ENTREY_VOUCHERS.Credit_Or_Debit ,"
StrSQL = StrSQL & "                TblCustemers_1.CusName,"
StrSQL = StrSQL & "               TblCustemers_1.CusNamee"




StrSQL = StrSQL & "  Having (dbo.notes_all.NoteType = 370) AND (dbo.DOUBLE_ENTREY_VOUCHERS.Credit_Or_Debit = 0)"
   ...
   If Not IsNull(FrmDate.value) Then
    ...
    End If
       ...
       If SystemOptions.UserInterface = ArabicInterface Then
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepTrans" & reportno & ".rpt"
        Else
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepTrans" & reportno & "E.rpt"
        End If
...
If RdPrint(3).value = False And RdPrint(2).value = False And RdPrint(1).value = False And RdPrint(0).value = False And RdPrint(5).value = False And RdPrint(6).value = False And RdPrint(7).value = False Then
If SystemOptions.UserInterface = ArabicInterface Then
MsgBox "Ì—ÃÏ «Œ Ì«— «· ﬁ—Ì—"
Else
...
Exit Sub
End If
If RdPrint(3).value = True Then
print_report2
ElseIf RdPrint(6).value = True Then
print_report6 (6)

ElseIf RdPrint(7).value = True Then
print_report6 (7)
...
Private Sub Form_Load()
  ...
  If SystemOptions.UserInterface = ArabicInterface Then
   ...
   End If
    fill_combo Me.DcbEmployee(0), str
