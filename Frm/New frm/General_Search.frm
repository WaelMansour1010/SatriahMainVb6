...
Begin VB.Form General_Search 
   ...
   Begin VB.Frame Frame20 
      ...
      Begin VSFlex8UCtl.VSFlexGrid VSFlexGrid7 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"General_Search.frx":0204
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8UCtl.VSFlexGrid VSFlexGrid6 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"General_Search.frx":03DD
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame fram_empadv 
      ...
      Begin VSFlex8UCtl.VSFlexGrid VSFlexGrid5 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"General_Search.frx":0659
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Fram_Visa 
      ...
      Begin VSFlex8UCtl.VSFlexGrid fg2 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"General_Search.frx":07BC
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Fram_Advreq 
      ...
      Begin VSFlex8UCtl.VSFlexGrid Fg 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"General_Search.frx":0A30
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Fram_treat 
      ...
      Begin VB.Frame Frame15 
         ...
         Begin MSDataListLib.DataCombo DataCombo7 
            Bindings        =   "General_Search.frx":0B78
            Height          =   288
            Left            =   6120
            TabIndex        =   132
            Top             =   1800
      ...
      Begin VB.Frame Frame13 
         ...
         Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid4 
            ...
            FormatString    =   $"General_Search.frx":0BA9
            ScrollTrack     =   0   'False
            ScrollBars      =   1
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   Begin VB.Frame Fram_adv 
      ...
      Begin VB.Frame Frame12 
         ...
         Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid3 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"General_Search.frx":0CE4
            ScrollTrack     =   0   'False
            ScrollBars      =   1
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame Frame10 
         ...
         Begin MSDataListLib.DataCombo DataCombo4 
            Bindings        =   "General_Search.frx":0E8F
            Height          =   288
            Left            =   6120
            TabIndex        =   101
            Top             =   1800
   ...
   Begin VB.Frame Fram_Passports 
      ...
      Begin VB.Frame Frame9 
         ...
         Begin MSDataListLib.DataCombo branch_no 
            Bindings        =   "General_Search.frx":0EC0
            Height          =   288
            Left            =   6120
            TabIndex        =   76
            Top             =   1800
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid2 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"General_Search.frx":0EF1
            ScrollTrack     =   0   'False
            ScrollBars      =   1
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   Begin VB.Frame Fram_businessjob 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"General_Search.frx":1026
            ScrollTrack     =   0   'False
            ScrollBars      =   1
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame Frame3 
         ...
         Begin MSDataListLib.DataCombo branch_name 
            Bindings        =   "General_Search.frx":11BD
            Height          =   288
            Left            =   6120
            TabIndex        =   44
            Top             =   2160
   ...
   Begin VB.Frame fram_empMove 
      ...
      Begin VB.Frame fram1 
         ...
         Begin MSDataListLib.DataCombo Dcbranch 
            Bindings        =   "General_Search.frx":11EE
            Height          =   288
            Left            =   6120
            TabIndex        =   8
            Top             =   2160
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VSFlex8Ctl.VSFlexGrid Fg_Journal 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"General_Search.frx":121F
            ScrollTrack     =   0   'False
            ScrollBars      =   1
            ScrollTips      =   0   'False
            MergeCells      =   0
