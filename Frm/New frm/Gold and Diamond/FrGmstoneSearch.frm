...
Begin VB.Form FrmGemstonesSearch 
   BackColor       =   &H00E2E9E9&
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"FrGmstoneSearch.frx":038A
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmGemstonesSearch"
...
Private Sub Fg_Click()
    ...
    'FindRec val(FrmModels.Grid.TextMatrix(FrmModels.Grid.Row, Me.Grid.ColIndex("UnitID")))
'ErrTrap:
...
Private Sub Fg_EnterCell()
    On Error GoTo ErrTrap
  '  FrmModels.FindRec
   FrmGemstones.FindRec val(Me.Fg.TextMatrix(Me.Fg.Row, Me.Fg.ColIndex("id")))
ErrTrap:
End Sub
...
StrSQL = "SELECT * FROM TblGemstones "
    BolBegine = False
    StrWhere = ""
...
lbl(7).Caption = "Code"
lbl(3).Caption = "Remark"
lbl(5).Caption = "From"
lbl(6).Caption = "To"
lbl(0).Caption = "Name Arb"
lbl(8).Caption = "t Name ENG"
lbl(2).Caption = "Total"
...
Me.lbprocess.Caption = "Process No"
     With Me.Fg
       ...
       ' .TextMatrix(0, .ColIndex("RecordDate")) = "Date"
         .TextMatrix(0, .ColIndex("name")) = "Unit Name Arb"
        .TextMatrix(0, .ColIndex("namee")) = "Unit Name ENG"
       '
