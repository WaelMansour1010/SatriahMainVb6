...
Begin VB.Form FrmDiamondsSearch 
   BackColor       =   &H00E2E9E9&
   ...
   ClientTop       =   435
   ClientWidth     =   8085
   Icon            =   "FrmDiamondsSearch.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"FrmDiamondsSearch.frx":038A
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmDiamondsSearch"
...
Private Sub Fg_EnterCell()
    On Error GoTo ErrTrap
  '  FrmModels.FindRec
   FrmDiamonds.FindRec val(Me.Fg.TextMatrix(Me.Fg.Row, Me.Fg.ColIndex("id")))
ErrTrap:
End Sub
...
StrSQL = "SELECT * FROM TblDiamonds "
    BolBegine = False
    StrWhere = ""
