...
Begin VB.Form FrmAverGram 
   ...
   Begin VB.Frame Frm2 
      ...
      Top             =   3855
      Width           =   8625
      Begin XtremeSuiteControls.CheckBox ChDefalut 
         Height          =   255
         Left            =   120
         TabIndex        =   33
         Top             =   240
      ...
      Begin VB.ComboBox CmbType 
         BackColor       =   &H80000018&
         Height          =   315
         ItemData        =   "FrmAverGram.frx":038A
         Left            =   2280
         List            =   "FrmAverGram.frx":039A
         RightToLeft     =   -1  'True
   ...
   Begin C1SizerLibCtl.C1Elastic EleHeader 
      ...
      Begin ImpulseButton.ISButton btnLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":03B3
      ...
      Begin ImpulseButton.ISButton btnNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":074D
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
      Begin ImpulseButton.ISButton btnPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":0AE7
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
      Begin ImpulseButton.ISButton btnFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":0E81
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
   ...
   Begin C1SizerLibCtl.C1Elastic EltCont 
      ...
      Begin ImpulseButton.ISButton btnNew 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":121B
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":15B5
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnModify 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":194F
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnUndo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":1CE9
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnDelete 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":2083
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnQuery 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":261D
      ...
      Begin ImpulseButton.ISButton BtnUpdate 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":29B7
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":2D51
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
      Begin ImpulseButton.ISButton btnCancel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmAverGram.frx":30EB
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
      Begin ImpulseButton.ISButton ButPrient 
         ...
         EndProperty
         BackStyle       =   0
         ButtonImage     =   "FrmAverGram.frx":3485
         ColorButton     =   14871017
   ...
   Begin VSFlex8Ctl.VSFlexGrid Grid 
      ...
      FormatString    =   $"FrmAverGram.frx":381F
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
Private Sub ChangeLang()
    ...
    Label1(0).Caption = "Type caliber"
    Label1(1).Caption = "Averag Price"
     Label1(2).Caption = " Remarks"
 Me.ButPrient.Caption = "Prient"
' ISButton1.Caption = "Search"
 btnQuery.Caption = "Search"
 Me.ChDefalut.Caption = "Defualt"
 
    With Grid
        .TextMatrix(0, .ColIndex("Code")) = " Code"
        .TextMatrix(0, .ColIndex("UnitName")) = "Type caliber"
        .TextMatrix(0, .ColIndex("UnitNameE")) = " Averag Price"
        .TextMatrix(0, .ColIndex("remark")) = "Remarks"
        Me.Caption = "Averag Price of Garm"
...
FrmAvgGramSearch.calltype = 0
Load FrmAvgGramSearch
FrmAvgGramSearch.show
End Sub
...
Private Sub btnNew_Click()
    On Error GoTo ErrTrap
    Dim My_SQL As String
Me.ChDefalut.value = xtpUnchecked
...
StrVacName = ""
    ...
    StrVacName = IsRecExist("TblAveragGrm", "name", Trim(TxtVacName.text), "name", "ID<>'" & Trim(TxtUnitID.text) & "'")
    ...
    If StrVacName <> "" Then
        ...
        Exit Sub
    End If
    StrVacName = IsRecExist("TblAveragGrm", "code", Trim(Me.TxtCode.text), "code", "ID<>'" & Trim(TxtUnitID.text) & "'")
...
Public Sub AddNewRec()
    ...
    StrRecID = new_id("TblAveragGrm", "ID", "")
    RsSavRec.AddNew
...
Public Sub FiLLRec()
    ...
    RsSavRec.Fields("AvPrice").value = val(IIf(TxtVacNamee.text <> "", Trim(TxtVacNamee.text), 0))
...
If Me.ChDefalut.value = xtpChecked Then
    RsSavRec.Fields("Defult").value = 1
    Else
     RsSavRec.Fields("Defult").value = 0
     End If
...
Public Sub FiLLTXT()
    ...
    TxtVacNamee.text = IIf(IsNull(RsSavRec.Fields("AvPrice").value), 0, RsSavRec.Fields("AvPrice").value)
Me.txtRemark.text = IIf(IsNull(RsSavRec.Fields("Remrks").value), "", RsSavRec.Fields("Remrks").value)
    ...
    If RsSavRec.Fields("Defult").value = True Then
    Me.ChDefalut.value = xtpChecked
    Else
    Me.ChDefalut.value = xtpUnchecked
    End If
...
Public Sub FillGridWithData()
    ...
    Set rs = New ADODB.Recordset
    My_SQL = "select * From TblAveragGrm order by id"
    ...
    With Me.Grid
        ...
        If rs.RecordCount > 0 Then
            ...
            For i = 1 To .Rows - 1
                ...
                .TextMatrix(i, .ColIndex("UnitNamee")) = IIf(IsNull(rs.Fields("AvPrice").value), "", rs.Fields("AvPrice").value)
