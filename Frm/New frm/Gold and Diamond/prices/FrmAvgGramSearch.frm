...
Begin VB.Form FrmAvgGramSearch 
   BackColor       =   &H00E2E9E9&
   ...
   ClientTop       =   435
   ClientWidth     =   8085
   Icon            =   "FrmAvgGramSearch.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"FrmAvgGramSearch.frx":038A
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmAvgGramSearch"
...
If Me.calltype = 0 Then
    ...
    FrmAverGram.FindRec val(Me.Fg.TextMatrix(Me.Fg.Row, Me.Fg.ColIndex("id")))
...
StrSQL = "SELECT * FROM TblAveragGrm "
    BolBegine = False
    StrWhere = ""
...
'////////////////////////
 If Me.TxtName.text <> "" Then
    ...
    If Me.TxtNameE.text <> "" Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND AvPrice like '%" & Me.TxtNameE.text & "%'"
        Else
            BolBegine = True
            StrWhere = " Where AvPrice like '%" & Me.TxtNameE.text & "%'"
        End If
    End If
        ...
        With Me.Fg
            ...
            For i = .FixedRows To .Rows - 1
               ...
               ' End If
                ...
                .TextMatrix(i, .ColIndex("namee")) = IIf(IsNull(rs("AvPrice").value), "", rs("AvPrice").value)
...
Private Sub ChangeLang()
  ...
  Me.Caption = "Search Averag Price of Gram"
...
lbl(5).Caption = "From"
lbl(6).Caption = "To"
lbl(0).Caption = "Type caliber"
lbl(8).Caption = " Averag Price"
lbl(2).Caption = "Total"
...
Me.lbprocess.Caption = "Process No"
     With Me.Fg
       ...
       ' .TextMatrix(0, .ColIndex("RecordDate")) = "Date"
         .TextMatrix(0, .ColIndex("name")) = "Type caliber"
        .TextMatrix(0, .ColIndex("namee")) = " Averag Price"
