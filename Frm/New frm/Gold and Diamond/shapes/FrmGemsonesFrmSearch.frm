...
Begin VB.Form FrmGemsonesFrmSearch 
   BackColor       =   &H00E2E9E9&
   ...
   ClientTop       =   435
   ClientWidth     =   8085
   Icon            =   "FrmGemsonesFrmSearch.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"FrmGemsonesFrmSearch.frx":038A
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmGemsonesFrmSearch"
...
If Me.calltype = 0 Then
    ...
    FrmGemstoneFrms.FindRec val(Me.Fg.TextMatrix(Me.Fg.Row, Me.Fg.ColIndex("id")))
...
StrSQL = "SELECT * FROM TblGestonesFrm "
    BolBegine = False
    StrWhere = ""
...
Private Sub ChangeLang()
  ...
  Me.Caption = "Search Gemstones Forms"
