...
Begin VB.Form FrmIqarWaiverSet 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VSFlex8UCtl.VSFlexGrid VSFlexGrid1 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"FrmIqarWaiverSet.frx":64B6
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
Private Sub fg_Click()
   ...
   If m_RetrunType = 5 Then
            ...
            If val(FG.TextMatrix(FG.Row, FG.ColIndex("net"))) > 0 Then
                    ...
                    FrmCashing1.DcbUnitNo.text = (FG.TextMatrix(FG.Row, FG.ColIndex("unitno")))
                    ...
                    FrmCashing1.GetWonerID (val(FG.TextMatrix(FG.Row, FG.ColIndex("iqarid"))))
                     ...
                     FrmCashing1.DcbUnitType.BoundText = val(FG.TextMatrix(FG.Row, FG.ColIndex("unittype")))
...
.TextMatrix(Num, .ColIndex("DayNo")) = IIf(IsNull(rs("DayNo").value), "", Trim(rs("DayNo").value))
                    ...
                    .TextMatrix(Num, .ColIndex("unittype")) = IIf(IsNull(rs("unittype").value), 0, (rs("unittype").value))
