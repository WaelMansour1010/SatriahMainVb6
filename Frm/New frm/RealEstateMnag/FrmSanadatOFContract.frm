...
ElseIf Indx = 2 Then
Label1(2).Caption = "”‰œ«  «·„œ›Ê⁄«  «·Œ«’…      »⁄ﬁÊœ «·„·«ﬂ ··⁄ﬁ«—   "
...
Public Sub FillGridWithData()
    ...
    My_SQL = "SELECT   dbo.Notes.VAT ,   "
    
    
    
        My_SQL = My_SQL & "                                 Note_Value2 ="
    My_SQL = My_SQL & "                                     CASE"
        My_SQL = My_SQL & "                                     WHEN dbo.notes.Note_Value2 Is Null Or dbo.notes.Note_Value2 = 0"
    My_SQL = My_SQL & "                                             THEN dbo.notes.Note_Value"
    My_SQL = My_SQL & "                                         WHEN dbo.notes.Note_Value2 < dbo.notes.Note_Value"
    My_SQL = My_SQL & "                                             THEN dbo.notes.Note_Value"
    My_SQL = My_SQL & "                                         Else dbo.notes.Note_Value2"
        My_SQL = My_SQL & "                                 End"

    My_SQL = My_SQL & "                   ,dbo.notes.NoteID , dbo.notes.NoteDate, dbo.notes.renterName, dbo.notes.NoteType, dbo.notes.NoteSerial1, dbo.notes.ContNo, dbo.notes.ContractNo, "
...
If Indx = 2 Then
    ...
    My_SQL = My_SQL & "  FROM         dbo.Notes LEFT OUTER JOIN"
    My_SQL = My_SQL & "                   dbo.TblCustemers ON dbo.Notes.CusID = dbo.TblCustemers.CusID"
   My_SQL = My_SQL & "  WHERE    NoteType=5 and cashingtype<=8  AND akarid=  " & val(TxtNotID.text)
 My_SQL = My_SQL & " order by dbo.Notes.NoteDate"
