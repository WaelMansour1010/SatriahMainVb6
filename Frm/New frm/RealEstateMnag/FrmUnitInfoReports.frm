...
Public Sub GetData()
    ...
    If RdUnitTrans.value = True Then
        STRSQL = " SELECT  TblAqarDetai.Mremarks,  TblAqarDetai.ready , TblAqarDetai.readyDAte,    dbo.TblUnitNoInformation.ID, dbo.TblUnitNoInformation.UnitNo, dbo.TblAqarDetai.unitno AS unitnoName, dbo.TblAqar.Aqarid, dbo.TblAqar.aqarname, "
    ...
    If RdUnitStatus.value = True Then
        STRSQL = " SELECT    TblAqarDetai.Mremarks, TblAqarDetai.ready , TblAqarDetai.readyDAte,  dbo.TblAqarDetai.unitno AS unitnoName, dbo.TblAqar.Aqarid, dbo.TblAqar.aqarname, dbo.TblAqarDetai.unittype, dbo.TblAkarUnit.name, dbo.TblAkarUnit.namee, "
