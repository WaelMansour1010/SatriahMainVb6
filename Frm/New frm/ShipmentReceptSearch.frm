...
Begin VB.Form ShipmentReceptSearch 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   7200
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   11880
   Icon            =   "ShipmentReceptSearch.frx":0000
   LinkTopic       =   "Form4"
   MaxButton       =   0   'False
   RightToLeft     =   -1  'True
   ScaleHeight     =   7200
   ...
   Begin ALLButtonS.ALLButton ALLButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "ShipmentReceptSearch.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
      ...
      Begin MSComctlLib.ImageList GrdImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ShipmentReceptSearch.frx":0028
               Key             =   "CompanyName"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ShipmentReceptSearch.frx":03C2
               Key             =   "Ser"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ShipmentReceptSearch.frx":075C
               Key             =   "Vac_Name"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ShipmentReceptSearch.frx":0AF6
               Key             =   "ShareCount"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ShipmentReceptSearch.frx":0E90
               Key             =   "Dis_Count"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ShipmentReceptSearch.frx":122A
               Key             =   "Bouns"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ShipmentReceptSearch.frx":15C4
               Key             =   "SharesValue"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ShipmentReceptSearch.frx":1B5E
               Key             =   "BuyValue"
            EndProperty
         EndProperty
      End
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"ShipmentReceptSearch.frx":1EF8
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin ImpulseButton.ISButton CmdItemSearch 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "ShipmentReceptSearch.frx":20FC
      ColorButton     =   14871017
      DrawFocusRectangle=   0   'False
   End
   ...
   End
End
Attribute VB_Name = "ShipmentReceptSearch"
...
Private Sub Fg_Click()
    On Error GoTo ErrTrap
        ...
        FrmShipmentRegestration1.Retrive val(Fg.TextMatrix(Fg.Row, 1))
...
Private Sub Retrive()
    ...
    If Not (rs.EOF Or rs.BOF) Then
        ...
        For Num = 1 To rs.RecordCount
            ...
            With Fg
                .TextMatrix(Num, .ColIndex("Transaction_ID1")) = IIf(IsNull(rs("Transaction_Serial").value), "", rs("Transaction_Serial").value)
...
StrSQL = StrSQL & " FROM         dbo.TblEmployee RIGHT OUTER JOIN"
 StrSQL = StrSQL & "                     dbo.Transactions LEFT OUTER JOIN"
  StrSQL = StrSQL & "                    dbo.TblCustemers ON dbo.Transactions.CusID = dbo.TblCustemers.CusID ON dbo.TblEmployee.Emp_ID = dbo.Transactions.Emp_ID"
    ...
    StrSQL = StrSQL + " WHERE     (dbo.Transactions.Transaction_Type = 56)"
...
Private Sub ChangeLang()
    Me.Caption = "Search For  Receipt shipping"
...
lbl(44).Caption = "This Screen Looks for  Receipt shipping"
