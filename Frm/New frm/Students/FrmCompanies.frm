...
Begin VB.Form FrmCompanies 
   ...
   Begin VB.Frame Frame4 
      ...
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCompanies.frx":1B57
         Height          =   555
         Index           =   0
         Left            =   7200
         Picture         =   "FrmCompanies.frx":8E89
         Style           =   1  'Graphical
         TabIndex        =   172
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCompanies.frx":9430
         Height          =   555
         Index           =   6
         Left            =   5760
         Picture         =   "FrmCompanies.frx":10762
         Style           =   1  'Graphical
         TabIndex        =   171
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCompanies.frx":10C03
         Height          =   555
         Index           =   7
         Left            =   4320
         Picture         =   "FrmCompanies.frx":17F35
         Style           =   1  'Graphical
         TabIndex        =   170
         Top             =   120
         Width           =   735
      ...
      Begin VB.CommandButton menue 
         ...
         Index           =   8
         Left            =   2160
         Picture         =   "FrmCompanies.frx":187C5
         Style           =   1  'Graphical
         TabIndex        =   169
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCompanies.frx":18CAA
         Height          =   555
         Index           =   9
         Left            =   720
         Picture         =   "FrmCompanies.frx":1FFDC
         Style           =   1  'Graphical
         TabIndex        =   168
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCompanies.frx":204FC
         Height          =   555
         Index           =   10
         Left            =   6480
         Picture         =   "FrmCompanies.frx":20AE3
         Style           =   1  'Graphical
         TabIndex        =   167
         Top             =   120
         Width           =   735
      End
      Begin VB.CommandButton menue 
         DownPicture     =   "FrmCompanies.frx":210CA
         Height          =   555
         Index           =   11
         Left            =   0
         Picture         =   "FrmCompanies.frx":283FC
         Style           =   1  'Graphical
         TabIndex        =   166
         Top             =   120
         Width           =   735
   ...
   Begin C1SizerLibCtl.C1Elastic EleHeader 
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCompanies.frx":28F90
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCompanies.frx":2932A
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCompanies.frx":296C4
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCompanies.frx":29A5E
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin VB.Image Img 
         Height          =   480
         Left            =   7080
         Picture         =   "FrmCompanies.frx":29DF8
         Top             =   0
         Visible         =   0   'False
         Width           =   480
      End
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         Begin VB.Frame Fra 
            ...
            Begin VB.ComboBox CboSex 
               Height          =   315
               ItemData        =   "FrmCompanies.frx":2AAC2
               Left            =   3000
               List            =   "FrmCompanies.frx":2AAC4
               RightToLeft     =   -1  'True
               Style           =   2  'Dropdown List
               TabIndex        =   98
               Top             =   600
         ...
         Begin C1SizerLibCtl.C1Elastic Ele 
            ...
            Begin VB.Frame Fra 
               ...
               Begin VB.ComboBox dcDepitIntervalID 
                  Height          =   315
                  ItemData        =   "FrmCompanies.frx":2AAC6
                  Left            =   120
                  List            =   "FrmCompanies.frx":2AAC8
                  RightToLeft     =   -1  'True
                  TabIndex        =   71
                  Top             =   240
                  Width           =   975
               ...
               Begin VB.ComboBox dcCreditIntervalID 
                  Height          =   315
                  ItemData        =   "FrmCompanies.frx":2AACA
                  Left            =   120
                  List            =   "FrmCompanies.frx":2AACC
                  RightToLeft     =   -1  'True
                  TabIndex        =   70
                  Top             =   600
                  Width           =   975
 ...
 If Me.calledFromForm = False Then Exit Sub
    Select Case Me.DealingForm
     ...
     StrSQL = "SELECT * From TblCustemers where Type=55"
       'salah  fill_combo FrmMainPriceList.DBCboSupplierName, StrSQL
       'salah    FrmMainPriceList.DBCboSupplierName.BoundText = val(XPTxtCusID.text)

            '⁄—÷ «·√”⁄«—
        Case ShowPrice
        'salah fill_combo FrmShowPrice.DBCboClientName, StrSQL
        'salah  FrmShowPrice.DBCboClientName.BoundText = val(XPTxtCusID.text)
    End Select
  ...
  lbl(8).Caption = 0
        ...
        Case 5
            ...
            If DoPremis(Do_Search, Me.Name, True) = False Then
                Exit Sub
            End If
         FrmCustemerSearch.SearchType = 18
...
ShowAttachments DCPreFix.Text & txtid.Text, "3108201622"
...
Me.DcbDigCustomer.AddItem "7"
  ...
  End If
    ...
    LogTextA = "   «·œŒÊ· «·Ì ‘«‘… " & " »Ì«‰«  «·‘—ﬂ«   "
    LogTexte = " Open Window " & "  Companies Data "
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    On Error GoTo ErrTrap
    LogTextA = "  «·Œ—ÊÃ „‰  " & " »Ì«‰«  «·‘—ﬂ«   "
    LogTexte = " Exit   Window " & "  Companies Data "
...
Function CuurentLogdata(Optional Currentmode As String)
    ...
    LogTexte = "  Õ›Ÿ ‘«‘… " & " Companies Data  " _
       ...
       LogTexte = LogTexte & CHR(13) & "Companies ?  "
    ...
    If Me.TxtModFlg.Text = "N" Then
        If Len(txtCustGID.Text) >= 10 Then
            If CheckCustomerID(txtCustGID, Custcode, CustName) = True Then
                If SystemOptions.UserInterface = ArabicInterface Then
                    Msg = "Â–Â «·‘—ﬂ… „”Ã· „‰ ﬁ»·   "
                    Msg = Msg & CHR(13) & " ﬂÊœ «·‘—ﬂ…: " & Custcode
                    Msg = Msg & CHR(13) & " «”„ «·‘—ﬂ… : " & CustName
                Else
                    Msg = "This Company Already Exist"
                    Msg = Msg & CHR(13) & " Company Code  " & Custcode
                    Msg = Msg & CHR(13) & "Company Name  " & CustName
    ...
    Select Case Me.TxtModFlg.Text
        ...
        Case "N"
            ...
            If SystemOptions.UserInterface = ArabicInterface Then
                Me.Caption = "»Ì«‰«  «·‘—ﬂ« ( ÃœÌœ )"
            Else
                Me.Caption = "Companies Data(Enter New Customer)"
            End If
        ...
        Case "E"
            ...
            If SystemOptions.UserInterface = ArabicInterface Then
                Me.Caption = "»Ì«‰«  «·‘—ﬂ« (  ⁄œÌ· )"
            Else
                Me.Caption = "Companies Data(Edit Current Customer)"
            End If
...
Public Sub Retrive(Optional Lngid As Long = 0)
    ...
    '''///////////////////
    TxtMail2.Text = IIf(IsNull(rs("Mail2").value), "", rs("Mail2").value)
...
End If
        ...
        Select Case TxtModFlg.Text
            ...
            Case "N"
                ...
                StrSQL = "Select * From TblCustemers where Type=55 And CusName='" & Trim(XPTxtCusName.Text) & "'"
                ...
                If RsTemp.RecordCount > 0 Then
                 ...
                 Msg = "  ÊÃœ ‘—ﬂ… „”Ã·… „”»ﬁ« »Â–« «·«”„" & CHR(13)
                    ...
                    Else
                     Msg = "this Company Already Exist" & CHR(13)
            ...
            RsTemp.Close
            Set RsTemp = Nothing
          StrSQL = "Select * From TblCustemers where   Type=55 And fullcode='" & Trim(DCPreFix.Text & txtid.Text) & "'"
                RsTemp.Open StrSQL, Cn, adOpenStatic, adLockOptimistic, adCmdText

                If RsTemp.RecordCount > 0 Then
                      If SystemOptions.UserInterface = ArabicInterface Then

                 Msg = "  ÊÃœ ‘—ﬂ… „”Ã·… „”»ﬁ« »Â–« «·ﬂÊœ " & CHR(13)
                    Msg = Msg + "»—Ã«¡ «· √ﬂœ „‰ «·»Ì«‰«  «·„œŒ·… " & CHR(13)
                                        Msg = Msg + "√Ê  €ÌÌ— √Ê  „ÌÌ“ «·»Ì«‰«  «·„œŒ·…"
                    Else
                     Msg = "this Company Already Exist" & CHR(13)
     ...
     RsTemp.Close
       ...
       '     End If
        ...
        rs("Mail2").value = Trim(TxtMail2.Text)
...
'
       ...
       rs("Cus_Phone").value = IIf(XPTxtPhone.Text = "", "", Trim(XPTxtPhone.Text))
        rs("PassWord").value = IIf(txtPassword.Text = "", "", Trim(txtPassword.Text))
...
End If
        ...
        Select Case Me.TxtModFlg.Text
            ...
            Case "N"
                ...
                If SystemOptions.UserInterface = EnglishInterface Then
                    Msg = "Done do you want new Company"
                End If
...
MySQL = MySQL & " Where (dbo.TblCustemers.CusID =" & val(XPTxtCusID.Text) & ")"
 ...
 If SystemOptions.UserInterface = ArabicInterface Then
          StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "CartCompany..rpt"
     Else
        StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "CartCompany..rpt"
       End If
    If Dir(StrFileName) = "" Then
...
lbl(62).Caption = "Stars No"
    ...
    XPLbl(1).Caption = "Comp. Code"
    XPLbl(0).Caption = "Arb. Name"
    ...
    lbl(10).Caption = "Company Sale Type"
...
'**************************************
    ...
    Me.Cmd(9).Caption = "Company Balance Report"
