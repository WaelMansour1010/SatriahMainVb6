      ...
      Begin C1SizerLibCtl.C1Tab TabMain 
         ...
         Begin C1SizerLibCtl.C1Elastic ELe 
            ...
            Begin ImpulseButton.ISButton Cmd_DeleteRow 
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               ButtonImage     =   "FrmStudentCalling.frx":2CFE0
               ColorButton     =   14871017
               DrawFocusRectangle=   0   'False
            End
            Begin ImpulseButton.ISButton Cmd_DeleteAll 
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               ButtonImage     =   "FrmStudentCalling.frx":2D57A
               ColorButton     =   14871017
               DrawFocusRectangle=   0   'False
            End
         ...
         Begin C1SizerLibCtl.C1Elastic ELe 
            ...
            Begin VSFlex8UCtl.VSFlexGrid FgItems 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"FrmStudentCalling.frx":2DB14
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
...
With Fg4
 '   If val(.TextMatrix(Row, .ColIndex("EmpID"))) = 0 Then
   ...
   Select Case .ColKey(Col)
    Case "ItemID", "ItemName"
             StrAccountCode = .ComboData
                ...
                End If
                s = "Select FullCode,ItemName,tblItemsUnits.UnitSalesPrice From TblItems inner join tblItemsUnits On  TblItems.ItemId = tblItemsUnits.ItemID and TblItemsUnits.DefaultUnit = 1"
                s = s & " WHERE TblItems.ItemId = " & val(StrAccountCode)
                Set rsDummy = New ADODB.Recordset
                rsDummy.Open s, Cn, adOpenStatic, adLockReadOnly
                If Not rsDummy.EOF Then
                    .TextMatrix(Row, .ColIndex("Code")) = rsDummy!Fullcode & ""
                    .TextMatrix(Row, .ColIndex("Price")) = rsDummy!UnitSalesPrice & ""
                    '.TextMatrix(Row, .ColIndex("PercentV")) = rsDummy!PercentV & ""
                End If
  ...
  Case "Code"
        ...
        s = "Select ItemId,ItemName, tblItemsUnits.UnitSalesPrice From TblItems inner join tblItemsUnits On  TblItems.ItemId = tblItemsUnits.ItemID and TblItemsUnits.DefaultUnit = 1"""
        s = s & " WHERE "
...
s = " SELECT TblStudCalling2.*,TblEmployee.Emp_Code,TblItems.FullCode Code,TblItemsUnits.UnitSalesPrice as Price,"
s = s & "       TblEmployee.Emp_Name        EmpName,"
s = s & "       TblItems.ItemName,"
s = s & "       tblReservationType.Name  AS ReservationTypeName"
s = s & " From TblStudCalling2"
...
s = s & "       INNER JOIN TblItems"
s = s & "            ON  TblItems.ItemID = TblStudCalling2.ItemID"
s = s & "       left outer JOIN TblItemsUnits"
s = s & "            ON  TblItemsUnits.ItemID = TblStudCalling2.ItemID"
...
Private Sub AddNewRecored()
  ...
  On Error GoTo ErrTrap
   ...
   My_SQL = "TblStudCalling"
    ...
    If rs.RecordCount > 0 Then
        TxtSerial1.Text = CStr(new_id("TblStudCalling", "ID", "", True))
    Else
        TxtSerial1.Text = 1
    End If
   rs.Close
