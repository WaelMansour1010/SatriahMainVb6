...
Private Sub CmdEmploy_Click()
 ...
 Dim i As Long
    ...
    If Not SystemOptions.EmpAccountByDep Then
    ...
    Else
        ...
        s = "Select a7,a29,a30,a74,a65,a93 from TblEmpDepartments"
        Account_Code_dynamic = get_account_code_branch(7, my_branch)
        Account_Code_dynamic1 = get_account_code_branch(29, my_branch)
        Account_Code_dynamic2 = get_account_code_branch(30, my_branch)
        Account_Code_dynamic3 = get_account_code_branch(74, my_branch)
    ...
    For i = 1 To rs.RecordCount
        ...
        If SystemOptions.EmpAccountByDep Then
            s = "Select a7,a29,a30,a74,a65,a93 from TblEmpDepartments where DeparmentID= " & val(rs!DepartmentID & "")
            Set rsDummy = New ADODB.Recordset
            rsDummy.Open s, Cn, adOpenStatic, adLockReadOnly
            If Not rsDummy.EOF Then
                Account_Code_dynamic = rsDummy!a7 & ""
                Account_Code_dynamic1 = rsDummy!a29 & ""
                Account_Code_dynamic2 = rsDummy!a30 & ""
                Account_Code_dynamic3 = rsDummy!a74 & ""
                Account_Code_dynamic4 = rsDummy!a65 & ""
                Account_Code_dynamic5 = rsDummy!a93 & ""
                
                
                ticketAccount = Account_Code_dynamic5
                advPaymentAccount = Account_Code_dynamic4
                rsDummy.Close
            Else
                Account_Code_dynamic = get_account_code_branch(7, my_branch)
                Account_Code_dynamic1 = get_account_code_branch(29, my_branch)
...
, NoteDate As Date)
   ...
   Mmsg = "··›« Ê—… —ﬁ„" & "  " & ContractNo
   Mmsg = Mmsg & " «—ÌŒ «·«” Õﬁ«ﬁ" & "  " & dueDate
            If Notevalue > 0 And StrAccountCodeDebt <> "" Then
                                    
                           '  StrAccountCodeDebt = get_account_code_branch(2, my_branch)
                            If ModAccounts.AddNewDev(LngDevID, line_no, StrAccountCodeDebt, Notevalue, 0, Msg & "    Õ”«»  «·⁄„Ì·  " & Mmsg, val(notes_id), , , , ContractDate, user_id, , , , , , , , , setfoxy_Line, , , , , , , , , val(my_branch), , , , , , , , , , , , , , , , , , , , , , , , , 1) = False Then
                                GoTo ErrTrap
                            End If
  
                          StrAccountCodeCridet = get_account_code_branch(59, my_branch)
                            line_no = line_no + 1
                                If ModAccounts.AddNewDev(LngDevID, line_no, StrAccountCodeCridet, Notevalue, 1, Msg & "    Õ”«»    Ê”Ìÿ «›  «ÕÌ Õ”«»«   " & Mmsg, val(notes_id), , , , ContractDate, user_id, , , , , , , , , setfoxy_Line, , , , , , , , , val(my_branch), , , , , , , , , , , , , , , , , , , , , , , , , 1) = False Then
                                GoTo ErrTrap
                            End If
                             line_no = line_no + 1
            End If
...
''/////////////////////
   ...
   ContractDate = IIf(IsNull(rs("ContractDate").value), Date, rs("ContractDate").value)
   ContractNo = IIf(IsNull(rs("ContractNo").value), "", rs("ContractNo").value)
   Mmsg = "·„— Ã⁄ «·›« Ê—…  —ﬁ„" & "  " & ContractNo

            If Notevalue > 0 And StrAccountCodeDebt <> "" Then
                                    
                           StrAccountCodeCridet = get_account_code_branch(59, my_branch)
                            If ModAccounts.AddNewDev(LngDevID, line_no, StrAccountCodeCridet, Notevalue, 0, Msg & "    Õ”«»  Ê”Ìÿ «›  «ÕÌ  " & Mmsg, val(notes_id), , , , ContractDate, user_id, , , , , , , , , setfoxy_Line, , , , , , , , , val(my_branch), , , , , , , , , , , , , , , , , , , , , , , , , 1) = False Then
                                GoTo ErrTrap
                            End If
  
                          
                            line_no = line_no + 1
                                If ModAccounts.AddNewDev(LngDevID, line_no, StrAccountCodeDebt, Notevalue, 1, Msg & "    Õ”«»    «·⁄„Ì·  " & Mmsg, val(notes_id), , , , ContractDate, user_id, , , , , , , , , setfoxy_Line, , , , , , , , , val(my_branch), , , , , , , , , , , , , , , , , , , , , , , , , 1) = False Then
                                GoTo ErrTrap
                            End If
                             line_no = line_no + 1
            End If
  ...
  Dim Acount3 As String
        ...
        ParnetAccount = IIf(IsNull(rs("parent_account").value), "", rs("parent_account").value)
           ...
           Current_account = IIf(IsNull(rs("Account_VAT").value), "", rs("Account_VAT").value)
                 If ModAccounts.check_account_exist(Account_Code_dynamic) = True Then
                     If Current_account = "" Then 'new
                      rs("Account_VAT").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "-ﬁÌ„… „÷«›…", True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "-VAT", , , , , , , , , , 1, 1, 1, 0, 0)        '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("Account_VAT").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "-ﬁÌ„… „÷«›…", True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "-VAT", , , , , , , , , , 1, 1, 1, 0, 0) '
                             Else

                               ModAccounts.EditAccount rs("Account_VAT").value, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "-ﬁÌ„… „÷«›…", IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "-VAT", , , , , , , , , 1, 1, 1, 0, 0, , , , True
                             End If
...
LngDevID = new_id("DOUBLE_ENTREY_VOUCHERS1", "Double_Entry_Vouchers_ID", "", True)
      ...
      '     Rs("BankID").value = BankID
            ...
            If index = 0 Then
                des = "»‰«¡ ⁄·Ï —’Ìœ «›  «ÕÌ ··⁄„Ì· " & Customer
            Else
                des = "»‰«¡ ⁄·Ï —’Ìœ «›  «ÕÌ ··„Ê—œ " & Customer
            End If
...
Dim Account_Code_dynamic1 As String
    Set rs = New ADODB.Recordset
      sql = " update DOUBLE_ENTREY_VOUCHERS"
Set value = QryTransactionsTotal_1.TransNet
...
sql = sql & "            dbo.Transactions ON dbo.Notes.NoteID = dbo.Transactions.NoteId INNER JOIN"
sql = sql & "                                     dbo.QryTransactionsTotal() AS QryTransactionsTotal_1 ON dbo.Transactions.Transaction_ID = QryTransactionsTotal_1.Transaction_ID"
sql = sql & "            WHERE        (dbo.Notes.NoteType = 160 OR"
sql = sql & "                                     dbo.Notes.NoteType = 180 OR"
sql = sql & "                                     dbo.Notes.NoteType = 190 OR"
sql = sql & "                                     dbo.Notes.NoteType = 210 OR"
sql = sql & "                                     dbo.Notes.NoteType = 240 OR"
sql = sql & "                                     dbo.Notes.NoteType = 250 OR"
sql = sql & "                                     dbo.Notes.NoteType = 330 OR"
sql = sql & "                                     dbo.Notes.NoteType = 340 OR"
sql = sql & "                                     dbo.Notes.NoteType = 360)"
Cn.Execute sql
...
Private Sub Command44_Click()
    ...
    s = s & "       Emp_Name, "
    s = s & "       Emp_Phone, "
    s = s & "       Sex,MangerId,FullCode,PassWord,Emp_Namee   "
    s = s & " FROM TblEmployee; "
    s = s & " "
    ...
    Do While Not rs.EOF
        ...
        End If
       jsonStr = jsonStr & "{"
        jsonStr = jsonStr & " ""Emp_ID"" : " & rs!Emp_id & ","
        jsonStr = jsonStr & " ""Emp_Code"" : """ & rs!Emp_Code & ""","
        jsonStr = jsonStr & " ""Emp_Name"" : """ & rs!emp_Name & ""","
        jsonStr = jsonStr & " ""EmpNamee"" : """ & rs!Emp_Namee & ""","
        jsonStr = jsonStr & " ""Emp_Phone"" : """ & rs!Emp_Phone & ""","
        jsonStr = jsonStr & " ""Sex"" : " & val(rs!Sex & "") & ","
        jsonStr = jsonStr & " ""Password"" : """ & rs!Password & ""","
        jsonStr = jsonStr & " ""FullCode"" : """ & rs!Fullcode & ""","
        jsonStr = jsonStr & " ""MangerId"" : " & val(rs!mangerid & "") & " "
        jsonStr = jsonStr & "}"
        rs.MoveNext
    Loop
    jsonStr = jsonStr & " ]"
    ...
    Req.setTimeouts 10000000, 10000000, 10000000, 10000000
    Req.Open "post", APIURL & "/api/empdata/uploademps", async:=False
    Dim opt
    opt = Req.Option(WinHttpRequestOption_SslErrorIgnoreFlags)
    opt = Options Or SslErrorFlag_Ignore_All
    Req.Option(WinHttpRequestOption_SslErrorIgnoreFlags) = opt
    ...
    Req.send jsonStr
    MsgBox "Status:[" & Req.Status & "] " + Req.responseText
End Sub
...
Private Sub Command45_Click()
    ...
    Dim s      As String
    s = ""
    s = s & "SELECT Top 35 ItemID, "
    s = s & "       ItemCode, "
    s = s & "       ItemName, "
    s = s & "       ItemNamee "
    s = s & "FROM TblItems where len (ItemNamee) <= 30;"
    'where len (ItemNamee) <= 70;"
    ...
    Do While Not rs.EOF
        ...
        End If
        jsonStr = jsonStr & "{"
        jsonStr = jsonStr & " ""itemId"" : " & val(rs!ItemID & "") & ","
        jsonStr = jsonStr & " ""itemCode"" : """ & rs!itemcode & ""","
        jsonStr = jsonStr & " ""itemName"" : """ & rs!ItemName & ""","
        jsonStr = jsonStr & " ""itemNamee"" : """ & rs!ItemNamee & """ "
        jsonStr = jsonStr & "}"
        rs.MoveNext
    Loop
    jsonStr = jsonStr & " ]"
    ...
    Dim Req As New WinHttp.WinHttpRequest
    Req.setTimeouts 10000000, 10000000, 10000000, 10000000
    Req.Open "post", APIURL & "/api/empdata/uploaditems", async:=False
    Dim opt
    opt = Req.Option(WinHttpRequestOption_SslErrorIgnoreFlags)
    opt = Options Or SslErrorFlag_Ignore_All
    Req.Option(WinHttpRequestOption_SslErrorIgnoreFlags) = opt
...
If Check3.value = vbChecked Then
                     For i = 1 To rs.RecordCount
                       ...
                       If ModAccounts.DeleteAccount(IIf(IsNull(rs("Account_Code").value), "", rs("Account_Code").value)) = True Then
                        ...
                        Flagdel = False
                        If ModAccounts.DeleteAccount(IIf(IsNull(rs("Account_CodeAss1").value), "", rs("Account_CodeAss1").value)) = True Then
                            rs("Account_CodeAss1").value = ""
                        Else
                            Flagdel = True
                        End If
                                               
                        Flagdel = False
                        If ModAccounts.DeleteAccount(IIf(IsNull(rs("Account_CodeAss2").value), "", rs("Account_CodeAss2").value)) = True Then
                            rs("Account_CodeAss2").value = ""
                        Else
                            Flagdel = True
                        End If
                        
                        Flagdel = False
                        If ModAccounts.DeleteAccount(IIf(IsNull(rs("Account_CodeHi1").value), "", rs("Account_CodeHi1").value)) = True Then
                            rs("Account_CodeHi1").value = ""
                        Else
                            Flagdel = True
                        End If
                        ...
                        Flagdel = False
                        If ModAccounts.DeleteAccount(IIf(IsNull(rs("Account_CodeHi2").value), "", rs("Account_CodeHi2").value)) = True Then
                            rs("Account_CodeHi2").value = ""
                        Else
                            Flagdel = True
                        End If
                        ...
                        Flagdel = False
                       ' If ModAccounts.DeleteAccount(IIf(IsNull(rs("ParentAccountCurrentAss").value), "", rs("ParentAccountCurrentAss").value)) = True Then
                            rs("ParentAccountCurrentAss").value = ""
                       ' Else
                       '     Flagdel = True
                       ' End If
                                                                                                       
                                       Flagdel = False
                       ' If ModAccounts.DeleteAccount(IIf(IsNull(rs("ParentAccountCurrentHih").value), "", rs("ParentAccountCurrentHih").value)) = True Then
                            rs("ParentAccountCurrentHih").value = ""
                       ' Else
                       '     Flagdel = True
                       ' End If
  ...
  Dim Acount3 As String
    ...
    Dim ParentAccountCurrentAss As String
           ...
           Dim ParnetAccount2 As String
           Dim ParnetAccount3 As String
           ParnetAccount2 = CStr(ParnetAccount)
           ...
           Else
           Account_Code_dynamic = Account_Code_dynamic1
           ParnetAccount = Account_Code_dynamic
           End If
           ParnetAccount2 = ParnetAccount
           If SystemOptions.CustCreat4Acc = True Then
                            ...
                            mSerial = GET_ACCOUNT_name_by_Code(CStr(ParentAccount), "T") & mTxt & Trim(rs("Code") & "")
                            rs("ParentAccountCurrentAss").value = ParentAccount
                            
                               If Not IsNull(rs("Account_Code").value) And Not (rs("Account_Code").value) = "" Then
                                    ModAccounts.EditAccount rs("Account_Code").value, rs("CusName") & " " & " Ã«—Ì «·⁄„· ", Trim(rs("CusNamee")) & "  payable ", , , , , CStr(mSerial), , , , , , , , , , , , True
                                Else
                                    rs("Account_Code").value = ModAccounts.AddNewAccount(CStr(ParentAccount), Trim$(rs("CusName") & " ") & " Ã«—Ì «·⁄„· ", True, False, Trim(rs("CusNamee")) & " payable  ", , , , , , CStr(mSerial))
                            ...
                            If Not IsNull(rs("Account_CodeAss2").value) And Not (rs("Account_CodeAss2").value) = "" Then
                                ModAccounts.EditAccount rs("Account_CodeAss2").value, rs("CusName") & " " & " ÷„«‰ «⁄„«· ", Trim(rs("CusNamee")) & " retention  ", , , , , CStr(mSerial), , , , , , , , , , , , True
                            Else
                                rs("Account_CodeAss2").value = ModAccounts.AddNewAccount(CStr(ParentAccount), Trim$(rs("CusName") & " ") & " ÷„«‰ «⁄„«· ", True, False, Trim(rs("CusNamee")) & "  retention  ", , , , , , CStr(mSerial))
                            ...
                            rs("ParentAccountCurrentHih").value = ParentAccount
                                ...
                                If Not IsNull(rs("Account_CodeHi1").value) And Not (rs("Account_CodeHi1").value) = "" Then
                                    ModAccounts.EditAccount rs("Account_CodeHi1").value, rs("CusName") & " " & " œ›⁄«  „ﬁœ„…  ", Trim(rs("CusNamee")) & " Advance payment  ", , , , , CStr(mSerial), , , , , , , , , , , , True
                                Else
                                    rs("Account_CodeHi1").value = ModAccounts.AddNewAccount(CStr(ParentAccount), Trim$(rs("CusName") & " ") & " œ›⁄«  „ﬁœ„… ", True, False, Trim(rs("CusNamee")) & "  Advance payment ", , , , , , CStr(mSerial))
                            ...
                            rs("ParentAccountCurrentHih").value = ParentAccount
                                ...
                                If Not IsNull(rs("Account_CodeHi2").value) And Not (rs("Account_CodeHi2").value) = "" Then
                                    ModAccounts.EditAccount rs("Account_CodeHi2").value, rs("CusName") & " " & "„Ê«œ ", Trim(rs("CusNamee")) & " Materials ", , , , , CStr(mSerial), , , , , , , , , , , , True
                                Else
                                    rs("Account_CodeHi2").value = ModAccounts.AddNewAccount(CStr(ParentAccount), Trim$(rs("CusName") & " ") & " „Ê«œ ", True, False, Trim(rs("CusNamee")) & " Materials   ", , , , , , CStr(mSerial))
        
                                End If
                            Else
                              If Not IsNull(rs("Account_Code").value) Then
                                ModAccounts.EditAccount rs("Account_Code").value, rs("CusName") & " ", Trim(rs!CusNamee & ""), , , , , , , , , , , , , , , , , True
                                End If
                            End If
...
'
'                               ParnetAccount2 = get_account_code_branch(217, my_branch)
'                              If Not IsNull(rs("ParentAccountCurrentAss").value) And Not (rs("ParentAccountCurrentAss").value) = "" Then
'                                  ModAccounts.EditAccount rs("ParentAccountCurrentAss").value, rs("CusName") & " ", Trim(rs("CusNamee")), , , , , , , , , , , , , , , , , False
'                              Else
'                                  ParentAccountCurrentAss = ModAccounts.AddNewAccount(ParnetAccount2, rs("CusName") & " ", False, False, rs("CusNamee"))
'                                  rs("ParentAccountCurrentAss").value = ParentAccountCurrentAss
'                              End If
'
'
'                         '   ParentAccount2 = get_account_code_branch(216, my_branch)
'                            ParnetAccount3 = get_account_code_branch(218, my_branch)
'                              If Not IsNull(rs("ParentAccountCurrentHih").value) And Not (rs("ParentAccountCurrentHih").value) = "" Then
'                                  ModAccounts.EditAccount rs("ParentAccountCurrentHih").value, rs("CusName") & "   ", Trim(rs("CusNamee")), , , , , , , , , , , , , , , , , False
'                              Else
'                                  ParentAccountCurrentHih = ParnetAccount3 ' ModAccounts.AddNewAccount(ParnetAccount3, rs("CusName") & "  ", False, False, rs("CusNamee"))
'                                  rs("ParentAccountCurrentHih").value = ParentAccountCurrentHih
'                              End If
'
'                                If Not IsNull(rs("Account_Code").value) And Not (rs("Account_Code").value) = "" Then
'                                    ModAccounts.EditAccount rs("Account_Code").value, rs("CusName") & "Ã«—Ì «·⁄„·  ", rs("CusNamee") & "  payable ", , , , , , , , , , , , , , , , , True
'                                Else
'                                    rs("Account_Code").value = ModAccounts.AddNewAccount(ParentAccountCurrentAss, Trim$(rs("CusName")) & " Ã«—Ì «·⁄„· ", True, False, rs("CusNamee") & " payable  ")
'
'                                End If
'
'
'                                If Not IsNull(rs("Account_CodeAss2").value) And Not (rs("Account_CodeAss2").value) = "" Then
'                                    ModAccounts.EditAccount rs("Account_CodeAss2").value, rs("CusName") & " ÷„«‰ «⁄„«· ", rs("CusNamee") & " retention ", , , , , , , , , , , , , , , , , True
'                                Else
'                                    rs("Account_CodeAss2").value = ModAccounts.AddNewAccount(ParentAccountCurrentAss, Trim$(rs("CusName")) & " ÷„«‰ «⁄„«· ", True, False, rs("CusNamee") & "  retention  ")
'
'                                End If
'
'
'
'                                If Not IsNull(rs("Account_CodeHi1").value) And Not (rs("Account_CodeHi1").value) = "" Then
'                                    ModAccounts.EditAccount rs("Account_CodeHi1").value, rs("CusName") & " œ›⁄«  „ﬁœ„… ", rs("CusNamee") & " Advance payment ", , , , , , , , , , , , , , , , , True
'                                Else
'                                    rs("Account_CodeHi1").value = ModAccounts.AddNewAccount(ParentAccountCurrentHih, Trim$(rs("CusName")) & " œ›⁄«  „ﬁœ„… ", True, False, rs("CusNamee") & " Advance payment   ")
'
'                                End If
'
'                                If Not IsNull(rs("Account_CodeHi2").value) And Not (rs("Account_CodeHi2").value) = "" Then
'                                    ModAccounts.EditAccount rs("Account_CodeHi2").value, rs("CusName") & "„Ê«œ   ", rs("CusNamee") & " Materials  ", , , , , , , , , , , , , , , , , True
'                                Else
'                                    rs("Account_CodeHi2").value = ModAccounts.AddNewAccount(ParentAccountCurrentHih, Trim$(rs("CusName")) & " „Ê«œ   ", True, False, rs("CusNamee") & " Materials  ")
'
'                                End If
                  '      End If
           ...
           Current_account = IIf(IsNull(rs("Account_Code").value), "", rs("Account_Code").value)
                 If ModAccounts.check_account_exist(Account_Code_dynamic) = True Then
                     If Current_account = "" Then 'new
                        If SystemOptions.CustCreat4Acc = True Then
                      rs("Account_Code").value = ModAccounts.AddNewAccount(ParentAccountCurrentAss, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")), True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")), , , , , , , , , , 1, 1, 1, 0, 0)            '
                      Else
                        rs("Account_Code").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")), True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")), , , , , , , , , , 1, 1, 1, 0, 0)            '
                      End If
                     Else 'check
                      ...
                      If SystemOptions.CustCreat4Acc = False Then
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("Account_Code").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")), True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")), , , , , , , , , , 1, 1, 1, 0, 0)     '
                             Else
           ...
           If SystemOptions.CustomerhavethreeAccounts = True Then
            Current_account = IIf(IsNull(rs("Account_Code1").value), "", rs("Account_Code1").value)
                   If ModAccounts.check_account_exist(Account_Code_dynamic) = True Then
                     If Current_account = "" Then 'new
                      rs("Account_Code1").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "   ‘Ìﬂ«    Õ  «· Õ’Ì· ", True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "  Under Collection Cheque  ", , , , , , , , , , 1, 1, 1, 0, 0)           '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("Account_Code1").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "   ‘Ìﬂ«    Õ  «· Õ’Ì· ", True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "  Under Collection Cheque  ", , , , , , , , , , 1, 1, 1, 0, 0)    '
                             Else
                                                'ModAccounts.EditAccount rs("Account_Code1").value, 1, 1, , , , , , , , , 1, 1, 1, 0, 0, , , , True
                                              '  ModAccounts.EditAccount rs("Account_Code1").value, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName").value), IIf(IsNull(rs("CusNamee").value) & "   ‘Ìﬂ«    Õ  «· Õ’Ì· ", rs("Fullcode").value, rs("CusNamee").value) & "  Under Collection Cheque  ", , , , , , , , , , , , , , , , , True
                                                ModAccounts.EditAccount rs("Account_Code1").value, IIf(IsNull(rs("CusName")), rs("Fullcode").value & "   ‘Ìﬂ«   Õ  «· Õ’Ì·  ", rs("CusName")) & "  ‘Ìﬂ«   Õ  «· Õ’Ì·   ", IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & " Under Collection Cheque   ", , , , , , , , , 1, 1, 1, 0, 0, , , , True
                             End If
           ...
           ''/////////
            ...
            Current_account = IIf(IsNull(rs("Account_Code2").value), "", rs("Account_Code2").value)
                 If ModAccounts.check_account_exist(Account_Code_dynamic) = True Then
                     If Current_account = "" Then 'new
                      rs("Account_Code2").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName").value), rs("Fullcode").value & "   œ›⁄«  „ﬁœ„…   ", rs("CusName") & "   œ›⁄«  „ﬁœ„…   "), True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & " Advanced Payment  ", , , , , , , , , , 1, 1, 1, 0, 0)             '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("Account_Code2").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value & "   œ›⁄«  „ﬁœ„…   ", rs("CusName") & "   œ›⁄«  „ﬁœ„…   "), True, False, IIf(IsNull(rs("CusNamee") & "   œ›⁄«  „ﬁœ„…   "), rs("Fullcode").value, rs("CusNamee")) & " Advanced Payment  ", , , , , , , , , , 1, 1, 1, 0, 0)   '
                             Else

                               ModAccounts.EditAccount rs("Account_Code2").value, IIf(IsNull(rs("CusName")), rs("Fullcode").value & "   œ›⁄«  „ﬁœ„…   ", rs("CusName")) & "   œ›⁄«  „ﬁœ„…   ", IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & " Advanced Payment  ", , , , , , , , , 1, 1, 1, 0, 0, , , , True
                             End If
...
'
'                         '   ParentAccount2 = get_account_code_branch(216, my_branch)
'                            ParnetAccount3 = get_account_code_branch(216, my_branch)
'                              If Not IsNull(rs("ParentAccountCurrentHih").value) And Not (rs("ParentAccountCurrentHih").value) = "" Then
'                                  ModAccounts.EditAccount rs("ParentAccountCurrentHih").value, rs("CusName") & "   ", Trim(rs("CusNamee")), , , , , , , , , , , , , , , , , False
'                              Else
'                                  ParentAccountCurrentHih = ModAccounts.AddNewAccount(ParnetAccount3, rs("CusName") & "  ", False, False, rs("CusNamee"))
'                                  rs("ParentAccountCurrentHih").value = ParentAccountCurrentHih
'                              End If
'
'                                If Not IsNull(rs("Account_Code").value) And Not (rs("Account_Code").value) = "" Then
...
'                     '   End If
                 ...
                 If ModAccounts.check_account_exist(Account_Code_dynamic) = True Then
                     ...
                     If Current_account = "" Then 'new
                        If SystemOptions.SuppCreat4Acc = True Then
                           ' rs("Account_Code").value = ModAccounts.AddNewAccount(ParentAccountCurrentAss, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")), True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")))
                        Else
           ...
           If SystemOptions.SubContactorHave3Account = True Then
            Current_account = IIf(IsNull(rs("Account_Code1").value), "", rs("Account_Code1").value)
         '  ParnetAccount = IIf(IsNull(rs("ParnetAccount").value), "", rs("ParentAccount").value)
         '  If ModAccounts.check_account_exist(ParnetAccount) = True Then
         '  Account_Code_dynamic = ParnetAccount
         '  Else
         '  Account_Code_dynamic = Account_Code_dynamic1
         '  End If
           '/////////
                 ...
                 If ModAccounts.check_account_exist(Account_Code_dynamic) = True Then
                     If Current_account = "" Then 'new
                      rs("Account_Code1").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "   ÷„«‰ «·«⁄„«· ", True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "  retention  ")
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                            rs("Account_Code1").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "   ÷„«‰ «·«⁄„«· ", True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "  retention  ")
                             Else
                               ModAccounts.EditAccount rs("Account_Code1").value, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "    ÷„«‰ «·«⁄„«·  ", IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "  retention ", , , , , , , , , , , , , , , , , True
                             End If
          ...
          ' End If
                 If ModAccounts.check_account_exist(Account_Code_dynamic) = True Then
                     If Current_account = "" Then 'new
                         rs("Account_Code2").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName").value), rs("Fullcode").value & "   œ›⁄«  „ﬁœ„…   ", rs("CusName") & "   œ›⁄«  „ﬁœ„…   "), True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & " Advanced Payments")
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                            rs("Account_Code2").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName").value), rs("Fullcode").value & "   œ›⁄«  „ﬁœ„…   ", rs("CusName") & "   œ›⁄«  „ﬁœ„…   "), True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & " Advanced Payments")
                             Else
                               ModAccounts.EditAccount rs("Account_Code2").value, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "  œ›⁄«  „ﬁœ„…  ", IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "  Cheque Box ", , , , , , , , , , , , , , , , , True
                             End If
    ...
    Set rs = New ADODB.Recordset
        ...
        Else
            ...
            If Account_Code_dynamic7 = "NO account" Then
                MsgBox "·„ Ì „  ÕœÌœ Õ”«» Õ”‰ «·«œ«¡", vbCritical
                Exit Sub
            End If
        End If
        End If
       ...
       If Account_Code_dynamic6 = "NO branch" Then
        ...
        Else
            ...
            If Account_Code_dynamic6 = "NO account" Then
                MsgBox "·„ Ì „  ÕœÌœ Õ”«»   „‘«—Ì⁄  Õ  «· ‰›Ì– ›Ì «·›—⁄ ·Â–… «·⁄„·Ì…", vbCritical
                Exit Sub
            End If
        End If
  ...
  End If
        ...
        If UnderImp = 2 Then
                 ...
                 If ModAccounts.check_account_exist(Account_Code_dynamic6) = True Then
                     If Current_account = "" Then 'new
                      rs("AccountUnderImp").value = ModAccounts.AddNewAccount(Account_Code_dynamic6, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " - Õ  «· ‰›Ì– ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -Under Implementation")               '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("AccountUnderImp").value = ModAccounts.AddNewAccount(Account_Code_dynamic1, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " - Õ  «· ‰›Ì– ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -Under Implementation")
                             Else
                               ModAccounts.EditAccount rs("AccountUnderImp").value, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -  Õ  «· ‰›Ì– ", IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & "- Under Implementation", , , , , , , , , , , , , , , , , True
                             End If
        ...
        Else
           Current_account = IIf(IsNull(rs("expanses_account").value), "", rs("expanses_account").value)
                 If ModAccounts.check_account_exist(Account_Code_dynamic1) = True Then
                     If Current_account = "" Then 'new
                      rs("expanses_account").value = ModAccounts.AddNewAccount(Account_Code_dynamic1, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -„’—Ê›«  ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -EXPANSES")               '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("expanses_account").value = ModAccounts.AddNewAccount(Account_Code_dynamic1, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -„’—Ê›«  ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -EXPANSES")
                             Else
                               ModAccounts.EditAccount rs("expanses_account").value, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " - „’—Ê›«  ", IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & "- Expenses", , , , , , , , , , , , , , , , , True
                             End If
    ...
    '//////
               ...
               Current_account = IIf(IsNull(rs("AcountGood").value), "", rs("AcountGood").value)
                 If ModAccounts.check_account_exist(Account_Code_dynamic7) = True Then
                     If Current_account = "" Then 'new
                      rs("AcountGood").value = ModAccounts.AddNewAccount(Account_Code_dynamic7, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -Õ”‰ «·«œ«¡ ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -Good performance")               '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("AcountGood").value = ModAccounts.AddNewAccount(Account_Code_dynamic7, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -Õ”‰ «·«œ«¡ ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -Good performance")
                             Else
                               ModAccounts.EditAccount rs("AcountGood").value, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " - Õ”‰ «·«œ«¡ ", IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & "- Good performance", , , , , , , , , , , , , , , , , True
                             End If
      ...
      Current_account = IIf(IsNull(rs("REVENUE_account").value), "", rs("REVENUE_account").value)
                 If ModAccounts.check_account_exist(Account_Code_dynamic2) = True Then
                     If Current_account = "" Then 'new
                      rs("REVENUE_account").value = ModAccounts.AddNewAccount(Account_Code_dynamic2, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -«Ì—«œ«  ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -REVENUE")               '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("REVENUE_account").value = ModAccounts.AddNewAccount(Account_Code_dynamic2, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -«Ì—«œ«  ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -REVENUE")
                             Else
                               ModAccounts.EditAccount rs("REVENUE_account").value, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -«Ì—«œ«  ", IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & "-REVENUE", , , , , , , , , , , , , , , , , True
                             End If
      ...
      Current_account = IIf(IsNull(rs("Material_account").value), "", rs("Material_account").value)
                 If ModAccounts.check_account_exist(Account_Code_dynamic3) = True Then
                     If Current_account = "" Then 'new
                      rs("Material_account").value = ModAccounts.AddNewAccount(Account_Code_dynamic3, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -„Ê«œ ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -Material")               '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("Material_account").value = ModAccounts.AddNewAccount(Account_Code_dynamic3, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -„Ê«œ ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -Material")
                             Else
                               ModAccounts.EditAccount rs("Material_account").value, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -„Ê«œ ", IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & "-Material", , , , , , , , , , , , , , , , , True
                             End If
         ...
         Current_account = IIf(IsNull(rs("Salary_account").value), "", rs("Salary_account").value)
                 If ModAccounts.check_account_exist(Account_Code_dynamic4) = True Then
                     If Current_account = "" Then 'new
                      rs("Salary_account").value = ModAccounts.AddNewAccount(Account_Code_dynamic4, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -«ÃÊ— ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -salary")               '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("Salary_account").value = ModAccounts.AddNewAccount(Account_Code_dynamic4, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -«ÃÊ— ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -salary")
                             Else
                               ModAccounts.EditAccount rs("Salary_account").value, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -«ÃÊ—œ ", IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & "-salary", , , , , , , , , , , , , , , , , True
                             End If
              ...
              Current_account = IIf(IsNull(rs("legal").value), "", rs("legal").value)
                 If ModAccounts.check_account_exist(Account_Code_dynamic5) = True Then
                     If Current_account = "" Then 'new
                      rs("legal").value = ModAccounts.AddNewAccount(Account_Code_dynamic5, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & "-„” Œ·’«  ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -legal")               '
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                              rs("legal").value = ModAccounts.AddNewAccount(Account_Code_dynamic5, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -„” Œ·’«  ", True, False, IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & " -legal")
                             Else
                               ModAccounts.EditAccount rs("legal").value, IIf(IsNull(rs("Project_name")), rs("Fullcode").value, rs("Project_name")) & " -„” Œ·’«  ", IIf(IsNull(rs("Project_nameE")), rs("Fullcode").value, rs("Project_nameE")) & "-legal", , , , , , , , , , , , , , , , , True
                             End If
