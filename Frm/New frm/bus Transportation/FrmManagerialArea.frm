   ...
   ' On Error GoTo ErrTrap
    ...
    If Me.TxtModFlg.Text <> "R" Then
        ...
        If XPTxtBoxName.Text = "" Then
            MsgBox "„‰ ›÷·ﬂ √œŒ· «”„ «·„‰ÿﬁ… «·«œ«—Ì… ", vbOKOnly + vbInformation + vbMsgBoxRight + vbMsgBoxRtlReading, App.title
            XPTxtBoxName.SetFocus
            Exit Sub
        End If
