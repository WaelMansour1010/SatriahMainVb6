...
Private Sub AddTip()
    ...
    With TTP
        .Create Me.hWnd, "»Ì«‰«  „Ã„Ê⁄«  «·„Œ«·›« ", 1, 15204351, -2147483630
        .MaxWidth = 4000
        .VisibleTime = 9000
        .DelayTime = 600
        .AddControl Cmd(0), "ÃœÌœ ..." & Wrap & "·«÷«›… »Ì«‰«  „Ã„Ê⁄Â ÃœÌœ" & Wrap & " ›ﬁÿ ≈÷€ÿ Â‰«", True
    End With
    ...
    With TTP
        ...
        .VisibleTime = 9000
        .DelayTime = 600
        .AddControl Cmd(1), " ⁄œÌ· ..." & Wrap & "· ⁄œÌ· »Ì«‰«  „Ã„Ê⁄…" & Wrap & " ›ﬁÿ ≈÷€ÿ Â‰«", True
    End With
    ...
    With TTP
        ...
        .VisibleTime = 9000
        .DelayTime = 600
        .AddControl Cmd(4), "Õ–› ..." & Wrap & "·Õ–› »Ì«‰«  Â–« „Ã„Ê⁄…" & Wrap & " ›ﬁÿ ≈÷€ÿ Â‰«", True
    End With
