   ...
   Begin C1SizerLibCtl.C1Elastic EleMain 
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin VB.ComboBox CBoBasedON 
            Height          =   315
            ItemData        =   "frmpo7.frx":038A
            Left            =   6360
            List            =   "frmpo7.frx":038C
            RightToLeft     =   -1  'True
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin ImpulseButton.ISButton CmdInfo 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            ButtonImage     =   "frmpo7.frx":2A91
            ButtonImageHover=   "frmpo7.frx":376B
...
'    On Error GoTo ErrTrap
    ...
    Select Case Index
        ...
        '    FG.SetFocus
            ...
            If mIndex = 1 Then CBoBasedON.ListIndex = 0
...
'
        ...
        Case 5
            ...
            FrmBuySearch.DealingForm = GridTransType.BookInventories
            FrmBuySearch.Caption = "”‰œ«  ÕÃ“ »÷«⁄Â"
...
Private Sub TxtPONo_Change()
  ...
  ElseIf CBoBasedON.ListIndex = 2 Then
     ...
     Transaction_Type = 0
   End If
        If mIndex = 1 Then Transaction_Type = 39
...
Private Sub TxtPONo_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF3 Then
        ...
        Order_no_search4.RetrunType = 76
...
Private Sub Form_Load()
   ...
   ' If GeneralPriceType = 0 Then
        ...
        If mIndex = 0 Then
            ScreenNameArabic = " ”‰œ«  ÕÃ“ "
            ScreenNameEnglish = "Book Inventories"
            CurrentTransactionType = 39
        ElseIf mIndex = 1 Then
            ScreenNameArabic = "«·€«¡ ”‰œ«  «·ÕÃ“"
            ScreenNameEnglish = "Cancellation of reservation"
            CurrentTransactionType = 76
   ...
   ' End If
    ...
    Set NewGrid.Grid = FG
    NewGrid.GridTrans = GridTransType.BookInventories
...
'Me.TxtModFlg.text = "R"
  ...
  CBoBasedON.ListIndex = IIf(IsNull(rs("CBoBasedON").value), 0, (rs("CBoBasedON").value))
   ...
   If Not IsNull(rs("ContactTime").value) Then
    ...
    BookingDate.value = IIf(IsNull(rs("BookingDate").value), Date, (rs("BookingDate").value))
...
rs("Transaction_Type").value = CurrentTransactionType
        ...
        rs("BookingDate").value = BookingDate.value
...
Private Sub PrintReport()
    ...
    If XPTxtBillID.Text <> "" Then
        Set SaleReport = New ClsSaleReport
        SaleReport.ShowPrice XPTxtBillID.Text, 9, DcboEmp.Text
    End If
...
sql = " SELECT     Transaction_Type, order_no"
sql = sql & " From dbo.Transactions"
sql = sql & " WHERE     (order_no = '" & TxtNoteSerial1.Text & "') and Transaction_Type=21 "
...
lbl(34).Caption = "Book Until Date"
         With Me.CBoBasedON
        .Clear
        .AddItem "NA"
        .AddItem "Sales Order"
    ...
    lbl(49).Caption = "Net"
lbl(38).Caption = "Equip"
Label11.Caption = "Need To Approve"
Label16.Caption = "Contact Time"
XPTab301.TabCaption(2) = "Intenal order"
