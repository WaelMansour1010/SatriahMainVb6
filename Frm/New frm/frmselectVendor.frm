...
Private Sub CmdOk_Click()
  ...
  If Indxx = 2 Or Indxx = 1 Or Indxx = 3 Or Indxx = 4 Or Indxx = 56 Or Indxx = 57 Then
  save2
  If StrCus = "0,0" Then Exit Sub
        If Indxx = 2 Or Indxx = 1 Then
            Ageng_all.StrCusID = StrCus
        ElseIf Indxx = 3 Or Indxx = 4 Or Indxx = 56 Or Indxx = 57 Then
            FrmVizitScreen.StrCusID = StrCus
        End If
    ElseIf Indxx = 5645 Then
        save2
        If StrCus = "0,0" Then Exit Sub
        
            FrmAnalysItems.StrCusID = StrCus
...
If Indxx = 0 Or Indxx = 1 Or Indxx = 3 Then
    ...
    If Flag = "R" And StrCusID <> "" Then
        StrSQL = StrSQL & "  and (CusID in ( " & StrCusID & " )) "
    End If
ElseIf Indxx = 56 Then
   StrSQL = "SELECT     CusID, Fullcode, CusName, CusNamee"
   StrSQL = StrSQL & "  from dbo.TblCustemers"
   StrSQL = StrSQL & "  WHERE     (Type = 56) "
   ...
   StrSQL = StrSQL & "     and CusID>2"
    ...
    End If
ElseIf Indxx = 5645 Then
   StrSQL = "SELECT      ItemId as CusID, Fullcode, ItemName CusName, ItemNamee CusNamee"
   StrSQL = StrSQL & "  from dbo.tblItems"
   
    If Flag = "R" And StrCusID <> "" Then
        StrSQL = StrSQL & "  and (5645 in ( " & StrCusID & " )) "
    End If

ElseIf Indxx = 57 Then
      StrSQL = "SELECT     CusID, Fullcode, CusName, CusNamee"
      StrSQL = StrSQL & "  from dbo.TblCustemers"
      StrSQL = StrSQL & "  WHERE      (Type = 57) "
...
ELe(5).Caption = " ÕœÌœ «·⁄„·«¡"
ElseIf Indxx = 56 Then
ELe(5).Caption = " ÕœÌœ «·„” √Ã—Ì‰"
ElseIf Indxx = 57 Then
ELe(5).Caption = " ÕœÌœ «·„·«ﬂ"
