...
Private Sub Command3_Click()
    ...
    If dlgFile.FileName <> vbNullString And dlgFile.FileName <> "" Then
        ...
        foldername = App.path & "\Doc"
        If Not fs.FolderExists(foldername) Then
            fs.CreateFolder foldername
        End If
        
        desFilename = foldername & "\" & FileName
...
Private Sub Command4_Click()
    Adodc1.CommandType = adCmdText
    Adodc1.RecordSource = "SELECT * FROM subjects_images WHERE subject_no='" & Trim(SUBJECT_NO.Caption) & "'"
    Adodc1.Refresh
