...
Begin VB.Form project_search 
   ...
   Begin MSDataGridLib.DataGrid DataGrid4 
      Bindings        =   "project_search.frx":000C
      Height          =   2535
      Left            =   1560
      TabIndex        =   16
      Top             =   5040
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "project_search.frx":003D
      Height          =   3015
      Left            =   120
      TabIndex        =   4
      Top             =   1440
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "project_search.frx":0052
      Height          =   2535
      Left            =   0
      TabIndex        =   2
      Top             =   5160
   ...
   Begin MSDataGridLib.DataGrid DataGrid3 
      Bindings        =   "project_search.frx":0067
      Height          =   2535
      Left            =   1560
      TabIndex        =   12
      Top             =   5040
   ...
   Begin MSDataGridLib.DataGrid DataGrid5 
      Bindings        =   "project_search.frx":00D0
      Height          =   2535
      Left            =   120
      TabIndex        =   20
      Top             =   1440
   ...
   End
End
Attribute VB_Name = "project_search"
...
Private Sub ALLButton1_Click()
    ...
    If case_id.Caption = 1 And Adodc1.Recordset.RecordCount >= 0 Then
        ...
        With FrmEmpSalary4.Grid
            ...
            FrmEmpSalary4.Grid_AfterEdit .Row, 22
