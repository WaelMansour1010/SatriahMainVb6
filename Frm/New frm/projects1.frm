...
Begin VB.Form Projects1 
   ...
   Begin VB.Frame Frame12 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid3 
         ...
         FormatString    =   $"projects1.frx":0121
         ScrollTrack     =   0   'False
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         Begin ImpulseButton.ISButton CmdAdd 
            ...
            EndProperty
            BackStyle       =   0
            ButtonImage     =   "projects1.frx":026D
      ...
      Begin VSFlex8UCtl.VSFlexGrid FG 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"projects1.frx":0607
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame10 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"projects1.frx":0872
         ScrollTrack     =   0   'False
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame11 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid2 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"projects1.frx":0A21
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   -1  'True
         MergeCells      =   0
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VSFlex8Ctl.VSFlexGrid Fg_Journal 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"projects1.frx":0F21
         ScrollTrack     =   0   'False
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "projects1.frx":180C
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "projects1.frx":1BA6
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "projects1.frx":1F40
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin ImpulseButton.ISButton XPBtnMove 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "projects1.frx":22DA
      ColorHighlight  =   4194304
      ColorHoverText  =   16777215
      ColorShadow     =   -2147483631
      ColorOutline    =   -2147483631
   ...
   Begin VB.Frame Fra 
      ...
      Begin VSFlex8Ctl.VSFlexGrid GridSub 
         ...
         FormatString    =   $"projects1.frx":2674
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin ImpulseButton.ISButton Cmd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "projects1.frx":2A4D
         DrawFocusRectangle=   0   'False
      End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid4 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"projects1.frx":2FE7
         ScrollTrack     =   0   'False
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
...
Private Sub terms_operations_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 1
            ...
            StrSQL = "Delete From terms_operations Where term_fullcode ='" & current_terms & "'" ' Val(Me.txt_project_id.text) & "AND item_id=" & current_terms
            Cn.Execute StrSQL, , adExecuteNoRecords
            ' ⁄„·Ì«  «·»‰Êœ
            Set RsDev = New ADODB.Recordset
...
Me.DcEmp.BoundText = IIf(IsNull(rs("EmpId")), "", rs("EmpId"))
    ...
    '-----------------------------------------------------------------------------
    If SystemOptions.SysAppAccoutingType = CompeleteAccounting Then
        StrSQL = "SELECT    projects_des.fullcode, [index], des, qty, cost, dbo.projects_des.total, discount, net, project_id,sub_contractor_id,CusName"
