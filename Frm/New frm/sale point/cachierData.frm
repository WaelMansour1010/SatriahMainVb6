...
Function CuurentLogdata(Optional Currentmode As String)
    LogTextA = "    ‘«‘… " & ScreenNameArabic & CHR(13) & "ﬂÊœ  «·ﬂ ‘Ì— " & TxtSerial.Text & CHR(13) & "   «”„ «·ﬂ«‘Ì— " & TxtVacName & CHR(13) & " Ì »⁄ " & dcpoint & CHR(13) & "   «”„ «·„” Œœ„ " & txtusername & CHR(13) & "  ﬂ·„… «·„—Ê— " & TxtPassWord
