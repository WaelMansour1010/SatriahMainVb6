...
Public mIndex As Integer
    ...
    Dim PCusName  As String
    Dim Pemp_Name  As String
    Dim Pemp_id As Integer
    Dim PCus_id As Integer
...
Private Sub ALLButton1_Click()
    ...
    If case_id.Caption = 988 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmLC.cmbAccount.BoundText = (Adodc1.Recordset.Fields!Account_code)
    ...
    If case_id.Caption = 90520 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmCars.DCOwner.BoundText = (Adodc1.Recordset.Fields!Account_code)
        '      Exit Sub
    End If
    ...
    If case_id.Caption = 26112014 And Adodc1.Recordset.RecordCount >= 0 Then
        With FrmAccEditJournal4.Fg_Journal
            ...
            .TextMatrix(.Row, .ColIndex("NEmpid")) = Pemp_id
            .TextMatrix(.Row, .ColIndex("NEmpName")) = Pemp_Name
            .TextMatrix(.Row, .ColIndex("SupplierID")) = PCus_id
            .TextMatrix(.Row, .ColIndex("Supplier")) = PCusName

            '.TextMatrix(.Row, .ColIndex("AccountName")) = Adodc1.Recordset.Fields!account_name
            .TextMatrix(.Row, .ColIndex("Account_Serial")) = Adodc1.Recordset.Fields!Account_Serial
            FrmAccEditJournal4.Fg_Journal_AfterEdit .Row, 12
    ...
    If case_id.Caption = 240219 And Adodc1.Recordset.RecordCount >= 0 Then
        ...
        FrmRevenuesTypes.DboAcc.BoundText = (Adodc1.Recordset.Fields!Account_code)
    End If
    ...
    If case_id.Caption = 7897289 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmBillBuy.cmbAccounts.BoundText = (Adodc1.Recordset.Fields!Account_code)
    End If
    

    If case_id.Caption = 989 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmVacancy.cmbAccountCode.BoundText = (Adodc1.Recordset.Fields!Account_code)
    End If
    
        If case_id.Caption = 990 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmLC.cmbAccountExpProject.BoundText = (Adodc1.Recordset.Fields!Account_code)
    End If
    ...
    If case_id.Caption = 29125 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmPayments.DcbAccount.BoundText = (Adodc1.Recordset.Fields!Account_code)
    End If
    ...
    If case_id.Caption = 2608178 And Adodc1.Recordset.RecordCount >= 0 Then
    
        projectsbill.txtDiscountAccountCode = getAccountSerial_Code("Account_Serial", "Account_Code", (Adodc1.Recordset.Fields!Account_code))
        projectsbill.DcDiscountAccount.BoundText = (Adodc1.Recordset.Fields!Account_code)
    End If
    

    If case_id.Caption = 2608180 And Adodc1.Recordset.RecordCount >= 0 Then
    
        
        project_status.cmbAccount.BoundText = (Adodc1.Recordset.Fields!Account_code)
    End If
    

    If case_id.Caption = 2608181 And Adodc1.Recordset.RecordCount >= 0 Then
    
        
        project_status.cmbAccountComm.BoundText = (Adodc1.Recordset.Fields!Account_code)
    End If
    ...
    If case_id.Caption = 180620 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmTotals2Report.DboParentAccount.BoundText = (Adodc1.Recordset.Fields!Account_code)
    End If
    ...
    If case_id.Caption = 808080 And Adodc1.Recordset.RecordCount >= 0 Then
        With FrmBillBuy.FG
            '.TextMatrix(.Row, .ColIndex("AccountName")) = Adodc1.Recordset.Fields!account_name
            .TextMatrix(.Row, .ColIndex("Account_Serial2")) = Adodc1.Recordset.Fields!Account_Serial
            .TextMatrix(.Row, .ColIndex("Account_Code")) = Adodc1.Recordset.Fields!Account_code
            .TextMatrix(.Row, .ColIndex("Account_Name")) = Adodc1.Recordset.Fields!FirstName
    ...
    If case_id.Caption = 33350 And Adodc1.Recordset.RecordCount >= 0 Then
        With projectsbill.Fg_Journal
            .TextMatrix(.Row, .ColIndex("AccountCode")) = Adodc1.Recordset.Fields!Account_code
            .TextMatrix(.Row, .ColIndex("AccountName")) = Adodc1.Recordset.Fields!FirstName
            .TextMatrix(.Row, .ColIndex("Account_Serial")) = Adodc1.Recordset.Fields!Account_Serial
            Fg_Journal.VSFlexGrid1_AfterEdit .Row, 6
        End With
    End If
       
    If case_id.Caption = 33360 And Adodc1.Recordset.RecordCount >= 0 Then
        With frmSubcontractorContract.Fg_Journal
            .TextMatrix(.Row, .ColIndex("AccountCode")) = Adodc1.Recordset.Fields!Account_code
            .TextMatrix(.Row, .ColIndex("AccountName")) = Adodc1.Recordset.Fields!FirstName
            .TextMatrix(.Row, .ColIndex("Account_Serial")) = Adodc1.Recordset.Fields!Account_Serial
            Fg_Journal.VSFlexGrid1_AfterEdit .Row, 6
    ...
    If case_id.Caption = 350057 And Adodc1.Recordset.RecordCount >= 0 Then
        With FrmLC.GrdMargin2
            .TextMatrix(.Row, .ColIndex("MarginAccountCode")) = Adodc1.Recordset.Fields!Account_code
            .TextMatrix(.Row, .ColIndex("MarginAccount")) = Adodc1.Recordset.Fields!FirstName
            .TextMatrix(.Row, .ColIndex("MarginAccountSerial")) = Adodc1.Recordset.Fields!Account_Serial
        End With
    End If
    
        If case_id.Caption = 350059 And Adodc1.Recordset.RecordCount >= 0 Then
        With FrmLC.GrdMargin2
            .TextMatrix(.Row, .ColIndex("AccountMargen2")) = Adodc1.Recordset.Fields!Account_code
            .TextMatrix(.Row, .ColIndex("AccountMargen2Name")) = Adodc1.Recordset.Fields!FirstName
            .TextMatrix(.Row, .ColIndex("AccountMargen2Serial")) = Adodc1.Recordset.Fields!Account_Serial
        End With
    End If
    

    If case_id.Caption = 350058 And Adodc1.Recordset.RecordCount >= 0 Then
        With FrmLC.GrdMargin2
            .TextMatrix(.Row, .ColIndex("BankAccountCode")) = Adodc1.Recordset.Fields!Account_code
            .TextMatrix(.Row, .ColIndex("BankAccount")) = Adodc1.Recordset.Fields!FirstName
            .TextMatrix(.Row, .ColIndex("BankAccountSerial")) = Adodc1.Recordset.Fields!Account_Serial
        End With
    End If
    
    
    If case_id.Caption = 350070 And Adodc1.Recordset.RecordCount >= 0 Then
        With FrmLC.GrdMargin2
            .TextMatrix(.Row, .ColIndex("BankAccountCode2")) = Adodc1.Recordset.Fields!Account_code
            .TextMatrix(.Row, .ColIndex("BankAccount2")) = Adodc1.Recordset.Fields!FirstName
            .TextMatrix(.Row, .ColIndex("BankAccountSerial2")) = Adodc1.Recordset.Fields!Account_Serial
        End With
    End If
    
       If case_id.Caption = 350061 And Adodc1.Recordset.RecordCount >= 0 Then
        With FrmLC.GrdMargin4
            .TextMatrix(.Row, .ColIndex("BankAccountCode2")) = Adodc1.Recordset.Fields!Account_code
            .TextMatrix(.Row, .ColIndex("BankAccount2")) = Adodc1.Recordset.Fields!FirstName
            .TextMatrix(.Row, .ColIndex("BankAccountSerial2")) = Adodc1.Recordset.Fields!Account_Serial
        End With
    End If
        ...
        If case_id.Caption = 350060 And Adodc1.Recordset.RecordCount >= 0 Then
        With FrmLC.GrdMargin2
            .TextMatrix(.Row, .ColIndex("AccountMargen2")) = Adodc1.Recordset.Fields!Account_code
            .TextMatrix(.Row, .ColIndex("AccountMargen2Name")) = Adodc1.Recordset.Fields!FirstName
            .TextMatrix(.Row, .ColIndex("AccountMargen2Serial")) = Adodc1.Recordset.Fields!Account_Serial
    ...
    If case_id.Caption = 1 And Adodc1.Recordset.RecordCount >= 0 Then
        If chkSelectAll.value = vbChecked Then
            FrmAccountingReport.Grid3.rows = 1
            If Not Adodc1.Recordset.EOF Then
                Do While Not Adodc1.Recordset.EOF
                    FrmAccountingReport.Grid3.AddItem ""
                    Dim Row As Integer
                    Dim LngRow2 As Long
                    Row = FrmAccountingReport.Grid3.rows - 1
                    
                    LngRow2 = val(FrmAccountingReport.Grid3.FindRow(Adodc1.Recordset.Fields!parentCOde, FrmAccountingReport.Grid3.FixedRows, FrmAccountingReport.Grid3.ColIndex("Account_Code"), False, True))
                    If LngRow2 = -1 And Not FrmAccountingReport.OptAccount(44).value Then
                        FrmAccountingReport.Grid3.TextMatrix(Row, FrmAccountingReport.Grid3.ColIndex("Account_Code")) = Adodc1.Recordset.Fields!parentCOde
                        FrmAccountingReport.Grid3.TextMatrix(Row, FrmAccountingReport.Grid3.ColIndex("Account_Name")) = Adodc1.Recordset.Fields!parentName
                        FrmAccountingReport.Grid3.TextMatrix(Row, FrmAccountingReport.Grid3.ColIndex("Account_Serial")) = Adodc1.Recordset.Fields!Account_SerialPar
                        Row = Row + 1
                        
                        FrmAccountingReport.Grid3.AddItem ""
                    End If
                    FrmAccountingReport.Grid3.TextMatrix(Row, FrmAccountingReport.Grid3.ColIndex("Account_Code")) = Adodc1.Recordset.Fields!Account_code
                    FrmAccountingReport.Grid3.TextMatrix(Row, FrmAccountingReport.Grid3.ColIndex("Account_Name")) = Adodc1.Recordset.Fields!FirstName
                    FrmAccountingReport.Grid3.TextMatrix(Row, FrmAccountingReport.Grid3.ColIndex("Account_Serial")) = Adodc1.Recordset.Fields!Account_Serial
    ...
    If case_id.Caption = 556 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmLC.cmbAccountExpensParent.text = Adodc1.Recordset.Fields!FirstName
    End If
    
    
   
    If case_id.Caption = 557 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmLC.cmbAccountMarginParent.text = Adodc1.Recordset.Fields!FirstName
    End If
     
     
    
    If case_id.Caption = 558 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmLC.cmbAccountLGParent.text = Adodc1.Recordset.Fields!FirstName
    End If
     
     
    
    If case_id.Caption = 559 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmLC.cmbAccountAcceptanceParent.text = Adodc1.Recordset.Fields!FirstName
    End If
    ...
    If case_id.Caption = 2014110503 And Adodc1.Recordset.RecordCount >= 0 Then
        FrmPaymentType.DcAccTaxTobacco.BoundText = Adodc1.Recordset.Fields!Account_code
    End If
...
'Exit Sub
    ...
    If Me.case_id = 16112 Or Me.case_id = 700 Or Me.case_id = 55 Or Me.case_id = 16915 Or Me.case_id = 555 Or Me.case_id = 66 Or Me.case_id = 77 Or Me.case_id = 88 Or Me.case_id = 2116 Or Me.case_id = 11116 Or Me.case_id = 556 Or Me.case_id = 990 Or Me.case_id = 558 Or Me.case_id = 557 Or Me.case_id = 559 Then
...
Private Sub Form_Load()
    ...
    If SystemOptions.UserInterface = ArabicInterface Then
        sql = "   SELECT  ACCOUNTS.Account_Code ,ACCOUNTS.Account_SERIAL, ACCOUNTS.Account_Name As FirstName,ACCOUNTS_1.Account_Name As ParentName, ACCOUNTS_2.Account_Name As RootName ,ACCOUNTS.Account_ID  "
        sql = sql & " FROM (ACCOUNTS INNER JOIN ACCOUNTS AS ACCOUNTS_1 ON ACCOUNTS.Parent_Account_Code = ACCOUNTS_1.Account_Code) "
        sql = sql & " INNER JOIN ACCOUNTS AS ACCOUNTS_2 ON ACCOUNTS_1.Parent_Account_Code= ACCOUNTS_2.Account_Code "
        
        
        
        
        sql = "  SELECT ACCOUNTS.Account_Code, ACCOUNTS.Account_Serial, ACCOUNTS.Account_Name AS FirstName, ACCOUNTS_1.Account_Name AS ParentName, ACCOUNTS_2.Account_Name AS RootName, ACCOUNTS.Account_ID,"
        sql = sql & "        TblCustemers_3.Fullcode Cus3Code,"
        sql = sql & "       TblCustemers_2.Fullcode AS Cus2Code, TblCustemers.Fullcode AS CusCode, TblCustemers_1.Fullcode AS Cus1Code"
        sql = sql & " FROM   TblCustemers AS TblCustemers_3 RIGHT OUTER JOIN"
        sql = sql & "              ACCOUNTS INNER JOIN"
        sql = sql & "              ACCOUNTS AS ACCOUNTS_1 ON ACCOUNTS.Parent_Account_Code = ACCOUNTS_1.Account_Code INNER JOIN"
        sql = sql & "              ACCOUNTS AS ACCOUNTS_2 ON ACCOUNTS_1.Parent_Account_Code = ACCOUNTS_2.Account_Code ON TblCustemers_3.Account_CodeHi2 = ACCOUNTS.Account_Code LEFT OUTER JOIN"
        sql = sql & "              TblCustemers AS TblCustemers_2 ON ACCOUNTS.Account_Code = TblCustemers_2.Account_CodeHi1 LEFT OUTER JOIN"
        sql = sql & "              TblCustemers ON ACCOUNTS.Account_Code = TblCustemers.Account_Code LEFT OUTER JOIN"
        sql = sql & "              TblCustemers AS TblCustemers_1 ON ACCOUNTS.Account_Code = TblCustemers_1.Account_CodeAss2"
             
        sql = sql & "         Where ACCOUNTS.Account_Code ='x'  "
        
        
        If Me.case_id = 556 Or Me.case_id = 990 Or Me.case_id = 558 Or Me.case_id = 557 Or Me.case_id = 559 Then
            sql = sql & "      and  ACCOUNTS.last_account = 0"
        End If
        sql = sql & GetAccountByBarnchUser
        sql = sql & GetAccountCodeHiding
        sql = sql & " Order By ACCOUNTS.Account_Name"
    Else
        sql = "   SELECT  ACCOUNTS.Account_Code ,ACCOUNTS.Account_SERIAL, ACCOUNTS.Account_NameEng As FirstName,ACCOUNTS_1.Account_NameEng As ParentName, ACCOUNTS_2.Account_NameEng As RootName,ACCOUNTS.Account_ID"
    ...
    If SystemOptions.UserInterface = EnglishInterface Then
        ...
        OpTcode(1).Caption = "Cus."
        OpTcode(2).Caption = "Supp"
        OpTcode(3).Caption = "Emp."
        OpTcode(4).Caption = "Subcontractor."
    ...
    Cn.Execute "delete accounts_temp"
    ...
    If True = True Then
        ...
        If Index = 0 Then
            ...
            If OpTcode(0).value = True Then
                sql = "   SELECT  ACCOUNTS.Account_Code ,ACCOUNTS.Account_SERIAL, ACCOUNTS.Account_Name As FirstName,ACCOUNTS_1.Account_Name As ParentName, ACCOUNTS_2.Account_Name As RootName  ,ACCOUNTS_1.Account_Code ParentCode,ACCOUNTS_1.Account_Serial Account_SerialPar ,ACCOUNTS.Account_ID FROM (ACCOUNTS  LEFT OUTER JOIN ACCOUNTS AS ACCOUNTS_1 ON ACCOUNTS.Parent_Account_Code = ACCOUNTS_1.Account_Code)   LEFT OUTER JOIN ACCOUNTS AS ACCOUNTS_2 ON ACCOUNTS_1.Parent_Account_Code= ACCOUNTS_2.Account_Code Where ACCOUNTS.Account_Code <>'r'   "
                ...
                ElseIf Me.CboAccountCodeSearch.ListIndex = -1 Then
                    ' sql = sql & " AND ACCOUNTS.Account_Serial like '%" & Text1(Index).Text & "%' "
                    sql = sql & " AND  ( ACCOUNTS.Account_Serial = '" & Text1(Index).text & "' or  ACCOUNTS.Account_Serial1 = '" & Text1(Index).text & "' or  ACCOUNTS.Account_Serial2 = '" & Text1(Index).text & "' or  ACCOUNTS.Account_Serial3 = '" & Text1(Index).text & "'  )"
                End If
            ElseIf OpTcode(1).value = True Then
                GetCustomersDetail Cus_ID, , Text1(0).text, 1, , , CusName
                'If CusName = "" Then
                If SystemOptions.UserInterface = EnglishInterface Then
                    
                    sql = "   SELECT ACCOUNTS.Account_Code , ACCOUNTS.Account_SERIAL, ACCOUNTS.Account_NameENG As FirstName,ACCOUNTS_1.Account_NameEng As ParentName, ACCOUNTS_2.Account_NameEng As RootName,ACCOUNTS_1.Account_Code ParentCode,ACCOUNTS_1.Account_Serial Account_SerialPar ,ACCOUNTS.Account_ID  "
                    
                    sql = sql & " FROM (ACCOUNTS  LEFT OUTER JOIN  ACCOUNTS AS ACCOUNTS_1 ON ACCOUNTS.Parent_Account_Code = ACCOUNTS_1.Account_Code)  LEFT OUTER JOIN   ACCOUNTS AS ACCOUNTS_2 ON ACCOUNTS_1.Parent_Account_Code= ACCOUNTS_2.Account_Code"
                    ...
                    sql = sql & " TblCustemers AS TblCustemers_1 ON ACCOUNTS.Account_Code = TblCustemers_1.Account_CodeAss2"
                    sql = sql & " LEFT OUTER JOIN"
                    sql = sql & " TblCustemers AS TblCustemers_3 ON ACCOUNTS.Account_Code = TblCustemers_3.Account_CodeHi2"

                    sql = sql & " Where ACCOUNTS.Account_Code <>'r' "
                    'AND ACCOUNTS.Account_NameENG like'%" & CusName & "%'"
                    If Me.CboAccountCodeSearch.ListIndex = 0 Then
                        If Trim(Text1(0).text) <> "" Then
                            sql = sql & "and (TblCustemers_2.FullCode  = '" & Trim(Text1(0).text) & "'  Or TblCustemers_3.FullCode  = '" & Trim(Text1(0).text) & "' Or  TblCustemers_1.FullCode  = '" & Trim(Text1(0).text) & "' "
                            
                            sql = sql & " Or  TblCustemers.FullCode  = '" & Trim(Text1(0).text) & "')"
                        Else
                    ...
                    End If
                Else
                    sql = "   SELECT ACCOUNTS.Account_Code , ACCOUNTS.Account_SERIAL, ACCOUNTS.Account_Name As FirstName,ACCOUNTS_1.Account_Name As ParentName, ACCOUNTS_2.Account_Name As RootName,ACCOUNTS_1.Account_Code ParentCode,ACCOUNTS_1.Account_Serial Account_SerialPar ,ACCOUNTS.Account_ID  "
                    ...
                    ElseIf Me.CboAccountCodeSearch.ListIndex = -1 Then
                        '  sql = sql & " AND ACCOUNTS.Account_Name like '%" & CusName & "%' "
                        If Index <> 0 Then
                            sql = sql & " AND  ( ACCOUNTS.Account_Name like '%" & CusName & "%'  or " & "  ACCOUNTS.Account_Name1 like '%" & CusName & "%'  or " & " ACCOUNTS.Account_Name2 like '%" & CusName & "%'  or " & " ACCOUNTS.Account_Name3 like '%" & CusName & "%' )"
                        Else
                            
                            If Trim(Text1(0).text) = "" Then
                                sql = sql & " and  ACCOUNTS.Account_Code In (Select TblCustemers.Account_code from TblCustemers where Type = 1) and ACCOUNTS.Account_Code IN (sELECT ACCOUNT_CODE FROM DOUBLE_ENTREY_VOUCHERS Union all sELECT ACCOUNT_CODE FROM DOUBLE_ENTREY_VOUCHERS1)"
                            Else
                                sql = sql & "and (TblCustemers_2.FullCode  = '" & Trim(Text1(0).text) & "'  Or TblCustemers_3.FullCode  = '" & Trim(Text1(0).text) & "' Or  TblCustemers_1.FullCode  = '" & Trim(Text1(0).text) & "' "
            ...
            ElseIf OpTcode(4).value = True Then
                GetCustomersDetail Cus_ID, , Text1(0).text, 3, , , CusName
            ...
            ElseIf OpTcode(2).value = True Then
                GetCustomersDetail Cus_ID, , Text1(0).text, 2, , , CusName
                If CusName = "" Then CusName = "?xc????"
                If SystemOptions.UserInterface = EnglishInterface Then
                    sql = "   SELECT ACCOUNTS.Account_Code , ACCOUNTS.Account_SERIAL, ACCOUNTS.Account_NameENG As FirstName,ACCOUNTS_1.Account_NameENG As ParentName, ACCOUNTS_2.Account_NameENG As RootName,ACCOUNTS_1.Account_Code ParentCode,ACCOUNTS_1.Account_Serial Account_SerialPar ,ACCOUNTS.Account_ID   FROM (ACCOUNTS  LEFT OUTER JOIN  ACCOUNTS AS ACCOUNTS_1 ON ACCOUNTS.Parent_Account_Code = ACCOUNTS_1.Account_Code)  LEFT OUTER JOIN   ACCOUNTS AS ACCOUNTS_2 ON ACCOUNTS_1.Parent_Account_Code= ACCOUNTS_2.Account_Code Where ACCOUNTS.Account_Code <>'r'  "
            ...
            ElseIf OpTcode(3).value = True Then
                GetEmployeeIDFromCode Text1(0).text, Emp_id, , , emp_Name
                ...
                If SystemOptions.UserInterface = EnglishInterface Then
                    ...
                    sql = " SELECT ACCOUNTS.Account_Code , ACCOUNTS.Account_SERIAL, ACCOUNTS.Account_NameENG As FirstName,ACCOUNTS_1.Account_NameEng As ParentName, ACCOUNTS_2.Account_NameEng As RootName,ACCOUNTS_1.Account_Code ParentCode,ACCOUNTS_1.Account_Serial Account_SerialPar ,ACCOUNTS.Account_ID"
                    sql = sql & " FROM (ACCOUNTS  LEFT OUTER JOIN  ACCOUNTS AS ACCOUNTS_1 ON ACCOUNTS.Parent_Account_Code = ACCOUNTS_1.Account_Code)  LEFT OUTER JOIN   ACCOUNTS AS ACCOUNTS_2 ON ACCOUNTS_1.Parent_Account_Code= ACCOUNTS_2.Account_Code"
                    sql = sql & " LEFT OUTER JOIN  TblEmployee AS TblEmployee_2 ON ACCOUNTS.Account_Code = TblEmployee_2.Account_Code1 LEFT OUTER JOIN TblEmployee ON ACCOUNTS.Account_Code = TblEmployee.Account_Code"
                    sql = sql & " LEFT OUTER JOIN TblEmployee AS TblEmployee_1 ON ACCOUNTS.Account_Code = TblEmployee_1.Account_Code2 LEFT OUTER JOIN TblEmployee AS TblEmployee_3 ON ACCOUNTS.Account_Code = TblEmployee_3.Account_Code4"
            
                    sql = sql & " LEFT OUTER JOIN TblEmployee AS TblEmployee_4 ON ACCOUNTS.Account_Code = TblEmployee_4.Account_Code5"
                    sql = sql & " Where ACCOUNTS.Account_Code <>'r' "
                    ...
                    ElseIf Me.CboAccountCodeSearch.ListIndex = -1 Then
                        ...
                        Else
                            ...
                            sql = sql & "and (TblEmployee_2.FullCode  = '" & Trim(Text1(0).text) & "'  Or TblEmployee_3.FullCode  = '" & Trim(Text1(0).text) & "' Or  TblEmployee_1.FullCode  = '" & Trim(Text1(0).text) & "' "
                                
                            sql = sql & " Or  TblEmployee.FullCode  = '" & Trim(Text1(0).text) & "' Or  TblEmployee_4.FullCode  = '" & Trim(Text1(0).text) & "')"
            ...
            If Text1(0).text = "" And OpTcode(1).value = False Then
                sql = "   SELECT  ACCOUNTS.Account_Code ,ACCOUNTS.Account_SERIAL, ACCOUNTS.Account_Name As FirstName,ACCOUNTS_1.Account_Name As ParentName, ACCOUNTS_2.Account_Name As RootName ,ACCOUNTS_1.Account_Code ParentCode,ACCOUNTS_1.Account_Serial Account_SerialPar ,ACCOUNTS.Account_ID  FROM (ACCOUNTS  LEFT OUTER JOIN  ACCOUNTS AS ACCOUNTS_1 ON ACCOUNTS.Parent_Account_Code = ACCOUNTS_1.Account_Code)   LEFT OUTER JOIN ACCOUNTS AS ACCOUNTS_2 ON ACCOUNTS_1.Parent_Account_Code= ACCOUNTS_2.Account_Code Where ACCOUNTS.Account_Code <>'r'   "
        ...
        If Index = 1 Then
            ...
            If Text1(1).text = "" Then
                sql = "SELECT  ACCOUNTS.Account_Code ,ACCOUNTS.Account_SERIAL, ACCOUNTS.Account_Name As FirstName,ACCOUNTS_1.Account_Name As ParentName, ACCOUNTS_2.Account_Name As RootName,ACCOUNTS_1.Account_Code ParentCode ,ACCOUNTS.Account_ID  FROM (ACCOUNTS  LEFT OUTER JOIN  ACCOUNTS AS ACCOUNTS_1 ON ACCOUNTS.Parent_Account_Code = ACCOUNTS_1.Account_Code)   LEFT OUTER JOIN ACCOUNTS AS ACCOUNTS_2 ON ACCOUNTS_1.Parent_Account_Code= ACCOUNTS_2.Account_Code Where ACCOUNTS.Account_Code <>'r'    AND ACCOUNTS.Account_Serial like '%X" & Text1(Index).text & "%' " 'Order By ACCOUNTS.Account_Name
            End If
        End If
        If Me.case_id = 291115 Or Me.case_id = 22915 Or Me.case_id = 110815 Or Me.case_id = 778899 Or Me.case_id = 667788 Or Me.case_id = 20150204 Or Me.case_id = 26112014 Or Me.case_id = 26112015 Or Me.case_id = 2001 Or Me.case_id = 350 Or Me.case_id = 200 Or Me.case_id = 201301 Or Me.case_id = 201302 Or Me.case_id = 1700 Or Me.case_id = 177 Or Me.case_id = 178 Or Me.case_id = 188 Or Me.case_id = 189 Or Me.case_id = 190 Or Me.case_id = 1200 Or Me.case_id = 191 Or Me.case_id = 192 Or Me.case_id = 23072014 Or Me.case_id = 2014110501 Or Me.case_id = 2014110502 Or Me.case_id = 50150221 Or Me.case_id = 17815 Or Me.case_id = 80 Or Me.case_id = 350053 Or Me.case_id = 350054 Or Me.case_id = 6660 Or Me.case_id = 6661 Or Me.case_id = 203 Or Me.case_id = 204 Or Me.case_id = 190 Or Me.case_id = 260816 Or Me.case_id = 260817 Or Me.case_id = 2608178 _
        Or Me.case_id = 654879 Or Me.case_id = 240219 Or Me.case_id = 260219 Or Me.case_id = 2602191 Or Me.case_id = 90519 Or Me.case_id = 90520 Or Me.case_id = 10519 Or Me.case_id = 20190719 Or _
           Me.case_id = 31219 Or Me.case_id = 29121 Or Me.case_id = 29122 Then

            sql = sql & " and ACCOUNTS.last_account=1"
        End If
        If Me.case_id = 25102017 Or Me.case_id = 789725 Or Me.case_id = 16112 Or Me.case_id = 700 Or Me.case_id = 55 Or Me.case_id = 66 Or Me.case_id = 77 Or Me.case_id = 88 Or Me.case_id = 556 Or Me.case_id = 990 Or Me.case_id = 558 Or Me.case_id = 557 Or Me.case_id = 559 Then
            sql = sql & " and ACCOUNTS.last_account=0"
        End If
