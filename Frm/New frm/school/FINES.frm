...
Private Sub Form_Load()
    ...
    Adodc1.RecordSource = "SELECT * FROM FINES WHERE MEMBER_ID=0 "
    Adodc1.Refresh
    ...
    Adodc4.RecordSource = "select * from  Fine_TYPES "
    Adodc4.Refresh

    Adodc5.ConnectionString = connection_string
    Adodc5.CommandType = adCmdText
    Adodc5.RecordSource = "select * from   FINES_DETAILS"
    Adodc5.Refresh
    ...
    Adodc7.CommandType = adCmdText
    Adodc7.RecordSource = " select *  FROM MEMBERS where MEMBER_ID =0 "
    Adodc7.Refresh
