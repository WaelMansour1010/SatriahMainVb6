...
Begin VB.Form member_activity 
   ...
   Begin MSDataListLib.DataCombo DataCombo1 
      Bindings        =   "member_activity.frx":0000
   ...
   End
End
Attribute VB_Name = "member_activity"
...
Private Sub Command2_Click()
    ...
    If CHECKN = 1 Then
        ...
        Adodc5.Recordset.Fields!operation_type = "‰‘«ÿ ÃœÌœ"
...
Private Sub Command3_Click()
    member_search.Show
    member_search.from = 1

End Sub

Private Sub Command4_Click()
    MEMBER_CHILD_SEARCH.Show
    MEMBER_CHILD_SEARCH.from = 1
End Sub
...
Private Sub Form_Load()
    ...
    Adodc1.RecordSource = "select * from  member_activity"
    Adodc1.Refresh
