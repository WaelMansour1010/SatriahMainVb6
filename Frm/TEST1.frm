...
'''//////////
         ...
         '  End If
           '/////////
                 ...
                 If ModAccounts.check_account_exist(Account_Code_dynamic) = True Then
                     If Current_account = "" Then 'new
                      rs("Account_Code1").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "   ÷„«‰ «·«⁄„«· ", True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "  Gurantee  ")
                     Else 'check
                            If ModAccounts.check_account_exist(Current_account) = False Then
                            rs("Account_Code1").value = ModAccounts.AddNewAccount(Account_Code_dynamic, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "   ÷„«‰ «·«⁄„«· ", True, False, IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "  Gurantee  ")
                             Else
                               ModAccounts.EditAccount rs("Account_Code1").value, IIf(IsNull(rs("CusName")), rs("Fullcode").value, rs("CusName")) & "    ÷„«‰ «·«⁄„«·  ", IIf(IsNull(rs("CusNamee")), rs("Fullcode").value, rs("CusNamee")) & "  Cheque Box ", , , , , , , , , , , , , , , , , True
                             End If
