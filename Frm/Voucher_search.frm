...
Private Sub Combo1_Click()
    ...
    If Combo1.ListIndex = 0 Then
        Sql = "SELECT     * from dbo.RptLedger_Sub  where NoteType=200 "
        Adodc1.RecordSource = Sql
        Adodc1.Refresh
...
Sql = Sql & " and   convert(decimal(30,10), noteSerial)   LIKE '%" & (Text1(0).text) & "%'"

End If


If (Text1(1).text) <> "" Then
Sql = Sql & " and    DEV_DES like '%" & Text1(1).text & "%'"
...
Sql = Sql & " AND dev_value >=" & val(Text1(3).text)

End If
 
If val((Text1(5).text)) <> 0 Then
Sql = Sql & " AND dev_value <=" & val(Text1(5).text)

End If

 If (Text1(4).text) <> "" Then
Sql = Sql & " and    remark like '%" & Text1(4).text & "%'"
...
End If
 ...
 If SystemOptions.usertype <> UserAdminAll Then
       Sql = Sql & " and branch_id =" & Current_branch & ""
    End If
    ...
    If SystemOptions.UserInterface = ArabicInterface Then
         Label12.Caption = "‰ ÌÃ… «·»ÕÀ  " & Adodc1.Recordset.RecordCount
    Else
