...
'-----------------------------------
   ...
   ' Cn.BeginTrans
    ...
    CreateSalesTrans Dcbranch(mIndex).BoundText, 0, XPDtbTrans(mIndex).Value, 21, 0, val(user_id), 0, DcCustmer.BoundText, CDbl(StoreId1), 1, DcboEmp.BoundText, "›« Ê—… „»Ì⁄«  »‰«¡« ⁄·Ï «„— ‘€· —ﬁ„ " & TxtSerial1(mIndex)
