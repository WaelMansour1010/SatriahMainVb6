...
End If
 ...
 StrSQL = StrSQL & "  and ( dbo.TblCustemers.BranchId in(" & Current_branchSql & ") or dbo.TblCustemers.BranchId is null)"
...
End If
    ...
    getOpeningBalancedate , , , , year(todate), openingbalacedate, True
        ...
        StrSQL = " update projects"
          ...
          StrSQL = StrSQL & " set  expansesE_account_balance= dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(todate) & "', expanses_account, 1),"
          StrSQL = StrSQL & " UnderAccountBalance=  isnull(dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(todate) & "', AccountUnderImp, 1),0)+ isnull(dbo.GetOpeningBalance('" & SQLDate(openingbalacedate) & "', AccountUnderImp,1),0),"
          StrSQL = StrSQL & "    expansesM_account_balance= dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(todate) & "', Material_account, 1),"
          StrSQL = StrSQL & "    expansesS_account_balance= dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(todate) & "', Salary_account, 1),"
          StrSQL = StrSQL & "    REVENUE_account_balance= dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(todate) & "', REVENUE_account,  1),"
          StrSQL = StrSQL & " Legal_account_balance=  isnull(dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(todate) & "', legal, 1),0)+ isnull(dbo.GetOpeningBalance('" & SQLDate(openingbalacedate) & "', legal,1),0),"
...
'todate1 = DTPickerAccTo.value
  ...
  ' Dim Fromdate As Date
   StrSQL = StrSQL & " set  expansesE_account_balance= dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(ToDate1) & "', expanses_account, 1),"
      StrSQL = StrSQL & "    expansesM_account_balance= dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(ToDate1) & "', Material_account, 1),"
       StrSQL = StrSQL & "    expansesS_account_balance= dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(ToDate1) & "', Salary_account, 1),"
          StrSQL = StrSQL & "    REVENUE_account_balance= dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(ToDate1) & "', REVENUE_account,  1),"
          StrSQL = StrSQL & " Legal_account_balance=  isnull(dbo.GetBalance('" & SQLDate(Fromdate) & "','" & SQLDate(ToDate1) & "', legal, 1),0)+ isnull(dbo.GetOpeningBalance('" & SQLDate(openingbalacedate) & "', legal,1),0),"
