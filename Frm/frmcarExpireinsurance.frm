...
Begin VB.Form FrmCarExpireInsurance 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "»Ì«‰«  «·„⁄œ« /«·”Ì«—«  «· Ì  ”Ì‰ ÂÌ  «„Ì‰Â«"
   ClientHeight    =   6210
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9645
   Icon            =   "frmcarExpireinsurance.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList GrdImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmcarExpireinsurance.frx":058A
               Key             =   "CompanyName"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmcarExpireinsurance.frx":0924
               Key             =   "Ser"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmcarExpireinsurance.frx":0CBE
               Key             =   "Vac_Name"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmcarExpireinsurance.frx":1058
               Key             =   "ShareCount"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmcarExpireinsurance.frx":13F2
               Key             =   "Dis_Count"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmcarExpireinsurance.frx":178C
               Key             =   "Bouns"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmcarExpireinsurance.frx":1B26
               Key             =   "SharesValue"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmcarExpireinsurance.frx":20C0
               Key             =   "BuyValue"
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame Frm2 
      ...
      Begin VB.ComboBox CmbType 
         BackColor       =   &H80000018&
         Height          =   315
         ItemData        =   "frmcarExpireinsurance.frx":245A
         Left            =   2280
         List            =   "frmcarExpireinsurance.frx":246A
         RightToLeft     =   -1  'True
   ...
   Begin C1SizerLibCtl.C1Elastic EltCont 
      ...
      Begin ImpulseButton.ISButton btnNew 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "frmcarExpireinsurance.frx":2483
      ...
      Begin ImpulseButton.ISButton btnSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "frmcarExpireinsurance.frx":281D
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnModify 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "frmcarExpireinsurance.frx":2BB7
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnUndo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "frmcarExpireinsurance.frx":2F51
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnDelete 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "frmcarExpireinsurance.frx":32EB
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnQuery 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "frmcarExpireinsurance.frx":3885
      ...
      Begin ImpulseButton.ISButton BtnUpdate 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "frmcarExpireinsurance.frx":3C1F
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "frmcarExpireinsurance.frx":3FB9
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
   ...
   Begin ImpulseButton.ISButton btnCancel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      ButtonImage     =   "frmcarExpireinsurance.frx":4353
      ColorButton     =   14871017
      DrawFocusRectangle=   0   'False
      DisabledImageStyle=   1
   End
   Begin VSFlex8Ctl.VSFlexGrid Grid 
      ...
      FormatString    =   $"frmcarExpireinsurance.frx":46ED
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmCarExpireInsurance"
...
Private Sub Command1_Click()
    ...
    If val(TxtQtyUpload.Text) <> 0 Then
        If RdTotal(0).value = True Then
            My_SQL = My_SQL & " AND  DATEDiff(D ,GETDATE(), TblCarsData.TestExpireDate)  >" & val(TxtQtyUpload.Text) & ""
        ...
        End If
    Else
       My_SQL = My_SQL & "  and   (InsuranceExpireDate >= CONVERT(DATETIME, '" & Format$(d1.value, "dd-mm-yyyy") & " 00:00:00', 102)) AND (LicenseExpireDate <= CONVERT(DATETIME, '" & Format$(d2.value, "dd-mm-yyyy") & " 00:00:00', 102))"
...
Private Sub Command2_Click()
    ...
    Set xReport = xApp.OpenReport(App.path & "\reports\Transporter\REPORT2.rpt")
    xReport.Database.SetDataSource rs
    Dim FrmReport As New FrmReportViewer
    '   FrmReport = New FrmReportViewer
    FrmReport.CRViewer.ReportSource = xReport
    FrmReport.txtpath = (App.path & "\reports\Transporter\REPORT2.rpt")
    ...
    With Me.Grid
        ...
        If rs.RecordCount > 0 Then
            ...
            For i = 1 To .Rows - 1
                ...
                .TextMatrix(i, .ColIndex("InsuranceExpireDateH")) = IIf(IsNull(rs.Fields("InsuranceExpireDateH").value), "", rs.Fields("InsuranceExpireDateH").value)
                .TextMatrix(i, .ColIndex("InsuranceExpireDate")) = IIf(IsNull(rs.Fields("InsuranceExpireDate").value), "", rs.Fields("InsuranceExpireDate").value)
            
                Dim days As Double
      
                days = IIf(IsNull(rs.Fields("InsuranceExpireDate").value), "", DateDiff("d", Date, rs.Fields("InsuranceExpireDate").value))
