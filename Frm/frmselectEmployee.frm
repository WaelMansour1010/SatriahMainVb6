...
Private Sub Form_Load()
   ...
   StrSQL = " SELECT     dbo.TblEmployee.Emp_Name, dbo.TblEmployee.Emp_Code, dbo.TblEmployee.Emp_Namee, dbo.TBLSalesRepData.EmpID"
    ...
    If Not (RsTemp.EOF Or RsTemp.BOF) Then
        ...
        With fg
            ...
            For ReCount = 1 To RsTemp.RecordCount
                ...
                .TextMatrix(RowNum, .ColIndex("EmpID")) = IIf(IsNull(RsTemp("EmpID").value), "", RsTemp("EmpID").value)
