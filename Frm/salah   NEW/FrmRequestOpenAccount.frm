...
Begin VB.Form FormRequestOpenAccount 
   BackColor       =   &H00E2E9E9&
   ...
   ClientTop       =   330
   ClientWidth     =   12795
   Icon            =   "FrmRequestOpenAccount.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   RightToLeft     =   -1  'True
   ...
   Begin C1SizerLibCtl.C1Elastic EleHeader 
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmRequestOpenAccount.frx":038A
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmRequestOpenAccount.frx":0724
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmRequestOpenAccount.frx":0ABE
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmRequestOpenAccount.frx":0E58
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
   ...
   Begin MSDataListLib.DataCombo Dcbranch 
      Bindings        =   "FrmRequestOpenAccount.frx":11F2
      Height          =   315
      Left            =   2640
      TabIndex        =   30
      Top             =   720
   ...
   Begin C1SizerLibCtl.C1Tab XPTab301 
      ...
      AccessibleValue =   ""
      AccessibleRole  =   37
      Picture(0)      =   "FrmRequestOpenAccount.frx":1207
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         Begin VSFlex8UCtl.VSFlexGrid GRID2 
            ...
            FormatString    =   $"FrmRequestOpenAccount.frx":15A1
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         FrameShadow     =   -2147483632
         FloodStyle      =   1
         _GridInfo       =   $"FrmRequestOpenAccount.frx":16ED
         AccessibleName  =   ""
         AccessibleDescription=   ""
         AccessibleValue =   ""
         AccessibleRole  =   9
   ...
   End
End
Attribute VB_Name = "FormRequestOpenAccount"
...
MySQL = "SELECT     ID, RecordDate, BranchID, ClientName, AdminName, Telephone, Mobil, Address"
MySQL = MySQL & " From dbo.TblRequestOpenAccount"
MySQL = MySQL & " Where (id =" & val(XPTxtID.text) & ")"
 
        If SystemOptions.UserInterface = ArabicInterface Then
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RequestOpenAccount.rpt"
        Else
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RequestOpenAccount.rpt"
        End If
...
Private Sub Form_Load()
  ...
  '  YearMonth
    ...
    StrSQL = "select * From TblRequestOpenAccount     Order By ID"
...
Private Sub ChangeLang()
 ...
 Cmd(9).Caption = "Prient"
    ...
    Me.Caption = "Request to Open an Account"
    EleHeader.Caption = Me.Caption
    lbl(4).Caption = "OPR#"
    lbl(1).Caption = "Date"
    LblBr.Caption = "Bramch"
    LblDataClient.Caption = "Data of Client"
    lbl(3).Caption = "Mobile"
    lbl(5).Caption = "Client Name"
    lbl(2).Caption = "Telephone"
    lbl(9).Caption = "Company Address"
    lbl(11).Caption = "Resp Comm"
 '   lbl(2).Caption = "value"
 '   lbl(0).Caption = "Box"
...
Public Sub Retrive(Optional Lngid As Long = 0)
    ...
    Me.TxtClientname.text = IIf(IsNull(rs("ClientName").value), "", rs("ClientName").value)
    Me.TxtAdminName.text = IIf(IsNull(rs("AdminName").value), "", rs("AdminName").value)
    Me.TxtTelephone.text = IIf(IsNull(rs("Telephone").value), "", rs("Telephone").value)
    Me.TxtMobil.text = IIf(IsNull(rs("Mobil").value), "", rs("Mobil").value)
...
'
    Cn.BeginTrans
        ...
        If TxtModFlg.text = "N" Then
            ...
            XPTxtID.text = CStr(new_id("TblRequestOpenAccount", "ID", "", True))
       ...
       '     Me.oldtxtNoteSerial1.text = Trim$(Me.TxtNoteSerial1.text)
        ...
        rs("ClientName").value = TxtClientname.text
        rs("AdminName").value = TxtAdminName.text
        rs("Telephone").value = TxtTelephone.text
        rs("Mobil").value = TxtMobil.text
