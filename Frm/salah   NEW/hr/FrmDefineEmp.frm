...
Begin VB.Form FrmDefineEmp 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Contract_period 
         Height          =   315
         ItemData        =   "FrmDefineEmp.frx":07EE
         Left            =   13200
         List            =   "FrmDefineEmp.frx":07F8
         RightToLeft     =   -1  'True
         TabIndex        =   70
         Top             =   480
         Width           =   975
      ...
      Begin MSDataListLib.DataCombo Dcbranch 
         Bindings        =   "FrmDefineEmp.frx":0806
         Height          =   315
         Left            =   2760
         TabIndex        =   60
         Top             =   240
   ...
   Begin C1SizerLibCtl.C1Elastic EleHeader 
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmDefineEmp.frx":081B
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmDefineEmp.frx":0BB5
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmDefineEmp.frx":0F4F
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmDefineEmp.frx":12E9
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
   ...
   Begin C1SizerLibCtl.C1Tab XPTab301 
      ...
      AccessibleValue =   ""
      AccessibleRole  =   37
      Picture(0)      =   "FrmDefineEmp.frx":52EB
      Flags(1)        =   2
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         Begin VSFlex8UCtl.VSFlexGrid GRID2 
            ...
            FormatString    =   $"FrmDefineEmp.frx":5685
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         FrameShadow     =   -2147483632
         FloodStyle      =   1
         _GridInfo       =   $"FrmDefineEmp.frx":57D1
         AccessibleName  =   ""
         AccessibleDescription=   ""
         AccessibleValue =   ""
         AccessibleRole  =   9
         Begin C1SizerLibCtl.C1Elastic Ele 
            ...
            Begin VB.Frame lbDW 
               ...
               Begin MSDataListLib.DataCombo DcboJobsType 
                  ...
                  RightToLeft     =   -1  'True
               End
               Begin MSComCtl2.DTPicker IssueDate 
                  Height          =   315
                  Left            =   3720
                  TabIndex        =   44
                  Top             =   240
            ...
            Begin VSFlex8UCtl.VSFlexGrid Fg 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"FrmDefineEmp.frx":5805
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmDefineEmp"
...
FG.Enabled = True
        ...
        Case 5
            ...
            Load FrmEmpMoveSearch
            FrmEmpMoveSearch.show
...
'MySQL = " SELECT     dbo.TblDefin.RecordDate, dbo.TblDefin.RecordDateH, dbo.TblDefin.ID, dbo.TblDefinDetails.MValue, dbo.mofrdat.mofrad_name, dbo.TblDefin.BranchID, "
'  MySQL = MySQL & "                     dbo.TblBranchesData.branch_name, dbo.TblBranchesData.branch_namee, dbo.TblDefin.EmpID, dbo.TblEmployee.Emp_Code, dbo.TblEmployee.Emp_Name,"
...
' MySQL = MySQL & "                      dbo.TblDefin.JobID, dbo.TblEmpJobsTypes.JobTypeName, dbo.TblEmpJobsTypes.JobTypeNamee, dbo.TblDefin.TypeDef, dbo.TblDefin.FileNo, dbo.TblDefin.CurrSala,"
' MySQL = MySQL & "                      dbo.TblDefin.PointSala, dbo.TblDefin.Iqama, dbo.TblDefin.IssuDate, dbo.TblDefin.IssuDateH, dbo.TblDefin.Remark, dbo.TblDefin.UserID,"
' MySQL = MySQL & "                      dbo.TblEmployee.Nationality"
' MySQL = MySQL & " FROM         dbo.TblEmpJobsTypes LEFT OUTER JOIN"
'  MySQL = MySQL & "                     dbo.TblDefin ON dbo.TblEmpJobsTypes.JobTypeID = dbo.TblDefin.JobID LEFT OUTER JOIN"
'  MySQL = MySQL & "                     dbo.TblEmployee ON dbo.TblDefin.EmpID = dbo.TblEmployee.Emp_ID LEFT OUTER JOIN"
'   MySQL = MySQL & "                    dbo.TblBranchesData ON dbo.TblDefin.BranchID = dbo.TblBranchesData.branch_id LEFT OUTER JOIN"
'   MySQL = MySQL & "                    dbo.mofrdat RIGHT OUTER JOIN"
'   MySQL = MySQL & "                    dbo.TblDefinDetails ON dbo.mofrdat.mofrad_code = dbo.TblDefinDetails.Morfd ON dbo.TblDefin.ID = dbo.TblDefinDetails.IDDef"
' MySQL = MySQL & " Where (dbo.TblDefin.id =" & val(XPTxtID.Text) & ")"
'
...
MySQL = MySQL & " Where (dbo.TblDefin.id =" & val(XPTxtID.text) & ")"
 ...
 If opt(0).value = True Then
        If SystemOptions.UserInterface = ArabicInterface Then
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepDefinAccount.rpt"
        Else
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepDefinAccount.rpt"
        End If
 ...
 Else
  ...
  If SystemOptions.UserInterface = ArabicInterface Then
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepDefin.rpt"
        Else
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepDefin.rpt"
        End If
 End If
...
Private Sub IssueDate_Change()
If Me.TxtModFlg.text <> "R" Then
     
         IssueDateH.value = ToHijriDate(IssueDate.value)
       
End If
End Sub

Private Sub IssueDateH_LostFocus()
If Me.TxtModFlg.text <> "R" Then
     
      IssueDate.value = ToGregorianDate(IssueDateH.value)
...
End If
 ...
 '   Dcombos.GetEmpGrades Me.DcboSpecifications
  ...
  '  YearMonth
    ...
    StrSQL = "select * From TblDefin     Order By ID"
...
opt(0).Caption = "DefinFinancial"
opt(1).Caption = "Definition"
...
XPTab301.Caption = "Data"
 ...
 lbDW.Caption = "Data of Employee"
   lbl(10).Caption = "Iqama No"
  
    lbl(24).Caption = "Job"
   
  lbl(9).Caption = "Issue Date"
...
Public Sub Retrive(Optional Lngid As Long = 0)
    ...
    XPDtbTransH.value = IIf(IsNull(rs("RecordDateH").value), Date, rs("RecordDateH").value)
    ...
    DcNational.BoundText = IIf(IsNull(rs("NotionalID").value), "", rs("NotionalID").value)
      Me.txtFile.text = IIf(IsNull(rs("FileNo").value), "", rs("FileNo").value)
       lbl(23).Caption = IIf(IsNull(rs("CurrSala").value), "", rs("CurrSala").value)
       lbl(31).Caption = IIf(IsNull(rs("PointSala").value), "", rs("PointSala").value)
  ' DcProject.BoundText = IIf(IsNull(rs("ProjectID").value), "", rs("ProjectID").value)
   Me.TxtIqamaNo.text = IIf(IsNull(rs("Iqama").value), "", rs("Iqama").value)

   Me.IssueDate.value = IIf(IsNull(rs("IssuDate").value), Date, rs("IssuDate").value)
    IssueDateH.value = IIf(IsNull(rs("IssuDateH").value), Date, rs("IssuDateH").value)
   If IsNull(rs("TypeDef").value) Then
          opt(0).value = True
   Else
  ...
  '       Opt(0).value = IIf((rs("HolidayType").value) = 1, True, False)
            If rs("TypeDef").value = False Then
             opt(0).value = True
            ElseIf rs("TypeDef").value = True Then
             opt(1).value = True
            End If
...
''                                                   If SystemOptions.UserInterface = ArabicInterface Then
 ...
 StrSQL = " SELECT     dbo.TblDefinDetails.ID, dbo.TblDefinDetails.IDDef, dbo.TblDefinDetails.MValue, dbo.TblDefinDetails.Morfd, dbo.mofrdat.mofrad_name"
StrSQL = StrSQL & " FROM         dbo.TblDefinDetails LEFT OUTER JOIN"
StrSQL = StrSQL & "                      dbo.mofrdat ON dbo.TblDefinDetails.Morfd = dbo.mofrdat.mofrad_code"
StrSQL = StrSQL & " Where (dbo.TblDefinDetails.IDDef = " & val(Me.XPTxtID.text) & ")"
 
'StrSQL = StrSQL & " Where (dbo.TblDefinDetails.IDDef = " & val(XPTxtID.text)
 RsDetails.Open StrSQL, Cn, adOpenStatic, adLockReadOnly, adCmdText
    ...
    If Not (RsDetails.BOF Or RsDetails.EOF) Then
        ...
        FG.TextMatrix(i, FG.ColIndex("Serial")) = i
            FG.TextMatrix(i, FG.ColIndex("mofrdID")) = RsDetails("Morfd").value
           FG.TextMatrix(i, FG.ColIndex("mofrd")) = RsDetails("mofrad_name").value
            FG.TextMatrix(i, FG.ColIndex("value")) = RsDetails("MValue").value
            RsDetails.MoveNext
        Next i
...
'
        ...
        If TxtModFlg.text = "N" Then
            ...
            XPTxtID.text = CStr(new_id("TblDefin", "ID", "", True))
       '     TxtNoteID.text = CStr(new_id("Notes", "NoteID", "", True))
       '     Me.oldtxtNoteSerial1.text = Trim$(Me.TxtNoteSerial1.text)
        
            rs.AddNew
        ElseIf Me.TxtModFlg.text = "E" Then
            StrSQL = "Delete From TblDefinDetails Where IDDef=" & val(Me.XPTxtID.text)
            Cn.Execute StrSQL, , adExecuteNoRecords

        End If
           rs("ID").value = val(XPTxtID.text)
         rs("RecordDate").value = XPDtbTrans.value
         rs("RecordDateH").value = XPDtbTransH.value
        rs("EmpID").value = IIf(DcboEmpName.BoundText = "", Null, DcboEmpName.BoundText)
       rs("BranchID").value = IIf(Me.dcBranch.BoundText = "", Null, Me.dcBranch.BoundText)
         rs("JobID").value = val(IIf(Me.DcboJobsType.BoundText = "", 0, val(Me.DcboJobsType.BoundText)))
         rs("NotionalID").value = val(IIf(Me.DcNational.BoundText = "", Null, Me.DcNational.BoundText))
  rs("UserID").value = IIf(Me.DCboUserName.BoundText = "", Null, Me.DCboUserName.BoundText) 'Me.DCboUserName.BoundText
 rs("FileNo").value = IIf(Me.txtFile.text = "", "", Me.txtFile.text)
 rs("CurrSala").value = val(lbl(23).Caption)
  rs("PointSala").value = val(lbl(31).Caption)
   If opt(0).value = True Then
    rs("TypeDef").value = 0
   Else
   rs("TypeDef").value = 1
   End If
   rs("Iqama").value = IIf(Me.TxtIqamaNo.text = "", "", Me.TxtIqamaNo.text)

 rs("IssuDate").value = IssueDate.value
         rs("IssuDateH").value = IssueDateH.value



        rs.update
           Set RsDetails = New ADODB.Recordset
       StrSQL = "SELECT     *  from dbo.TblDefinDetails Where (1 = -1)"
   RsDetails.Open StrSQL, Cn, adOpenKeyset, adLockOptimistic, adCmdText
       ...
       If val(FG.TextMatrix(i, FG.ColIndex("mofrdID"))) <> 0 Then
            RsDetails.AddNew
            RsDetails("IDDef").value = val(XPTxtID.text)
            RsDetails("MValue").value = val(FG.TextMatrix(i, FG.ColIndex("value")))
            RsDetails("Morfd").value = val(FG.TextMatrix(i, FG.ColIndex("mofrdID")))
