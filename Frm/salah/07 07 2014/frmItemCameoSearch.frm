...
Begin VB.Form FrmItemCameoSearch 
   BackColor       =   &H00E2E9E9&
   ...
   ClientTop       =   435
   ClientWidth     =   6780
   Icon            =   "frmItemCameoSearch.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"frmItemCameoSearch.frx":038A
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmItemCameoSearch"
...
'FrmCarAuthontication.ComGranty.ListIndex = 2
  'End If
           ...
           With FrmItems.fgCameo
                ' FrmExpenses3.Fg_Journal_StartEdit .Row, 4, False
                .TextMatrix(.Row, .ColIndex("type")) = Fg.TextMatrix(Fg.Row, 4)
                '  .TextMatrix(.Row, .ColIndex("nohours")) = Fg.TextMatrix(Fg.Row, 3)
                .TextMatrix(.Row, .ColIndex("id")) = Fg.TextMatrix(Fg.Row, 1)
...
Public Sub GetData()
    ...
    Dim Msg As String
    Dim i As Integer
 'select code,name,nameE from TblDiamonds
 StrSQL = " SELECT    * From dbo.TblGemstones"
'StrSQL = StrSQL & " From dbo.TblMaintenanceWork "
    ...
    If val(Me.TxtIDFrom.text) <> 0 Then
        If BolBegine = True Then
            StrWhere = StrWhere & " code >=" & val(Me.TxtIDFrom.text) & ""
        Else
            BolBegine = True
            StrWhere = " Where code >=" & val(Me.TxtIDFrom.text) & ""
        End If
    End If
    ...
    If val(Me.TxtIDTO.text) <> 0 Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND code <=" & val(Me.TxtIDTO.text) & ""
        Else
            BolBegine = True
            StrWhere = " Where code <=" & val(Me.TxtIDTO.text) & ""
        End If
    End If
    '///////////////////
     If TxtPhone.text <> "" Then
        If BolBegine = True Then
            StrWhere = StrWhere & " AND name like like '%" & Me.TxtPhone.text & "%'"
        Else
            BolBegine = True
            StrWhere = " Where name like '%" & Me.TxtPhone.text & "%'"
        End If
    End If
    ...
    Else
        ...
        With Me.Fg
            ...
            For i = .FixedRows To .Rows - 1
                ...
                .TextMatrix(i, .ColIndex("id")) = IIf(IsNull(rs("code").value), "", rs("code").value)
...
Private Sub ChangeLang()
    ...
    Cmd(2).Caption = "Exit"
  Me.Caption = "Search Gemstones"

Me.LblClientName.Caption = "Gemstones "
'bl(4).Caption = "From"
'bl(3).Caption = "To"
lbl(5).Caption = "From"
lbl(6).Caption = "To"
...
Me.lbprocess.Caption = "Process No"
     With Me.Fg
        ...
        .TextMatrix(0, .ColIndex("RecordDate")) = "Date"
         .TextMatrix(0, .ColIndex("name")) = "Gemstones"
