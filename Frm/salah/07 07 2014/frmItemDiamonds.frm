...
Begin VB.Form FrmItemDiamoSearch 
   BackColor       =   &H00E2E9E9&
   ...
   Begin VSFlex8UCtl.VSFlexGrid Fg 
      ...
      FormatString    =   $"frmItemDiamonds.frx":038A
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmItemDiamoSearch"
...
Public Sub GetData()
 ...
 StrSQL = " SELECT    * From dbo.TblDiamonds"
...
Private Sub ChangeLang()
    ...
    Cmd(2).Caption = "Exit"
  Me.Caption = "Search Diamonds"

Me.LblClientName.Caption = "Diamonds "
'bl(4).Caption = "From"
'bl(3).Caption = "To"
lbl(5).Caption = "From"
lbl(6).Caption = "To"
...
Me.lbprocess.Caption = "Process No"
     With Me.Fg
        ...
        .TextMatrix(0, .ColIndex("RecordDate")) = "Date"
         .TextMatrix(0, .ColIndex("name")) = "Diamonds"
