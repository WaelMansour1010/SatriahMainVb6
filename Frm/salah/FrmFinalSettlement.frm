...
Begin VB.Form FrmFinalSettlement 
   BackColor       =   &H00E2E9E9&
   ...
   ClientTop       =   330
   ClientWidth     =   12780
   Icon            =   "FrmFinalSettlement.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   RightToLeft     =   -1  'True
   ...
   Begin C1SizerLibCtl.C1Elastic EleHeader 
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmFinalSettlement.frx":038A
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmFinalSettlement.frx":0724
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmFinalSettlement.frx":0ABE
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin ImpulseButton.ISButton XPBtnMove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmFinalSettlement.frx":0E58
         ColorHighlight  =   4194304
         ColorHoverText  =   16777215
         ColorShadow     =   -2147483631
         ColorOutline    =   -2147483631
      ...
      Begin VB.Image ImgFavorites 
         Height          =   390
         Left            =   5520
         Picture         =   "FrmFinalSettlement.frx":11F2
         Stretch         =   -1  'True
         Top             =   0
         Width           =   525
      End
   ...
   Begin MSDataListLib.DataCombo Dcbranch 
      Bindings        =   "FrmFinalSettlement.frx":4E5A
      Height          =   315
      Left            =   2640
      TabIndex        =   29
      Top             =   720
   ...
   Begin C1SizerLibCtl.C1Tab XPTab301 
      ...
      AccessibleValue =   ""
      AccessibleRole  =   37
      Picture(0)      =   "FrmFinalSettlement.frx":4E6F
      Flags(1)        =   2
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         Begin VSFlex8UCtl.VSFlexGrid GRID2 
            ...
            FormatString    =   $"FrmFinalSettlement.frx":5209
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin C1SizerLibCtl.C1Elastic Ele 
         ...
         FrameShadow     =   -2147483632
         FloodStyle      =   1
         _GridInfo       =   $"FrmFinalSettlement.frx":5355
         AccessibleName  =   ""
         AccessibleDescription=   ""
         AccessibleValue =   ""
         AccessibleRole  =   9
   ...
   End
End
Attribute VB_Name = "FrmFinalSettlement"
...
MySQL = " SELECT     dbo.TblFinalSettl.ID, dbo.TblFinalSettl.RecordDate, dbo.TblFinalSettl.NationalID, dbo.TblFinalSettl.BranchID, dbo.TblFinalSettl.FileNo, dbo.TblFinalSettl.EndDate,"
       ...
       MySQL = MySQL & "                dbo.TblEmployee.Emp_Name4, dbo.TblEmployee.Nationality, dbo.TblEmployee.Emp_Namee, dbo.TblEmployee.Emp_Namee1, dbo.TblEmployee.Emp_Namee2,"
         MySQL = MySQL & "              dbo.TblEmployee.Emp_Namee4 , dbo.TblEmployee.Emp_Namee3"
           MySQL = MySQL & "    FROM         dbo.TblFinalSettl LEFT OUTER JOIN"
           MySQL = MySQL & "            dbo.TblEmployee ON dbo.TblFinalSettl.EmpID = dbo.TblEmployee.Emp_ID"
          MySQL = MySQL & "     Where (dbo.TblFinalSettl.id = " & val(XPTxtID.Text) & ")"
 
        If SystemOptions.UserInterface = ArabicInterface Then
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepFinalSettlement.rpt"
        Else
            StrFileName = App.path & "\REPORTS\REPORTS NEW\" & "RepFinalSettlement.rpt"
        End If
...
'    On Error Resume Next
   ...
   If Me.TxtModFlg = "R" Then Exit Sub
    ...
    Dim StrSQL As String
        ...
        get_employee_information val(Me.DcboEmpName.BoundText), IssueDate, DepID, specid, JobTypeID, gradeID, Account_code2, Account_code, endContractPerMonth, national
...
Private Sub Form_Load()
  ...
  '  Set GrdBack = New ClsBackGroundPic
   ...
   ' End With
Me.DCNationality.Enabled = False
...
Dcombos.GetEmployeesNationlity Me.DCNationality
    ...
    StrSQL = "select * From TblFinalSettl     Order By ID"
...
lbl(3).Caption = "This screen you sign a release final"
    Me.Caption = "Final Clearance"
  ...
  Me.lbldata.Caption = "Data of Employee"
  lbl(9).Caption = "Nationality"
  lbl(2).Caption = "File No"
  lbl(10).Caption = "Date Final"
  '  lbl(0).Caption = "Box"
...
DCNationality.BoundText = IIf(IsNull(rs("NationalID").value), "", rs("NationalID").value)
TxtFileNo.Text = rs("FileNo").value
...
'
    '    Cn.BeginTrans
        ...
        If TxtModFlg.Text = "N" Then
            ...
            XPTxtID.Text = CStr(new_id("TblFinalSettl", "ID", "", True))
       ...
       '     Me.oldtxtNoteSerial1.text = Trim$(Me.TxtNoteSerial1.text)
        ...
        rs("EmpID").value = val(Me.DcboEmpName.BoundText)
          rs("NationalID").value = val(Me.DCNationality.BoundText)
          rs("FileNo").value = Me.TxtFileNo.Text
...
Private Sub AddTip()
    ...
    With TTP
        .Create Me.hwnd, "„Œ«·’… ‰Â«∆Ì…", 1, 15204351, -2147483630
        .MaxWidth = 4000
        .VisibleTime = 9000
        .DelayTime = 600
