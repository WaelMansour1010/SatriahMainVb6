...
Begin VB.Form FrmCarModels 
   ...
   Begin VB.Frame Frm2 
      ...
      Begin VB.ComboBox CmbType 
         BackColor       =   &H80000018&
         Height          =   315
         ItemData        =   "FrmCarModels.frx":058A
         Left            =   2280
         List            =   "FrmCarModels.frx":059A
         RightToLeft     =   -1  'True
      ...
      Begin VB.TextBox TxtVacNamee 
         ...
         Width           =   2520
      End
      Begin MSDataListLib.DataCombo DctypeCar 
         Height          =   315
         Left            =   120
         TabIndex        =   33
         Top             =   285
   ...
   Begin VB.Frame FraHeader 
      ...
      Begin MSComctlLib.ImageList GrdImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCarModels.frx":05B3
               Key             =   "CompanyName"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCarModels.frx":094D
               Key             =   "Ser"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCarModels.frx":0CE7
               Key             =   "Vac_Name"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCarModels.frx":1081
               Key             =   "ShareCount"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCarModels.frx":141B
               Key             =   "Dis_Count"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCarModels.frx":17B5
               Key             =   "Bouns"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCarModels.frx":1B4F
               Key             =   "SharesValue"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCarModels.frx":20E9
               Key             =   "BuyValue"
            EndProperty
         EndProperty
      End
      Begin ImpulseButton.ISButton btnLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":2483
      ...
      Begin ImpulseButton.ISButton btnNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":281D
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
      Begin ImpulseButton.ISButton btnPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":2BB7
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
      Begin ImpulseButton.ISButton btnFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":2F51
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
   ...
   Begin C1SizerLibCtl.C1Elastic EltCont 
      ...
      Begin ImpulseButton.ISButton btnNew 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":32EB
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":3685
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnModify 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":3A1F
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnUndo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":3DB9
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnDelete 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":4153
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton btnQuery 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":46ED
      ...
      Begin ImpulseButton.ISButton BtnUpdate 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":4A87
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
      End
      Begin ImpulseButton.ISButton BtnPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":4E21
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
      Begin ImpulseButton.ISButton btnCancel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonImage     =   "FrmCarModels.frx":51BB
         ColorButton     =   14871017
         DrawFocusRectangle=   0   'False
         DisabledImageStyle=   1
      End
   ...
   Begin VSFlex8Ctl.VSFlexGrid Grid 
      ...
      FormatString    =   $"FrmCarModels.frx":5555
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
If Me.DctypeCar.BoundText = "" Then
                    If SystemOptions.UserInterface = ArabicInterface Then
                                   MsgBox "ÌÃ» √Œ Ì«— ‰Ê⁄ «·„⁄œÂ/«·”Ì«—…"
                     Else
...
End If
    ...
    StrVacName = IsRecExist("TblCarModels", "nameˆ", Me.DctypeCar, "name", "ID<>'" & Trim(TxtVac_ID.Text) & "'")
...
Private Sub Form_Load()
  ...
  Dim Dcombos As ClsDataCombos
    ...
    Dcombos.GetTblCarsDataGroup Me.DctypeCar
...
Private Sub ChangeLang()
    ...
    Me.Caption = "Vehicles Style"
    Me.Label1(2).Caption = Me.Caption
    Label1(3).Caption = "Code"
    Label1(1).Caption = "Name AR"
...
Public Sub AddNewRec()
    ...
    StrRecID = new_id("TblCarModels", "id", "")
    RsSavRec.AddNew
...
Public Sub FiLLRec()
    ...
    RsSavRec.Fields("CarID").value = IIf(Me.DctypeCar.BoundText <> "", Me.DctypeCar.BoundText, Null)
    RsSavRec.Fields("Model").value = IIf(TxtVacNamee.Text <> "", Trim(TxtVacNamee.Text), Null)
RsSavRec.Fields("ModelE").value = IIf(TxtVacNameee.Text <> "", Trim(TxtVacNameee.Text), Null)
...
Public Sub FiLLTXT()
    ...
    Me.DctypeCar.BoundText = IIf(IsNull(RsSavRec.Fields("CarID").value), "", RsSavRec.Fields("CarID").value)
    TxtVacNamee.Text = IIf(IsNull(RsSavRec.Fields("model").value), "", RsSavRec.Fields("model").value)
    TxtVacNameee.Text = IIf(IsNull(RsSavRec.Fields("ModelE").value), "", RsSavRec.Fields("ModelE").value)
...
Public Sub FillGridWithData()
    ...
    Set rs = New ADODB.Recordset
    My_SQL = "select * From TblCarModels order by id"
    ...
    With Me.Grid
        ...
        If rs.RecordCount > 0 Then
            ...
            For i = 1 To .Rows - 1
             ...
             Me.DctypeCar.BoundText = IIf(IsNull(rs.Fields("CarID").value), "", rs.Fields("CarID").value)
                .TextMatrix(i, .ColIndex("name")) = Me.DctypeCar
               
                .TextMatrix(i, .ColIndex("namee")) = IIf(IsNull(rs.Fields("Model").value), "", rs.Fields("Model").value)
