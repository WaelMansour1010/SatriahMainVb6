...
Begin VB.Form ItemProductionDate2 
   BackColor       =   &H00E2E9E9&
   ...
   End
End
Attribute VB_Name = "ItemProductionDate2"
...
If Index = 1 Then
    FrmStudentCalling.Fg4.TextMatrix(FrmStudentCalling.LngRow, FrmStudentCalling.Fg4.ColIndex("HoursT")) = Format(timeEnter.value, "HH:mm AM/PM")
ElseIf Index = 2 Then
    FrmItemsClass.FG5.TextMatrix(FrmItemsClass.LngRow, FrmItemsClass.FG5.ColIndex("FromDate")) = XPDtbBill.value
    FrmItemsClass.FG5.TextMatrix(FrmItemsClass.LngRow, FrmItemsClass.FG5.ColIndex("DayName")) = Weekday(XPDtbBill.value, vbUseSystemDayOfWeek)
ElseIf Index = 3 Then
    FrmItemsClass.FG5.TextMatrix(FrmItemsClass.LngRow, FrmItemsClass.FG5.ColIndex("FromTime")) = Format(timeEnter.value, "HH:mm AM/PM")
ElseIf Index = 4 Then
    FrmItemsClass.FG5.TextMatrix(FrmItemsClass.LngRow, FrmItemsClass.FG5.ColIndex("ToTime")) = Format(timeEnter.value, "HH:mm AM/PM")
...
If Index = 1 Then
    lbl(6).Visible = False
    XPDtbBill.Visible = False
ElseIf Index = 2 Then
    timeEnter.Visible = False
    lbl(9).Visible = False
