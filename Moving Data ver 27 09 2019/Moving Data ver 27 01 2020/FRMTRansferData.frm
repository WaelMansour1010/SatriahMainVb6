...
Begin VB.Form FRMTRansferData 
   ...
   Begin VSFlex8UCtl.VSFlexGrid grd 
      ...
      FormatString    =   $"FRMTRansferData.frx":0590
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
lblWait.Visible = True
  ...
  Cn.Execute "Delete notes_all " & mWhere
  Cn.Execute "Delete notes " & mWhere
  Cn.Execute "Delete Transactions " & mWhere2
  ...
  UpdateFiles POSlServer, POSDb, "TransactionValueAdded", "Transaction_ID", mWhere4
...
s = s & " Where  CusName Not In (Select Tc.CusName from  " & mServerD & "TblCustemers Tc  ) Or Code "
